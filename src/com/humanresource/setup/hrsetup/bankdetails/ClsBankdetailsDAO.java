...
public class ClsBankdetailsDAO {
 ...
 public int insert(Date formdate, String brchname, String ifsccode, String remarks,String mode, String fromcode, HttpSession session, HttpServletRequest request) throws SQLException {
        ...
        try{
               ...
               CallableStatement stmtDEP = conn.prepareCall("{CALL HR_bankDML(?,?,?,?,?,?,?,?,?)}");
   
               stmtDEP.setDate(1,formdate);
               stmtDEP.setString(2,ifsccode);
               stmtDEP.setString(3,remarks);
               stmtDEP.setString(4,brchname);
...
public int Update(int docno,Date formdate, String brchname, String ifsccode, String remarks,String mode, String formdetailcode, HttpSession session, HttpServletRequest request) throws SQLException {
   ...
   public JSONArray loadgrid() throws SQLException {
      ...
      sql="select doc_no doc_no,ifsccode ifsccode,brchname brchname,date date,remarks remarks from hr_setbank where status=3";
    ...
    public JSONArray branchdet() throws SQLException {
      ...
      sql="select distinct brchname brchname from hr_empm where status=3 and active=1"+sqltest;
    ...
    public JSONArray ifsccodedet() throws SQLException {
      ...
      sql="select distinct ifsccode ifsccode from hr_empm where status=3 and active=1"+sqltest;
