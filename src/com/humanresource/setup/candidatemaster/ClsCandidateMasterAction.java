...
public class ClsCandidateMasterAction {
	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(mode.equalsIgnoreCase("A")){
			...
			int val=cndDao.insert(getCnddate(),getTxtrefno(),getTxtcndname(),getCmbgender(),getCnddob(),getHidnationid(),getHidqualificationid(),getTxtexpyear(),getTxtpostapplied(),getHiddesignationid(),getTxtremarks(),cvarray,session,request,mode,getTxtmobileno(),getTxtmobileno());
			if(val>0.0){
			...
			int val=cndDao.edit(getDocno(),getCnddate(),getTxtrefno(),getTxtcndname(),getCmbgender(),getCnddob(),getHidnationid(),getHidqualificationid(),getTxtexpyear(),getTxtpostapplied(),getHiddesignationid(),getTxtremarks(),cvarray,session,request,mode,getTxtmobileno(),getTxtemail());
			if(val>0.0){
				setDocno(val);
				setHidmasterdocno(val);
				setData();
			...
			setTxtdesignation(cndBean.getTxtemail());
			setTxtdesignation(cndBean.getTxtmobileno());
