...
public class ClsLeaveRequestDAO {
	...
	public JSONArray lrqMainSearch(String docNo,String date,String check,String employeebranchchk,String brhid) throws SQLException {
     ...
     try {
	        ...
	        if(employeebranchchk.equalsIgnoreCase("1")){    
            	if(!(brhid.equalsIgnoreCase("")) && !(brhid.equalsIgnoreCase("0")) && !(brhid.equalsIgnoreCase("a"))){  
            		sqltest=sqltest+" and r.brhid='"+brhid+"'";   
            	}
            } 
	...
	public JSONArray employeeDetailsSearch(String empid,String employeename,String contact,String designation,String department,String category,String employeebranchchk,String brhid) throws SQLException {
	    Connection conn=null;
	    ...
	    try {
				...
				sql = "select doc_no,codeno,UPPER(name) name,pmmob,desc_id,dept_id,pay_catid from hr_empm where active=1 and status=3"+sql+" order by name"; 
