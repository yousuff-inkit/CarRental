...
public class MobileApiAction extends ActionSupport {
    ...
    private String sqlCloseDate, chaufferid, sqlOutDate, hidfleet, creditnotesum;
    ...
    public String fetchDashboard() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                collection.put("date", rs.getString("todate"));
    ...
    public String submitCollection() {
        try {
            ...
            int result = closeDAO.insert(
                ...
                outDt, clacno, hidfleet, creditnotesum, request, collectchg, brchname, branchsearch, 
    ...
    public String submitDelivery() {
        try {
            ...
            int result = deliveryDAO.insert(
                ...
                delchk, chfchk, deldriverid, (ArrayList<String>) deliveryDriverArray, inkm, infuel, outDt, 
                outTime, salesagentid, rentalagentid, checkoutid, dueDt, dueTime, 
                (ArrayList<String>) deliveryTariffArray, tasystem, tadocno, invoice, exessinsu, 
                (ArrayList<String>) deliveryPaymentArray, paymentMra, paymentPo, origFleetno, Vehlocationid, 
    ...
    public String getSalesAgentList() { 
        try {
            ...
            agents.put("salesAgents", dao.SalesgentSearch());
            agents.put("rentalAgents", dao.RentalgentSearch());
            dropdownData = agents;
            status = "success";
        } catch (Exception e) { e.printStackTrace(); status = "error"; }
        return SUCCESS; 
