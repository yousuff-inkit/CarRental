...
public String saveAction() throws ParseException, SQLException{
	...
	if(mode.equalsIgnoreCase("A") || mode.equalsIgnoreCase("E") || mode.equalsIgnoreCase("C") || mode.equalsIgnoreCase("R")){  // have added "C"  case as the date issue is coming 
		...
		if(mode.equalsIgnoreCase("E") || mode.equalsIgnoreCase("C") || mode.equalsIgnoreCase("R")){ // have added "C"  case as the date issue is coming
...
System.out.println("datein - "+sqldatein);
...
//		System.out.println("Action Val:"+val);
	...
	ArrayList<String> tarifarray= new ArrayList<>();
	tarifarray.add(temp);
	System.out.println("Action - "+sqldatein);
