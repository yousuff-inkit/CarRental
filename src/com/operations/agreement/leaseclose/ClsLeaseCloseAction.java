...
//				System.out.println("fuel:::::"+getHidcmbinfuel());
				...
				setHidcollectdate(bean.getHidcollectdate());
				setHidindate(bean.getHidindate());
				setHidclosedate(bean.getHidclosedate());      
				return "success";
			}
...
//			System.out.println(calcarray.get(i));
		...
		int deleteval=leasecloseDAO.delete(getDocno(),getAgreementno(),session,getMode(),getHidfleet(),getBrchName(),request);
