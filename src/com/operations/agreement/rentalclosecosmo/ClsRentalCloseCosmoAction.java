...
public class ClsRentalCloseCosmoAction extends ActionSupport{
ClsRentalCloseCosmoDAO rentalcloseDAO=new ClsRentalCloseCosmoDAO();
ClsCommon objcommon=new ClsCommon();
ClsRentalCloseCosmoBean bean;
private int docno;
