		...
		int val=0;
		 ...
		 Map<String, String[]> requestParams = request.getParameterMap();
           ...
           if(mode.equalsIgnoreCase("A")){
			...
			ClsLeaseAgmtForMasterAction masteraction=new ClsLeaseAgmtForMasterAction();
			...
			val=leaseAgmtDAO.insert(sqlleaseDate,getClientid(),getLe_salmanid(),getDescription(),getLe_clcodeno(),
					...
					advance_chk,invoice,getVehlocation(),getFormdetailcode(),getClientname(),request,vehdetarray,getExcessinsur(),getLeaseprojectDoc(),getLeasePo(),getCmbmasterreftype(),getHidmasterrefno(),masteraction);
     	   ...
     	   java.sql.Date sqldelDateout = commonDAO.changeStringtoSqlDate(getDeldateout());   
		     ...
		     setMasterdoc_no(getMasterdoc_no());
				...
				setHiddelcmbtype(getCmbdelfuelout());
     			...
     			setHidcmbenqtype(LeaseAgreementBean.getHidcmbenqtype());
