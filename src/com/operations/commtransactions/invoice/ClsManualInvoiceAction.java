...
import com.controlcentre.audit.yearendclose.ClsYearEndCloseBean;
...
private String client,chkstatus;

private String lblcompbranchaddress,lblbankdetails,lblbankbeneficiary1,lblbankaccountno,lblbeneficiarybank,lblbankibanno;
	...
	public String getLblbankbeneficiary1() {
		return lblbankbeneficiary1;
	}
	public void setLblbankbeneficiary1(String lblbankbeneficiary1) {
		this.lblbankbeneficiary1 = lblbankbeneficiary1;
	}
...
private String lbltotal,lblbankibanno1;
private String lblcomplogo;
public String getLblcomplogo() {
	return lblcomplogo;
}
public void setLblcomplogo(String lblcomplogo) {
	this.lblcomplogo = lblcomplogo;
}
public String getLblbankibanno1() {
	return lblbankibanno1;
}
public void setLblbankibanno1(String lblbankibanno1) {
	this.lblbankibanno1 = lblbankibanno1;
}
...
private String traficheader;
public String getTraficheader() {
	return traficheader;
}
public void setTraficheader(String traficheader) {
	this.traficheader = traficheader;
}
...
//projectname
private String lblprojectname;

public String getLblprojectname() {
	return lblprojectname;
}
public void setLblprojectname(String lblprojectname) {
...
public ClsManualInvoiceAction(String lblinvno,String lblclient,String lblaccount,String lbldate,String lbladdress1,String lblrano,String lbladdress2,String lbllpono,
		...
		int lbldamagecount,String lblinspno,String lblinspregno,int lblshowfees,int lblagmtcounteasy,String lblcompemail,String lblcompwebsite,String lblcreditdiff,String duedate,
		 ...
		 String lblextrasrvcstatus,String lblchasisno,String lblbrhid,String lblcurntvehgrn,String lblcntrctvehgrn,String lblcompnameeasy,int lblsalikauhcount,int lblsalikdxbcount,String lblmanual,String trafic,String lblcomppbno,String lblcompbranchaddress,String lblbankdetails,String lblbankbeneficiary1,String lblbankaccountno,String lblbeneficiarybank,String lblbankibanno1,String lblcomplogo,String lblprojectname,String lblbrtinno)
{
	this.lblcomplogo=lblcomplogo;
...
//							System.out.println(val);
							setDocno(val);
							bean=(ClsManualInvoiceBean)request.getAttribute("bean"); 
							if(bean!=null){
							if(!bean.getValidmsg().equals("") && bean.getValidmsg()!=null) {
								setMsg(bean.getValidmsg());
								setChkstatus("1");
							}else {
							setMsg("Not Saved");
							}
...
setDeleted(bean.getDeleted());
			...
			for(int i=0;i<getGridlength();i++){
				...
				String temp=requestParams.get("test"+i)[0];
				 ...
				 String cmprhnstat=request.getParameter("cmprhnstat")==null?"1":request.getParameter("cmprhnstat").toString();
...
//		System.out.println("Check Type:"+getCmbagmttype());
		...
		String trafic=request.getParameter("trafic")==null||request.getParameter("trafic").equals("")?"0":request.getParameter("trafic");
		...
		bean=manualinvoiceDAO.getPrint(request.getParameter("fromno"),request.getParameter("tono"),request.getParameter("branch"),request.getParameter("printdocno"),allbranch,hidheader,chkdeletedinv,trafic,bankdocno);
		setHdbrhid(bean.getHdbrhid());
		setTraficheader(bean.getTraficheader());   
		//System.out.println("bankdocnnnoooooooo--"+bankdocno);        
		setCntrctvehgrn(bean.getCntrctvehgrn());
		setCurntvehgrn(bean.getCurntvehgrn());
		setHeaderchk(hidheader);
		setLblcomplogo(bean.getLblcomplogo());
		setLblcompname(bean.getLblcompname());
		setLblcompaddress(bean.getLblcompaddress());
		setLbladdress1(lbladdress1);
		setLblprintname(bean.getLblprintname());
		setLblcompfax(bean.getLblcompfax());
		setLblcomppbno(bean.getLblcomppbno());
		setLblcomptel(bean.getLblcomptel());
		setLblbranch(bean.getLblbranch());
		...
		setLblbankibanno1(bean.getLblbankibanno1());
		...
		setLblcompbranchaddress(bean.getLblcompbranchaddress());
    	setLblbankdetails(bean.getLblbankdetails());
    	setLblbankbeneficiary1(bean.getLblbankbeneficiary1());
    	setLblbankaccountno(bean.getLblbankaccountno());
    	setLblbeneficiarybank(bean.getLblbeneficiarybank());
    	setLblbankibanno(bean.getLblbankibanno());
    	setLblcomptrn(bean.getLblcomptrn());
    	//projectname
    	setLblprojectname(bean.getLblprojectname());
    	setLblbrtinno(bean.getLblbrtinno());
	System.out.println("pro in action-----"+bean.getLblbrtinno());
		//System.out.println("lblbeneficiary--"+bean.getLblbeneficiarybank()+"--Lblcompbranchaddress-"+bean.getLblcompbranchaddress());
...
//		System.out.println("chasno==="+getLblchasisno());
	...
	//System.out.println("==bean.getLblrano==="+bean.getLblrano()+"===bean.getLblinvfrom=="+objcommon.getSqlDate(bean.getLblinvfrom())+"==bean.getLblinvto===="+bean.getLblinvto()+"==bean.getLblratype===="+bean.getLblratype());
			...
			/*setLblcompbranchaddress(bean.getLblcompbranchaddress());
	    	setLblbankdetails(bean.getLblbankdetails());
	    	setLblbankbeneficiary(bean.getLblbankbeneficiary());
	    	setLblbankaccountno(bean.getLblbankaccountno());
	    	setLblbeneficiarybank(bean.getLblbeneficiarybank());
	    	setLblbankibanno(bean.getLblbankibanno());*/
		...
		public void printActionJasper() throws ParseException, SQLException{
			...
			String bankdocno=request.getParameter("bankdocno")==null?"0":request.getParameter("bankdocno").toString();
			String chkdeletedinv=request.getParameter("chkdeletedinvprint")==null?"0":request.getParameter("chkdeletedinvprint");
			bean=manualinvoiceDAO.getPrint(request.getParameter("fromno"),request.getParameter("tono"),request.getParameter("branch"),request.getParameter("printdocno"),allbranch,hidheader,chkdeletedinv,bankdocno,"");
