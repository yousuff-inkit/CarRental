...

{
	...
	private double lbltaxamount,lblnettotal;
	private String lblcomptrn,lblvendtrn,chkstatus;
...
public void setBean(ClspurchaseDirectBean bean) {
	...
	public String saveAction() throws ParseException, SQLException{           
		...
		if(mode.equalsIgnoreCase("A")){
			...
			int val=purchaseDirectDAO.insert(sqlStartDate,invDate,getHeadacccode(),getVehdesc(),session,getMode(),getFormdetailcode(),descarray,getInvno(),request,getTxttaxamount(),getTxtnetotal());
			...
			if(val>0){
				...
				pintbean=(ClspurchaseDirectBean)request.getAttribute("pintbean");  
				if(pintbean!=null){
