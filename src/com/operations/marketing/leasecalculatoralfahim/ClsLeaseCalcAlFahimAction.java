...
private Map<String, Object> param=null;
	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(mode.equalsIgnoreCase("A")){
			...
			ClsLeaseCalcAlFahimBean bean=calcdao.getViewDetails(getDocno());
			setVocno(bean.getVocno());
			setLeasereqdoc(bean.getLeasereqdoc());
			setClientmob(bean.getClientmob());
			setLeasereqclient(bean.getLeasereqclient());
			setDocno(bean.getDocno());
			setDate(bean.getDate());
			setHidleasereqdoc(bean.getHidleasereqdoc());
			setHidemail(bean.getLblemail());
		}
		return "fail";
	}
