...
public class ClsGuidelineAction  extends ActionSupport {
	...
	private String txtpdfpath;
    private String lbpdfllink;
	
	public String getLbpdfllink() {
		return lbpdfllink;
	}

	public void setLbpdfllink(String lbpdfllink) {
		this.lbpdfllink = lbpdfllink;
	}
	
	public String getTxtvideopath() {
		return txtvideopath;
	}

	public void setTxtvideopath(String txtvideopath) {
		this.txtvideopath = txtvideopath;
	}

	public String getTxtpdfpath() {
		return txtpdfpath;
	}

	public void setTxtpdfpath(String txtpdfpath) {
		this.txtpdfpath = txtpdfpath;
	}
	...
	public String saveGuideline() throws ParseException, SQLException
	{
		...
		if(mode.equalsIgnoreCase("A")){
     	 ...
     	 ArrayList<String> notearray= new ArrayList<>();
				...
				int val=guidelineDAO.insert(getTxtrefno(),getTxtmenuid(),sqlDate,getTxtdoctype(),getTxtmenuname(),descarray,fieldarray,notearray,getTxtvideopath(),getTxtpdfpath());
	...
	public String printAction() throws ParseException, SQLException{
		...
		setLbllink(guidelineBean.getLbllink());
		setLbpdfllink(guidelineBean.getLbpdfllink());
