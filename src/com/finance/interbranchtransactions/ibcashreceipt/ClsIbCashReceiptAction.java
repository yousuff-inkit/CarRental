		...
		if(mode.equalsIgnoreCase("A")){
			...
			if(chk>0){
						...
						if(val>0.0){
							...
							setData();
							ibCashReceiptBean=(ClsIbCashReceiptBean)request.getAttribute("ibCashReceiptBean");  
							if(ibCashReceiptBean!=null){  
    							if(!ibCashReceiptBean.getValidmsg().equals("") && ibCashReceiptBean.getValidmsg()!=null) {
    								setMsg(ibCashReceiptBean.getValidmsg());
    								setChkstatus("1");
    							}else {
    							    setMsg("Not Saved");
    							}
