		...
		if(mode.equalsIgnoreCase("A")){
			...
			/*Journal Voucher Grid Ends*/  
						...
						if(val>0.0){
							...
							setData();
							setHidjqxFixedAssetDepreciationPostingDate(fixedAssetDepreciationDate.toString());
							fixedAssetDepreciationPostingBean=(ClsFixedAssetDepreciationPostingBean)request.getAttribute("fixedAssetDepreciationPostingBean");   
							if(fixedAssetDepreciationPostingBean!=null){
							if(!fixedAssetDepreciationPostingBean.getValidmsg().equals("") && fixedAssetDepreciationPostingBean.getValidmsg()!=null) {
								setMsg(fixedAssetDepreciationPostingBean.getValidmsg());
								setChkstatus("1");
							}else {
							setMsg("Not Saved");
							}
