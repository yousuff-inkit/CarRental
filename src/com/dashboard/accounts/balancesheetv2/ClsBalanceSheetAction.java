...
public class ClsBalanceSheetAction extends ActionSupport{
	...
	public void printTFormAction() throws ParseException, SQLException{
		...
		try {
    		...
    		System.out.println("sqlAssets--"+sqlAssets);
...
//    		System.out.println("==== expense ==== "+sqlExpenses);
    		...
    		String imgpath1=request.getSession().getServletContext().getRealPath("/icons/aitsheader2.jpg");
   		    imgpath1=imgpath1.replace("\\", "\\\\");
			param.put("imgpath1", imgpath1);
			...
			HttpServletResponse response = ServletActionContext.getResponse();
			 ...
			 try {
				 param = new HashMap();
             	 ...
             	 ResultSet rs1 = BalanceSheet.executeQuery(brchsql);
             	 while(rs1.next()) {
