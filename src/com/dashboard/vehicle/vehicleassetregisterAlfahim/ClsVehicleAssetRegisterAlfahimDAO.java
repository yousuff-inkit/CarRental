	...
	public JSONArray vehicleAsssetGridLoading(String branch,String fromdate,String todate,String fleetNo,String group,String model,String check) throws SQLException {
	    ...
	    try {
				...
				if(check.equalsIgnoreCase("1")){
				 ...
				 sql = "SELECT m.fleet_no,m.flname,m.reg_no,m.plate,m.age,m.purdate,m.deprper,m.residualvalue,m.prch_cost purvalue,m.startdate,m.enddate,CONVERT(coalesce(m.contractno, ' '),CHAR(50)) contractno,\r\n" + 
			    		...
			    		"l.fstatus,l.vgrpid,l.vmodid,l.deprper,l.brhid,l.date,l.residualvalue,l.prch_cost,l.contractno,l.startdate,l.enddate FROM (\r\n" + 
			    		...
			    		"d.flname,d.reg_no,d.prch_dte purdate,((DATEDIFF('"+sqlToDate+"',d.prch_dte)/365)*12) age,d.fstatus,d.vgrpid,d.vmodid,d.deprper,d.residual_val residualvalue,d.prch_cost,d.brhid,\r\n" + 
			    		...
			    		"0.00 depr_add,0.00 depr_del,v.flname,v.reg_no,v.prch_dte,v.fstatus,v.vgrpid,v.vmodid,v.depr deprper,v.residual_val,v.prch_cost,a.brhid,p.code_name from gc_assettran a\r\n" + 
			    		...
			    		"v.flname,v.reg_no,v.prch_dte,v.fstatus,v.vgrpid,v.vmodid,v.depr deprper,v.residual_val,v.prch_cost,a.brhid,p.code_name from gc_assettran a\r\n" + 
			    		"left join gl_vehmaster v on a.fleet_no=v.fleet_no left join gl_vehplate p on v.pltid=p.doc_no where acno=(select acno from\r\n" + 
			    		"my_account where codeno='VAD')\r\n" + 
			    		") d\r\n" + 
			    		"left join gl_vsaled sd on sd.fleetno=d.fleet_no left join gl_vsalem sm on sm.doc_no=sd.rdocno left join gl_lagmt lg on d.fleet_no=lg.perfleet and lg.status=3 where coalesce(sm.date,\r\n" + 
