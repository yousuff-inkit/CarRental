...
public class ClsWorkDetailsApprovalAction {
	
	ClsCommon ClsCommon=new ClsCommon();
	ClsWorkDetailsApprovalDAO timeSheetDAO=new ClsWorkDetailsApprovalDAO();
	private String mode;
	private String msg;
	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(mode.equalsIgnoreCase("A")){
			...
			int val=timeSheetDAO.insert(getCmbmonth(),getCmbyear(),timesheetarray,session,request,mode,getTxtemployeedocno());
			if(val>0.0){
				setDetail("Human Resource");
				setDetailname("Work Details Approval");
