...
public class ClsAppliedDeleteDAO {
	...
	public JSONArray appliedGridLoading(JSONObject paramsObj) throws SQLException {
	    String branch = paramsObj.optString("branch", "NA");
		String atype = paramsObj.optString("atype", "0");
		String check = paramsObj.optString("check", "0");
		String accountno = paramsObj.optString("accountno", "0");
		...
		try {
		        ...
		        System.out.println("Applied Grid :"+xsql);
				ResultSet rs = stmtMAD.executeQuery(xsql);
				//RESULTDATA=ClsCommon.convertToJSON(rs);
				while(rs.next()) {
					JSONObject obj = new JSONObject();
					
					obj.put("transno", rs.getString("transno"));
					obj.put("transtype", rs.getString("transtype"));
					obj.put("date", rs.getString("date"));
					obj.put("description", rs.getString("description"));
					obj.put("tramt", rs.getString("tramt"));
					obj.put("applied", rs.getString("applied"));
					obj.put("balance", rs.getString("balance"));
					obj.put("out_amount", rs.getString("out_amount"));
					obj.put("tranid", rs.getString("tranid"));
					obj.put("acno", rs.getString("acno"));
					obj.put("currency", rs.getString("currency"));
					obj.put("tr_no", rs.getString("tr_no"));
					obj.put("brhid", rs.getString("brhid"));
					obj.put("applyinfo", rs.getString("applyinfo")); 
	...
	public JSONArray applyInvoiceDeleteGridLoading(JSONObject paramsObj) throws SQLException {
		String trno = paramsObj.optString("trno", "0");
		String check = paramsObj.optString("check", "0");
		String accountno = paramsObj.optString("accountno", "0");
		...
		try {
				...
				String sql="select a.*,"+casestatement+"'0' dummy from (select t.doc_no transno,t.dtype transtype,t.description description,t.date date,(t.dramount*t.id) tramt,"
						...
						+ ")) a"+joins+"";
             	System.out.println("Applied Deatil Grid : "+sql);
				ResultSet rs = stmtMAD.executeQuery(sql);
				//RESULTDATA=ClsCommon.convertToJSON(rs);
				while(rs.next()) {
					JSONObject obj = new JSONObject();
					...
					obj.put("description", rs.getString("description"));
					obj.put("tramt", rs.getString("tramt"));
					obj.put("applying", rs.getString("applying"));
					obj.put("balance", rs.getString("balance"));
					obj.put("out_amount", rs.getString("out_amount"));
					obj.put("tranid", rs.getString("tranid"));
					obj.put("acno", rs.getString("acno"));
