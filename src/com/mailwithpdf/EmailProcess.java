...
public class EmailProcess {
   ...
   System.out.println("===Message Success====");
	...
	if(port.equalsIgnoreCase("587")){	
		...
		properties.put("mail.smtp.starttls.enable", "true");
		// properties.put("mail.smtp.host", "smtp.gmail.com");
		properties.put("mail.smtp.host", host);           //  added for carfare outstanding
		properties.put("mail.smtp.ssl.protocols", "TLSv1.2");  // added for carfare outstanding
		properties.put("mail.smtp.port", port);
	}
	else //port 25
	{
	 ...
	 HttpSession retsession = request.getSession();
      ...
      // messageBodyPart.setHeader("content-Type", "text/html;charset=\"ISO-8859-1\""); // first
       ...
       // System.out.println("=====dfghjkjhgfdfghjkl======="+msg);
        Transport.send(msg);
	     	...
	     	ex.printStackTrace();
	     	retsession.setAttribute("emailStatus", "fail");
	   }
     retsession.setAttribute("emailStatus", "success");   
    }
