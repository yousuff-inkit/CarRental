...
private Date compaccdate1;
private Date compaccdate2;
private Date hidcompaccdate1;
private Date hidcompaccdate2;
...
/*public String getTxtsmsno() {
	return txtsmsno;
}
public void setTxtsmsno(String txtsmsno) {
	this.txtsmsno = txtsmsno;
}
...
public String getTxtsmsurl() {
	return txtsmsurl;
}
public void setTxtsmsurl(String txtsmsurl) {
	this.txtsmsurl = txtsmsurl;
}
public String getTxtfoliotime() {
	return txtfoliotime;
}
public void setTxtfoliotime(String txtfoliotime) {
	this.txtfoliotime = txtfoliotime;
}*/

public Date getCompaccdate1() {
	return compaccdate1;
}
public void setCompaccdate1(Date compaccdate1) {
	this.compaccdate1 = compaccdate1;
}
public Date getCompaccdate2() {
	return compaccdate2;
}
public void setCompaccdate2(Date compaccdate2) {
	this.compaccdate2 = compaccdate2;
}
public Date getHidcompaccdate1() {
	return hidcompaccdate1;
}
public void setHidcompaccdate1(Date hidcompaccdate1) {
	this.hidcompaccdate1 = hidcompaccdate1;
}
public Date getHidcompaccdate2() {
	return hidcompaccdate2;
}
public void setHidcompaccdate2(Date hidcompaccdate2) {
