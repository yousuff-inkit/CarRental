...
import com.opensymphony.xwork2.ActionSupport;
	...
	public class ClsServiceSaleAction extends ActionSupport{
		...
		private String srsrip; // Added Column for riderinvoice prep to add trno 
		private String srsmonth; // Added Column for riderinvoice prep to add trno 
		private String srsyear; // Added Column for riderinvoice prep to add trno 
		...
		private String lbldate,lbltype,docvals,lblacno,lblacnoname,lbldeldate,lbldddtm,lblpatms,lbldsc,nettaxamount,lblsubjobno,chkstatus; 
	...
	public void setLblbankibanno(String lblbankibanno) {
		...
		public String getSrsrip() {
			return srsrip;
		}
		public void setSrsrip(String srsrip) {
			this.srsrip = srsrip;
		}
		
		public String getSrsmonth() {
			return srsmonth;
		}
		public void setSrsmonth(String srsmonth) {
			this.srsmonth = srsmonth;
		}
		public String getSrsyear() {
			return srsyear;
		}
		public void setSrsyear(String srsyear) {
			this.srsyear = srsyear;
		}
	...
	if(mode.equalsIgnoreCase("A")){
		...
		masteraction.setSrsmonth(getSrsmonth());
		masteraction.setSrsrip(getSrsrip());
		masteraction.setSrsyear(getSrsyear());
		System.out.println(getSrsrip()+"SRS - "+masteraction.getSrsrip());
...
return "fail";	
		 ...
		 public String printAction() throws ParseException, SQLException{
			  ...
			  String bankdocno = request.getParameter("bankdocno")==null || request.getParameter("bankdocno").equals("") || request.getParameter("bankdocno").equals("0")?"1":request.getParameter("bankdocno").toString();
			    ...
			    bean=pintbean;
				 ...
				 String tstimg="",invnum="",duedate="",slfoot="";
					...
					//System.out.println("brhid==="+invoicenum);
			         ...
			         String c= "select imgpath,imgfooter from my_brch where doc_no="+brhid+"";
...
//			          System.out.println("amt====="+bean.getNettaxamount());
					  ...
					  param.put("account", bean.getAccount());
...
//			          System.out.println("headerstatus"+header);
			         ...
			         // param.put("email", bean.getLblclientemail());
			          ...
			          System.out.println("lpo=="+bean.getLblinvno()+"-lpodate-"+bean.getLblinvdate());
			          ...
			          furnitureheader=furnitureheader.replace("\\", "\\\\");
					    ...
					    param.put("printname","Tax Invoice");
	             ...
	             JasperDesign design = JRXmlLoader.load(request.getSession().getServletContext().getRealPath("com/project/execution/ServiceSale/" +path));   
