...
<style>
/* ═══════════════════════════════════════════════════════════
   PREMIUM SPLIT-PANEL LOGIN  —  INK IT Business Solutions
...
.tab-content { padding: 18px 20px; display: none; }
...
.btn-next:hover { background: #1d4ed8; transform: translateX(2px); }
...
/* hide old layout classes that Bootstrap might try to render */
.outer-container, .login-container, .first, .second,
.login-control-container, .header-image,
.forgotpwd-container, .btnlogin-container,
.btnlogin, .rowgap { all: unset; }
</style>
</head>
...
<div class="page-shell">
  ...
  <div class="form-panel">
    <div class="fp-inner">
      ...
      <!-- error / licence expiry message (hidden by JS when blank) -->
      <span id="msgexpiry"></span>
      ...
      <form method="post" action="login" autocomplete="off" class="fp-form">
        ...
        <div class="fp-field">
          ...
          <div class="fp-input-wrap">
            ...
            <input id="username" type="text" name="userid" placeholder="Enter your username">
          </div>
        </div>
        ...
        <button type="submit" class="btn-signin" id="btnlogin">Sign In</button>

        <input type="hidden" id="msg" name="msg" value='<s:property value="msg"/>'/>

      </form>

      <p class="fp-footer">&copy; 2025 INK IT Business Solutions. All rights reserved.</p>
...
<div class="wizard-container">
  <span class="btnwizardclose-container">
    <a href="" class="btnwizardclose"><i class="fa fa-times"></i></a>
  </span>
  ...
  <div class="tabcontrols-container">
    ...
    <button type="button" class="tab-control"        data-tab="step2" id="btnstep2">Step 2</button>
  </div>
  <div class="tab-content-container">
    <div class="tab-content" id="step1">
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="email" class="form-control" id="forgotemail" name="forgotemail" placeholder="Enter your email address">
        </div>
    ...
    <div class="tab-content" id="step2">
      ...
      <button type="button" class="btn-dismiss">Done</button>
    </div>
  </div>
</div>
