...
$(document).ready(function () {
    ...
    $("#jqxWorkOrderStatusGrid").jqxGrid(
    {
        ...
        columns: [
						...
						{ text: 'Status', datafield: 'status',cellclassname: cellclassname , width: '13%' },
						{ text: 'Branch', datafield: 'branchname',cellclassname: cellclassname , width: '10%' },
						{ text: 'Doc No', datafield: 'docno' ,cellclassname: cellclassname, width: '6%' },
						{ text: 'Date', datafield: 'date' , cellsformat: 'dd.MM.yyyy' , cellclassname: cellclassname, width: '6%' },
						{ text: 'Fleet', datafield: 'fleetno' ,cellclassname: cellclassname, width: '7%' },
						{ text: 'Reg No', datafield: 'reg_no' ,cellclassname: cellclassname, width: '7%' },
						...
						{ text: 'Amount', datafield: 'totalamt', width: '8%',align:'right',cellsalign:'right',cellsformat:'d2',cellclassname: cellclassname},
						]
