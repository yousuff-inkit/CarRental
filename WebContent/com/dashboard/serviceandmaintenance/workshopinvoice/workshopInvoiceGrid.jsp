...
<script type="text/javascript">
      ...
      var id = '<%= id%>';
      if(id=='1'){ 
	  		invdata='<%=DAO.wsinvGridLoad(fromdate,todate,id,brhid)%>';
	  	}
        $(document).ready(function () {
        	...
        	var source =
            {
                ...
                datafields: [
							...
							{name : 'tyretot' , type:'number'},
							{name : 'carwashtot' , type:'number'},
							{name : 'batterytot' , type:'number'},
							...
							{name : 'acnotyr' , type:'string'},
							{name : 'acnocws' , type:'string'},
							{name : 'acnobat' , type:'string'},
							{name : 'jdocno' , type:'string'},
            ...
            $("#workshopInvGrid").jqxGrid(
            {
                ...
                columns: [
						...
						{ text: 'Labour Total', datafield:'labourtot', width:'12%',cellsformat: 'd2', align: 'right', cellsalign: 'right',
									aggregates: ['sum'],aggregatesrenderer:rendererstring},
						{ text: 'Tyre Total', datafield:'tyretot', width:'12%',cellsformat: 'd2', align: 'right', cellsalign: 'right', aggregates: ['sum'],aggregatesrenderer:rendererstring, hidden:false},
						{ text: 'Battery Total', datafield:'batterytot', width:'12%',cellsformat: 'd2', align: 'right', cellsalign: 'right',aggregates: ['sum'],aggregatesrenderer:rendererstring, hidden:false},
						{ text: 'Car Wash Total', datafield:'carwashtot', width:'12%',cellsformat: 'd2', align: 'right', cellsalign: 'right',aggregates: ['sum'],aggregatesrenderer:rendererstring, hidden:false},
            ...
            $('#workshopInvGrid').on('rowdoubleclick', function (event){ 
        	  	...
        	  	document.getElementById("hidtyretot").value=$("#workshopInvGrid").jqxGrid('getcellvalue', rowindex1, "tyretot");
        	  	document.getElementById("hidcarwashtot").value=$("#workshopInvGrid").jqxGrid('getcellvalue', rowindex1, "carwashtot");
        	  	document.getElementById("hidbatterytot").value=$("#workshopInvGrid").jqxGrid('getcellvalue', rowindex1, "batterytot");
        	  	...
        	  	document.getElementById("hidacnotyr").value=$("#workshopInvGrid").jqxGrid('getcellvalue', rowindex1, "acnotyr");
        	  	document.getElementById("hidacnocws").value=$("#workshopInvGrid").jqxGrid('getcellvalue', rowindex1, "acnocws");
        	  	document.getElementById("hidacnobat").value=$("#workshopInvGrid").jqxGrid('getcellvalue', rowindex1, "acnobat");
        	  	
        	  	//console.log($('#hidsparetot').val()+" - "+$('#hidtyretot').val() +" - "+$("#workshopInvGrid").jqxGrid('getcellvalue', rowindex1, "batterytot")+" - "+$("#workshopInvGrid").jqxGrid('getcellvalue', rowindex1, "tyretot")+" - "+$("#workshopInvGrid").jqxGrid('getcellvalue', rowindex1, "carwashtot"));
        	  	 $("#workshopinvoiceSpareDiv").load("spareGrid.jsp?jobcardno="+$("#workshopInvGrid").jqxGrid('getcellvalue', rowindex1, "jdocno")+"&invno="+$("#workshopInvGrid").jqxGrid('getcellvalue', rowindex1, "invno")+"&id=1");
        	  	 $("#workshopinvoiceLabourDiv").load("labourGrid.jsp?jobcardno="+$("#workshopInvGrid").jqxGrid('getcellvalue', rowindex1, "jdocno")+"&&invno="+$("#workshopInvGrid").jqxGrid('getcellvalue', rowindex1, "invno")+"&id=1");
