 ...
 ClstempSalikDAO showDAO = new  ClstempSalikDAO();
	...
	String uptodate = request.getParameter("uptodate")==null?"0":request.getParameter("uptodate").trim();
	 ...
	 String saliktype = request.getParameter("saliktype")==null?"":request.getParameter("saliktype").trim();
// String RR="RR";
...
if(temp4=='10')
	{
//alert(1);
	datas2='<%=showDAO.allocationlist1(uptodate,tagno,regno,chval,fromdate,hidchkdate,saliktype)%>'; 

	}
else if(temp4=='2')
{ 
	//alert(2);
	datas2='<%=showDAO.unallocation1(uptodate,tagno,regno,chval,fromdate,hidchkdate,saliktype)%>'; 
	exceldatas='<%=showDAO.unallocation1Excel(uptodate,tagno,regno,chval,fromdate,hidchkdate,saliktype)%>';
