...
function mainloadSearch() {
    // Safety check included in case this is running in a modal/iframe
    var brcElem = document.getElementById("cmballocatebranch");
    var brc = brcElem ? brcElem.value : ""; 
