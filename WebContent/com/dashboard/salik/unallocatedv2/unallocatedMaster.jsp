...
{     
	...
	function funallocate()
	{
		...
		var selectedrows=$('#salikgrid').jqxGrid('getselectedrowindexes');
		if(selectedrows.length==0){
			$.messager.alert('Warning','Please select a salik','warning');
			return false;
		}
	     	...
	     	if(r==false)
	     	  {
	     		...
	     		for(var i=0;i<selectedrows.length;i++){
	     			allocatearray.push($('#salikgrid').jqxGrid('getcellvalue',selectedrows[i],'trans'));
	     		}
	     		
	     		$.post('savedata.jsp',{'allocatearray[]':allocatearray},function(data,status){
