<%@page import="com.dashboard.leaseagreement.ClsleaseagreementDAO" %>
 	<%ClsleaseagreementDAO dao= new ClsleaseagreementDAO();%>
   	...
   	String blexid = request.getParameter("blexid")==null?"NA":request.getParameter("blexid").trim();
   	%>
...
if(tepss!='NA')
	{
	 rtariffchange='<%=dao.latariffapprovegrid(rdocno,blexid)%>';
   ...
   $("#rtaiffchange").jqxGrid(
   {
      ...
      theme: theme,
       ...
       columns: [  
					...
					{ text: ''+document.getElementById("mainoinschg").value,         datafield: 'oinschg',  editable:true,cellsformat: 'd2', cellsalign: 'right', align:'right',cellsrenderer: cellsrenderer,hidden:true},
					{ text: ''+document.getElementById("mainexhrchg").value,         datafield: 'exhrchg',  editable:true,cellsformat: 'd2', cellsalign: 'right', align:'right',cellsrenderer: cellsrenderer,hidden:true},
