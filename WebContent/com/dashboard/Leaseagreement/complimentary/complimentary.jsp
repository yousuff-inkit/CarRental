...
<table width="100%" id="raupdate">
	     <tr><td align="right"><label class="branch">LA NO</label></td><td align="left"><input type="text" name="rano" id="rano" readonly="readonly"  style="height:20px;width:70%;" value='<s:property value="rano"/>'></td></tr>
	 <tr><td colspan="2"></td></tr>
