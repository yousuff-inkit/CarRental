...
<div id="mainBG" class="homeContent" data-type="background"> 
    <div class="master-container">
        ...
        <!-- ===== LEFT SIDEBAR ===== -->
        <!-- Retained for structural consistency across pages, even though this specific page has no filters -->
        <div class="sidebar-filters">
            <div class="sidebar-scroll-content">
                <!-- Empty as per original legacy code, ready if filters are added later -->
            </div>
        </div>
        ...
        <div class="main-content-area">
            ...
            <div class="grid-content-container">
                <div id="tempdiv">
                    <jsp:include page="templistGrid.jsp"></jsp:include>
                </div>
            </div>
