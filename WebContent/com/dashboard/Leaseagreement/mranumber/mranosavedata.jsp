...
java.sql.Date sqlprocessdate=null;
	...
	Statement stmt = conn.createStatement ();
	   ...
	   if(!(mrano.equalsIgnoreCase("")|| mrano.equalsIgnoreCase("NA")))
	   {
	    ...
	    upsql="update  gl_lagmt  set manualra='" +mrano+ "'  where doc_no='"+ra_no+"' ";
		   //System.out.println("----upsql-1--"+upsql);
		     val= stmt.executeUpdate(upsql);
		    
			    
		   upsql="insert into gl_blmra(rano, manualra,new_manualra, userid,edate)values('"+ra_no+"','"+oldmrano+"','"+mrano+"','"+session.getAttribute("USERID").toString()+"',now()) ";
