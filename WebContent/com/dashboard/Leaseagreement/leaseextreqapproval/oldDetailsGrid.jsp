...
<script>
var agmtno='<%=docno%>';
var oldurl='getGridData.jsp?mode=2&agmtno='+agmtno;
        ...
        */
        ...
        columns: [
                    { text: 'SL#', sortable: false, filterable: false, editable: false,
                      ...
                      datafield: '', columntype: 'number', width: '12%',
                      cellsrenderer: function (row, column, value) {
                          return "<center><div style='margin:4px;'>" + (value + 1) + "</div></center>";
                      }  
                    },							
					{ text: 'Date', datafield: 'date', width: '20%',cellsformat: 'dd.MM.yyyy', editable: true,columntype:'datetimeinput' },
					{ text: 'Amount',datafield:'amount',width:'20%',cellsformat:'d2',cellsalign:'right',align:'right', editable: true,aggregates: ['sum'],aggregatesrenderer:rendererstring},
					{ text: 'Cheque No', datafield: 'chequeno', width: '20%'},
