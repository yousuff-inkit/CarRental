...
String pytadvance=request.getParameter("pytadvance")==null?"0":request.getParameter("pytadvance").replace(",","").trim();
String pytbalance=request.getParameter("pytbalance")==null?"0":request.getParameter("pytbalance").replace(",","").trim();
