                            ...
                            <fieldset>
                                ...
                                <table class="filter-table">
                                    <tr>
                                        <td class="label-cell">Salesman</td>
                                        <td>
                                            <input type="text" name="salesmann" id="salesmann" 
                                                   placeholder="Press F3 To Search" readonly="readonly" 
                                ...
                                <div class="action-buttons">
                                    <button type="button" class="btn-submit" name="update" id="update" onclick="funupdate();">Update</button>
                                </div>
                            </fieldset>
                        </div>
