        ...
        $(document).ready(function () { 	
            ...
            $("#jqxDashBoardDetail").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'value', datafield: 'value', hidden: true, cellclassname: cellclassname , width: '10%' }
						]
            });
            ...
            $('#jqxDashBoardDetail').on('celldoubleclick', function (event) {
            	  if(event.args.columnindex == 0)
            	  {
            	   ...
            	   <%-- <%String detail="";%>
					...
					var value=$("#jqxDashBoardDetail").jqxGrid('getcellvalue', rowindextemp, "value");
					
					top.addTab( detName,reurl[0]+""+path+"?name="+detName+"&main="+desc+"&docno="+docno+"&value="+value);
