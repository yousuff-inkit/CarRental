                        ...
                        <tr>
                            ...
                            <td>
                                <div class="range-container">
                                    <input type="text" id="fromdocno" name="fromdocno" class="half-input" placeholder="From" value='<s:property value="fromdocno"/>' onkeypress="return isNumber(event);">
                                    <span>-</span>
                                    <input type="text" id="todocno" name="todocno" class="half-input" placeholder="To" value='<s:property value="todocno"/>' onkeypress="return isNumber(event);">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="range-container">
                                    <input type="text" id="fromamount" name="fromamount" class="half-input text-right" placeholder="From" value='<s:property value="fromamount"/>' onblur="funRoundAmt(this.value,this.id);" onkeypress="return isNumber(event);">
                                    <span>-</span>
                                    <input type="text" id="toamount" name="toamount" class="half-input text-right" placeholder="To" value='<s:property value="toamount"/>' onblur="funRoundAmt(this.value,this.id);" onkeypress="return isNumber(event);">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" id="acno" name="acno" readonly placeholder="Press F3 To Search" value='<s:property value="acno"/>' tabindex="-1" onkeydown="getacc(event);">
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <input type="text" id="accname" name="accname" readonly tabindex="-1" value='<s:property value="accname"/>'>
                            </td>
                        </tr>
                    </table>
