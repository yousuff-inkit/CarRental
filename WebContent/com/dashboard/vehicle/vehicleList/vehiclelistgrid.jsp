            ...
            var source = 
            {
                ...
                datafields: [
                        ...
                        {name : 'finname', type: 'String'  },
 						...
 						{name : 'modelac', type: 'string'  },
 						{name : 'engine', type: 'string'  },
 						{name : 'specs', type: 'string'  },
 						{name : 'segment', type: 'string'  },
 						{name : 'transmittype', type: 'string'  }    
				...
				/* 	{ text: 'Doc No', datafield: 'doc_no', width: '3%' },
					...
					{ text: 'SL#', sortable: false, filterable: false, editable: false, 
					    ...
					    cellsrenderer: function (row, column, value) {
						 ...
						 { text: 'ModelAc ',groupable: false, datafield: 'modelac', width: '8%' },
						 { text: 'Engine',groupable: false, datafield: 'engine', width: '8%' },
						 { text: 'Specs',groupable: false, datafield: 'specs', width: '8%' },
						 { text: 'Segment',groupable: false, datafield: 'segment', width: '8%' },
						 { text: 'TransmissionType',groupable: false, datafield: 'transmittype', width: '8%' }
