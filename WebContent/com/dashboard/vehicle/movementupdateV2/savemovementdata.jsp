...
ClsCommon ClsCommon=new ClsCommon();
	...
	String infuel=request.getParameter("infuel");
	 ...
	 System.out.println("datein========="+datein+"=====status======"+status);
...
/* 	  dateout timeout outkm outfuel datein timein inkm infuel */
	...
	if(!(datein.equalsIgnoreCase("undefined"))&&!(datein.equalsIgnoreCase(""))&&!(datein.equalsIgnoreCase("0")))
	 ...
	 System.out.println("datein========="+datein+"sqlindate======="+sqlindate);
	String branchval="";
	 ...
	 try{
		...
		//  vmdocno status sqloutdate timeout outkm outfuel sqlindate timein inkm infuel
		 ...
		 System.out.println("vmovedoc========="+vmdocno);
		 ...
		 movement.registerOutParameter(1, java.sql.Types.INTEGER);
		 ...
		 movement.setString(12,fleetno);
	 System.out.println("----movement----"+movement);
		 movement.executeUpdate();    
 
		 res=movement.getInt(1);
...
/* 		 
	...
	
	 {
		...
		String sqlsave="insert into gl_biblog (doc_no, brhId, dtype, edate, userId, ENTRY) values ("+vmdocno+",1,'BVMU',getdate(),'"+session.getAttribute("USERID").toString()+"','A')";
