<%@page import="com.dashboard.analysis.profitlossanalysisnew.ClsProfitLossAnalysis" %>
...
<script type="text/javascript">
       ...
       var dataexcel='<%=cpla.accountStatementDetailExcel(branchval, fromDate, toDate, accdocno)%>';
       var name='<%=name%>';  
	  	
        $(document).ready(function (){ 
        	 
        	$("#excelExport").click(function() {
        		JSONToCSVCon(dataexcel , 'Account Details', true);
