...
.d-bar-label{width:110px;text-align:right;color:#5c5c5c;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;flex-shrink:0;font-size:11px;font-weight:500;}
...
function setSearch(){
    ...
    if(value=="brand"){ getBrand(); }
    else if(value=="model"){ getModel(); }
    else if(value=="group"){ getGroup(); }
    else if(value=="yom"){ getYom(); }
    else if(value=="fleet"){ getFleet(); }
}
...
function setRemove(){
    ...
    if(value=="brand"){
        ...
        if(document.getElementById("group").value!=""){ document.getElementById("searchdetails").value+="\n"+document.getElementById("group").value; }
        if(document.getElementById("yom").value!=""){ document.getElementById("searchdetails").value+="\n"+document.getElementById("yom").value; }
        if(document.getElementById("fleet").value!=""){ document.getElementById("searchdetails").value+="\n"+document.getElementById("fleet").value; }
    }
    else if(value=="model"){
        document.getElementById("searchdetails").value="";
        ...
        document.getElementById("searchdetails").value=document.getElementById("brand").value;
        if(document.getElementById("model").value!=""){ document.getElementById("searchdetails").value+="\n"+document.getElementById("model").value; }
        if(document.getElementById("yom").value!=""){ document.getElementById("searchdetails").value+="\n"+document.getElementById("yom").value; }
        if(document.getElementById("fleet").value!=""){ document.getElementById("searchdetails").value+="\n"+document.getElementById("fleet").value; }
    }
    else if(value=="yom"){
...
function _renderBrand(brd){
    if(!brd||!brd.length){document.getElementById('dp_brand').innerHTML='<div class="d-loading">No brand data &mdash; load data first.</div>';return;}
...
function _renderModel(mo){
    if(!mo||!mo.length){document.getElementById('dp_model').innerHTML='<div class="d-loading">No model data &mdash; load data first.</div>';return;}
...
function _renderYOM(yo){
    if(!yo||!yo.length){document.getElementById('dp_yom').innerHTML='<div class="d-loading">No YOM data &mdash; load data first.</div>';return;}
    ...
    _setKpi('yo_oldest',yo[yo.length-1]?_lbl(yo[yo.length-1]):'-',yo[yo.length-1]?_pct(_fld(yo[yo.length-1],'rental'),_fld(yo[yo.length-1],'total'))+'% &mdash; oldest':'');
...
function _renderGroup(grp){
    if(!grp||!grp.length){document.getElementById('dp_group').innerHTML='<div class="d-loading">No group data &mdash; load data first.</div>';return;}
...
function _renderLowUtil(veh){
    if(!veh||!veh.length){document.getElementById('dp_lowutil').innerHTML='<div class="d-loading">No vehicle data &mdash; load data first.</div>';return;}
    ...
    _setKpi('lu_zero',zero.length,'0% &mdash; investigate');
