...
<script type="text/javascript">
        ...
        $(document).ready(function () { 
            ...
            $("#jqxRefund").jqxGrid(
            {
                ...
                columns: [
		                	{ text: 'SL#', sortable: false, filterable: false, editable: false,groupable: false, draggable: false, resizable: false,datafield: 'sl', columntype: 'number', width: '3%',cellsrenderer: function (row, column, value) {
							...
							{ text: 'Pay Type', datafield: 'paytype', width: '6%'},
							{ text: 'Security', datafield: 'securityamount', width: '7%',cellsformat: 'd2', cellsalign: 'right', align: 'right', cellclassname: 'securityClass' },
							{ text: 'Invoice', datafield: 'invoiceamount', width: '7%',cellsformat: 'd2', cellsalign: 'right', align: 'right', cellclassname: 'balanceClass' }, 
							{ text: 'Receipt', datafield: 'receiptamount', width: '7%',cellsformat: 'd2', cellsalign: 'right', align: 'right', cellclassname: 'balanceClass' },
							{ text: 'Credit Note', datafield: 'creditnoteamount', width: '7%',cellsformat: 'd2', cellsalign: 'right', align: 'right', cellclassname: 'balanceClass' },
							{ text: 'Balance', datafield: 'balance', width: '7%', cellsformat: 'd2', cellsalign: 'right', align: 'right', cellclassname: 'balanceClass',aggregates: ['sum'] },
							{ text: 'Net Value', datafield: 'netvalue', width: '7%', cellsformat: 'd2', cellsalign: 'right', align: 'right', cellclassname: 'netValueClass' },
