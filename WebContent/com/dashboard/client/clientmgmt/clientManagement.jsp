    ...
    <div class="row rowgap">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> 
       ...
       <div class="actionpanel custompanel1">      
	          ...
	          <button type="button" class="btn btn-default" id="btnblock" data-toggle="tooltip" title="Block" data-placement="bottom"><i class="fa fa-lock "  aria-hidden="true"></i></button>        
	          <button type="button" class="btn btn-default" id="btnunblock" data-toggle="tooltip" title="Unblock" data-placement="bottom"><i class="fa fa-unlock "  aria-hidden="true"></i></button>          
        </div>              
...
$(document).ready(function () {
    ...
    $('#btnblock').on('click',function(){
	    	...
	    	Swal.fire({
				title: 'Are you sure?',
				text: "Do you want block the client?",  
				icon: 'warning',
    ...
    $('#btnunblock').on('click',function(){
	    	...
	    	Swal.fire({
				title: 'Are you sure?',
				text: "Do you want unblock the client?",  
				icon: 'warning',
				showCancelButton: true,
				confirmButtonColor: '#3085d6',
				cancelButtonColor: '#d33',
...
function saveBlock(cldocno, process){
	var x=new XMLHttpRequest();
	x.onreadystatechange=function(){
	if (x.readyState==4 && x.status==200){
	...
	x.open("GET","saveData.jsp?cldocno="+cldocno+"&process="+process);          
	x.send();
}	 
</script> 
  </div>
