...
<table width="100%">
  <tr>
    ...
    <td width="45%">
        <input type="text" name="txtclientsname" id="txtclientsname" style="width:100%;" value='<s:property value="txtclientsname"/>'>
    </td>
    <td width="17%" align="right">Contact No.</td>
    <td width="23%">
        <input type="text" name="txtcontactno" id="txtcontactno" style="width:90%;" value='<s:property value="txtcontactno"/>'>
    </td>
