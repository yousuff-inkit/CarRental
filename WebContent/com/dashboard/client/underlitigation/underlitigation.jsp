...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$("#underdate, #disputeDate").jqxDateTimeInput({ width: '100%', height: '24px', formatString:"dd.MM.yyyy"});
...
   	   }
	    ...
	    $.messager.confirm('Message', 'Do you want to save changes?', function(r){
	     	...
	     	else { savegriddata(rentaldocno,branchids,remarks,cmbinfo,underdate,cldocno,disdoc,choice); }
		 });
	}
...
     var changestatus = document.getElementById("cmbchangestatus").value;
	 ...
	 var cldocno=document.getElementById("cldocno").value;
	    ...
	    $.messager.confirm('Message', 'Do you want to save changes?', function(r){
            if(r==false) { return false; }
		    else { savegriddatas(changestatus,disputedate,caseno,station,value,casenote,cldocno); }
		});
	}
            ...
            <div class="filter-card">
                <table class="filter-table">
                    <tr>
                        ...
                        <td>
                            <select name="cmbinfo" id="cmbinfo" onchange="funchangeinfo()"></select>
                        </td>
                    </tr>
                    <tr>
                        <td class="label-cell">Date</td>
                        <td><div id='underdate'></div></td>
                    </tr>
                    <tr>
                ...
                <button type="button" name="driverUpdate" id="driverUpdate" class="myButton" onclick="funupdate()">UPDATE</button>
            </div>
                ...
                <fieldset>
                    ...
                    <table class="filter-table">
                        <tr>
                            ...
                            <td><input type="text" name="clientname" id="clientname" placeholder="Press F3 To Search" readonly="readonly" onKeyDown="getclinfo(event);"></td>
                        </tr>
                        <tr>
                            <td class="label-cell">Status</td>
                            <td>
                                <select id="cmbchangestatus" name="cmbchangestatus">
                        ...
                        <tr>
                            <td class="label-cell">Date</td>
                            <td><div id='disputeDate'></div></td>
                        </tr>
                        <tr>
                            <td class="label-cell">Case No</td>
                            <td><input type="text" id="caseno" name="caseno"></td>
                        </tr>
                        <tr>
                            <td class="label-cell">Station</td>
                            <td><input type="text" id="station" name="station"></td>
                        </tr>
                        <tr>
                            <td class="label-cell">Value</td>
                            <td><input type="text" id="value" name="value" onkeypress="return isNumber(event)"></td>
                        </tr>
                        <tr>
                            <td class="label-cell">Note</td>
                            <td><input type="text" id="casenote" name="casenote"></td>
                        </tr>
                    </table>
                    <button type="button" name="driverUpdates" id="driverUpdates" class="myButton" onclick="funupdatess()">UPDATE</button>
                </fieldset>
            </div>
