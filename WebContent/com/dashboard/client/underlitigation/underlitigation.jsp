...
div[id^="underdate"], div[id^="disputeDate"] {
    width: 100%;
}
        ...
        <div class="sidebar-filters">
            <div class="sidebar-scroll-content">
                ...
                <div class="filter-card">
                    <table class="filter-table">
                        <tr>
                            ...
                            <td><select name="cmbinfo" id="cmbinfo" onchange="funchangeinfo()"></select></td>
                        </tr>
                        <tr>
                ...
                <div class="filter-card">
                    ...
                    <button type="button" name="driverUpdates" id="driverUpdates" class="btn-submit" onclick="funupdatess()">Update Status</button>
                </div>
