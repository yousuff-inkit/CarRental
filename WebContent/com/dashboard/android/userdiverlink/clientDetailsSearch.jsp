...
<table width="100%">
  <tr>
    <td width="10%" align="right"><label style="font-size:9px;">Driver Name</label></td>
    ...
    <td width="10%" align="right"><label style="font-size:9px;">Account Name</label></td>
  ...
  <tr>
   <td width="10%" align="right"><label style="font-size:9px;">Code</label></td>
  ...
  <tr>
    <td colspan="5"><div id="refreshAccountDetailsDiv"><jsp:include page="driverSearch.jsp"></jsp:include></div></td>
  </tr>
</table>
</div>
</body>
