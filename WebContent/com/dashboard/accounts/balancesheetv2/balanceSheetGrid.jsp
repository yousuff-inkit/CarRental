<%@page import="com.dashboard.accounts.balancesheetv2.ClsBalanceSheetDAO" %>
...
<%   String branchval = request.getParameter("branchval")==null?"NA":request.getParameter("branchval").trim();
	 ...
	 String currency = request.getParameter("currency")==null?"0":request.getParameter("currency").trim();
%>  
...
<style type="text/css">
 ...
 <script type="text/javascript">
 		...
 		if(temp!='NA'){   
	    		data = '<%=cbs.balanceSheetGrid(branchval, fromDate, toDate, level1, level2, level3, level4, check,entrydate, rate, onedaylessdt,currency)%>';
	    		dataExcelExport = '<%=cbs.balanceSheetExcelExport(branchval, fromDate, toDate, level1, level2, level3, level4, check,entrydate, rate,currency)%>';
 		}
