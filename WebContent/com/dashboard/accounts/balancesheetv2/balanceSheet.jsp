...
<script type="text/javascript">
	...
	$(document).ready(function () {
	     ...
	     function funreload(event) {
	         ...
	         console.log("onedaylessdt="+onedaylessdt)
	         var currency = $('#currencyid').val();
	         $("#overlay, #PleaseWait").show();
	         if (document.getElementById("chcklevel4").checked) {
	             $('#btnprint').attr("disabled", true);
	         }
	         $("#balanceSheetDiv").load("balanceSheetGrid.jsp?branchval=" + branchval + '&entrydate=' + entrydate + '&fromdate=' + fromdate + '&todate=' + todate + '&level1=' + level1 + '&level2=' + level2 + '&level3=' + level3 + '&level4=' + level4 + '&check=' + check+ '&rate=' + rate+ '&onedaylessdt=' + onedaylessdt+'&currency=' + currency);
	     }
	     ...
	     function funPrintTForm() {
	         ...
	         var win = window.open(reurl[0] + "../balancesheet/printTForm?branch=" + document.getElementById("cmbbranch").value + '&fromdate=' + fromdate + '&entrydate=' + entrydate+ '&todate=' + todate, "_blank", "top=150,left=250,Width=1020,Height=500,location=no,scrollbars=no,toolbar=yes");
	         win.focus();
	     }      
	     ...
	     function funPrint() {
	         ...
	         if (document.getElementById("chcklevel4").checked) {
	             ...
	             var path = "balancesheetv2printlv4.action?branchval=" + branchval + '&fromdate=' + fromdate + '&todate=' + todate + '&entrydate=' + entrydate;
	             ...
	             var url = document.URL;
	             var reurl = url.split("com/");    
	             var path = "balancesheetv2print.action?branchval=" + branchval + '&fromdate=' + fromdate + '&todate=' + todate + '&entrydate=' + entrydate;
	             var win = window.open(reurl[0] + path, "_blank", "top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
	             win.focus();
	         }
	     }
                                 ...
                                 <table width="100%">
                                    ...
                                    <tr>
                                       <td colspan="2" align="center">
                                           <button class="myButton" type="button" id="btnPrintTForm" name="btnPrintTForm" onclick="funPrintTForm(event);">T-Form</button> 
                                          <button type="button" class="myButton" id="btnprint" onclick="funPrint();">Print</button>
                                       </td>
                                    </tr>
                                    <tr>
                                       <td colspan="2">&nbsp;</td>
