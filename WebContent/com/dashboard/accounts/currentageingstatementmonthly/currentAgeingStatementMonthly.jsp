...
<script type="text/javascript">
   ...
   function getMonthNames(a){
	...
	function funreload(event){
		 ...
		 $("#currentAgeingStatementMonthlyDiv").load("currentAgeingStatementMonthlyGrid.jsp?branchval="+branchval+'&uptodate='+uptodate1+'&atype='+atype+'&accdocno='+accdocno+'&salesperson='+salesperson+'&category='+category+'&chkloadinbasecurr='+chkloadinbasecurr+'&check='+check);
		...
		function funExportBtn(){      
			...
			$("#ageingStatement").excelexportjs({
				containerid: "ageingStatement",
				datatype: 'json', 
				dataset: null, 
				gridId: "ageingStatement", 
				columns: getColumns("ageingStatement") , 
				worksheetName: "CurrentAgeingStatementMonthWise"
			});
