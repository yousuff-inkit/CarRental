        ...
        $(document).ready(function () {
        	...
        	var source =
            {
                ...
                datafields: [
							...
							{name : 'creditperiod' , type:'number'},
							{name : 'creditlimit' , type:'number'},
							{name : 'activecont' , type:'int'}
	                      ],
                          localdata: data,
            ...
            $("#currentAgeing").jqxGrid(
            {
                ...
                columns: [
                	{ text: 'Sr. No.',datafield: 'srno',columntype:'number', width: '5%', cellsrenderer: function (row, column, value) {
                        return "<center><div style='margin:4px;'>" + (value + 1) + "</div></center>";
							...
							{ text: 'Category',  datafield: 'catname',  width: '8%'},
							{ text: 'Credit Period',  datafield: 'creditperiod',  width: '8%',cellsformat:'d0' },
							{ text: 'Credit Limit',  datafield: 'creditlimit',  width: '8%' ,cellsformat:'d2',align:'right',cellsalign:'right'},
							
							{ text: 'Account No',  datafield: 'acno', hidden: true, width: '8%'  },
							{ text: 'Branch Id',  datafield: 'brhid', hidden: true, width: '8%'  },
							{ text: 'Active Aggrement',  datafield: 'activecont',  width: '8%',cellsformat:'d0' },
						 ]
            });
