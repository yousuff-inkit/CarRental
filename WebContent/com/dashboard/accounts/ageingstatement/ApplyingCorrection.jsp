...
<%
	...
	try {
		...
		String sql = "select sum(dramount) a ,  sum(dramount- out_amount)b,sum(out_amount) ,acno,count(*),h.atype from my_jvtran j left join my_head h on j.acno=h.doc_no where   h.den in (340,255) and  status=3  group by acno having a!=b ";
