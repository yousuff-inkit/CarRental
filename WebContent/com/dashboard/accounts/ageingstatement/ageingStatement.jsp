			...
			<table width="100%">
				<tr>
						...
						<fieldset style="background: #ECF8E0;">
							<table width="100%">
								...
								<tr>
									...
									<td align="left"><div id="uptodate" name="uptodate"
								...
								<tr>
									...
									<td align="left"><select id="cmbtype" name="cmbtype"
										style="width: 40%;"
										onchange="clearAccountInfo();getCategory();"
								...
								<tr>
									<td align="right"><label class="branch">Sales
											Person</label></td>
									<td><select id="cmbsalesperson" name="cmbsalesperson"
										style="width: 100%;"
										value='<s:property value="cmbsalesperson"/>'>
											<option value="">--Select--</option>
									</select> <input type="hidden" id="hidcmbsalesperson"
										name="hidcmbsalesperson"
										value='<s:property value="hidcmbsalesperson"/>' /></td>
								</tr>
								<tr>
									<td align="right"><label class="branch">Category</label></td>
									<td><select id="cmbcategory" name="cmbcategory"
										style="width: 100%;" value='<s:property value="cmbcategory"/>'>
											<option value="">--Select--</option>
									</select> <input type="hidden" id="hidcmbcategory" name="hidcmbcategory"
										value='<s:property value="hidcmbcategory"/>' /></td>
								</tr>
								<tr>
									<td align="right"><label class="branch">Status</label></td>
									<td align="left"><select id="cmbclientstatus"
										style="width: 70%;" name="cmbclientstatus"
										value='<s:property value="cmbclientstatus"/>'>
											<option value=''>-- Select --</option>
											<option value='0'>Active</option>
											<option value='1'>Litigation</option>
											<option value='2'>Dispute</option>
											<option value='3'>Over Due</option>
									</select> <input type="hidden" id="hidcmbclientstatus"
										name="hidcmbclientstatus"
										value='<s:property value="hidcmbclientstatus"/>' /></td>
								</tr>
								<tr>
									<td align="right"><label class="branch">Level 1</label></td>
									<td align="left"><input type="text" id="txtlevel1from"
										name="txtlevel1from"
										style="width: 20%; height: 20px; text-align: center;"
										readonly="readonly" value='0' />&nbsp;-&nbsp; <input
										type="text" id="txtlevel1to" name="txtlevel1to"
										style="width: 20%; height: 20px; text-align: center;"
										onblur="changelevel1();" value='30' /></td>
								</tr>
								<tr>
									<td align="right"><label class="branch">Level 2</label></td>
									<td align="left"><input type="text" id="txtlevel2from"
										name="txtlevel2from"
										style="width: 20%; height: 20px; text-align: center;"
										readonly="readonly" value='31' />&nbsp;-&nbsp; <input
										type="text" id="txtlevel2to" name="txtlevel2to"
										style="width: 20%; height: 20px; text-align: center;"
										onblur="changelevel2();" value='60' /></td>
								</tr>
								<tr>
									<td align="right"><label class="branch">Level 3</label></td>
									<td align="left"><input type="text" id="txtlevel3from"
										name="txtlevel3from"
										style="width: 20%; height: 20px; text-align: center;"
										readonly="readonly" value='61' />&nbsp;-&nbsp; <input
										type="text" id="txtlevel3to" name="txtlevel3to"
										style="width: 20%; height: 20px; text-align: center;"
										onblur="changelevel3();" value='90' /></td>
								</tr>
								<tr>
									<td align="right"><label class="branch">Level 4</label></td>
									<td align="left"><input type="text" id="txtlevel4from"
										name="txtlevel4from"
										style="width: 20%; height: 20px; text-align: center;"
										readonly="readonly" value='91' />&nbsp;-&nbsp; <input
										type="text" id="txtlevel4to" name="txtlevel4to"
										style="width: 20%; height: 20px; text-align: center;"
										onblur="changelevel4();" value='120' /></td>
								</tr>
								<tr>
									<td align="right"><label class="branch">Level 5</label></td>
									<td align="left"><input type="text" id="txtlevel5from"
										name="txtlevel5from"
										style="width: 20%; height: 20px; text-align: center;"
										value='121' />&nbsp;>=</td>
								</tr>
								...
								<tr>
									<td colspan="2" align="center">
											<button class="myButton" type="button" id="btnIndividual"
												name="btnIndividual" onclick="funOutStandingStatement();">Outstanding
												Statement</button>
									</td>
								</tr>
								<tr>
									<td colspan="2" align="center">
											<button class="myButton" type="button" id="btncrrct"
												name="btncrrct" onclick="funApplyingCrrct();">Applying Correct</button>
										</td>
								</tr>
								<tr>
									<td colspan="2" hidden="true" align="center">
											<button class="myButton" type="button" id="btnIndividual"
												name="btnIndividual" onclick="funauditletterprint();">Audit
												Balance Confirmation Letter</button>
										</td>
								</tr>
								<tr>
									<td colspan="2" align="center">
											<button class="myButton" type="button" id="btnApply"
												name="btnApply" onclick="funAutoApply();">Auto
												Apply</button>
										</td>
								</tr>
								<tr>
									<td colspan="2"><input type="hidden" id="txtacountno"
										name="txtacountno" style="width: 100%; height: 20px;"
										value='<s:property value="txtacountno"/>' /> <input
										type="hidden" id="txtaccemail" name="txtaccemail"
										value='<s:property value="txtaccemail"/>' /> <input
										type="hidden" id="txtbalance" name="txtbalance"
										value='<s:property value="txtbalance"/>' /> <input
										type="hidden" id="txtbranch" name="txtbranch"
										style="width: 100%; height: 20px;"
										value='<s:property value="txtbranch"/>' /></td>
								</tr>
							</table>
						</fieldset>
					</td>
					<td width="80%">
						<table width="100%">
							<tr>
								<td><div id="ageingStatementDiv"><jsp:include
											page="ageingStatementGrid.jsp"></jsp:include></div></td>
							</tr>
						</table>
				</tr>
			</table>
			...
			<table width="100%" >
				...
				<td width="10%">&nbsp;</td>
					<td width="5%" align="right"
						style="font-family: Myriad Pro; font-size: 12px; font-weight: bold;">Net
						Total :&nbsp;</td>
					<td width="10%" align="left"><input type="text"
						class="textbox" id="txtnetbalance" name="txtnetbalance"
						style="text-align: left;"
						value='<s:property value="txtnetbalance"/>' /></td>

					<td width="5%" align="right"
						style="font-family: Myriad Pro; font-size: 12px; font-weight: bold;"><label
						id="aedLabel">AED Total :</label></td>
					<td width="10%" align="left"><label class="textbox" id="aedbalance" style="font-family: Myriad Pro; font-size: 12px; font-weight: bold;"></label></td>

					<td width="5%" align="right"
						style="font-family: Myriad Pro; font-size: 12px; font-weight: bold;"><label
						id="cadlabel">CAD Total :</label></td>
					<td width="10%" align="left"><label class="textbox" id="cadbalance" style="font-family: Myriad Pro; font-size: 12px; font-weight: bold;"></label></td>

					<td width="5%" align="right"
						style="font-family: Myriad Pro; font-size: 12px; font-weight: bold;"><label
						id="chflabel">CHF Total :</label></td>
					<td width="10%" align="left"><label class="textbox" id="chfbalance" style="font-family: Myriad Pro; font-size: 12px; font-weight: bold;"></label></td>

					<td width="5%" align="right"
						style="font-family: Myriad Pro; font-size: 12px; font-weight: bold;"><label
						id="eurlabel">EUR Total :</label></td>
					<td width="10%" align="left"><label class="textbox" id="eurbalance" style="font-family: Myriad Pro; font-size: 12px; font-weight: bold;"></label></td>

					<td width="5%" align="right"
						style="font-family: Myriad Pro; font-size: 12px; font-weight: bold;"><label
						id="usdlabel">USD Total :</label></td>
					<td width="10%" align="left"><label class="textbox" id="usdbalance" style="font-family: Myriad Pro; font-size: 12px; font-weight: bold;"></label></td>
				</tr>
			</table>
		</div>
