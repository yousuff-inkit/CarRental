...
<td width="20%" >
	...
	<jsp:include page="../../heading.jsp"></jsp:include>
	 ...
	 <tr>
	 	<td colspan="2">
	 		...
	 		<label for="chkolddate" class="branch">Further amount from old date</label>	
	...
	<input type="hidden" id="hidAcurrconfig" name="hidAcurrconfig"  value='<s:property value="hidAcurrconfig"/>'/></td></tr>
	</table>
	</fieldset>
</td>
<td width="80%">
