...
<%-- 	var data;
	...
	{ 
	 ...
	 var type="postingcheque";
	 if(temp!='NA')
		{ 
		 var postingchequeurl='getallGridLoadingData.jsp?branchval='+branchval+'&fromDate='+fromDate+'&toDate='+toDate+'&payType='+payType+'&check='+check+'&type='+type;
		}
