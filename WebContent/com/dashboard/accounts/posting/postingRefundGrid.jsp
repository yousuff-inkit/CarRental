...
<%-- 	var data;
	...
	{ 
	 ...
	 var type="postingrefund";
	 if(temp!='NA')
		{ 
		 var postingrefundurl='getallGridLoadingData.jsp?branchval='+branchval+'&fromDate='+fromDate+'&toDate='+toDate+'&payType='+payType+'&check='+check+'&type='+type;
		}
