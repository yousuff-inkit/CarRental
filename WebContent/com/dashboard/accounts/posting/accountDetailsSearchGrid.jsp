...
<%-- 	var accountData='<%=cpd.accountsDetails(session, accountno, accountname,date, check)%>';
 --%> 	
 var type="accountsdetailsearch";
  
	 var accdetsearchurl='getallGridLoadingData.jsp?accountno='+accountno+'&accountname='+accountname+'&date='+date+'&check='+check+'&type='+type;
