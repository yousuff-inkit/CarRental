...
<td class="right-panel" valign="top" style="padding: 15px; background: #ffffff !important; display: flex; flex-direction: column; height: 100vh;">
                ...
                <tr>
                    ...
                    <td width="35%">
                        <input type="text" id="txtdrtotal" name="txtdrtotal" readonly="readonly" 
                               style="text-align: right; font-weight: bold; color: #2563eb; background: #f3f6f9 !important;" 
