...
// alert(data);
	 ...
	 var type="postingcard";
	 if(temp!='NA')
		{ 
		 var postingcardurl='getallGridLoadingData.jsp?branchval='+branchval+'&fromDate='+fromDate+'&toDate='+toDate+'&payType='+payType+'&check='+check+'&type='+type;
		}
