...
$(document).ready(function () {  
	...
	$("#currentdate").jqxDateTimeInput({ width: '115px', height: '22px',formatString:"dd.MM.yyyy"});
	$("#postingdate").jqxDateTimeInput({ width: '115px', height: '22px',formatString:"dd.MM.yyyy",value:null});
	var curfromdate= $('#fromdate').jqxDateTimeInput('getDate');
    var oneyeardate=new Date(new Date(curfromdate).setMonth(curfromdate.getMonth()-1));
    var oneyearbackdate=new Date(new Date(oneyeardate).setDate(oneyeardate.getDate()));
    $('#fromdate ').jqxDateTimeInput('setDate', new Date(oneyearbackdate));
    $('#purchasewindow').jqxWindow({ width: '25%', height: '55%',  maxHeight: '62%' ,maxWidth: '60%' , title: 'Term Loan Search' ,position: { x: 250, y: 60 }, keyboardCloseKey: 27});
    $('#purchasewindow').jqxWindow('close'); 
    $('#balanceloanacwindow').jqxWindow({ width: '40%', height: '55%',  maxHeight: '62%' ,maxWidth: '60%' , title: 'Bank Search' ,position: { x: 250, y: 60 }, keyboardCloseKey: 27});
    ...
    $('#purchasedocno,#dealno').dblclick(function(){
    ...
    $('#purchasedocno,#dealno,#total,#balanceloanacno,#balanceloanamt').attr('disabled',true);
...
function getBalanceLoanAcno(event){
	...
	function funSaveAJAX(principalsum,totalloanamount,balanceloanacno){
	   ...
	   $('#dltgridlength').val(dltrowindex);  
		 ...
		 document.getElementById("frmtermloanrestructuring").submit(); 
		}
	    });
	 }
	...
	function funEdit(){
		$('#purchasedocno,#dealno,#total,#balanceloanacno,#balanceloanamt').attr('disabled',false);
...
function funExportBtn(){   
	   $("#mortgagediv").excelexportjs({   
		   ...
		   worksheetName:"Term Loan Restructuring"    
		   });
	 }
</script>
...
<form id="frmtermloanrestructuring" action="savetermloanrestructuring" method="post" autocomplete="off"> 
...
<td width="20%" rowspan="2" >
	...
	<tr><td align="right"><label class="branch">Term Loan Docno</label></td> 
	...
	<tr style="height:209px"><td colspan="2">&nbsp;</td></tr>
	</table>
	</fieldset>
</td>
