...
$(document).ready(function () { 	
    ...
    var rendererstring=function (aggregates){  
    	...
    	return '<div style="float: right; margin: 4px;font-size:12px; overflow: hidden;">' + "" + '' + value + '</div>';
            ...
            var cellbeginedit = function (row) {
            ...
            $("#mortgageGrid").jqxGrid(
            {
               ...
               // pagermode: 'default',
                ...
                columns: [
                            ...
                            { text:'Term Loan Docno',datafield:'purchasevocno',cellclassname: cellclassname,cellbeginedit: cellbeginedit,width:'13.5%'},
                            { text:'Term Loan Docno',datafield:'purchasedocno',cellclassname: cellclassname,cellbeginedit: cellbeginedit,width:'13.5%',hidden:true},
