...
<%
ClsTermLoanRestructuringDAO mortdao=new ClsTermLoanRestructuringDAO();
            ...
            $("#deleteGrid").jqxGrid(
            {
               ...
               // pagermode: 'default',
                ...
                columns: [
                            ...
                            { text:'Term Loan Docno',datafield:'purchasevocno',width:'13.5%'},    
                            { text:'Term Loan Docno',datafield:'purchasedocno',width:'13.5%',hidden:true},
