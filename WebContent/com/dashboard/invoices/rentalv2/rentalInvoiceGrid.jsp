 <%@page import="com.dashboard.invoices.rentalV2.*"%>
 <%ClsRentalInvoiceV2DAO rentaldao=new ClsRentalInvoiceV2DAO();%> 
    ...
    $("#rentalInvoiceGrid").jqxGrid(
    {
       ...
       sortable:false,
        columns: [
						...
						{ text: 'Acc Sum', datafield: 'accsum',hidden:true, width: '6%',cellsformat:'d2',cellsalign:'right',align:'right' ,cellclassname: cellclassname},
						{ text: 'salik Amt', datafield: 'salikamt',hidden:true, width: '6%',cellsformat:'d2',cellsalign:'right',align:'right' ,cellclassname: cellclassname},
						{ text: 'Traffic Amt', datafield: 'trafficamt',hidden:true, width: '6%',cellsformat:'d2',cellsalign:'right',align:'right' ,cellclassname: cellclassname},
						{ text: 'Salik Srvc', datafield: 'saliksrvc', hidden:true,width: '6%',cellsformat:'d2',cellsalign:'right',align:'right' ,cellclassname: cellclassname},
						...
						{ text: 'RMS.Chg',  datafield: 'cdw',  width: '8%',hidden:customhidden,cellsformat: 'd2',cellsalign:'right',align:'right',cellclassname: cellclassname},
						{ text: 'Bank Service',  datafield: 'pai',  width: '8%',hidden:customhidden,cellsformat: 'd2',cellsalign:'right',align:'right',cellclassname: cellclassname},
						{ text: 'Plate Fee',  datafield: 'cdw1',  width: '8%',hidden:customhidden,cellsformat: 'd2',cellsalign:'right',align:'right',cellclassname: cellclassname},
						{ text: 'RTA Fee',  datafield: 'pai1',  width: '8%',hidden:customhidden,cellsformat: 'd2',cellsalign:'right',align:'right',cellclassname: cellclassname},
						{ text: 'EMI',  datafield: 'gps',  width: '8%',hidden:customhidden,cellsformat: 'd2',cellsalign:'right',align:'right',cellclassname: cellclassname},
						{ text: 'Salik Service Chg',  datafield: 'babyseater',  width: '8%',hidden:customhidden,cellsformat: 'd2',cellsalign:'right',align:'right',cellclassname: cellclassname},
						{ text: 'Fine',  datafield: 'cooler',  width: '8%',hidden:customhidden,cellsformat: 'd2',cellsalign:'right',align:'right',cellclassname: cellclassname},
						
						{ text: 'WPS Chg',  datafield: 'exkmrte',  width: '8%',hidden:customhidden,cellsformat: 'd2',cellsalign:'right',align:'right',cellclassname: cellclassname},
						{ text: 'Hotel Chg',  datafield: 'oinschg',  width: '8%',hidden:customhidden,cellsformat: 'd2',cellsalign:'right',align:'right',cellclassname: cellclassname},
						{ text: 'Additional Driver',  datafield: 'chaufchg',  width: '8%',hidden:customhidden,cellsformat: 'd2',cellsalign:'right',align:'right',cellclassname: cellclassname},
						{ text: 'Tashriya',  datafield: 'chaufexchg',  width: '8%',hidden:customhidden,cellsformat: 'd2',cellsalign:'right',align:'right',cellclassname: cellclassname}
