...
<% ClsExtraKmDAO ckd=new ClsExtraKmDAO(); %>
 ...
 String notinvoiced=request.getParameter("notinvoiced")==null?"":request.getParameter("notinvoiced");
 %>
...
var temp='<%=temp%>';
if(temp=="1"){
	exkmdata='<%=ckd.getInvoice(temp,date1,branch,client,notinvoiced)%>';
}
    ...
    $("#extraKmGrid").jqxGrid(
    {
       ...
       columnsresize:true,
        ...
        columns: [
						...
						{ text: 'Start Date', datafield: 'fromdate', width: '7%',cellsformat:'dd.MM.yyyy' ,cellclassname: cellclassname },
						{ text: 'To Date', datafield: 'todate', width: '7%',cellsformat:'dd.MM.yyyy'  ,cellclassname: cellclassname},
						{ text: 'Ac No', datafield: 'acno', width: '7%'   ,cellclassname: cellclassname},
