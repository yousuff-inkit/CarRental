...
function funClearData(){
    $('#txtclientname').val(''); $('#txtcldocno').val(''); $('#rentaltype').val(''); $('#txtagreementno').val(''); $('#vocnos').val(''); $('#clstatuss').val('');
            ...
            <div class="filter-card">
                <table class="filter-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="vocnos" name="vocnos" readonly placeholder="Press F3 to Search" onfocus="chktype();" ondblclick="funSearchdblclick();" onkeydown="getAgreement(event);" value='<s:property value="vocnos"/>'>
