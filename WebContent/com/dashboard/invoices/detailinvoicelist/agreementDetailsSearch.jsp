...
<table width="100%" cellspacing="8">
  ...
  <!-- ROW 1 -->
  <tr>
    <td width="8%" align="right" class="label">Name</td>
    <td width="40%">
      <input type="text"
             name="SCl_name"
             id="SCl_name"
    ...
    <td width="8%" align="right" class="label">Mob</td>
    <td width="18%">
      <input type="text"
             name="Sl_mob"
             id="Sl_mob"
    ...
    <td width="8%" align="right" class="label">Reg No</td>
    <td width="18%">
      <input type="text"
             name="sregno"
             id="sregno"
  ...
  <!-- ROW 2 -->
  <tr>
    <td align="right" class="label">Doc No</td>
    <td>
      <input type="text"
             name="rno"
             id="rno"
