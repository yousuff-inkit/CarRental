...
<%@page import="com.dashboard.invoices.leaseview.*"%>
<%ClsLeaseInvoiceViewDAO leasedao=new ClsLeaseInvoiceViewDAO();%>
...
$(document).ready(function () {
    ...
    $("#leaseInvoiceGrid").jqxGrid(
    {
       ...
       sortable:false,
				...
				{ text: 'From', datafield: 'displayfromdate', width: '7%',cellsformat:'dd.MM.yyyy' ,cellclassname: cellclassname},
