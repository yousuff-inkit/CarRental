...
if(temp4!='')
{ 
  invoicedata='<%= cid.invoicelist(branchval,fromDate,toDate,cldocno,rentaltype,agmtNo,clstatuss,invtype,catid)%>';
}
...
$(document).ready(function () {
    ...
    $("#rentalInvoiceGrid").jqxGrid(
    {
        ...
        columns: [
                        ...
                        { text: 'Inv Type', datafield: 'dtype', width: '5%',cellclassname: cellclassname},
                        { text: 'Original RA No', datafield: 'rano', width: '7.5%' ,hidden:true ,cellclassname: cellclassname},
						{ text: 'RA No', datafield: 'refvocno', width: '10%' ,cellclassname: cellclassname },
						...
						{ text: 'Account Name', datafield: 'acname', width: '27%' ,aggregates: ['sum1'],aggregatesrenderer:rendererstring1,cellclassname: cellclassname },
						{ text: 'Amount', datafield: 'amount', width: '9.5%',cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring,cellclassname: cellclassname },
						{ text: 'Cldocno', datafield: 'cldocno', width: '12%',cellsformat:'d2',hidden:true,cellclassname: cellclassname},	
{ text: 'email', datafield: 'mail1', width: '12%',cellsformat:'d2',hidden:true,cellclassname: cellclassname},
						{ text: 'branch id', datafield: 'brhid', width: '12%',cellsformat:'d2',hidden:true,cellclassname: cellclassname},
						{ text: 'TRNO', datafield: 'tr_no', width: '12%',cellsformat:'d2',hidden:true,cellclassname: cellclassname},
						{ text: 'Mailed', datafield: 'mailed', width: '5%',hidden:true,cellclassname: cellclassname},
