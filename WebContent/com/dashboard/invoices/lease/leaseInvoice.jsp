...
<html>
    <head>
        ...
        $(document).ready(function () {
            ...
            $('#agmtwindow').jqxWindow({ width: '62%', height: '65%',  maxHeight: '85%' ,maxWidth: '80%' , title: 'Agreement Search' ,position: { x: 250, y: 60 }, keyboardCloseKey: 27, theme: 'energyblue'});
                            ...
                            <div class="filter-card">
                                <table class="filter-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="client" id="client" readonly onkeydown="getClient(event);" value='<s:property value="client"/>' placeholder="Press F3 To Search">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="agmtno" id="agmtno" readonly onkeydown="getAgmt(event);" value='<s:property value="agmtno"/>' placeholder="Press F3 To Search">
                                        </td>
                                    </tr>
                                ...
                                <fieldset>
                                    ...
                                    <div style="display: flex; justify-content: space-around; gap: 10px;">
                                        <label class="checkbox-wrap"><input type="radio" name="chksalik" id="chksalik" onchange="setSalik();"> Salik</label>
                                        <label class="checkbox-wrap"><input type="radio" name="chktraffic" id="chktraffic" onchange="setTraffic();"> Traffic</label>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset>
                                    ...
                                    <div style="display: flex; justify-content: space-around; gap: 10px;">
                                        <label class="checkbox-wrap"><input type="radio" name="chksalik" id="chkexsalik" onchange="setSalik();"> Salik</label>
                                        <label class="checkbox-wrap"><input type="radio" name="chktraffic" id="chkextraffic" onchange="setTraffic();"> Traffic</label>
                                    </div>
                                </fieldset>
                            </div>
