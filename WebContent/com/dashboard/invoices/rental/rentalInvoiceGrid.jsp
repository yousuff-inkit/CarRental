    ...
    $("#rentalInvoiceGrid").jqxGrid(
    {
       ...
       sortable:false,
        columns: [
						...
						{ text: 'RA No', datafield: 'rano', width: '7%'  ,cellclassname: cellclassname,hidden:true},
						{ text: 'RA No', datafield: 'voc_no', width: '7%'  ,cellclassname: cellclassname},
						...
						{ text: 'Start/Last Invoiced', datafield: 'displayfromdate', width: '7%',cellsformat:'dd.MM.yyyy' ,cellclassname: cellclassname},
						...
						{ text: 'Salik Park.Amount',  datafield: 'salikparkamt',  width: '8%',hidden:false,cellsformat: 'd2',cellsalign:'right',align:'right'},
						{ text: 'Salik Park.Srvc',  datafield: 'salikparksrvc',  width: '8%',hidden:false,cellsformat: 'd2',cellsalign:'right',align:'right'},
						{ text: 'Salik Park.Amount.Rate',  datafield: 'salikparkrate',  width: '8%',hidden:true,cellsformat: 'd2',cellsalign:'right',align:'right'},
