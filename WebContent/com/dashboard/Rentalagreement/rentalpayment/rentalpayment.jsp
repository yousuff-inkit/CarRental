...
$(document).ready(function () {
     ...
     $('#agmtwindow').jqxWindow({ width: '60%', height: '60%', maxHeight: '62%' ,maxWidth: '60%' , title: 'Agreement Search' ,position: { x: 250, y: 120 }, keyboardCloseKey: 27});
     ...
     $('#clientcatwindow').jqxWindow({ width: '20%', height: '60%', maxHeight: '62%' ,maxWidth: '60%' , title: 'Category Search' ,position: { x: 250, y: 120 }, keyboardCloseKey: 27});
...
function funreload(event){
    ...
    if(fromdate>todate){
        ...
        $("#overlay, #PleaseWait").show();
        $("#detlist").load("detailsGrid.jsp?branch="+branch+"&fromdate="+fromdateStr+"&todate="+todateStr+"&cldocno="+document.getElementById("cldocno").value+"&fleet="+document.getElementById("fleet").value+"&status="+document.getElementById("status").value+"&type="+$("#rentaltype").val()+"&clientcat="+clientcat+"&agmtno="+agmtno+"&id=1");
    }
    disiem(); 
}
        ...
        <div class="sidebar-scroll-content">
            ...
            <div class="filter-card">
                <table class="filter-table">
                    ...
                    <tr>
                        <td class="label-cell">Client Cat</td>
                        <td>
                ...
                <button type="button" class="btn-submit" onclick="funcleardata();" style="margin-top: 15px;">
                    Clear
                </button>
            </div>
