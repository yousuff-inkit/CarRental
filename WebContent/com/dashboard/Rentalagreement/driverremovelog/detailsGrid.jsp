<%@page import="com.dashboard.rentalagreement.driverremovelog.ClsdriverRemovelogDAO" %>
 <%

 ClsdriverRemovelogDAO RemoveDAO=new ClsdriverRemovelogDAO();
            ...
            { 
                ...
                editable:false,
			         ...
			         columns: [
							  ...
							  { text: 'RA NO', datafield: 'voc_no', width: '5%' },   //voc no
								
								
								{ text: 'Client Name', datafield: 'refname', width: '25%' },
					 
								{ text: 'Driver', datafield: 'drname', width: '24%'},
								...
								{ text: 'Fleet Name', datafield: 'flname', width: '15%' },
								 ...
								 { text: 'EDate', datafield: 'edate', width: '7%' },
