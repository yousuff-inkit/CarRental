	  ...
	  $("#rtaiff").on('cellclick', function (event) 
			   {
			    ...
			    if(cdw1>0||cdw1!="")
			    	  ...
			    	  {
			   /* super cdw not used by other clients and WTI was having problem in saving
	 		  ...
	 		  $('#rtaiff').jqxGrid('setcellvalue', rentalrow, "rate",$('#rtaiff').jqxGrid('getcellvalue', rowindex1, "rate"));
                ...
                $('#jqxDateOut ').jqxDateTimeInput('setDate', new Date(onemounth));
				 ...
				 if(columnfrist>0)
					 ...
					 var value = $('#rtaiff').jqxGrid('getcellvalue', rowindex1, "rentaltype");	
					// alert("value :"+value);
					 var values = $('#rtaiff').jqxGrid('getcellvalue',3, "rentaltype");	
					// alert("values :"+values);
         	 ...
         	 if(value==values){
				// alert("test");
				 ...
				 if(rowindex1!=discountrow){
	                ...
	                $('#rtaiff').jqxGrid('setcellvalue', nettotalrow, dataFields,val1);
		 		   ...
		 		   $("#rtaiff").on('cellvaluechanged', function (event) 
					  ...
					  if(rowBoundIndex1==discountrow)
						   ...
						   if(dataField=="cdw"){
						 	  ...
						 	  var value2= $('#rtaiff').jqxGrid('getcellvalue', nettotalrow, dataField);
						       ...
						       // console.log(tempval+"=="+value+"=="+value2+"=="+maxdisc+"=="+dataField);  
								if(parseFloat(value)>parseFloat(maxdisc) || (parseFloat(value)>parseFloat(tempval)))  
					             ...
					             $('#rtaiff').jqxGrid('setcellvalue', discountrow, dataField,value);
					            $('#rtaiff').jqxGrid('setcellvalue', nettotalrow, dataField,value2);
					                }
				            }
