	  ...
	  aa=1;
        ...
        $(document).ready(function () { 
            ...
            { 
                ...
                columns: [
                          { text: 'SL#', sortable: false, filterable: false, editable: false,
							...
							{ text: 'Rate', datafield: 'rate', width: '12%',align:'right',cellsalign: 'right',cellsformat:'d2'},
							{ text: 'Credit_balance', datafield: 'sum', width: '12%',align:'right',cellsalign: 'right',cellsformat:'d2'},
            ...
            $('#duedategrid').on('rowdoubleclick', function (event) 
        	  ...
        	  $('#duegridDate1').val($('#duedategrid').jqxGrid('getcellvalue', rowindex1, "odate")) ; 
