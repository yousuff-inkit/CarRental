...
function mainloadSearch() {
    // Safely check for the branchsss element (handles if it's placed in a parent DOM)
    var brcEle = document.getElementById("branchsss");
    var brc = brcEle ? brcEle.value : "";
    ...
    // Safely handle spaces encoding natively alongside encodeURIComponent
...
function getdata(sclname, smob, rno, flno, sregno, brc) {
    $("#ssrefreshdiv").load('lasubmainSearch.jsp?sclname=' + sclname + '&smob=' + encodeURIComponent(smob) + '&rno=' + encodeURIComponent(rno) + '&flno=' + encodeURIComponent(flno) + '&sregno=' + encodeURIComponent(sregno) + '&brc=' + encodeURIComponent(brc));
}
</script>
</head>
    ...
    <div class="search-panel">
        <table width="100%">
            ...
            <tr>
                ...
                <td><!-- Empty spacer for the button column --></td>
            </tr>
