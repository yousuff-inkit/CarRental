...
{     
	dis();
	  ...
	  $("#allodiv").load("allocatelistGrid.jsp?chval="+val+"&uptodate="+uptodate+"&fromdate="+fromdate+"&hidchkdate="+hidchkdate);
...
/* 	function ajaxcall(fleet_no,rdocno,trancode,trans,tagno,saveval){ */
		...
		x.open("GET","savedata.jsp?saveval="+saveval+"&uptodate="+$('#uptodate').jqxDateTimeInput('val')+"&fromdate="+$('#fromdate').jqxDateTimeInput('val')+"&hidchkdate="+$("#hidchkdate").val());
