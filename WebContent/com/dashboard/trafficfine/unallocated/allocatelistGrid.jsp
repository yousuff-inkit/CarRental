...
if(temp4=='10')
{
	dats='<%=showDAO.allocationlist(uptodate,fromdate,hidchkdate)%>';    
}
else if(temp4=='2')
{ 
	//alert("in");
dats='<%=showDAO.unallocation(uptodate,fromdate,hidchkdate)%>'; 
...
$(document).ready(function () {
    ...
    $("#trafficGrid").jqxGrid(
    {
        ...
        columns: [   	
						...
						{ text: 'Black Points', datafield: 'blackpoints', width: '5%'},
