...
function mainloadSearch() {
    ...
    getdata(sclnames, smob, rno, flno, sregno, smra, brc);
}

function getdata(sclname, smob, rno, flno, sregno, smra, brc) {
    $("#srefreshdiv").load('rasubmainSearch.jsp?sclname=' + encodeURIComponent(sclname) + 
    ...
    <div class="search-panel">
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td align="right"><label class="formfont">MRA</label></td>
                <td align="left">
                    <input type="text" name="smra" id="smra" value='<s:property value="smra"/>'>
                </td>
