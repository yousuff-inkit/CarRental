...
<html>
    <head>
        ...
        function funClearData(){
            $('#txtclientname,#ticketno').val(''); $('#agmtvocno').val(''); $('#txtcldocno').val('');
            $('#rentaltype').val(''); $('#txtagreementno').val(''); $('#fromdate').val(new Date()); $('#todate').val(new Date());
                        ...
                        <div class="sidebar-scroll-content">
                            <div class="filter-card">
                                    ...
                                    <tr>
                                        <td colspan="2" align="right">
                                            <div class="checkbox-wrap" style="justify-content: flex-end; padding-bottom: 5px;">
                                                ...
                                                <label for="chksaperate">Separate Invoice</label>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="action-buttons">
                                    ...
                                    <button type="button" id="btnTrafficToBeInvoicedPrint" class="btn-submit" onclick="funTrafficToBeInvoicedPrint();" style="background:#10b981 !important;">
                                        Print
                                    </button>
                                </div>
                            </div>
