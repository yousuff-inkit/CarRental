...
function getdata(partyname, cldocno, contactNo){
    $("#refreshdiv").load('clientDetailsSearchGrid.jsp?partyname=' + encodeURIComponent(partyname) + '&cldocno=' + encodeURIComponent(cldocno) + '&contactNo=' + encodeURIComponent(contactNo));
}
</script>
</head>
