...
<html>
    <head>
        ...
        function funClearData(){
            $('#txtclientname').val(''); $('#txtcldocno').val(''); $('#rentaltype').val('');
            $('#txtagreementvoucherno').val(''); $('#txtagreementno').val('');
        ...
        function funTrafficInvoicePrint(){
            ...
            var win = window.open(reurl[0]+"printTrafficInvoice?&branch="+document.getElementById("cmbbranch").value+'&fromDate='+document.getElementById("fromdate").value+'&toDate='+$("#todate").val()+'&txtcldocno='+$("#txtcldocno").val(),"_blank","top=150,left=250,Width=1020,Height=500,location=no,scrollbars=no,toolbar=yes");
            win.focus();
        }
    ...
    <body onload="getBranch();">
        <form id="frmInvoicedTraffic" action="saveInvoicedTraffic" method="post">
                            ...
                            <div class="filter-card">
                                <table class="filter-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="txtagreementvoucherno" name="txtagreementvoucherno" readonly placeholder="Press F3 to Search" onkeydown="getAgreement(event);" value='<s:property value="txtagreementvoucherno"/>'>
                                ...
                                <div class="action-buttons">
                                    ...
                                    <button type="button" id="btnTrafficInvoicePrint" class="btn-submit" onclick="funTrafficInvoicePrint();">
                                        Print
                                    </button>
                                </div>
                            </div>
