...
$(document).ready(function () {
    ...
    funSearchdblclick(); // Initialize double-click handlers
});
            ...
            <div class="filter-card">
                <table class="filter-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="txtclientname" name="txtclientname" readonly
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="txtagreementvoucherno" name="txtagreementvoucherno" readonly
                                   placeholder="Press F3 to Search"
