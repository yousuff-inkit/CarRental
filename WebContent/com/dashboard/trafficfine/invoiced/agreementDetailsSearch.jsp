...
function mainloadSearch() {
    ...
    // Safety check to grab 'rentaltype' from parent DOM if it exists
...
function getdata(sclname, smob, rno, flno, sregno, rentaltype){
    $("#srefreshdiv").load('agreementDetailsSearchGrid.jsp?sclname=' + encodeURIComponent(sclname) + '&smob=' + encodeURIComponent(smob) + '&rno=' + encodeURIComponent(rno) + '&flno=' + encodeURIComponent(flno) + '&sregno=' + encodeURIComponent(sregno) + '&rentaltype=' + encodeURIComponent(rentaltype));
}
</script>
</head>
