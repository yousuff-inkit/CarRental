...
ArrayList<String> driverarray= new ArrayList<String>();
		...
		String delchgs="";	
			...
			//System.out.println("---ssssssssssssssssssssssss----"+delchgs);
					masteraction.setHidchkinsurcomp("0");
					masteraction.setCmbinsurcomp("0");
					masteraction.setInsurcompdays("0");
					masteraction.setCmbenqtype("0");
					masteraction.setRacrate("0");
					masteraction.setActualcldocno("0");
					int val1=rentalAgmtDAO.insert(masterdate,fleetno,cldocno,sal_id,"0",
							...
							advchk,"A",session,"RAG",request,refname,delchgs,remarks,0,"0","0","0",masteraction);	
								   ...
								   String  qreftype=""; 	
									...
									String qotsql="select reftype,refno from gl_bookingm where doc_no='"+docno+"'";	
					                  	...
					                  	if(qotrs.next())
										{
					                  	 ...
					                  	 if(qreftype.equalsIgnoreCase("DIR"))	
						                	  
						                  {
					                  		 String updateqotdir="update gl_bookingm set clstatus=4 where DOC_NO='"+docnos+"'";
					                  		 qotstmt.executeUpdate(updateqotdir); 
						                  }
