...
$(document).ready(function () {
    ...
    var source = {
        ...
        datafields: [   
            ...
            // NEW FIELD ADDED HERE: Ensure your Java backend includes "status" in the JSON string
    ...
    $("#qutfollowgrid").jqxGrid({
        ...
        columns: [   
            ...
            { text: 'Date', datafield: 'date', width: '7%', columntype: 'date', cellsformat: 'dd.MM.yyyy'},
            { text: 'hidDoc No',datafield: 'doc_no', width: '5%',hidden:true},
            { text: 'Doc No',datafield: 'voc_no', width: '5%' },
            
            // NEW STATUS COLUMN ADDED HERE
            { text: 'Status', datafield: 'status', width: '8%', 
                cellsrenderer: function (row, column, value) {
                    var statusHtml = value;
                    if (value == '2') {
                        statusHtml = "<span style='color: #d97706; font-weight: bold;'>Entering</span>";
                    } else if (value == '3') {
                        statusHtml = "<span style='color: #059669; font-weight: bold;'>Confirmed</span>";
                    }
                    return "<div style='margin:4px; margin-top:8px;'>" + statusHtml + "</div>";
                }
            },
            ...
            { text: 'From Date', datafield: 'frmdate', width: '7%', columntype: 'date', cellsformat: 'dd.MM.yyyy'},
            { text: 'From Time', datafield: 'frmtime', width: '5%'},
            { text: 'To Date', datafield: 'todate', width: '7%', columntype: 'date', cellsformat: 'dd.MM.yyyy'},
            { text: 'Follow up Date', datafield: 'fdate', width: '10%', columntype: 'date', cellsformat: 'dd.MM.yyyy'},
