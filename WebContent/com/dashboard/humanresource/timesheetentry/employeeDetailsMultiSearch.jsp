...
#search {
	...
	function loadSearchSelect(){
		...
		var i=0;var j=0;var k=0;var tempcodeno="",tempdocno="",tempempdb="";
	    ...
	    $('#txtselectedempdbs').val(tempempdb1);
