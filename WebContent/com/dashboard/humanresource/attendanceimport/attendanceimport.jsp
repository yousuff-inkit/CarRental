...
<script type="text/javascript">
      $(document).ready(function () {
		 ...
		 $('#txtmarkedattendance').val('0');
    	  ...
    	  document.getElementById("formdet").innerText="Attendance Import(ATI)";
   		document.getElementById("formdetail").value="Attendance Import";
   		document.getElementById("formdetailcode").value="ATI";
   		window.parent.formCode.value="ATI";
   		window.parent.formName.value="Attendance Import";
	...
	function funChkButton(){
	 ...
	 function setValues(){
			 ...
			 if(indexVal> 0){
				 var employeebranchchk=window.parent.employeebranchchk.value;     
	         	 ...
	         	 $("#attendanceDiv").load("attendanceGrid.jsp?docno="+indexVal+'&branchid='+branch+'&employeebranchchk='+employeebranchchk);
			 } 
		}
	 ...
	 function funViewAttendance(){
		    if(document.getElementById("btnView").value =="View"){
		    	...
		    	var employeebranchchk=window.parent.employeebranchchk.value; 
		 		var branch=document.getElementById("brchName").value;    
		    	$("#attendanceDiv").load("attendanceGrid.jsp?totdays="+totdays+"&year="+$('#cmbyear').val()+"&month="+$('#cmbmonth').val()+"&day="+$('#cmbday').val()+"&department="+$('#cmbempdepartment').val()+"&category="+$('#cmbempcategory').val()+"&empid="+$('#txtemployeedocno').val()+"&check=1"+'&branchid='+branch+'&employeebranchchk='+employeebranchchk);
...
<form id="frmAttendanceImport" action="saveAttendanceImport" method="post" autocomplete="off">
