...
.release-actions .btn-submit {
    flex: 1;
    min-width: 0;
    padding: 0 5px; /* Tighter padding to fit 3 buttons */
}
    ...
    <div class="master-container">
            ...
            <div class="sidebar-scroll-content">
                ...
                <div class="filter-card">
                    ...
                    <div class="release-actions">
                        ...
                        <button type="button" class="btn-submit" id="btnSaveSalaryPayment" onclick="funNotify();">Save</button>
                    </div>
                </div>
        ...
        <div class="main-content-area">
            ...
            <div class="grid-content-container">
                ...
                <div class="grid-wrapper" id="JVTDiv" style="display: none;">
