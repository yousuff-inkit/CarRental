    ...
    <div class="search-panel">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="txtbankaccountsno" id="txtbankaccountsno"
                ...
                <td>
                    <input type="text" name="txtbankaccountsname" id="txtbankaccountsname"
                        value='<s:property value="txtbankaccountsname"/>'>
                </td>

                <!-- Button -->
                <td>
                    <input type="button" name="btnbanksearch" id="btnbanksearch"
                        class="myButton"
                        value="Search"
