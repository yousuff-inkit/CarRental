...
ClsCommon ClsCommon=new ClsCommon();
	...
	try{
		...
		int val=0,docNo=0,processNo=0;
		  ...
		  sql="select rowno from gl_bibp where bibdid=(select doc_no from gl_bibd where description='Document Expiry Mgmt') and process='"+process+"'";
		  ...
		  if(process.trim().equalsIgnoreCase("Follow-Up")){
			   ...
			   /*Extended */
				sql="update hr_empdoc set expdt='"+sqlDate+"', visarenewid=0, rtarenewid=0 where docid='"+documentid+"' and rdocno='"+empdocno+"'";
				System.out.println(sql);
			   	val= stmt.executeUpdate(sql); 	  
