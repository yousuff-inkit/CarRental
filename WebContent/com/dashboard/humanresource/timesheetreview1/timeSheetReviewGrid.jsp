<%@page import="com.dashboard.humanresource.timesheetreview1.ClsTimeSheetReviewDAO"%>
        ...
        $(document).ready(function () {
            ...
            $("#timeSheetReviewGridID").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Entered Hours', datafield: 'normalhrs', cellclassname: cellclassname, cellsformat: 'H:mm',hidden:true,  width: '7%', cellsalign: 'left',columntype: 'datetimeinput',editable: false
								/* createeditor: function(row,cellvalue,editor,celltext,cellwidth,cellheight) {
								    editor.jqxDateTimeInput({showCalendarButton : false});
								},
								cellbeginedit: function (row) {
							...
							{ text: 'Normal Hours', datafield: 'actualnormalhrs', cellclassname: cellclassname,hidden:true,  width: '7%', cellsalign: 'left',editable: false },
							{ text: 'OT Hours', datafield: 'overtimehrs', cellclassname: cellclassname, cellsformat: 'H:mm',hidden:true,  width: '7%', cellsalign: 'left',columntype: 'datetimeinput',editable: false
								/* createeditor: function(row,cellvalue,editor,celltext,cellwidth,cellheight) {
								    editor.jqxDateTimeInput({showCalendarButton : false});
								},
								cellbeginedit: function (row) {
							...
							{ text: 'HOT Hours', datafield: 'holidayovertimehrs', cellclassname: cellclassname, cellsformat: 'H:mm',hidden:true,  width: '7%', cellsalign: 'left',columntype: 'datetimeinput',editable: false
								/* createeditor: function(row,cellvalue,editor,celltext,cellwidth,cellheight) {
								    editor.jqxDateTimeInput({showCalendarButton : false});
								},
								cellbeginedit: function (row) {
