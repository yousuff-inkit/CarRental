...
<script type="text/javascript">
      ...
      var temp1='<%=branchval%>';
	  	...
	  	if(temp1!='NA'){ 
	  		    data1='<%=DAO.leavePayrollGridReloading(branchval, upToDate,category,checks)%>';   
	  	}
        ...
        $(document).ready(function () {
            ...
            $("#leavePayrollPostinggridid").jqxGrid(
            {
            	width: '98%',
    	        height: 260,
    	        source: dataAdapter,
                ...
                columns: [
						...
						{ text: 'Annual Leave Taken', pinned: true, datafield: 'annualleave', cellsformat: 'd2', width: '6%', editable: false, cellclassname: cellclassname, cellsalign: 'center', align: 'center', aggregates: ['sum1'],aggregatesrenderer:rendererstring1 },
					//	{ text: 'Days To Pay', pinned: true, datafield: 'daystopay', cellsformat: 'd2', width: '6%', editable: false, cellclassname: cellclassname, cellsalign: 'center', align: 'center', aggregates: ['sum1'],aggregatesrenderer:rendererstring1 },
						...
						{ text: 'House Rent Allowances', datafield: 'hra', cellsformat: 'd2', editable: false, width: '10%', cellsalign: 'right', align: 'right', cellclassname: 'redClass', aggregates: ['sum'],aggregatesrenderer:rendererstring },
						{ text: 'Transport Allowances', datafield: 'ta', cellsformat: 'd2', editable: false, width: '10%', cellsalign: 'right', align: 'right', cellclassname: 'redClass', aggregates: ['sum'],aggregatesrenderer:rendererstring },
						{ text: 'Other Allowances', datafield: 'oa', cellsformat: 'd2', editable: false, width: '10%', cellsalign: 'right', align: 'right', cellclassname: 'redClass', aggregates: ['sum'],aggregatesrenderer:rendererstring },
            ...
            if(temp1=='NA'){
                $("#leavePayrollPostinggridid").jqxGrid("addrow", null, {});
            }
...
<div id="leavePayrollPostinggridid"></div>