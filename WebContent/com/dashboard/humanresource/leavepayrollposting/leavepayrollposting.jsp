...
<script type="text/javascript">
	...
	function  funClearData(){
		...
		$("#leavePayrollPostinggridid").jqxGrid('clearselection');$("#leavePayrollPostinggridid").jqxGrid('clear');
		$("#leavePayrollPostinggridid").jqxGrid('clear');$("#leavePayrollPostinggridid").jqxGrid('addrow', null, {});$("#leavePayrollPostinggridid").jqxGrid({ disabled: true});
		$("#leavepayrollpostingjvgridid").jqxGrid('clear');$("#leavepayrollpostingjvgridid").jqxGrid({ disabled: true});getLastPayrollPostedDate();
	...
	function funreload(event){
		 ...
		 var check = 1;
		 $("#leavePayrollPostinggridid").jqxGrid('clearselection');$("#leavePayrollPostinggridid").jqxGrid('clear');$("#leavePayrollPostinggridid").jqxGrid('addrow', null, {});$("#leavePayrollPostinggridid").jqxGrid({ disabled: true});
		 $("#leavepayrollpostingjvgridid").jqxGrid('clear');$("#leavepayrollpostingjvgridid").jqxGrid({ disabled: true});$('#txtdrtotal').val('');$('#txtcrtotal').val('');
		 ...
		 $("#leavepayrollpostingdiv").load("leavepayrollpostinggrid.jsp?branchval="+$('#cmbbranch').val()+'&uptodate=01.'+$('#uptodate').val()+'&category='+caregoryID+'&checks='+check);		 
	}
	...
	function disable(){
		 ...
		 $("#leavePayrollPostinggridid").jqxGrid({ disabled: true});
		 $("#leavepayrollpostingjvgridid").jqxGrid({ disabled: true});
	}
	
	function funCalculate(){
		
		var rows = $('#leavePayrollPostinggridid').jqxGrid('getrows');
	...
	//	  alert("paymentpostingdate="+paymentPostingdate+"validdate="+validdate);
		...
		if(rowlength!=0){
			...
			$("#leavepayrollpostingjvgridid").jqxGrid('clear');
		...
		var selectedrows=$("#leavePayrollPostinggridid").jqxGrid('selectedrowindexes');
	    ...
	    var checked = 1;
	    tempempdocnos="";
	    $("#leavepayrollpostingjvgridid").jqxGrid('clear');$("#leavepayrollpostingjvgridid").jqxGrid({ disabled: false});
	    $('#postingDate').jqxDateTimeInput({ disabled: false});$('#txtremarks').attr("readonly",false);$('#btnpost').attr("disabled",false);
	    $("#JVTDiv").load("leavejvgrid.jsp?branchval="+$('#cmbbranch').val()+'&uptodate=01.'+$('#uptodate').val()+'&category='+$('#txtcategoryids').val()+'&employees='+$('#txtselectedemployees').val()+'&postdate='+$('#postingDate').val()+'&checked='+checked);
	...
	function funNotify() {	
		   ...
		   $.messager.confirm('Confirm', 'Do you want to Post?', function(r){
	    	...
	    	/* Journal Voucher Grid Saving */
			 ...
			 $("#overlay, #PleaseWait").show();
			 document.getElementById("frmDashboardLeavePayrollPosting").submit();
...
<form id="frmDashboardLeavePayrollPosting" action="saveDashboardLeavePayrollPosting" method="post">
...
<td width="20%" >
	...
	<jsp:include page="../../heading.jsp"></jsp:include>
     ...
     <input type="hidden" id="txtselectedemployees" name="txtselectedemployees" onchange="alert('Value changed to: ' + this.value);" value='<s:property value="txtselectedemployees"/>'/>
...
<td width="80%">
	<table width="100%">
		<tr><td><div id="leavepayrollpostingdiv"><jsp:include page="leavepayrollpostinggrid.jsp"></jsp:include></div><br/></td></tr>
		<tr><td><div id="JVTDiv"><jsp:include page="leavejvgrid.jsp"></jsp:include></div></td></tr> 
	</table>
</td></tr></table>
</div>
</div>
