        ...
        var costtype='<%=dtype1%>';
           ...
           $('#costcodeSearch').on('rowdoubleclick', function (event) {
                ...
                if($('#txtorgridclick').val()=='1') {  
                	 document.getElementById("txtprjbrhid").value = $('#costcodeSearch').jqxGrid('getcellvalue', rowindex2, "brhid");  
		             ...
		             $('#timeSheetDetailsGridID').jqxGrid('setcellvalue', rowindex1, "costbrhid" ,$('#costcodeSearch').jqxGrid('getcellvalue', rowindex2, "brhid"));
	            	 ...
	            	 document.getElementById("txtselectedbrhid").value = $('#costcodeSearch').jqxGrid('getcellvalue', rowindex2, "brhid");   
                }     
