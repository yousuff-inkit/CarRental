...
System.out.println("test");
 ...
 String filldescription = request.getParameter("description")==null?"":request.getParameter("description");
 String costbrhid = request.getParameter("costbrhid")==null || request.getParameter("costbrhid").trim().equals("")?"0":request.getParameter("costbrhid");
 %>
<script type="text/javascript">
        ...
        $(document).ready(function () {   
          ...
          if(gridload=="1"){
        	  fillgriddata = '<%=DAO.timeSheetFillGridLoading(session,fillfromdate,filltodate,daysselected,selectedempdocnos,selectedcosttypename,selectedcosttypeid,selectedcostid,selectedcostiddocno,fillintime,fillouttime,fillnormalhrs,fillothrs,fillhothrs,filldescription,gridload,costbrhid) %>'; 
          }
            ...
            $("#timeSheetFillSearchGridId").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Cost BRHID', datafield: 'costbrhid', width: '7%',hidden: true },
							{ text: 'Total Time', datafield: 'intime', cellsformat: 'H:mm',  width: '7%', cellsalign: 'left',columntype: 'datetimeinput',
								createeditor: function(row,cellvalue,editor,celltext,cellwidth,cellheight) {
								    editor.jqxDateTimeInput({showCalendarButton : false});
								} 
							},
							{ text: 'Out Time', datafield: 'outtime', cellsformat: 'H:mm',  width: '7%', cellsalign: 'left',columntype: 'datetimeinput',hidden:true,
								createeditor: function(row,cellvalue,editor,celltext,cellwidth,cellheight) {
								    editor.jqxDateTimeInput({showCalendarButton : false});
								} 
							},
							{ text: 'Normal Hours', datafield: 'hrs', cellsformat: 'H:mm',  width: '7%', cellsalign: 'left',columntype: 'datetimeinput',hidden:true,
								createeditor: function(row,cellvalue,editor,celltext,cellwidth,cellheight) {
								    editor.jqxDateTimeInput({showCalendarButton : false});
								} 
							}, 
