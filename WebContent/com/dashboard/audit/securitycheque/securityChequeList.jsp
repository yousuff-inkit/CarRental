...
div[id^="uptodate"], div[id^="date"], div[id^="chequeDate"] {
    width: 100%;
}
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
         /* Updated jqx inputs to match 100% width and 24px height pattern */
    ...
    <div class="master-container">
        ...
        <div class="sidebar-filters">
            <div class="sidebar-scroll-content">
                        ...
                        <tr>
                            <td colspan="2" style="padding-top: 5px;">
                                <div style="display: flex; align-items: center; gap: 8px;">
                                    <input type="checkbox" id="chktest" name="chktest" style="width: auto; height: auto;" onchange="intro1check();" onclick="$(this).attr('value', this.checked ? 1 : 0)"/>
                ...
                <div class="filter-card">
                    <textarea id="txtinfo" name="txtinfo" readonly="readonly"><s:property value="txtinfo" ></s:property></textarea>
