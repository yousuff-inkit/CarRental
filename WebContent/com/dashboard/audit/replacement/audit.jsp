...
<style type="text/css">
    /* Layout & Master Sidebar Structure */
    .master-container {
        display: flex;
    ...
    /* Clean Cards - Stripping legacy green/shading backgrounds */
    .filter-card {
        ...
        <div class="sidebar-scroll-content">
            ...
            <div style="padding: 10px 5px;">
                <div class="button-row">
                    <button class="myButton" type="button" id="btnRAG" name="btnRAG" onclick="getReplacement(event);">Replacement</button>
