...
if(parseInt(window.parent.chkexportdata.value)=="1")
		  {
		  	JSONToCSVCon(invoicedata, 'Invoice Audit List', true);
		  }
		 else
		  {
			 $("#rentalInvoiceGrid").jqxGrid('exportdata', 'xls', 'Invoice Audit List');
		  }
			}); 
...
/* 	function funSearchdblclick(){
	...
	function funPrintData(){
		...
		if(document.getElementById("printdocno").value!=""){
	    	...
	    	var win= window.open(reurl[0]+"/com/operations/commtransactions/invoice/printManualInvoice?allbranch=1&printdocno="+document.getElementById("printdocno").value+"&hidheader=1&chkdeletedinvprint=0","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
	    	win.focus();	
		}
		...
		if (x.readyState==4 && x.status==200)
			{
			 	...
			 	if(parseInt(items)>0){
			 		$.messager.alert('Message','Record Successfully Audited','warning');   
			 	}
			 	else{
			 		$.messager.alert('Message','Not Audited','warning');
			 	}
	     ...
	     x.open("GET","auditData.jsp?invno="+document.getElementById("printdocno").value,true);
	    x.send();
...
<td width="20%" >
	...
	<input type="button" class="myButtons" name="audit" id="audit"  value="Audit"onclick="funauditData();">
	<tr><td colspan="2">&nbsp;</td></tr>
	<tr><td colspan="2">&nbsp;</td></tr>
	<tr><td colspan="2">&nbsp;</td></tr> 
	<tr><td colspan="2">&nbsp;</td></tr>
