<%@page import="com.dashboard.workshop.carwashreminder.*" %>
<% ClsCarwashReminderDAO DAO=new ClsCarwashReminderDAO(); %> 
<%
...
if(id=='1'){
	  Data2='<%=DAO.getMaitenanceData(todate,id)%>'; 
        ...
        columns: [
             ...
             cellsrenderer: function (row, column, value) {
              return "<center><div style='margin:4px;'>" + (value + 1) + "</div></center>";
       				...
       				{ text: 'Doc No',datafield:'gatedocno',width:'6%',hidden:true},
       				{ text: 'Date',datafield:'date',width:'7%',cellsformat:'dd.MM.yyyy',hidden:true},
					...
					{ text: 'Reg No',datafield:'reg_no',width:'5%'},
       				...
       				{ text: 'Last IN (Date/Time)',datafield:'indatetime',width:'10%'},
       				{ text: 'Last OUT (Date/Time)',datafield:'outdatetime',width:'10%'},
