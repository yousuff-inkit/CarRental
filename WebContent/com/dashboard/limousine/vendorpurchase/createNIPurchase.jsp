...
<!-- commented this as there is an error arising when using topzeed project instead have added java.text,simpleDateformat -->
...
try{
	...
	// in topzeed the branchid column is of int type due to which when branchid is passed as a it will throw an error so to avoid this I have added the below snippet  
	if(session.getAttribute("BRANCHID").toString().equalsIgnoreCase("a")){
