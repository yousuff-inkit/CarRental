	...
	$(document).ready(function () {
 	...
 	function mainloadSearch() {
 		...
 		var sregno=document.getElementById("sregno").value;
 		  ...
 		  var rad;
 		 if(document.getElementById("rdra").checked)
 		{
 		rad=1;
 		}
 	else
		...
		getdata(sclname,smob,rno,flno,sregno,branchval,rad);

	}
	 function getdata(sclname,smob,rno,flno,sregno,branchval,rad){
		 $("#srefreshdiv").load('agreementDetailsSearchGrid.jsp?sclname='+sclname+'&smob='+smob+'&rno='+rno+'&flno='+flno+'&sregno='+sregno+'&branchval='+branchval+'&rad='+rad);
		}
