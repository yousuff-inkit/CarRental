...
function mainloadSearch() {
    ...
    getdata(sclname, smob, rno, flno, sregno, smra, agmttype);
}

function getdata(sclname, smob, rno, flno, sregno, smra, agmttype) {
    $("#srefreshdiv").load('submainSearch.jsp?sclname=' + sclname + '&smob=' + smob + '&rno=' + rno + '&flno=' + flno + '&sregno=' + sregno + '&smra=' + smra + '&agmttype=' + agmttype);
}
</script>
</head>
