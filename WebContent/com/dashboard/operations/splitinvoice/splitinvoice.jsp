  ...
  function funreload(event){
			 ...
			 var postacc =document.getElementById("postacc").value;
			  ...
			  $("#jqxsplitinvoicejvdetails").jqxGrid('addrow', null, {});
   			...
   			if(selectedrows.length==0){
   				...
   				var j=0;
   				var nettotal=0.0;
   				for (i = 0,j=0; i < selectedrows.length; i++) {
			      	...
			      	if(chargetodrive=='' || chargetodrive=='undefined' || typeof(chargetodrive)=='undefined' || chargetodrive==null){
		   	        ...
		   	        $('#jqxsplitinvoicejvdetails').jqxGrid('setcellvalue',j, "acno",postacc);
		            $('#jqxsplitinvoicejvdetails').jqxGrid('setcellvalue',j, "account",txtpostacc);
   			 ...
   			 $("#jqxsplitinvoicejvdetails").jqxGrid('addrow', null, {});
   			var client= $('#jqxsplitinvoice').jqxGrid('getcellvalue',rowindex1, "client");
   			var invoice= document.getElementById("invoice").value;
     		var acno= document.getElementById("acno").value;
     		  var doc_no= document.getElementById("doc_no").value;
   		  $('#jqxsplitinvoicejvdetails').jqxGrid('setcellvalue',j, "docno",doc_no);
   		  $('#jqxsplitinvoicejvdetails').jqxGrid('setcellvalue',j, "description","Adjustment Entry INV - "+invoice);
    	  $('#jqxsplitinvoicejvdetails').jqxGrid('setcellvalue',j, "acno",acno);
 	        $('#jqxsplitinvoicejvdetails').jqxGrid('setcellvalue',j, "account",client);
   		    $('#jqxsplitinvoicejvdetails').jqxGrid('setcellvalue',j, "credit",nettotal);
		 ...
		 function funcreatejv(){ 
			var postdate=$('#postdate').val();
				  var postdate1 = $('#postdate').jqxDateTimeInput('getDate');
				  var validdate=funDateInPeriod(postdate1);
			...
			var gridarray=new Array();
			   ...
			   var val=0;
				...
				if(val==0){
   					$.messager.alert('Warning','Please calculate properly');
   					return false;
   				}
