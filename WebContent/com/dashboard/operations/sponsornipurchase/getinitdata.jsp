...
//	System.out.println(strgetbranch);
	...
	String strstatus="SELECT CODE,refname FROM gl_riderstatus WHERE STATUS=1";
	ResultSet rsstatus=stmt.executeQuery(strstatus);
	while(rsstatus.next()){
		JSONObject objtemp=new JSONObject();
		objtemp.put("docno", rsstatus.getString("CODE"));
		objtemp.put("refname", rsstatus.getString("refname"));
