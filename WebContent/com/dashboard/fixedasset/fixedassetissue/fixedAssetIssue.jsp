...
$(document).ready(function () {
	...
	function funExportBtn(){
		  $("#faIssue").excelexportjs({  
	       		containerid: "faIssue", 
	       		datatype: 'json', 
	       		dataset: null, 
	       		gridId: "faIssueGrid", 
	       		columns: getColumns("faIssueGrid") , 
	       		worksheetName:" Fixed Asset Issue"
	       		}); 
				 }
...
<td width="20%">
  ...
  <tr>
	...
	<tr><td colspan="2" align="center"><textarea id="issueinfo" style="height:80px;width:200px;font: 10px Tahoma;resize:none" name="issueinfo"  readonly="readonly"  ><s:property value="issueinfo" ></s:property></textarea></td></tr>
	 ...
	 <tr><td align="right"><label class="branch" id="lbljobtype">Job Type</label></td>
	...
	<tr><td align="right"><label class="branch" id="lbljobno">Job No.</label></td> 
