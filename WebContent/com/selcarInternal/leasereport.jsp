...
//System.out.println("======aa==== ");		
	...
	Date to=com.changeStringtoSqlDate(request.getParameter("to")); 
			...
			if(!(from==null))
			{
           		...
           		String sql="select(select count(*) from gl_lagmt where outdate>='"+from+"' and outdate<='"+to+"')as open,(select count(*) from gl_lagmtclosem where indate>='"+from+"' and indate<='"+to+"')as close";
