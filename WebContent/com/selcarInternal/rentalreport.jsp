...
//System.out.println("======aa==== ");		
	...
	Date to=com.changeStringtoSqlDate(request.getParameter("to")); 
			...
			if(!(from==null))
			{
           		...
           		String sql="select (select count(*) from gl_ragmt where odate>='"+from+"' and odate<='"+to+"'  ) as open, (select count(*) from gl_ragmtclosem where indate>='"+from+"' and indate<='"+to+"' )as close";
