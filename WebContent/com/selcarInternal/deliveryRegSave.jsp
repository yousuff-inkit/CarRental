 ...
 //System.out.println("======aa==== ");		
	...
	System.out.println("=====deldateOut==== ");
			...
			if(chkupdate==1 && delstatus==0)
			{
				...
				stmtUpdaterent.setString(7,deltimeOut);
				...
				//stmtUpdaterent.getInt(1);
				stmtUpdaterent.close();
	    		 }
				if(aa>0 || !repno.equalsIgnoreCase("0")){
		...
		else
		{
				...
				response.getWriter().write("Incompatible App Version");
				conn.close();
				return ;
			}
