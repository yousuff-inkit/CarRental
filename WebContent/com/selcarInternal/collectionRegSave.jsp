...
Connection conn=null;
 ...
 //System.out.println("======aa==== ");		
		...
		CallableStatement stmtUpdaterent = null;
		 ...
		 String sqltst="select * from an_acollection where agmtno="+agmtno+" and km="+km+"  and userid="+userid+"";
		 System.out.println("==acollection initial check sql=="+sqltst);
		 ResultSet rs=stmt.executeQuery(sqltst);
		 
		 while(rs.next()){
			 value="Not Updated";
		 }
		 System.out.println("==acollection initial check value=="+value);
		 ...
		 if(value.equalsIgnoreCase("")){
			...
			stmtUpdaterent.registerOutParameter(8, java.sql.Types.INTEGER);
				...
				value="Incompatible App Version";
			}
		 }
	}
	catch(Exception e){
