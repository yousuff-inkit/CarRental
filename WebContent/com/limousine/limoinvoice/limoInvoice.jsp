...
<script type="text/javascript">
     ...
     function getvatconfig() {
		...
		x.onreadystatechange=function(){
			if (x.readyState==4 && x.status==200) {
				...
				vatconfiguration = JSON.parse(items).vatconfig;
			//	alert(items+" - "+vatconfiguration );
			} else {
     ...
     function funSendmail(){
    	...
    	var dtype=$('#formdetailcode').val();
 		...
 		if(docno.trim()=="" || typeof(docno.trim())=="undefined" || typeof(docno.trim())=="NaN"){
     	...
     	$("#overlay, #PleaseWait").show();
 	 	$.ajaxFileUpload({  
 	 		url: "sendLimoInvMail.action?docno="+docno+"&bankdocno="+bnk+"&dtype="+dtype,  
     ...
     function setValues(){
		 ...
		 if(document.getElementById("docno").value!=""){
			 $('#limoinvoicediv').load('limoInvoiceGrid2.jsp?docno='+document.getElementById("docno").value+'&id=1&rmvvatservice='+vatconfiguration);
		 }
     }
...
<body onload="setValues();funbnkdetls();getvatconfig();">
