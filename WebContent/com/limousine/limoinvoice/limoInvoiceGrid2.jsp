...
String rmvvatservice=request.getParameter("rmvvatservice")==null?"0":request.getParameter("rmvvatservice");
...
var amountdata=[];
var id='<%=id%>';
var rmvvatservice='<%=rmvvatservice%>';
if(id=="1"){
            ...
            $("#limoInvoiceGrid").jqxGrid(
            {
               ...
               // pagermode: 'default',
                ...
                columns: [
                            ...
                            { text:'Vessel No',datafield:'vesselno',width:"10%",hidden:false},
                            { text:'Vessel Name',datafield:'vesselname',width:"10%",hidden:false},
                            ...
                            { text: 'VAT%', datafield: 'vatpercent', width: '8%' ,cellsalign:'right',cellsformat:'D2',align:'right',editable:true},
               ...
               $("#limoInvoiceGrid").on('cellvaluechanged', function (event) 
                       {
               		    ...
               		    datafield=="vipchg" || datafield=="boquechg" || datafield=='vatpercent'){
               		    	var vatpercent=$('#limoInvoiceGrid').jqxGrid('getcellvalue',rowindex,'vatpercent');
               		    	...
               		    	vatpercent=vatpercent=="undefined" || typeof(vatpercent)=="undefined" || vatpercent==null || vatpercent==""?0.0:vatpercent;
               		    ...
               		    var vattotal=0;	
               		 	if(rmvvatservice==1){
               		 		vattotal=parseFloat(tarif)+parseFloat(nighttarif)+parseFloat(excesskmchg)+parseFloat(excesshrchg)+parseFloat(excessnighthrchg);
               		 	} else {
               		 		vattotal=parseFloat(tarif)+parseFloat(nighttarif)+parseFloat(excesskmchg)+parseFloat(excesshrchg)+parseFloat(excessnighthrchg)+parseFloat(fuelchg)+parseFloat(parkingchg)+parseFloat(otherchg)+parseFloat(greetchg)+parseFloat(vipchg)+parseFloat(boquechg);
               		 	}
               		    total=parseFloat(tarif)+parseFloat(nighttarif)+parseFloat(excesskmchg)+parseFloat(excesshrchg)+parseFloat(excessnighthrchg)+parseFloat(fuelchg)+parseFloat(parkingchg)+parseFloat(otherchg)+parseFloat(greetchg)+parseFloat(vipchg)+parseFloat(boquechg);
               		 	//total = total + (vattotal*(parseFloat(vatpercent)/100));
