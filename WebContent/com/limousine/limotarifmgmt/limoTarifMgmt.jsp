...
<script type="text/javascript">
	...
	function funTarifClone(){
		$('#prevdocno').val($('#docno').val());
		funRemoveReadOnly();
		$('#date').jqxDateTimeInput('val',new Date());
		setTarifClient();
		$('#btnTarifEdit').hide();
	...
	function funTarifSave(){
    	...
    	for(var i=0;i<rows.length;i++){
		    ...
		    var allowance = rows[i].allowance;
		    
		    if(allowance=="" || allowance==null || allowance=="undefined" || typeof(allowance)=="undefined"){
		    	allowance="0";
		    }
			...
			newTextBox.val(rows[i].pickuplocid+"::"+rows[i].dropofflocid+"::"+estdistance+"::"+newtime+"::"+tarif+"::"+exdistancerate+"::"+extimerate+"::"+allowance);
    	...
    	for(var i=0;i<rows2.length;i++){
    		...
    		var allowance = rows2[i].allowance;
    		 if(allowance=="" || allowance==null || allowance=="undefined" || typeof(allowance)=="undefined"){
 		    	allowance="0";
 		    }
				...
				newTextBox.val(rows2[i].blockhrs+"::"+rows2[i].limotarif+"::"+rows2[i].exhrrate+"::"+rows2[i].nighttarif+"::"+rows2[i].nightexhrrate+" :: "+rows2[i].locationdocno+" :: "+allowance);
 ...
 -->	    </select></td>
	  ...
	  <tr>
	    ...
	    <td colspan="12"><input type="text" name="desc" id="desc" style="width:98%;" value='<s:property value="desc" />'></td>
		  ...
		  <button type="button"  id="btnTarifClone" title="Tarif Clone" style="border:none;background:none;" onclick="funTarifClone();" class="tarifbuttons">
							<img alt="Tarif Clone" src="<%=contextPath%>/icons/clone.png" width="30" height="30">
		  </button>
    ...
    <table width="100%">
      ...
      <input type="hidden" id="isclone" name="isclone" value='<s:property value="isclone"/>'/>
      <input type="hidden" id="prevdocno" name="prevdocno" value='<s:property value="prevdocno"/>'/>
