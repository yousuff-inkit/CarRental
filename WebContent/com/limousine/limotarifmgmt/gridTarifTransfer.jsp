 ...
 var columnsrenderer = function (value) {
       ...
       /*      alert("here");
                ...
                columns: [
							...
							{ text: ''+document.getElementById("mainestdistance").value,  datafield: 'estdistance',editable:true ,width:'10%',renderer: columnsrenderer,cellsformat: 'd2',cellsalign:'right'},
							{ text: ''+document.getElementById("mainesttime").value,  datafield: 'esttime',width:'10%',cellsformat:'HH:mm',cellclassname:'column',columntype:"datetimeinput", createeditor: function (row, cellvalue, editor, celltext, cellwidth, cellheight) {
 						        editor.jqxDateTimeInput({ showCalendarButton: false });
 						    }},
							{ text: ''+document.getElementById("maintarif").value,  datafield: 'tarif',width:'10%',editable:true ,renderer: columnsrenderer,cellsformat: 'd2',cellsalign:'right'},
							{ text: ''+document.getElementById("mainexdistancerate").value,  datafield: 'exdistancerate',width:'10%',editable:true,renderer: columnsrenderer,cellsformat: 'd2',cellsalign:'right'},
							{ text: ''+document.getElementById("mainextimerate").value,  datafield: 'extimerate', editable:true,width:'10%',renderer: columnsrenderer,cellsformat: 'd2',cellsalign:'right'},
							...
							{ text: 'Dropoff location id', datafield: 'dropofflocid',hidden:true,width:'12%'},
 						    { text:'Allowance', datafield:'allowance', editble:true, width:'10%',cellsalign:'right',cellsformat: 'd2',renderer: columnsrenderer}
         	              ]
            ...
            $("#gridTarifTransfer").on("celldoubleclick", function (event)
            		{
            		    ...
            		    if(dataField=="pickuploc" || dataField=="dropoffloc"){
        					...
        					locationSearchContent('locationSearchGrid.jsp?datafield='+dataField+'&gridname=gridTarifTransfer', $('#locationwindow'));
            		    }
            		});                       
