 ...
 var acdata= '<%=tarifdao.getLocations()%>';
       ...
       $('#locationSearch').on('rowdoubleclick', function (event) {
            	...
            	if(data=="pickuploc"){
            		...
            		$("#gridTarifHour").jqxGrid('setcellvalue', transferrowindex, "location", $('#locationSearch').jqxGrid('getcellvalue', rowindex, "location"));
                    $("#gridTarifHour").jqxGrid('setcellvalue', transferrowindex, "locationdocno", $('#locationSearch').jqxGrid('getcellvalue', rowindex, "doc_no"));
            	}
