...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            document.getElementById("chkuptodate").checked=true;
            setDates();
...
// Changed The condition if(tarifdocno==0);
                if (tarifdocno == "" || tarifdocno == "undefined" || tarifdocno == null || typeof(tarifdocno) == "undefined") {
