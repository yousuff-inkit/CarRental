...
%> 
 ...
 var id='<%=id%>';
 if(id=="1"){
	searchdata='<%=limodao.getSearchData(docno, client, clientmob, date, guest,id,branch)%>';
 } 
        ...
        $(document).ready(function () { 
			...
			$('#mainSearch').on('rowdoubleclick', function (event) 
	            ...
	            document.getElementById("txtroomno").value=$('#mainSearch').jqxGrid('getcellvalue',rowindex1,'roomno');
	             ...
	             document.getElementById("refno").value=$('#mainSearch').jqxGrid('getcellvalue',rowindex1,'refno');
	             document.getElementById("vesselno").value=$('#mainSearch').jqxGrid('getcellvalue',rowindex1,'vesselno');
	             document.getElementById("vesselname").value=$('#mainSearch').jqxGrid('getcellvalue',rowindex1,'vesselname');
	            canEdit();
	            setValues();
	            $('#mainSearch').jqxGrid('clear');
