...
try{
	...
	String description="",guestno="",hidchknewguest="",client="",cldocno="",mobile="",licenseno="",guestname="",guestcontactno="",vesselno="",vesselname="",vocno="";
	java.sql.Date sqldate=null;
	
	String str="select book.voc_no,book.vesselno,book.vesselname,book.desc1 description,book.doc_no,book.date,book.guestno,book.newguest hidchknewguest,ac.refname,ac.cldocno,ac.per_mob,dr.dlno,guest.guest,guest.guestcontactno"+
	...
	while(rs.next()){
		...
		vesselname=rs.getString("vesselname");
		vocno=rs.getString("voc_no");
		
	}
	stmt.close();
	response.getWriter().write(description+"::"+docno+"::"+sqldate+"::"+guestno+"::"+hidchknewguest+"::"+client+"::"+cldocno+"::"+mobile+"::"+licenseno+"::"+guestname+"::"+guestcontactno+"::"+vesselno+"::"+vesselname+"::"+vocno);
}
catch(Exception e){
	e.printStackTrace();
}
