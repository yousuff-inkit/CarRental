...
/* Labels (table left cells). Keep right alignment already set in HTML */
#search td {
...
/* Date container styled like input */
#txtdob {
    width: 110px;
    height: 34px;
    padding: 6px 10px;
...
/* Hidden date input keeps its value as before */
#hidtxtdob {
    display: none;
}

/* Map CNO search button look to existing .myButton */
.myButton {
    display: inline-block;
