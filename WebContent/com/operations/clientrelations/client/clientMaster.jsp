...
<style>
/* --- 1. Global Reset for Tables --- */
* {
    box-sizing: border-box; /* Crucial: stops padding from expanding the width */
}
...
/* --- 2. Fieldset & Heading Line --- */
fieldset {
    border: 1px solid #e1e4e8;
    border-radius: 6px;
    background: #ffffff;
    margin-bottom: 15px;
    padding: 10px !important; /* Reduced padding to prevent overlap */
...
legend {
    ...
    border-left: 4px solid #007bff !important; /* THE BLUE LINE */
    margin-bottom: 5px;
}

/* --- 3. Input Styling (Width Fix) --- */
input[type="text"], select {
    ...
    width: 100% !important; /* Force input to stay inside the TD */
    max-width: 100%;
    outline: none;
}

/* Exception for inputs with inline styles like width:50% in your HTML */
input[style*="width:50%"] { width: 50% !important; }
input[style*="width:80%"] { width: 80% !important; }
input[style*="width:97%"] { width: 97% !important; }

/* --- 4. Table Layout Fixes --- */
table {
    table-layout: fixed; /* Prevents columns from expanding and overlapping */
    width: 100%;
}
...
/* --- 6. Special Fix for the KYC Table --- */
.table1 {
    table-layout: auto; /* Grid needs to expand based on content */
}
