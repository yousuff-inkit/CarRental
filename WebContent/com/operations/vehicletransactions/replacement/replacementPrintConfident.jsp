...
<div style="background-color:white;">
 ...
 <table width="100%" >
  <tr>
    <td width="22%" rowspan="6"><img src="<%=contextPath%>/icons/epic.jpg" width="200" height="91"  alt=""/></td> 
...
<td align="left">:&nbsp;
 ...
 <fieldset><legend><b>Driver Details</b></legend>
   ...
   <tr>
    ...
    <label id="drname" name="drname"><s:property value="drname"/></label></td>
      
    </tr>
    </table>
        <table  width="100%" >
    <tr>
    <td  width="20%" align="left">D\L NO</td>
    <td width="30%" >:&nbsp;<label id="radlno" name="drdlno"><s:property value="drdlno"/></label></td>
   
    <td width="15%" align="right">Exp Date</td>
    <td width="30%" >:&nbsp;<label id="lblaccount" name="drlexp" ><s:property value="drlexp"/></label></td>
    </tr>
  
    
    <tr>
     <td width="20%" align="left">Passport NO</td>
     <td width="30%" >:&nbsp; <label name="drpassno" id="drpassno" ><s:property value="drpassno"/></label></td>
    
     <td width="15%" align="right">Exp Date</td>
     <td width="30%">:&nbsp;<label name="drpassexp" id="drpassexp" ><s:property value="drpassexp"/></label></td>
    </tr>
    
     <tr>
     <td width="20%" align="left">EID NO</td>
     <td width="30%">:&nbsp; <label name="drvisano" id="drvisano" ><s:property value="drvisano"/></label></td>

    <td width="15%" align="right">DOB</td>
    <td width="30%">:&nbsp;<label name="drdob" id="drdob" ><s:property value="drdob"/></label></td>
    </tr>
    </table>
</fieldset>
...
<table width="100%" >
  ...
  <tr>
    ...
    <td>Colour</td>
    <td>:&nbsp;
      <label id="vehcolor" name="vehcolor">
        <s:property value="vehcolor"/>
      </label></td>
    <td>Model</td>
    <td>:&nbsp;
      <label id="vehmodel" name="vehmodel">
        <s:property value="vehmodel"/>
      </label></td>
    </tr>
  <tr>
...
<!-- <table width="100%">          
		<tr><td width="100%"><img src="vehrpltermsConfident.png" style="max-width: 100%; max-height: 100%; width: auto; height: auto;" alt=""/></td></tr>
	</table>   -->   

<table width="100%">
  <tr>
    <td width="35%"><fieldset><legend>Hirer </legend>
    <table width="100%">
  <tr>
    <td width="29%">Name</td>
    <td width="71%">&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
       ...
       <td width="35%"><fieldset><legend>Driver </legend>
    <table width="100%">
  <tr>
    <td width="29%">Name</td>
    <td width="71%">&nbsp;</td>
  ...
  <td width="30%"><fieldset><legend>FOR&nbsp;<label id="companyname" name="companyname"><s:property value="companyname"/></label> </legend>
    <table width="100%">
 <tr>
    <td width="29%">Name</td>
    <td width="71%">&nbsp;</td>
...
<table width="100%" >
  <tr>
    <td width="35%"><fieldset><legend>Company Name </legend>
    <table width="100%">
  <tr>
    
    <td width="30%"><label id="companyname" name="companyname"><s:property value="companyname"/></label></td>
  </tr>
  <tr>
    ...
    <td>&nbsp;</td>
       ...
       <td width="35%"><fieldset><legend>Stamp </legend>
    <table width="100%">
  <tr>
  ...
  <td width="30"><fieldset><legend>Remarks </legend>
    <table width="100%">
  <tr>
