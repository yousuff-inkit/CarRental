  ...
  <tr>
    ...
    <table width="100%">
      <tr>
        ...
        <td width="11%" align="left"><div id="time" name="time"  value='<s:property value="date"/>'></div></td>
      ...
      <tr>
        ...
        <td align="left"><div class="input-search-container"><input type="text" name="refvoucherno" id="refvoucherno" value='<s:property value="refvoucherno"/>' readonly placeholder="Press F3 to Search" onKeyDown="getDoc(event);"> <svg class="magnifier-icon" onclick="triggerToSearch();" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
<table width="100%" >
  <tr>
    <td height="104" width="50%" ><fieldset>
      <legend>Existing</legend>
      <div id="existingdiv">
        <jsp:include page="existingGrid.jsp"></jsp:include> 
        </div>
    </fieldset></td>
    <td width="50%" rowspan="3"><fieldset style="height=100%;width=100%;">
  <table width="100%">
    <tr>
  ...
  <tr>
    <td height="25" width="100%"><fieldset>
