...
<div class="document-container">
    ...
    <div class="info-grid">
        ...
        <div class="grid-row"><span class="grid-label">Doc No:</span> <span><label id="docvals" name="docvals"><s:property value="docvals"/></label> - <label id="lblbranch" name="lbbranchl"><s:property value="lblbranch"/></label></span></div>
