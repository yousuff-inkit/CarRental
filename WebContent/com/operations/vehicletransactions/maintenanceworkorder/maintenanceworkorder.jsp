...
<td align="right" width="1.2%">Next Ser.Due KM</td><td align="left" width="12.5%"><input type="text" id="nextserdue" name="nextserdue" onkeypress="javascript:return isNumber (event)" style="width:15%;" value='<s:property value="nextserdue"/>' > </td>
 ...
 <img  alt="Search User" src="<%=contextPath%>/icons/31load.gif"> </div></div>     
               ...
               <br><br> &nbsp;&nbsp;<input type="button" id="thirdedit" onclick="thirdedits();" class="myButtonss" value="EDIT"><input type="button" hidden="true" id="third" onclick="trdnext();" class="myButtonss" value="SAVE">
               <br><br><input type="button" id="thirdremove" onclick="funremoveapproval();" class="myButtonss" value="REMOVE"></td> </tr></table>
...
<td><button type="button" id="btnpostdetails" class="myButton" onclick="getPostDetails();">Post Details</button></td>
               ...
               <br><br><br><br><br><br> 
                ...
                <br><br>&nbsp;&nbsp; <input type="button" id="lastedit" onclick="lastedits();" class="myButtonss" value="EDIT"><input type="button" id="last" hidden="true" onclick="lastsave();" class="myButtonss" value="SAVE">
                  <br><br><input type="button" id="lastremove" onclick="funremoveposting();" class="myButtonss" value="REMOVE"></td> </tr></table>
