...
<table width="100%">
  ...
  <div class="input-search-container"> <input type="text" id="accid" name="accid" style="width:10%;" placeholder="Press F3 to Search" value='<s:property value="accid"/>'  onkeydown="getaccountdetails(event)" onblur="diserror()"/>
   ...
   <input type="text" id="vehpuraccname" name="vehpuraccname" style="width:70%;" value='<s:property value="vehpuraccname"/>'/>
    ...
    <td width="8%"><div class="input-search-container"><input type="text" id="vehrefno" name="vehrefno" style="width:96%;" placeholder="Press F3 to Search" value='<s:property value="vehrefno"/>'  onkeydown="getrefDetails(event)"/>
     <svg class="magnifier-icon" onclick="triggerToSearch();" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            <circle cx="11" cy="11" r="8"></circle>
            <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
        </svg>
