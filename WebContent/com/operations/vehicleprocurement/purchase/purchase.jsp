...
<meta charset="UTF-8">
<title>GatewayERP(i) - Vehicle Purchase</title>
...
<style>
    ...
    .section-block.finance-main {
        flex-basis: 45%; 
        min-width: 450px;
    }
    .section-block.distribution-main {
        flex-basis: 55%; 
        min-width: 550px;
    }
    ...
    /* Special style for the vendor fields to fit the new layout */
    .vendor-row {
        display: grid;
        grid-template-columns: 120px 1fr 1fr; /* Label + ID + Name */
        align-items: center;
        gap: 12px;
        margin-bottom: 12px;
    }
    .type-ref-row {
        display: grid;
        grid-template-columns: 120px 1fr 120px 1fr; /* Label/Select + Label/Input */
        align-items: center;
        gap: 12px;
        margin-bottom: 12px;
    }
    .delivery-row {
         display: grid;
        grid-template-columns: 120px 200px 1fr auto; /* Label/Date, Description, Button */
        align-items: center;
        gap: 12px;
        margin-bottom: 12px;
    }
    .delivery-row .jqx-datetimeinput {
         width: 100%; /* Ensure jqx date picker fits */
    }

    /* ------------------------------
       BUTTON STYLES (Header-like Consistency)
    ------------------------------ */
    
    /* Standard Primary Button (e.g., Save, Update, Edit, Calculate) */
    .myButton, #updatebtn, #calculatebtn {
        background: #007bff; 
        border: none; 
        padding: 6px 16px; 
        color: #fff;
    ...
    .myButton:hover, #updatebtn:hover, #calculatebtn:hover { 
        background: #0056b3; 
        box-shadow: 0 4px 8px rgba(0,0,0,0.15);
    }
    
    /* Specific button styles (Fleet Update & Posting & Edit Posting) - Harmonized with primary style */
    .myButtonss, /* Fleet Update */
    #updatefleet {
        background: #28a745; /* Green for update action */
        border: none;
        color: #fff;
        font-family: 'Segoe UI', 'Roboto', 'Arial', sans-serif;
        font-size: 13px;
    ...
    .myButtonp, /* Posting */
    #updateposting {
        background: #dc3545; /* Red for important/final action */
        border: none;
        color: #fff;
        font-family: 'Segoe UI', 'Roboto', 'Arial', sans-serif;
        font-size: 13px;
    ...
    #editss { /* Posting Edit button */
        background: #6c757d; /* Grey for secondary action */
        border: none;
        color: #fff;
        font-family: 'Segoe UI', 'Roboto', 'Arial', sans-serif;
        font-size: 13px;
    ...
    /* Icon buttons (for Calculate, Import) - Kept clean with a border */
    .icon {
        background: #fff;
        border: 1px solid #d1d5db;
        border-radius: 6px;
    ...
    .finance-grid .form-group {
        grid-template-columns: 120px 1fr; /* Keep inner groups for labels/inputs */
        margin-bottom: 0; 
    }
    
    /* Deal No. and Edit button alignment */
    .deal-group {
        display: flex;
        align-items: center;
        gap: 10px;
    }
    .deal-group input[type="text"] {
        flex-grow: 1;
    }
    .deal-group .myButton {
        height: 32px;
    ...
    .finance-totals label {
        text-align: right;
    }
    .finance-totals input[type="text"] {
        font-weight: 600;
        text-align: right;
    }

    /* Import Row Alignment */
    .import-row {
        display: flex;
        align-items: center;
        gap: 10px;
    ...
    /* Button row at the bottom of finance section */
    .finance-buttons-row {
        display: flex;
    ...
    /* ------------------------------
       POSTING SECTION LAYOUT
    ------------------------------ */
    .posting-controls {
        display: grid;
        grid-template-columns: auto 1fr auto 1fr 1fr; /* Inv No, Inv Date, Buttons */
        gap: 15px 30px;
        align-items: center;
        padding: 15px 0;
        margin-bottom: 15px;
...
<script type="text/javascript">
	// The existing complex JavaScript logic is preserved here.
...
<jsp:include page="../../../../header.jsp"></jsp:include>
   ...
   <div class='receipt-header' style="display:flex; justify-content:space-between; align-items:center;">
    ...
    <div style="display:flex; align-items:center; gap:8px;">
        <label>Date</label>
        <div>
            <div id="vehpurorderDate" name="vehpurorderDate"
                 value='<s:property value="vehpurorderDate"/>'></div>
            <input type="hidden"
                   id="hidvehpurorderDate"
                   name="hidvehpurorderDate"
    ...
    <div class="section-block">
        <h2>General Purchase Details</h2>
        
        <div class="vendor-row">
            <label for="accid">Vendor</label>
            <input type="text" id="accid" name="accid" placeholder="Press F3 to Search" value='<s:property value="accid"/>' onkeydown="getaccountdetails(event)"/>
            <input type="text" id="vehpuraccname" name="vehpuraccname" value='<s:property value="vehpuraccname"/>' tabindex="-1" readonly/>
        </div>

        <div class="type-ref-row">
            ...
            <input type="text" id="vehrefno" name="vehrefno" placeholder="Press F3 to Search" value='<s:property value="vehrefno"/>' onfocus="funcheckaccinvendor();" onkeydown="getrefDetails(event)"/>
        </div>
    ...
    <div class="section-block full-width" style="margin-top: 20px;">
    ...
    <div class="section-row">
        ...
        <div class="section-block finance-main">
            <h2>Finance Details</h2>
            <div id="finance">
                
                <div class="finance-totals">
                    <label id="taxlabel">Tax Amount</label>
                    <input type="text" id="taxamount" name="taxamount" readonly="readonly" value='<s:property value="taxamount"/>'>
                    
                    <label>Total Amount</label>
                    <input type="text" id="totalamt" name="totalamt" readonly="readonly" value='<s:property value="totalamt"/>'>
                </div>
                ...
                <div class="finance-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="downpayment" name="downpayment" onblur="funRoundAmt(this.value,this.id);calculateval();" value='<s:property value="downpayment"/>'/>
                    </div>
                    <div class="form-group">
                        <label>Loan Amount</label>
                        <input type="text" id="loanamount" tabindex="-1" name="loanamount" readonly value='<s:property value="loanamount"/>'/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="perinterest" name="perinterest" onkeypress="javascript:return isNumber (event)" value='<s:property value="perinterest"/>'/>
                    </div>
                    ...
                    <div class="form-group">
                        <label>Number Of Inst</label>
                        <input type="text" id="instnos" name="instnos" onkeypress="javascript:return isNumber (event)" value='<s:property value="instnos"/>'/>
                    </div>
                ...
                <div style="margin-top: 15px;">
                    <div class="form-group single-label-dual-input">
                        <label>Account(Financier)</label>
                        <input type="text" id="financeaccid" name="financeaccid" placeholder="Press F3 to Search" value='<s:property value="financeaccid"/>' onkeydown="getfinacc(event);"/>
                        <input type="text" id="financeaccname" name="financeaccname" tabindex="-1" readonly value='<s:property value="financeaccname"/>'/>
                    </div>
                    <div class="form-group single-label-dual-input">
                        <label>Bank A/C</label>
                        <input type="text" id="bankaccid" name="bankaccid" placeholder="Press F3 to Search" value='<s:property value="bankaccid"/>' onkeydown="getbankacc(event);"/>
                        <input type="text" id="bankaccname" name="bankaccname" tabindex="-1" readonly value='<s:property value="bankaccname"/>'/>
                    </div>
                    <div class="form-group single-label-dual-input">
                        <label>Interest A/C</label>
                        <input type="text" id="interestaccid" name="interestaccid" placeholder="Press F3 to Search" value='<s:property value="interestaccid"/>' onkeydown="getInterestacc(event);"/>
                        <input type="text" id="intaccname" name="intaccname" tabindex="-1" readonly value='<s:property value="intaccname"/>'/>
                    </div>
                    <div class="form-group single-label-dual-input">
                        <label>Loan A/C</label>
                        <input type="text" id="loanaccid" name="loanaccid" placeholder="Press F3 to Search" value='<s:property value="loanaccid"/>' onkeydown="getloanacc(event);"/>
                        <input type="text" id="loanaccname" name="loanaccname" tabindex="-1" readonly value='<s:property value="loanaccname"/>'/>
                    </div>
                </div>
                ...
                <div class="finance-grid" style="margin-top: 15px;">
                    ...
                    <div class="form-group">
                        <label>Amount</label>
                        <input type="text" id="chqamount" name="chqamount" onkeypress="javascript:return isNumber (event)" value='<s:property value="chqamount"/>' onblur="funRoundAmt(this.value,this.id);">
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="deal-group">
                             ...
                             <input type="button" class="myButton" name="editdeal" id="editdeal" onclick="funeditdeal()" value="Edit" style="display:none;" >
                        </div>
                    </div>
                </div>
        ...
        <div class="section-block distribution-main">
            <h2>Loan Distribution</h2>
             <div id="detailsdiv" style="overflow-x: auto;"><jsp:include page="distributionGrid.jsp"></jsp:include></div>
        </div>
    ...
    <div class="section-block full-width" style="margin-top: 20px;">
        ...
        <div class="posting-controls">
            ...
            <div class="posting-buttons">
                <button type="button" class="icon" id="btnCalculate" title="Calculate" onclick="funpostcalcu();">
        ...
        <div id="postingdiv" style="overflow-x: auto;"> 
