...
<table width="100%">
  <tr>
    ...
    <td width="30%">
      <input type="text" name="txtaccountsno2" id="txtaccountsno2" style="width:85%;" value='<s:property value="txtaccountsno2"/>'>
    </td>
    <td width="10%" align="right">Currency</td>
    <td width="27%">
      <input type="text" name="txtaccountcurrency2" id="txtaccountcurrency2" style="width:50%;" value='<s:property value="txtaccountcurrency2"/>'>
      <%-- Hidden fields preserved as comments/logic --%>
    </td>
  ...
  <tr>
    ...
    <td colspan="3">
      <input type="text" name="txtaccountsname2" id="txtaccountsname2" style="width:80%;" value='<s:property value="txtaccountsname2"/>'>
    </td>
  </tr>
  <tr>
    <td colspan="5">
