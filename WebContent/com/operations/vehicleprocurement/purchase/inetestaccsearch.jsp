...
<table width="100%">
  <tr>
    ...
    <td width="30%">
      <input type="text" name="txtaccountsno3" id="txtaccountsno3" style="width:85%;" value='<s:property value="txtaccountsno3"/>'>
    </td>
    <td width="10%" align="right">Currency</td>
    <td width="27%">
      <input type="text" name="txtaccountcurrency3" id="txtaccountcurrency3" style="width:50%;" value='<s:property value="txtaccountcurrency3"/>'>
  ...
  <tr>
    ...
    <td colspan="3">
      <input type="text" name="txtaccountsname3" id="txtaccountsname3" style="width:80%;" value='<s:property value="txtaccountsname3"/>'>
    </td>
  </tr>
  <tr>
    <td colspan="5">
