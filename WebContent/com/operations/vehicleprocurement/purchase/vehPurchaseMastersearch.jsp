...
body {
    margin: 0;
    background-color: #f5f7fa; /* Soft background so the white bordered panels pop */
}
...
/* THE MISSING BORDERS: White Panel for Search Inputs */
...
/* THE MISSING BORDERS: White Panel for the Results Grid */
