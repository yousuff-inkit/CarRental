              ...
              // disabled:true,
               localization: {thousandsSeparator: ""},
                     ...
                     {  
		               ...
		               /*  	   if(args.datafield=="brand")
		                   ...
		                   */
		                   ...
		                   if (cell5 != undefined && cell5.datafield == 'vehgroup') {
		                   	var key = event.charCode ? event.charCode : event.keyCode ? event.keyCode : 0; 
		                    document.getElementById("rowindex").value =cell3.rowindex;
                ...
                columns: [
							...
							{ text: 'Group', datafield: 'vehgroup', width: '8%',editable: true,cellclassname: cellclassname,
								cellbeginedit: function (row) {
									var temp=$('#mode').val();
									 if (temp =="view")
										 {
							...
							{ text: 'Group Id', datafield: 'vehgroupid', width: '2%',cellclassname: cellclassname,hidden:true },
							...
							{ text: 'Price', datafield: 'price', width: '7%',cellclassname: cellclassname,cellsformat: 'd2',aggregates: ['sum'],aggregatesrenderer:rendererstring ,editable: true,cellsformat: 'd2',cellsalign: 'right', align: 'right',
							...
							{ text: 'Fleet', datafield: 'fleet_no', width: '6%',cellclassname: cellclassname,editable: false},
...
//             document.getElementById("totalamt").value=$("#vehoredergrid").jqxGrid('getcellvalue', 0, "totalamt");
  	    ...
  	    $("#vehoredergrid").on('cellclick', function (event){
            ...
            if(datafield=="brand" || datafield=="model" || datafield=="color" || datafield=="vehgroup"){
						 ...
						 if (parseInt(temp)< 1)
							 ...
							 { */
					        		...
					        		if(typeof(rows[i].fleet_no)!="undefined" && rows[i].fleet_no!="" )
					                 ...
					                 var grpid=$('#vehoredergrid').jqxGrid('getcellvalue', event.args.rowindex, "vehgroupid");
					                if(event.args.rowindex>0)
					                	{
					                	 
					                	 var rowindextemp = event.args.rowindex;
					             	    document.getElementById("rowindex").value = rowindextemp;          
					             	     fleetSearchContent('fleetsearch.jsp?fleetval='+aa.replace(/ /g, "%20")+'&brandid='+brandid+'&modid='+modid+"&grpid="+grpid); 
