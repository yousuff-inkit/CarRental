...
<form id="frmInvoicePrint" action="printrental" autocomplete="off" target="_blank">
 <div style="background-color:white;">
      <table width="100%">
 	 <tr>
  		<td> <img src="<%=contextPath%>/icons/headerunited.jpg" width="100%"/></td> 
    </tr>
   </table>
 <table width="100%" >
...
<table width="100%" >
	<tr>
		<td width="40.33%" align="left"><b>RA NO :<label id="rentaldoc" name="rentaldoc" ><s:property value="rentaldoc"/></label></b></td>
		<!-- <td width="36.5%" align="center"></td> -->
		<td width="30%" align="left"><b>RA STATUS:</b><b>&nbsp;<label  id="rastatus" name="rastatus"><s:property value="rastatus"/></label></b></td>
	<td width="36.33%" align="left">Manual RA NO# :<label id="mrano" name="mrano"><s:property value="mrano"/></label></td>
