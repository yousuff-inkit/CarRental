...
<% String contextPath=request.getContextPath();%>
 <%
String rate=request.getParameter("rate")==null?"0":request.getParameter("rate").toString();
 %>
...
<table width="100%" border="1">
 ...
 <tr>
    ...
    <tr><td align="left">Due Date</td><td><label id="lblduedate" name="lblduedate"><s:property value="lblduedate"/></label></td></tr>
...
<td><label id="delfuels" name="delfuels"><s:property value="delfuels"/></label></td>
  ...
  <%--   <fieldset>
    ...
    <td width="10%" align="left">KM</td><td width="25%">
     ...
     <fieldset id="rentalratediv"><legend><b>Rental Rates</b></legend>  
      <table  width="100%" >
      <tr>
