...
By Initialing, you understand any accident, even if you have availed CDW (Full Insurance), must be accompanied by a valid police report.Failure to provide one will result in additional charges.Customer who opt of CDW will be liable to pay  the  excess deductible  amount  AED 1500 + 5%  VAT + 10  days of car rental.(Note Minimum age limit is 25 years). 
...
By putting your initial in box provided, You agree to pay all traffic and parking fines (within the period of 24 hours) issued to you whilst the vehicle is rented in your name, you also agree to pay AED 40 admin charge in addition to the fine
  <table width="100%" >
<tr><td  width="50%"></td><td width="50%" height="25px" > <fieldset style="height:100%;"></fieldset></td>
</tr>
</table>
