		...
		function getAgmtDates(doctemp){
    		...
    		x.onreadystatechange = function() {
    			if (x.readyState == 4 && x.status == 200) {
    				 ...
    				 var objcollect=JSON.parse(items.split("::")[3]);
    				 console.log(objcollect);
    				 if(objcollect.pickupstatus=="1"){
    					 document.getElementById("chkcollection").checked=true;
    					 setCollection();
    					 $('#collectkm').val(objcollect.pkm);
    					 $('#cmbcollectfuel').val(objcollect.pfuel);
    					 $('#collectdate').jqxDateTimeInput('setDate',new Date(objcollect.pdate));
    					 $('#collecttime').jqxDateTimeInput('val',objcollect.ptime);
    				 }
    				 if(objcollect.collectstatus=="1"){
    					 document.getElementById("chkcollection").checked=true;
    					 setCollection();
    					 $('#collectkm').val(objcollect.collectkm);
    					 $('#cmbcollectfuel').val(objcollect.collectfuel);
    					 $('#collectdate').jqxDateTimeInput('setDate',new Date(objcollect.collectsqldate));
    					 $('#collecttime').jqxDateTimeInput('val',objcollect.collecttime);
    				 }
    				 if(objcollect.instatus=="1"){
    					 $('#inkm').val(objcollect.inkm);
    					 $('#cmbinfuel').val(objcollect.infuel);
    					 $('#indate').jqxDateTimeInput('setDate',new Date(objcollect.insqldate));
    					 $('#intime').jqxDateTimeInput('val',objcollect.intime);
    				 }
    				 if(showagmtdate=="1"){
