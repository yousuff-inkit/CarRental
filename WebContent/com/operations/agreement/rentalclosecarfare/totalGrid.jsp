...
{ text: 'Calctype',  datafield: 'calctype',hidden:true}
  ...
  if(rows.length==0){
      $("#totalgrid").jqxGrid("addrow", null, {});
        ...
        var conf=$('#discountconfig').val();
        if(conf=='1'){
        	  $("#totalgrid").on('cellvaluechanged', function (event) 
      	            {
      		   disCheck();
      		   var rowBoundIndex1 = event.args.rowindex;
      		   var dataField = event.args.datafield;
      		  /*  alert("row :"+rowBoundIndex1);
      		   alert("data :"+dataField); */
      		  if(rowBoundIndex1==1)
      			   { 
      			  var tempval = $('#totalgrid').jqxGrid('getcellvalue', 0, dataField);
      			        var value= $('#totalgrid').jqxGrid('getcellvalue', 1, dataField);
      			 	   var maxdiscpercent=document.getElementById("calcuvals").value;
      			 	   var maxdiscvalue=(tempval<0?tempval*-1:tempval)*(maxdiscpercent/100);
      			 	  /*  alert("Temp value  : "+tempval);
      			 	   alert(" value  : "+value);
      			 	   alert("maxdisc  : "+maxdisc); */
      			 	//alert(value+"===="+maxdiscvalue+"===="+tempval+"===="+maxdiscpercent);
      					if(parseFloat(value)>parseFloat(maxdiscvalue))  
      							{ 
      						  var val="";
      						  $('#totalgrid').jqxGrid('setcellvalue', 1, dataField,val);
      		            	  $('#totalgrid').jqxGrid('setcellvalue', 2, dataField,tempval);
      		             ...
      		             if(tempval=="")
      		              {
      		            	  ...
      		            	  $('#totalgrid').jqxGrid('setcellvalue', 1, dataField,"");
      		            	  $('#totalgrid').jqxGrid('setcellvalue', 2, dataField,"");
      		              }
      		             ...
      		             $('#totalgrid').jqxGrid('setcellvalue', 1, dataField,dataval);
      		            $('#totalgrid').jqxGrid('setcellvalue', 2, dataField,dataval);
      		                }
      	            }
