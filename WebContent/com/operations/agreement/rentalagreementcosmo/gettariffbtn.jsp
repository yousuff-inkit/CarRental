...
String salesagent= request.getParameter("salesagent")==null?"":request.getParameter("salesagent").trim();
...
ClsRentalAgreementCosmoDAO viewDAO= new ClsRentalAgreementCosmoDAO();
 ...
 var datatar= '<%=viewDAO.trariffbtnGrid(session,vehgpid,cldocno,salesagent)%>';
       // alert(data);
