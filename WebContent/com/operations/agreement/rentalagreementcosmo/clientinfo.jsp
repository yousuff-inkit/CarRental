...
<%@page import="com.operations.agreement.rentalagreementcosmo.*" %>
 <%
 ClsRentalAgreementCosmoDAO viewDAO= new ClsRentalAgreementCosmoDAO();
            ...
            var source = 
            {
                ...
                datafields: [
     						...
     						{name : 'dlno', type: 'String'  }, 
      						...
      						{name : 'tradelicenseexp',type:'date'},
            ...
            $("#jqxclientsearch").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'ADDRESS', datafield: 'address', width: '21%' }, 
					 ...
					 { text: 'Trade lic Exp Date',datafield:'tradelicenseexp',width:'10%',hidden:true},
					 { text: 'Cat Id',datafield:'catid',width:'10%',hidden:true}
         ...
         /*    $("#jqxclientsearch").jqxGrid('addrow', null, {}); */
				           ...
				           $('#jqxclientsearch').on('rowdoubleclick', function (event) 
				              	...
				              	$('#invoice,#advance_chk').attr('disabled',false);
					               ...
					               var tradelicenseexp=$('#jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "tradelicenseexp");
				              		var today=new Date();
				              		var catid=$('#jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "catid");
				              		if((tradelicenseexp==null || tradelicenseexp=="undefined" || tradelicenseexp=="") && catid=="2"){
				              			document.getElementById("errormsg").innerText="Valid Trade License Date Required";
				              			return false;
				              		}
				              		if(tradelicenseexp<today && catid=="2"){
				              			document.getElementById("errormsg").innerText="Trade License Expired";
				              			return false;
				              		}
					...
					x.onreadystatechange=function(){
						if (x.readyState==4 && x.status==200)
						{
							...
							document.getElementById("creditlimit").value=creditlimit;
				              if(outstanding>creditlimit || (outstanding>0.0 && exceedstatus=="1")){
				            	  document.getElementById("errormsg").innerText="";
