...
<form id="frmInvoicePrint" action="printrental" autocomplete="off" target="_blank">
 <div style="background-color:white;">
  ...
  <tr>
    ...
    <td width="25%"><b><label id="companyname" name="companyname"><s:property value="companyname"/></label></b></td>
    <!-- <td width="11%" rowspan="6" align="center"><img src="../../../../icons/amexqrcode.jpg" style="width:100%;height:auto;"></td> -->
  </tr>
  <tr>
  ...
  <tr>
    <td align="left"><b>Email :</b>&nbsp;<label>asif@kohistanrentacar.com</label>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>ashref@kohistanrentacar.com</label>
    </td>
    </tr>
  <tr>
...
<table width="100%">
	...
	<tr>
		<td>Mob: <label>+971557865406</label></td>
		<td>Mob: <label>+971557862680</label></td>
		<td>&nbsp;</td>
		<td colspan="2"></td>
	</tr>
</table>
...
<td><label id="colfuels" name="colfuels"><s:property value="colfuels"/></label></td>
  ...
  <fieldset><legend><b>Insurance Type</b></legend>
  	<table width="100%">
  		<tr>
  			<td colspan="2"><input type="checkbox" style="border:2px solid #000;box-shadow:none;background-color:transparent;">&nbsp;Excess Claim 1000 AED + 10% Damage Value</td>
  		</tr>
  		<tr>
  			<td colspan="2"><input type="checkbox" style="border:2px solid #000;box-shadow:none;background-color:transparent;">&nbsp;Excess Claim 1000 AED</td>
  			<!--<td><input type="checkbox" style="border:2px solid #000;box-shadow:none;background-color:transparent;">&nbsp;Insurance Excess 2500</td>-->
  		</tr>
  		<tr>
  			<td colspan="2"><input type="checkbox" style="border:2px solid #000;box-shadow:none;background-color:transparent;">&nbsp;Insurance Excess Zero (Collision Damage Waiver)</td>
