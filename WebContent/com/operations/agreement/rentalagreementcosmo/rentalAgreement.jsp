										...
										$('#rentalproject').dblclick(function(){
										  ...
										  $('#jqxRentalDate').on('change', function (event) {
										        ...
										        funDateInPeriod(maindate);
										      	 ...
										      	 var checkdate=new Date($('#jqxRentalDate').jqxDateTimeInput('getDate'));
										      	 checkdate.setHours(0,0,0,0);
										      	 var currentdate=new Date();
										      	 currentdate.setHours(0,0,0,0);
										      	 if(checkdate!=currentdate){
										      		 document.getElementById("errormsg").innerText="Only Current Date Allowed";
										      		$('#jqxRentalDate').jqxDateTimeInput('setDate',new Date());
										      		return false;
										      	 }
										       });
										        ...
										        $('#ratariffbutton').click(function(){
										        	  if(($('#txtfleetno').val()!="") && ($('#txtcusid').val()!=""))
													      ...
													      if(document.getElementById("weekend").checked==true) 
													    	  ...
													    	  tariffbtnSearchContent('gettariffbtn.jsp?vehgpid='+document.getElementById("veh_fleetgrouptariff").value+"&cldocno="+document.getElementById("txtcusid").value+"&salesagent="+document.getElementById("tariffsales_Agentid").value);
		   ...
		   if($('#jqxTimeOut').jqxDateTimeInput('getDate')!=null){
			   ...
			   if(status){
				   ...
				   return false;
                             ...
                             function getPreAuthConfig(){
                             	var branch=$('#brchName').val();
                             	var x = new XMLHttpRequest();
                            	x.onreadystatechange = function() {
                            		if (x.readyState == 4 && x.status == 200) {
                            			var items = x.responseText.trim();
                            			document.getElementById("preauthconfig").value=items;
                            			}
                            		else {
                            			}
                            	}
                            	x.open("GET", "getPreAuthConfig.jsp?branch="+branch, true);
                           		x.send();
                             }
			...
			function funReadOnly(){
				  $("#jqxMenuMore").css('visibility', 'visible');  
				$('#frmRentalAgreementCosmo input').attr('readonly', true );
				$('#frmRentalAgreementCosmo textarea').attr('readonly', true );
				$('#frmRentalAgreementCosmo select').attr('disabled', true);
			    $("#ratariffbutton,#btnnewclient").attr("disabled", true);
			    $("#searchuser").attr("disabled", true);
			    
			    
			    
				//$('#frmRentalAgreementCosmo button').attr('disabled', true);
			...
			function funRemoveReadOnly(){
				...
				$('#frmRentalAgreementCosmo input').attr('readonly', false );
				$('#frmRentalAgreementCosmo select').attr('disabled', false);
				...
				var chkfleet=items.trim();
						 ...
						 if(chkfleet==1)
						     ...
						     $('#advance_chk').attr('disabled', false);
								...
								$('#frmRentalAgreementCosmo').submit();	
							 }
			...
			function funNotify(){	
				   ...
				   if(outstandingamt!="" && outstandingamt!=null && outstandingamt!="undefined"){
				    /* && exceedstatus=="1" */
				   	/*  */
				    if(parseFloat(outstandingamt)>parseFloat(creditlimit) || (parseFloat(outstandingamt)>0.0 && exceedstatus=="1")){
				   		document.getElementById("errormsg").innerText="";
						document.getElementById("errormsg").innerText="Cannot create RA,Outstanding balance is "+outstandingamt+", Please contact A/c Dept.";
						return 0;
				   	}
				   }
		    	...
		    	if(intimestatus){
				 ...
				 $('#jqxDeliveryOut').jqxDateTimeInput({ disabled: false});
				  ...
				  var valfleet=document.getElementById("txtfleetno").value;
					...
					var catid=$('#catid').val();
					if(catid!="2"){
						var preauthconfig=$("#preauthconfig").val();
						if(preauthconfig=="1"){
							var securitymode=$('#jqxgridpayment').jqxGrid('getcellvalue',1,'mode');
							var preauthmode=$('#jqxgridpayment').jqxGrid('getcellvalue',2,'mode');
							if((preauthmode=="undefined" || preauthmode==null || preauthmode=="" || typeof(preauthmode)=="undefined")&&(securitymode=="undefined" || securitymode==null || securitymode=="" || typeof(securitymode)=="undefined")){
								document.getElementById("errormsg").innerText="";
								document.getElementById("errormsg").innerText="Pre Auth/Security is mandatory";
								return 0;
							}
							var preauthamt=$('#jqxgridpayment').jqxGrid('getcellvalue',2,'amount');
							var securityamt=$('#jqxgridpayment').jqxGrid('getcellvalue',1,'amount');
							if((preauthamt=="undefined" || preauthamt==null || preauthamt=="" || typeof(preauthamt)=="undefined")&&(securityamt=="undefined" || securityamt==null || securityamt=="" || typeof(securityamt)=="undefined")){
								document.getElementById("errormsg").innerText="";
								document.getElementById("errormsg").innerText="Pre Auth/Security Amount is mandatory";
								return 0;
							}
						}
					}
						...
						if(excessinsur=="")
							...
							document.getElementById("excessinsur").value=0;  
							          ...
							          if ((document.getElementById('delivery_chk').checked)) {
											   var deldriver=document.getElementById("del_Driver").value;
											   if(deldriver=="" || deldriver=="undefined" || typeof(deldriver)=="undefined" || deldriver==null){
											   		document.getElementById("errormsg").innerText="Enter Delivery Driver";
													document.getElementById("del_Driver").focus();  
													return 0;
											   }
          ...
          function funchkDelStatus()
           ...
           x.send();
	         ...
	         function funupdate()
	         {
    	        ...
    	        $('#frmRentalAgreementCosmo txtfleetno').attr('disabled', false);
                $('#frmRentalAgreementCosmo txtcusid').attr('disabled', false);
                $('#frmRentalAgreementCosmo docno').attr('disabled', false); 
                $("table#vehicle input").prop("disabled", false);  
	   			$('#jqxRentalDate').jqxDateTimeInput({ disabled: false});
				$('#jqxDateOut').jqxDateTimeInput({ disabled: false});
		        $('#jqxDeliveryOut').jqxDateTimeInput({ disabled: false});
...
function funPreAuthHistory(){
	if(($("#mode").val() == "view") && $("#masterdoc_no").val()!="") {
 		$('#window1').jqxWindow('open');
      	menuContent('preAuthHistory.jsp?docno='+document.getElementById("masterdoc_no").value+'&id=1', $('#window1')); 
 	}
   	else {
    	$.messager.alert('Message','Select a Document....!','warning');
    	return false;
...
function clearSalesAgent(){
	$('#rasales_Agent,#tariffsales_Agentid').val('');
	$('#rasales_Agent').attr('placeholder','Press F3 to Search');
	return false;
}
 </script>
			...
			<td>
				<div id='jqxMenuMore' title="More" align="center" style='visibility: hidden;'>
        			<ul>
						...
						<li><a href="#preauthhistory" onclick="funPreAuthHistory();">Pre-Auth History</a></li>			
        			</ul>
     			</div>
     		</td>
   		</tr>
...
<tr><td>
 ...
 <td  align="right" width="6%" >Sales Agent</td>
    <td  width="8%">
            ...
            <td width="3%"><button type="button" onclick="clearSalesAgent();" style="background-color:transparent;border:none;outline:none;"><img src="../../../../icons/cleardata.png" width="16px" height="16px" alt="Clear Sales Agent"></button></td>
 ...
 <input type="hidden" id="masterdoc_no" name="masterdoc_no" value='<s:property value="masterdoc_no"/>' />  
  <input type="hidden" id="mode" name="mode" value='<s:property value="mode"/>' />  
   ...
   <input type="hidden" name="rentaltype" id="rentaltype" value='<s:property value="rentaltype"/>' />
	...
	<input type="hidden" name="exceedstatus" id="exceedstatus">
	<input type="hidden" name="catid" id="catid">
	<input type="text" name="preauthconfig" id="preauthconfig">
</div>
</form>
<div id="window1">
