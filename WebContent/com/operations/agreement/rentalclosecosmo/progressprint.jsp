...
<form id="frmInvoicePrint" action="printrental" autocomplete="off" target="_blank">
 <div style="background-color:white;">
  ...
  <tr>
    ...
    <b>RA :</b><b><label  id="rastatus" name="rastatus"><s:property value="rastatus"/></label> - <label  id="lblclosedocdate" name="lblclosedocdate"><s:property value="lblclosedocdate"/></label></b>
