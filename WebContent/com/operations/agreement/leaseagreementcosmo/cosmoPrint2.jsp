...
<table width="100%" class="location-table">
  ...
  <tr>
    ...
    <td class="borderbottom borderright"><label id="duedate" name="duedate"><s:property value="duedate"/></label>&nbsp;&nbsp;&nbsp;<label id="ratimeout" name="ratimeout"><s:property value="ratimeout"/></label></td>
  </tr>
</table>
