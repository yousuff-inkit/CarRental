   										...
   										<fieldset>
   											<table width="100%" border="0">            
   												<tr>
    												...
    												<td align="left">
    													<select name="cmbenqtype" id="cmbenqtype" style="width:99%;"><option value="">--Select--</option></select>
    													<input type="hidden" name="hidcmbenqtype" id="hidcmbenqtype" value='<s:property value="hidcmbenqtype"/>'>
    												</td>
    												<td align="right">Master Ref Type</td>
    												<td align="left">
    													<select name="cmbmasterreftype" id="cmbmasterreftype"><option value="DIR">DIR</option><option value="MLA">MLA</option></select>
    												...
    												<td width="201" align="left">
    													<input type="text" name="masterrefno" id="masterrefno" value='<s:property value="masterrefno"/>' readonly placeholder="Press F3 to Search" onkeydown="getMasterRefno(event);">
    											...
    											<tr>
  													...
  													<td ><input type="text" id="clientid" name="clientid" readonly placeholder="Press F3 To Search" value='<s:property value="clientid"/>' onKeyDown="getclientinfo(event);" ondoubleclick="getclientinfo(event);"/></td>
     												<td colspan="6" >
     													<input type="text" id="clientname" readonly name="clientname" style="width:99%;" tabindex="-1" value='<s:property value="clientname"/>'/>
     												</td>
     												<td align="right">Salesman</td>
 													<td>	
 														<input type="text" id="salesman" name="salesman" readonly placeholder="Salesman Name" value='<s:property value="salesman"/>'/>
  												...
  												<tr>
  													<td align="right"></td><td colspan="9"><input type="text" id="cusaddress"  placeholder="Mobil NO-Address" readonly name="cusaddress" style="width:99%; resize: none; " value='<s:property value="cusaddress"/>'></td>
  												</tr>
  												<tr>
          											<td align="right">Description</td>
          											<td colspan="10" align="left"><input type="text" name="description" id="description" placeholder="Description"  value='<s:property value="description"/>' style="width:99%;" onblur="fundescvalidate()"></td>
        										</tr>   
 											</table>
   										</fieldset>
 									</td>
