...
<table width="100%" >
 ...
 <tr>
   ...
   <fieldset><legend><b>Driver Details &nbsp;&nbsp;&nbsp;&nbsp; تفاصيل السائق</b></legend>
    <table  width="100%">
   <tr>
      <td width="21%" align="left">Name</td>
    <td width="82%" colspan="3">:&nbsp;<label id="radrname" name="radrname"><s:property value="radrname"/></label> </td>
      
    </tr>
    <tr>
        <td  width="21%" align="left">D\L NO</td>
    <td width="82%" colspan="3">:&nbsp;<label id="radlno" name="radlno"><s:property value="radlno"/></label></td>
    </tr>
    <tr>
   <td width="21%" align="left">Exp Date</td>
    <td width="82%" colspan="3">:&nbsp;<label id="licexpdate" name="licexpdate" ><s:property value="licexpdate"/></label></td>
    </tr>
     <tr>
        <td  width="21%" align="left">EID NO</td>
    <td width="82%" colspan="3">:&nbsp;<label id="lblidno" name="lblidno"><s:property value="lblidno"/></label></td>
    </tr>
    <tr>
   <td width="21%" align="left">Exp Date</td>
    <td width="82%" colspan="3">:&nbsp;<label id="lblvisaexp" name="lblvisaexp" ><s:property value="lblvisaexp"/></label></td>
    </tr>
    <tr>
     <td  width="21%" align="left">Passport NO</td>
...
<!--    <tr>
   ...
   <tr> 
    ...
    <tr>
      ...
      <td>Mobile</td>
      <td>:<label id="ramobile" name="ramobile"><s:property value="ramobile"/></label></td>
    </tr>
    <tr>
