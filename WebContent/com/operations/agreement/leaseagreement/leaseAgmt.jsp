...
$(document).ready(function () {
   ...
   /*   Menu-minimized window  */
	...
	//funchangeadv();
	 $('#printWindow').jqxWindow({width: '18%', height: '18%',  maxHeight: '60%' ,maxWidth: '40%' , title: 'Print',position: { x: 500, y: 60 } , theme: 'energyblue', showCloseButton: true, keyboardCloseKey: 27});
...
function funKmDetails(){
 ...
 function funFuelDetails() {
            if (($("#mode").val() == "view") && $("#masterdoc_no").val() != "") {
                $('#windows2').jqxWindow('open');
                menuContent('fueldetails.jsp?docno=' + document.getElementById("masterdoc_no").value + '&id=1', $('#windows2'));
            } else {
                $.messager.alert('Message', 'Select a Document....!', 'warning');
                return false;
            }
...
function setValues() {
	...
	//alert("ac========"+hidadvance_chk)
	  
  	if($('#hidadvance_chk').val()=="1"){
...
<td width="6%"><input type="checkbox" id="advance_chk"  name="advance_chk"   onchange="funchangeadv();"> &nbsp;Advance
...
<td width="20%">Invoice&nbsp;<select name="invoice" id="invoice" value='<s:property value="invoice"/>'  >
...
<input type="hidden" name="ratehideprintchk" id="ratehideprintchk">
</div>
