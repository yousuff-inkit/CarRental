...
<body>
<form action="printFuelDetailsLease" tartget="_blank">
...
<table width="100%" border="0">
	<tr>
        ...
        <td>Fuel In</td>
        <td>Used Fuel</td>
        <td>FuelTank Capacity</td>
        <td align ="right">Amount Charged</td>
        
  	</tr>
  	
	<s:iterator var="stat1" status="arr" value="%{#request.FUELPRINT}" >
	<tr>   
<%int i=0; %>
...
<table width="100%"  border="0">
  <tr>
    <td width="15%">Total Fuel Used</td>
    <td width="18%"><label name="lbltotalfuelused"><s:property value="lbltotalfuelused"/></label></td>
    <td width="21%">Total Amount</td>
    <td width="16%"><label name="lbltotalfuelamt"><s:property value="lbltotalfuelamt"/></label></td>
    <td colspan="4" align="right"><b><label name="lbltotalfuelamtwords"><s:property value="lbltotalfuelamtwords"/></label></b></td>
    </tr>
</table>
