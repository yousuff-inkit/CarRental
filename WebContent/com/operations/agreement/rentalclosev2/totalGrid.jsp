...
<script type="text/javascript">
	...
	{name : 'oinschg',type:'string'},
    {name : 'chaufexchg',type:'string'}
...
{ text: ''+document.getElementById("mainoinschg").value,  datafield: 'oinschg',editable:true,renderer: columnsrenderer,cellsformat: 'd2',cellsalign: 'right',align: 'right', cellbeginedit: rowEdit,cellclassname:'column2'},
...
{ text: ''+document.getElementById("mainchaufexchg").value,  datafield: 'chaufexchg', editable:true,renderer: columnsrenderer,cellsformat: 'd2',cellsalign: 'right', align: 'right', cellbeginedit: rowEdit,cellclassname:'column2'},
...
{ text: 'Calctype',  datafield: 'calctype',hidden:true}
            ...
            $('#totalgrid').jqxGrid('hidecolumn', ''+document.getElementById("suboinschg").value);
            $('#totalgrid').jqxGrid('hidecolumn', ''+document.getElementById("subchaufexchg").value);
