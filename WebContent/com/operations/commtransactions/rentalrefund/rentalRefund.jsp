...
$(document).ready(function() {
     ...
     $("#jqxRentalRefundDate").jqxDateTimeInput({ width: '100%', height: '24px', formatString:"dd.MM.yyyy"});
...
<form id="frmRentalRefund" action="saveRentalRefund" method="post" autocomplete="off">
    ...
    <div style="border: 1px solid transparent; padding: 5px 0;">
        <div class="field-row" style="margin-bottom: 15px;">
            ...
            <input type="text" id="docno" name="txtrentalrefunddocno" class="input-md" value='<s:property value="txtrentalrefunddocno"/>' tabindex="-1" readonly/>
    ...
    <div class="hidden-scrollbar">
            ...
            <div class="middle-section">
                ...
                <div class="middle-panel" style="flex: 1.1;">
                    <span class="middle-panel-title">Agreement Details</span>
                    <div style="padding-top: 5px;">
                        ...
                        <div class="field-row">
                            ...
                            <select id="cmbbranch" name="cmbbranch" class="input-lg" onchange="funIBDateInPeriod($('#jqxRentalRefundDate').val(),this.value);" value='<s:property value="cmbbranch"/>'>
                        ...
                        <div class="field-row">
                            <label class="lbl-right" style="width: 80px;">Agreement</label>
                            ...
                            <label class="lbl-right" style="width: 50px;">Paid As</label>
                ...
                <div class="middle-panel" style="flex: 1;">
                    ...
                    <div style="padding-top: 5px;">
                        ...
                        <div class="field-row">
                            ...
                            <select id="cmbpaytype" name="cmbpaytype" class="input-md" value='<s:property value="cmbpaytype"/>' onchange="bankAccountSearch();funchequedate();getAccounts(this.value);"></select>

                            <label class="lbl-right" style="width: 60px;">Account</label>
                            <input type="text" id="txtaccid" name="txtaccid" class="input-xs" value='<s:property value="txtaccid"/>' onkeydown="getAcc(event);" />
                            <input type="text" id="txtaccname" name="txtaccname" class="input-lg" value='<s:property value="txtaccname"/>' readonly/>
                        </div>
            ...
            <div class="middle-panel" style="margin-bottom: 15px;">
                <span class="middle-panel-title">Security Details</span>
                <div style="padding-top: 5px;">
                    <div id="jqxSecurityGrid" style="width: 100%; min-height:100px;">
            ...
            <div class="middle-panel" style="margin-bottom: 15px;">
                <span class="middle-panel-title">Refund Summary</span>
                <div style="padding-top: 5px;">
                    
                    <div class="field-row">
                        <label class="lbl-right" style="width: 80px;">Amount</label>
                        <input type="text" id="txtamount" name="txtamount" class="input-md align-right-input" value='<s:property value="txtamount"/>' onblur="funRoundAmt(this.value,this.id);getNetTotal();"/>
                        
                        <label class="lbl-right" style="width: 80px;">Deduction</label>
                        <input type="text" id="txtdeduction" name="txtdeduction" class="input-md align-right-input" onblur="funRoundAmt(this.value,this.id);getNetTotal();" value='<s:property value="txtdeduction"/>'/>
                        
                        <label class="lbl-right" style="width: 80px;">Add. Amount</label>
                        <input type="text" id="txtaddamount" name="txtaddamount" class="input-md align-right-input" value='<s:property value="txtaddamount"/>' onblur="funRoundAmt(this.value,this.id);getNetTotal();"/>

                        <label class="lbl-right" style="width: 80px;">Net Amount</label>
                        <input type="text" id="txtnetamount" name="txtnetamount" class="input-md align-right-input" value='<s:property value="txtnetamount"/>' tabindex="-1" readonly/>
                        
                        <label class="lbl-right" style="width: 90px;">On Acc. Amt</label>
                        <input type="text" id="txtonaccountamount" name="txtonaccountamount" class="input-md align-right-input" onblur="funRoundAmt(this.value,this.id);" value='<s:property value="txtonaccountamount"/>'/>
                    </div>
                    ...
                    <div class="field-row">
                        ...
                        <input type="text" id="txtpaidto" name="txtpaidto" class="input-xl" value='<s:property value="txtpaidto"/>'/>
                    </div>
                </div>
            </div>
