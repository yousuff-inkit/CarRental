...
<table width="100%">
  <tr>
    ...
    <td width="27%">: <label name="lblcosmoinvno" id="lblcosmoinvno" ><s:property value="lblcosmoinvno"/></label><%-- <label name="lblinvno" id="lblinvno" ><s:property value="lblinvno"/></label> --%>   <label name="lblinvtype" id="lblinvtype" >(<s:property value="lblinvtype"/>)</label></td>
  </tr>
  <tr>
...
<div class="trafficdiv" id="trafficdiv">
	<table width="100%">
			...
			<s:if test="#showfees > 0">
  				<tr><td>
  				<br>
  				**Govt. Knowledge Fees for Dubai/RTA Parking/Bus Lane Traffic fine AED 20/-</td></tr>
  			</s:if>
</table>
</div>
</s:if>
