...
function loadvalues(){
	...
	if(document.getElementById("traficheader").value=="1"){
		//trafic.hide();
		//$(".trafficdiv").show();
		//$(".trafficdiv").show();
		//$(".trafficdiv1").hide();
...
<body onload="loadvalues()" bgcolor="white" style="font-size:12px;margin:0px;">
...
<%-- <jsp:include page="../../../../../header.jsp"></jsp:include> --%>
	<s:set name="chktrafficheader" value="traficheader"></s:set>
<div style="position:fixed;z-index:-1;top:20%;" hidden="true">
  	<img src="../../../../icons/honest-watermark.jpg" style="width:100%;height:auto;">
  </div> 
 <div style="background-color:#fff;padding:5px;">
 <div class="commonheader">
 	<jsp:include page="../../../common/printHeaderHonest.jsp"></jsp:include>
 </div>
<%--</br></br></br></br>--%>
   <div class="invheader">
...
<s:if test="#showfees > 0">
	<table style="width:100%;" hidden="true">
  		<tr><td width="100%">
  				<br>
  				**Govt. Knowledge Fees for Dubai Traffic fine AED 5/-
  			</td>
  		</tr>
  		<tr><td><hr/></td></tr>
	</table>
...
<s:if test="#trafficdubai > 0 && #chktrafficheader==1"> 
<div class="trafficdiv" id="trafficdiv">
	...
	<table width="100%">
  			...
  			<tr hidden="false"><td colspan="4"><hr noshade size=1 width="100%"></td></tr>
  			<tr>
  				<td colspan="4"><table width="100%" class="saliktable">
  					<thead>
  						<tr class="saliktable">
  						<th width="5%" class="saliktable"><b>Sr No</b></th>
							  <th width="10%" class="saliktable" align="left"><b> No</b></th>
							  <th width="15%" class="saliktable" align="left"><b>Ticket No</b></th>
							  <th width="15%" class="saliktable" align="left"><b>Traffic Date</b></th>
							  <th width="10%" class="saliktable" align="left"><b>Time</b></th>
							  <th width="10%" class="saliktable" align="left"><b>Amount</b></th>
							  <th width="10%" class="saliktable" align="left"><b>Fine Source</b></th>
							  <th width="40%" class="saliktable" align="left"><b>Description</b></th>
  						</tr>
  					</thead>
  					<tbody>
...
<s:if test="#trafficelse > 0 && #chktrafficheader==1"> 
	<div class="trafficdiv1" id="trafficdiv1">
		<table width="100%">
  			<tr hidden="false">
  			...
  			<tr hidden="false"><td><hr noshade size=1 width="100%"></td></tr> 
  			<tr>
  				<td><table width="100%" class="saliktable">
  					<thead>
  						<tr class="saliktable">
  						<th width="10%" class="saliktable"><b>Sr No</b></th>
							  <th width="5%" class="saliktable" align="left"><b>Reg No</b></th>
							  <th width="15%" class="saliktable" align="left"><b>Ticket No</b></th>
							  <th width="15%" class="saliktable" align="left"><b>Traffic Date</b></th>
							  <th width="10%" class="saliktable" align="left"><b>Time</b></th>
							  <th width="10%" class="saliktable" align="left"><b>Amount</b></th>
...
<tr><td width="20%" align="center"><b>Customer Sign</b></td><td width="20%" align="center"><b>Manager</b></td><td width="20%" align="center"><b>Accountant</b></td><td width="20%" align="center"><b>Rental Agent</b></td></tr>
...
<table style="width:100%;">
	<tr><td style="width:100%;"><img src="../../../../icons/honest-footer.jpg" style="width:100%;height:auto;"></td></tr>
</table> 
<table width="100%" hidden="true">
 <tr>
     <td colspan="3" align="center"><fieldset><font style="color: #D8D8D8;font-size: 11px;">System Generated Document Signature & Stamp Not Required.</font></fieldset></td>
...
<s:if test="#trafficdubai > 0 && #chktrafficheader==0"> 
<div class="trafficdiv" id="trafficdiv">
...
<s:if test="#trafficelse > 0 && #chktrafficheader==0"> 
	<div class="trafficdiv1" id="trafficdiv1">
		<div style="page-break-after:always;"></div>
		<table width="100%">
  			<tr>
  			 	<td colspan="4"><s:property value="#trafficbanner"/><img alt="Traffic Logo" src="<%=contextPath%>/icons/traffic_banner.jpg"/></td> 
		    </tr>
  			<tr hidden="false"><td><hr noshade size=1 width="100%"></td></tr> 
  			<tr>
  				<td><table width="100%" class="saliktable">
...
<input type="hidden" name="traficheader" id="traficheader" value='<s:property value="traficheader"/>'/>
