...
.cr-table .th-applying {
    background-color: var(--bg-applying);
}
.cr-table tfoot td {
...
<div class="document-container">
    ...
    <div class="info-header">
        <div class="info-left">
            <div style="font-weight: bold; font-size: 12px; color: #666; text-transform: uppercase; margin-bottom: 5px;">Received with Thanks From</div>
            <div style="font-size: 14px; font-weight: bold; color: var(--text-main);">
                <label id="clientinfo" name="clientinfo"><s:property value="clientinfo"/></label>
            </div>
        </div>
    ...
    <div id="firstdiv" hidden="true">
        <table class="cr-table" style="font-size: 11px;">
            <thead>
                <tr>
                    <td colspan="10" style="background-color: var(--bg-applying); font-weight: bold; font-size: 12px; text-transform: uppercase; border-bottom: 2px solid var(--border-color); padding: 8px 12px;">Applying</td>
                </tr>
                <tr class="th-applying">
                    <th class="text-center" width="4%">Sr.No</th>
                    <th class="text-center" width="6%">Doc No.</th>
                    <th class="text-center" width="7%">Doc Type</th>
                    <th class="text-center" width="8%">Date</th>
                    <th class="text-center" width="7%">Ref Type</th>
                    <th class="text-center" width="7%">Ref No.</th>
                    <th width="31%">Remarks</th>
                    <th class="text-right" width="10%">Amount</th>
                    <th class="text-right" width="10%">Applying</th>
