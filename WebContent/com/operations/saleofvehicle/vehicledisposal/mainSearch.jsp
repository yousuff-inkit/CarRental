...
<script type="text/javascript">
    ...
    function getmaindata(docno, date, client, type, acno, mobile, branch){
        $("#srefreshdiv").load('disposalSearch.jsp?docno=' + encodeURIComponent(docno) + 
                              '&date=' + date + 
...
<div id="search" class="modern-ui">
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <colgroup>
                <col width="8%" />  <col width="18%" /> <col width="8%" />  <col width="18%" /> <col width="8%" />  <col width="22%" /> <col width="18%" /> </colgroup>
