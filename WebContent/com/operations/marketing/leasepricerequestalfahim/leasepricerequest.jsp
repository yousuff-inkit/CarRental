...
<% String masterdoc_no=request.getParameter("masterdoc_no");
   ...
   String brch=request.getParameter("brhid");
   ...
   String email = request.getParameter("email") == null? "0": request.getParameter("email").toString();
    ...
    String ldate = request.getParameter("ldate") == null? "0": request.getParameter("ldate"); 
   String lprdocno=request.getParameter("lprdocno");
   String lprvocno=request.getParameter("lprvocno");
   String enqsource=request.getParameter("enqsource");
   String enqdoc=request.getParameter("enqdoc");
	...
	function funReadOnly(){
...

		{
			...
			if(cldocno!='0')
			  ...
			  document.getElementById("docno").value='<%=lprvocno%>'; 
			  document.getElementById("masterdoc_no").value='<%=lprdocno%>'; 
              ...
              document.getElementById("hidEnquiryDate").value='<%=ldate%>';
              document.getElementById("enqsrc").value='<%=enqsource%>';
              document.getElementById("hidenqsrc").value='<%=enqdoc%>';

		      	if(lprdocno>0)
		      		{

		         $("#enqdiv").load("reqDetails.jsp?enqrdocno="+lprdocno);
		      		}
			}
