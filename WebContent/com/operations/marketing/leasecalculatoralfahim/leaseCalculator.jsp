...
String per_mob=request.getParameter("per_mob");
String qotdocno=request.getParameter("qotdocno");
String qotvocno=request.getParameter("qotvocno");
String lprvocno=request.getParameter("lprvocno");
String lprdocno=request.getParameter("lprdocno");
...
var modes='<%=modes%>';
var brch='<%=brch%>';
var lprdocno='<%=lprdocno%>';
var client='<%=client%>';
var per_mob='<%=per_mob%>';
var qotdocno='<%=qotdocno%>';
var qotvocno='<%=qotvocno%>';
var lprvocno='<%=lprvocno%>';
    ...
    function funReadOnly(){
		...
		if(modes=='A')
		...
		else if(modes=="view")
          {
		 	...
		 	$('#leasereqdiv').load('leaseReqGrid.jsp?reqdocno='+lprdocno);
		  	document.getElementById("hidleasereqdoc").value=lprdocno;
		  	document.getElementById("leasereqdoc").value=lprvocno;

	  		document.getElementById("leasereqclient").value=client;
	  		document.getElementById("clientmob").value=per_mob;
	  		document.getElementById("vocno").value=qotvocno;
	  		document.getElementById("docno").value=qotdocno;
