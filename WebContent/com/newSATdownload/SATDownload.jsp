...
#mainBG {
    ...
    margin: 0 auto;
    padding: 22px 28px;
    box-shadow: 0 6px 28px rgba(70,95,255,0.12);
}

/* ---------- PAGE HEADER (Title Box) ---------- */
.receipt-header {
    width: 100%;
    background: linear-gradient(90deg,#e2ebff,#f3f6ff);
    padding: 24px;
    border-radius: 14px;
    margin-bottom: 26px;
    box-shadow: 0 3px 10px rgba(107,132,255,0.10);
}
...
.receipt-header input[type="text"]:focus {
    border-color: #6a96ff;
    box-shadow: 0 0 0 2px rgba(70,120,255,0.15);
}
...
.table-section {
    ...
    padding: 20px 20px;
    margin-bottom: 24px;
    box-shadow: 0 4px 18px rgba(95,110,255,0.08);
}
.section-block h2,
.table-section h3 {
    font-size: 1.1rem;
...
.cr-table {
    ...
    border-radius: 10px;
    overflow: hidden;
    box-shadow: 0 2px 12px rgba(120,145,255,0.08);
}
.cr-table th {
    background: #e8eeff;
    padding: 10px;
...
.cr-table tbody tr:hover {
    background-color: rgba(70,120,255,0.08);
}
...
<tr>
<td width="50%">
<div style="width:100%;"><h3>Salik</h3>
...
<td width="50%">
<div style="width: 100%;"><h3>Traffic</h3>
