...
<script type="text/javascript">
    ...
    /* Helper for SVG Search Icon */
    function openUserRoleSearch() {
	...
	$(function(){
	    $('#frmUserMaster').validate({
	             ...
	             messages: {
	            	 txtuser: { required:" *required",maxlength:"max 10 chars" },
	                 txtusername: { required:"*required",maxlength:" max 30 chars" },
	            	 txtuserpassword: { required:" *required",maxlength:" max 100 chars" },
		             txtpasswordconfirm: { required:" *required" },
...
<form id="frmUserMaster" action="saveUserMaster" autocomplete="off">
    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            <span class="middle-panel-title">User Details</span>
            
            <div class="field-row">
                <label class="lbl-right" style="width:100px;">User ID</label>
                <input type="text" id="txtuser" name="txtuser" placeholder="Enter user ID" value='<s:property value="txtuser"/>' onblur="checkUserid()" style="width:150px;"/>
                
                <label class="lbl-right" style="width:100px;">User Name</label>
                <input type="text" id="txtusername" name="txtusername" placeholder="Enter user name" value='<s:property value="txtusername"/>' onblur="checkUsername()" style="flex:1; max-width:300px;"/>
            </div>
            
            <div class="field-row">
                <label class="lbl-right" style="width:100px;">Discount Level</label>
                <select id="levels" name="levels" value='<s:property value="levels"/>' style="width:150px;">
                ...
                <div class="input-search-container" style="width: 150px;">
                    ...
                    <svg class="magnifier-icon" onclick="openUserRoleSearch();" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
            ...
            <div class="field-row">
                ...
                <select id="cmblanguage" name="cmblanguage" value='<s:property value="cmblanguage"/>' style="width:150px;"></select>
                ...
                <input type="text" id="mobile" name="mobile" placeholder="Enter mobile" value='<s:property value="mobile"/>' onblur="mobileValid(this.value);" style="width:150px;"/>
            </div>
            
            <div class="field-row" style="margin-bottom:0;">
                <label class="lbl-right" style="width:100px;">Email</label>
                <input type="email" id="txtusermail" name="txtusermail" placeholder="Email" value='<s:property value="txtusermail"/>' style="flex:1; max-width:300px;"/>
                
                <label class="lbl-right" style="width:100px;">Permission</label>
                <select id="cmpermission" name="cmpermission" value='<s:property value="cmpermission"/>' onchange="fungriddis()" style="width:150px;">
        ...
        <div style="display: flex; gap: 15px; margin-bottom: 15px;">
            ...
            <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                ...
                <div class="field-row">
                    ...
                    <input type="password" id="txtmailpswd" name="txtmailpswd" placeholder="Email Password" value='<s:property value="txtmailpswd"/>' style="flex:1;"/>
                </div>
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Signature</label>
                    <input type="text" id="txtmailsign" name="txtmailsign" placeholder="Email Signature" value='<s:property value="txtmailsign"/>' style="flex:1;"/>
                </div>
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Host</label>
                    <input type="text" id="txtmailhost" name="txtmailhost" placeholder="Email Host" value='<s:property value="txtmailhost"/>' style="flex:1;"/>
                </div>
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:100px;">Port</label>
                    <input type="text" id="txtmailport" name="txtmailport" placeholder="Email Port" value='<s:property value="txtmailport"/>' style="flex:1;"/>
                </div>
            </div>

            <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                <span class="middle-panel-title">System Security</span>
                
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Login Password</label>
                    <input type="password" id="txtuserpassword" name="txtuserpassword" placeholder="Enter Password" value='<s:property value="txtuserpassword"/>' style="flex:1;"/>
                </div>
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:100px;">Confirm</label>
                    <input type="password" id="txtpasswordconfirm" name="txtpasswordconfirm" placeholder="Confirm Password" value='<s:property value="txtpasswordconfirm"/>' style="flex:1;"/>
                </div>
                <div class="field-row" style="justify-content: flex-end; margin-bottom:0; margin-top:5px;">
                    <span style="font-weight:bold; font-size:11px;" id="message"></span>
                </div>
            </div>
        ...
        <div class="middle-panel">
            <span class="middle-panel-title">Branch Permissions</span>
            <div class="grid-container" id="userMasterDiv" align="center">
