...
<script type="text/javascript">
	...
	function funClone(){
		 ...
		 $("#brchName").hide();  
         $("#brchNames").show(); 
         $('#brchNames').attr('readonly', true ); 
         $("#brchNames").val($("#brchName option:selected").text());
		 $("#currency").hide();  
         $("#currencys").show(); 
         $('#currencys').attr('readonly', true ); 
    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <label class="lbl-right" style="width:60px;">Role</label>
                ...
                <button class="myButton" type="button" id="btnclone" name="btnclone" onclick="funClone();" style="margin-left: 15px;">Clone</button>

                <label class="lbl-right" style="width:80px; margin-left:auto;">Doc No.</label>
                <input type="text" id="docno" name="txtuserrolebidocno" value='<s:property value="txtuserrolebidocno"/>' readonly tabindex="-1" style="width:120px;">
            </div>
        </div>

        <div class="grid-container" id="userRoleBIDiv">
