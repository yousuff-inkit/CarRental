...
<script type="text/javascript">
	$(document).ready(function () {    
	    $("#date").jqxDateTimeInput({ width: '150px', height: 24, formatString: "dd.MM.yyyy", value: new Date(), theme: 'energyblue'});
	    $("#dateupto").jqxDateTimeInput({ width: '150px', height: 24, formatString: "dd.MM.yyyy", value: null, theme: 'energyblue'});
	    $("#mclosedate").jqxDateTimeInput({ width: '150px', height: 24, formatString: "dd.MM.yyyy", value: null, theme: 'energyblue'});
	...
	function funNotify(){
	    ...
	    if($('#dateupto').jqxDateTimeInput('getDate')==null){
	        document.getElementById("errormsg").innerText="Period Upto Date is Mandatory";
	        return 0;
	    }
...
<form id="frmMonthClose" action="saveMonthClose" autocomplete="off">
	...
	<div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel" style="margin-top: 25px;">
            ...
            <div style="display: flex; gap: 40px; padding-top: 10px;">
                ...
                <div style="flex: 1;">
                    <div class="field-row">
                        ...
                        <input type="text" name="vocno" id="vocno" value='<s:property value="vocno"/>' style="width: 150px;">
                        <input type="hidden" name="docno" id="docno" value='<s:property value="docno"/>'>
                    </div>
                    
                    <div class="field-row" style="margin-bottom:0;">
                        <label class="lbl-right" style="width: 120px;">Month Close Date</label>
                        <div style="width: 150px;">
