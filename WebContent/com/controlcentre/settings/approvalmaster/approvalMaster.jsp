...
function funRemoveReadOnly(){
    ...
    $('#docno, #doctype, #doctypename').attr('readonly', true);
...
function funNotify(){
    ...
    var val1=$('#chckfirstmodify').val();
    var val2=$('#chcksecondmodify').val();
    var val3=$('#chckfinalmodify').val();
    return 1;
}

function setValues() {
    if(parseInt($('#chckfinalmodifyval').val())==1) {
        document.getElementById("chckfinalmodify").value=1;
        document.getElementById("chckfinalmodify").checked=true;
    }
    if(parseInt($('#chcksecondmodifyval').val())==1) {
        document.getElementById("chcksecondmodify").value=1;
        document.getElementById("chcksecondmodify").checked=true;
    }
    if(parseInt($('#chckfirstmodifyval').val())==1) {
        document.getElementById("chckfirstmodify").value=1;
...
<div id="mainBG" class="homeContent" data-type="background">
 ...
 <div class="modern-ui hidden-scrollbar">
    ...
    <div class="middle-panel" id="main">
        <span class="middle-panel-title">Document Info</span>
        <div class="field-row" style="margin-bottom:0;">
            <label class="lbl-right" style="width:80px;">Doc Type</label>
            <div class="input-search-container" style="width: 120px;">
                <input type="text" id="doctype" name="doctype" placeholder="Press F3" value='<s:property value="doctype"/>' required onKeyDown="getUser(event);" readonly/>
                <svg class="magnifier-icon" onclick="openDocTypeSearch();" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            </div>
            
            <input type="text" id="doctypename" name="doctypename" style="flex:1; max-width: 250px;" value='<s:property value="doctypename"/>' readonly /> 
    ...
    <div id="jqxTabs">
        ...
        <div id="level1">
            <div class="field-row" id="lev1" style="padding-bottom: 10px; border-bottom: 1px solid #e2e8f0; margin-bottom: 15px;">
                <button class="myButton" id="addUser" name="addUser" type="button" onclick="addUser1();" style="width:auto;">Add User</button>
                
                <div class="checkbox-inline" style="margin-left:20px;">
                    <input type="checkbox" id="chckfinalmodify" name="chckfinalmodify" value="0" onclick="$(this).attr('value', this.checked ? 1 : 0)" />
                    <label for="chckfinalmodify" style="font-size:12px; font-weight:bold; color:#444;">Modify</label>
                </div>
                
                <label class="lbl-right" style="width:100px; margin-left:auto;">Min. Approval</label>
                <input type="text" id="txtfinal_minapproval" name="txtfinal_minapproval" style="width:60px; text-align:center;" value='<s:property value="txtfinal_minapproval"/>'/>
            </div>
            ...
            <div id="users">
                <div id="user1" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtfinal_userfull1" name="txtfinal_userfull1" style="flex:1; max-width:300px;" value='<s:property value="txtfinal_userfull1"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(1,'level1')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(1,'final')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
                <div id="user2" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtfinal_userfull2" name="txtfinal_userfull2" style="flex:1; max-width:300px;" value='<s:property value="txtfinal_userfull2"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(2,'level1')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(2,'final')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
                <div id="user3" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtfinal_userfull3" name="txtfinal_userfull3" style="flex:1; max-width:300px;" value='<s:property value="txtfinal_userfull3"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(3,'level1')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(3,'final')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
                <div id="user4" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtfinal_userfull4" name="txtfinal_userfull4" style="flex:1; max-width:300px;" value='<s:property value="txtfinal_userfull4"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(4,'level1')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(4,'final')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
                <div id="user5" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtfinal_userfull5" name="txtfinal_userfull5" style="flex:1; max-width:300px;" value='<s:property value="txtfinal_userfull5"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(5,'level1')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(5,'final')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
            </div>
        </div>

        <div id="level2">
            <div class="field-row" id="lev2" style="padding-bottom: 10px; border-bottom: 1px solid #e2e8f0; margin-bottom: 15px;">
                <button class="myButton" id="addUsr" type="button" onclick="addUsr1();" style="width:auto;">Add User</button>
                
                <div class="checkbox-inline" style="margin-left:20px;">
                    <input type="checkbox" id="chcksecondmodify" name="chcksecondmodify" value="0" onclick="$(this).attr('value', this.checked ? 1 : 0)" />
                    <label for="chcksecondmodify" style="font-size:12px; font-weight:bold; color:#444;">Modify</label>
                </div>
                
                <label class="lbl-right" style="width:100px; margin-left:auto;">Min. Approval</label>
                <input type="text" id="txtsecond_minapproval" name="txtsecond_minapproval" style="width:60px; text-align:center;" value='<s:property value="txtsecond_minapproval"/>'/>
            </div>
            ...
            <div id="usrs">
                <div id="usr1" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtsecond_userfull1" name="txtsecond_userfull1" style="flex:1; max-width:300px;" value='<s:property value="txtsecond_userfull1"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(1,'level2')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(1,'second')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
                <div id="usr2" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtsecond_userfull2" name="txtsecond_userfull2" style="flex:1; max-width:300px;" value='<s:property value="txtsecond_userfull2"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(2,'level2')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(2,'second')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
                <div id="usr3" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtsecond_userfull3" name="txtsecond_userfull3" style="flex:1; max-width:300px;" value='<s:property value="txtsecond_userfull3"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(3,'level2')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(3,'second')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
                <div id="usr4" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtsecond_userfull4" name="txtsecond_userfull4" style="flex:1; max-width:300px;" value='<s:property value="txtsecond_userfull4"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(4,'level2')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(4,'second')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
                <div id="usr5" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtsecond_userfull5" name="txtsecond_userfull5" style="flex:1; max-width:300px;" value='<s:property value="txtsecond_userfull5"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(5,'level2')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(5,'second')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
            </div>
        </div>

        <div id="level3">
            <div class="field-row" id="lev3" style="padding-bottom: 10px; border-bottom: 1px solid #e2e8f0; margin-bottom: 15px;">
                <button class="myButton" id="addUsers" type="button" onclick="addUsers1();" style="width:auto;">Add User</button>
                
                <div class="checkbox-inline" style="margin-left:20px;">
                    <input type="checkbox" id="chckfirstmodify" name="chckfirstmodify" value="0" onclick="$(this).attr('value', this.checked ? 1 : 0)" />
                    <label for="chckfirstmodify" style="font-size:12px; font-weight:bold; color:#444;">Modify</label>
                </div>
                
                <label class="lbl-right" style="width:100px; margin-left:auto;">Min. Approval</label>
                <input type="text" id="txtfirst_minapproval" name="txtfirst_minapproval" style="width:60px; text-align:center;" value='<s:property value="txtfirst_minapproval"/>'/>
            </div>
            ...
            <div id="new_users">
                <div id="new_user1" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtfirst_userfull1" name="txtfirst_userfull1" style="flex:1; max-width:300px;" value='<s:property value="txtfirst_userfull1"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(1,'level3')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(1,'first')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
                <div id="new_user2" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtfirst_userfull2" name="txtfirst_userfull2" style="flex:1; max-width:300px;" value='<s:property value="txtfirst_userfull2"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(2,'level3')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(2,'first')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
                <div id="new_user3" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtfirst_userfull3" name="txtfirst_userfull3" style="flex:1; max-width:300px;" value='<s:property value="txtfirst_userfull3"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(3,'level3')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(3,'first')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
                <div id="new_user4" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtfirst_userfull4" name="txtfirst_userfull4" style="flex:1; max-width:300px;" value='<s:property value="txtfirst_userfull4"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(4,'level3')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(4,'first')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
                <div id="new_user5" class="field-row" style="display:none;">
                    ...
                    <input type="text" id="txtfirst_userfull5" name="txtfirst_userfull5" style="flex:1; max-width:300px;" value='<s:property value="txtfirst_userfull5"/>'/>
                    
                    <button type="button" class="icon-btn" onclick="funSearchBtn11(5,'level3')"><img src="../../../../icons/search_new.png"></button>
                    <button type="button" class="icon-btn" onclick="funResetbtn1(5,'first')" ><img src="../../../../icons/cancel_new.png"></button>
                </div>
            </div>
        </div>
