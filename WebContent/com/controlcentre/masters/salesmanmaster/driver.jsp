    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row">
                ...
                <input type="email" name="mail" id="mail" placeholder="someone@example.com" value='<s:property value="mail"/>' style="flex:1; max-width:250px;">

                <label class="lbl-right" style="width:80px;">External</label>
                <div style="display: flex; align-items: center; gap: 5px; height: 24px; margin-left: 5px;">
                    <input type="checkbox" name="external" id="external" onclick="$(this).attr('value', this.checked ? 1 : 0)" style="margin: 0;">
