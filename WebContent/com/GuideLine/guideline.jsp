...
<table width="100%">
  ...
  <tr>
   ...
   <tr>
    ...
    <td><input type="text" id="txtvideopath" name="txtvideopath"  style="width:200%;" value='<s:property value="txtvideopath"/>'/></td>

    <td align="right">PDF Path</td>
    <td><input type="text" id="txtpdfpath" name="txtpdfpath"  style="width:200%;" value='<s:property value="txtpdfpath"/>'/></td>
 </tr>
  <%-- <tr>
    <td colspan="4">&nbsp;</td>
...
<tr><td><div hidden="true" id="gtwoGrid"><jsp:include page="gtwoGrid.jsp"></jsp:include></div></td>
