...
<script type="text/javascript">
        ...
        $(document).ready(function () { 	
            ...
            $("#jqxMenuGrid").jqxGrid(
            {
              ...
              //Add row method
                ...
                columns: [
							...
							{ text: 'Video path', datafield: 'link', width: '70%',editable:false,hidden:true },
							{ text: 'PDF path', datafield: 'pdflink', width: '70%',editable:false,hidden:true },
            ...
            document.getElementById("txtvideopath").value=$('#jqxMenuGrid').jqxGrid('getcellvalue', rowindex1, "link");
            document.getElementById("txtpdfpath").value=$('#jqxMenuGrid').jqxGrid('getcellvalue', rowindex1, "pdflink");
