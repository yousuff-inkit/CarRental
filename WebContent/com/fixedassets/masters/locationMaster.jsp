...
<form id="frmloc" action="saveActionloc" method="post" autocomplete="off">
   ...
   <div id="mainBG">
    <div id="formdet">Location Master</div>
    ...
    <div class="section-block">
        ...
        <div class="agmt-info-grid">
            <label>Code</label>
            <input type="text" name="flmcode" id="flmcode" placeholder="Location Code" value='<s:property value="flmcode"/>'>
            
            <label>Name</label>
            <div style="grid-column: span 3;">
                <input type="text" name="flmname" id="flmname" placeholder="Location Name" value='<s:property value="flmname"/>'>
            </div>
        </div>
    </div>

    <div class="section-block">
        <h2>Location Grid Information</h2>
