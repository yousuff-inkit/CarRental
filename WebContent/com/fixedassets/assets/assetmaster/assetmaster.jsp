...
body {
    ...
    color: #222;
    margin: 0;
    padding: 10px; /* Reduced to pull layout tighter to the edges */
...
.modern-ui .checkbox-group input[type="checkbox"] {
    margin: 0;
    cursor: pointer;
}
...
/* Scrollbar Logic FIXED - Allows it to hug the content naturally */
.hidden-scrollbar {
    overflow-y: auto;
    height: auto;
...
/* Validation Error */
#errormsg { color: red; font-size: 12px; font-weight: bold; margin-left: 10px; }
</style>
...
<jsp:include page="../../../../header.jsp"></jsp:include>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <input type="text" id="assetid" name="assetid" value='<s:property value="assetid"/>' style="width:150px;" />
    ...
    <div style="display: flex; gap: 15px; margin-bottom: 15px;">
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <input type="text" id="supplieraccName" name="supplieraccName" value='<s:property value="supplieraccName"/>' style="flex:1;" readonly tabindex="-1"/>
            ...
            <div class="field-row">
                ...
                <input type="text" id="purchrefno" name="purchrefno" value='<s:property value="purchrefno"/>' style="width:120px;" />
                
                <label class="lbl-right" style="width:110px;">Purchase Date</label>
                <div style="width: 125px;">
            ...
            <div class="field-row">
                ...
                <input type="text" id="noofitems" name="noofitems" value='<s:property value="noofitems"/>' style="width:120px;" onkeypress="javascript:return isNumber(event);" />
                
                <label class="lbl-right" style="width:110px;">Total Purch. Value</label>
            ...
            <div class="field-row">
                ...
                <label class="lbl-right" style="width:110px;">WNTY DocNo</label>
                <input type="text" id="wntydocno" name="wntydocno" value='<s:property value="wntydocno"/>' style="width:125px;" />
            </div>
        </div>
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            <div class="field-row">
                 <div class="checkbox-group">
                    ...
                    <label for="subgriddis" style="padding-left:5px;">Sub Details</label>
                 </div>
                 <input type="hidden" name="subgriddisval" id="subgriddisval" value='<s:property value="subgriddisval"/>'/>
            </div>
            
            <div id="subdetail" hidden="true" class="grid-container">
                <jsp:include page="subdetails.jsp"></jsp:include>
            </div>
            <div id="freespace" style="display:none;"></div>
        </div>
    </div>
    ...
    <div style="display: flex; gap: 15px;">
        <div class="middle-panel" style="flex: 1;">
            ...
            <div class="field-row">
                <div class="checkbox-group" style="padding-left: 10px;">
                    <input type="checkbox" id="opening" name="opening" onchange="funopening()">
                    <label for="opening" style="padding-left:5px;">Opening</label>
                </div>
            ...
            <div class="field-row">
                ...
                <input type="text" id="accumdepr" name="accumdepr" value='<s:property value="accumdepr"/>' style="width:120px; text-align:right;" onblur="funRoundAmt(this.value,this.id);funchktotal();" onkeypress="javascript:return isNumber(event);" />

                <label class="lbl-right" style="width:110px;">Life Time (Year)</label>
                <input type="text" id="lifetimeyear" name="lifetimeyear" value='<s:property value="lifetimeyear"/>' style="width:120px; text-align:right;" onblur="funRoundAmt(this.value,this.id);funcalculatedep();" onkeypress="javascript:return isNumber(event);" />
            </div>
            
            <div class="field-row">
                <label class="lbl-right" style="width:100px;">Depr %</label>
                <input type="text" id="depper" name="depper" value='<s:property value="depper"/>' style="width:120px; text-align:right;" onblur="funRoundAmt(this.value,this.id);funcalcuyear();" onkeypress="javascript:return isNumber(event);" />
            </div>
        ...
        <div class="middle-panel" style="flex: 1;">
            <span class="middle-panel-title">Depreciation Accounts</span>
            ...
            <div class="field-row">
                ...
                <input type="text" id="fixedassetaccName" name="fixedassetaccName" value='<s:property value="fixedassetaccName"/>' style="flex:1;" readonly tabindex="-1"/>
            ...
            <div class="field-row">
                ...
                <input type="text" id="accdepraccName" name="accdepraccName" value='<s:property value="accdepraccName"/>' style="flex:1;" readonly tabindex="-1"/>
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <input type="text" id="depraccName" name="depraccName" value='<s:property value="depraccName"/>' style="flex:1;" readonly tabindex="-1"/>
