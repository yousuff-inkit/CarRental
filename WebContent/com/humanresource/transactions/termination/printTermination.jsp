...
<div class="document-container">
    ...
    <div class="info-grid">
        ...
        <div class="grid-row">
            ...
            <span class="grid-value"><label name="lblemployeeid" id="lblemployeeid"><s:property value="lblemployeeid"/></label></span>
        </div>
        <div class="grid-row">
            <span class="grid-label">Employee Name:</span>
            <span class="grid-value"><label name="lblemployeename" id="lblemployeename"><s:property value="lblemployeename"/></label></span>
        </div>
        <div class="grid-row">
            <span class="grid-label">Designation:</span>
            <span class="grid-value"><label name="lbldesignation" id="lbldesignation"><s:property value="lbldesignation"/></label></span>
        </div>
        <div class="grid-row">
            <span class="grid-label">Department:</span>
            <span class="grid-value"><label name="lbldepartment" id="lbldepartment"><s:property value="lbldepartment"/></label></span>
        </div>
        <div class="grid-row">
            <span class="grid-label">Category:</span>
            <span class="grid-value"><label name="lblcategory" id="lblcategory"><s:property value="lblcategory"/></label></span>
        </div>
        <div class="grid-row">
            <span class="grid-label">Date of Join:</span>
            <span class="grid-value"><label name="lbldateofjoin" id="lbldateofjoin"><s:property value="lbldateofjoin"/></label></span>
        </div>
        <div class="grid-row">
            <span class="grid-label">Appraisal Dt:</span>
            <span class="grid-value"><label name="lblappraisaldt" id="lblappraisaldt"><s:property value="lblappraisaldt"/></label></span>
        </div>
        <div class="grid-row">
            <span class="grid-label">Notify. Date:</span>
            <span class="grid-value"><label name="lblnotifydate" id="lblnotifydate"><s:property value="lblnotifydate"/></label></span>
        </div>
    </div>
    ...
    <div id="secdiv" hidden="true"> 
        <div class="section-title">3. Details</div>
        <table class="cr-table" id="accounting">
            <thead>
                <tr>
                    <th class="text-center" width="5%">Sl No</th>
                    <th width="52%">&nbsp;</th>
                    <th class="text-right" width="15%">Gratuity</th>
                    <th class="text-right" width="15%">Leave Salary</th>
                    <th class="text-right" width="15%">Travels</th> 
                </tr>
            </thead>
            <tbody>
                <%int i=0,l=0; %>
