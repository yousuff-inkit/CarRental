<%@page import="com.humanresource.transactions.employeeadvances.ClsEmployeeAdvancesDAO"%>
<%@page import="javax.servlet.http.HttpServletRequest" %>
<%@page import="javax.servlet.http.HttpSession" %>
<%@page import="com.humanresource.transactions.deductionschedule.ClsDeductionScheduleDAO"%>
<%ClsEmployeeAdvancesDAO DAO= new ClsEmployeeAdvancesDAO(); %>
<% 
...
<script type="text/javascript">
        ...
        $(document).ready(function () { 
            ...
            var rendererstring=function (aggregates){
            	var valueagg=aggregates['sum'];
            	if(typeof(valueagg) == "undefined"){
            		valueagg=0.00;
            	}
            	return '<div style="float: right; margin: 4px;font-size:10px; overflow: hidden;">' + " " + '' + valueagg + '</div>';
            }
            ...
            var cellbeginedit = function (row, datafield, columntype, value) {
            	var rowData = $('#deductionScheduleGridID').jqxGrid('getrowdata', row);
        	    if (rowData.posted > 0) {
