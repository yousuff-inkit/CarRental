        ...
        $(document).ready(function () { 	
        	...
        	if(temp=='1')
        	 { 
        		...
        		data='<%=DAO.attendanceGridLoading(session,totDays,year,month,day,department,category,empId, employeebranchchk, brhid)%>';
         ...
         --%>	
            ...
            $("#attendanceGridID").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Maternity Leave', datafield: 'leave5total', width: '8%', editable: false, cellsalign: 'center', align: 'center'/* , cellbeginedit: function (row) {
