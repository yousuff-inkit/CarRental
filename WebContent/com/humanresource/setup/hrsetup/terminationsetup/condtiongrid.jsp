...
<% String disdata = request.getParameter("disdata")==null?"0":request.getParameter("disdata");
   ...
   String leaveid = request.getParameter("refno")==null?"0":request.getParameter("refno");
...
<script type="text/javascript">
       ...
       var disdata='<%=disdata%>' ;  
   	   if(docnoss>0) {
   			var alldata='<%=showDAO.searchAllowancerelode(docnos,leaveid,type)%>';
   	   } else {
            ...
            $("#condtiongrid").jqxGrid(
            {
                ...
                columns: [
                          ...
                          { text: 'SL No', sortable: false, filterable: false, editable: false,
                            ...
                            { text: 'Allowance', datafield: 'allowance', width: '83%' ,
