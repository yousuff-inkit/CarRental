...
#designation-form-container .master-fieldset {
...
#designation-form-container .master-legend {
    font-size: 15px;
    font-weight: 600;
    color: #0056b3;
    padding: 0 10px;
...
/* Flexbox rows */
#designation-form-container .master-row {
    display: flex;
    align-items: center;
    margin-bottom: 12px;
    gap: 15px;
...
#designation-form-container .master-label {
    font-size: 13px;
    font-weight: 600;
    color: #1e293b;
    text-align: right;
...
#designation-form-container .master-input {
...
#designation-form-container .master-input:focus {
    border-color: #3b82f6;
    outline: none;
    box-shadow: 0 0 0 1px #3b82f6;
}

#designation-form-container .master-input[readonly],
#designation-form-container .master-input:disabled {
...
<script type="text/javascript">
	$(document).ready(function () {   
		...
		$("#desigdate").jqxDateTimeInput({ width: '140px', height: '26px' ,formatString : "dd.MM.yyyy", theme: 'energyblue' });
        ...
        setTimeout(function () {
            ...
            $("#desigdate").find(".jqx-action-button").css({"top": "0px", "height": "26px"});
        }, 0);
	...
	function funReadOnly() {
	    try {
    		$('#frmdesignation .master-input').attr('readonly', true);
	...
	function funRemoveReadOnly() {
	    try {
    		$('#frmdesignation .master-input').attr('readonly', false);
...
<form id="frmdesignation" action="saveDesignation" method="post" autocomplete="off">
    ...
    <div id="designation-form-container">

        <fieldset class="master-fieldset" style="max-width: 1000px;">
            <legend class="master-legend">Designation Details</legend>
            ...
            <div class="master-row">
                ...
                <label class="master-label" style="width: 100px; margin-left: 20px;">Designation</label>
                <input type="text" class="master-input" name="designation" id="designation" placeholder="Enter Designation" value='<s:property value="designation"/>' style="flex: 1; max-width: 350px;">
        ...
        <fieldset class="master-fieldset" style="padding-bottom: 0; overflow: hidden;">
            <legend class="master-legend">View Designations</legend>
