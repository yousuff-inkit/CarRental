...
var costcode= '<%=DAO.costCodeSearch("1") %>';
  	 ...
  	 $(document).ready(function () { 	
        var costtype="1";
           ...
           $('#costcodeSearch').on('rowdoubleclick', function (event) {
                ...
                $("#txtcost").val($('#costcodeSearch').jqxGrid('getcellvalue', rowindex, "name"));
              	$("#hidcostid").val($('#costcodeSearch').jqxGrid('getcellvalue', rowindex, "code"));
