...
String date = request.getParameter("date") == null || "undefined".equals(request.getParameter("date")) ? "0" : request.getParameter("date");
...
$(document).ready(function () {
    ...
    $("#jqxDebitNoteMainSearch").jqxGrid({
        ...
        columns: [
            ...
            { text: "Amount", datafield: "amounts", cellsformat: "d2", width: "10%", cellsalign: "right", align: "right" },
