            	 ...
            	 var rowindex = event.args.rowindex;
           		...
           		var expenditure = parseFloat(monthamt1)+parseFloat(monthamt2)+parseFloat(monthamt3)+parseFloat(monthamt4)+parseFloat(monthamt5)+parseFloat(monthamt6)+
           		 ...
           		 if(isNaN(expenditure)) {
                 	   $('#budgetExpenditureGridID').jqxGrid('setcellvalue', rowindex, "netexpense" ,"0.00");
                 }
                    
                 if(!isNaN(expenditure)){
                 	   $('#budgetExpenditureGridID').jqxGrid('setcellvalue', rowindex, "netexpense" ,expenditure);
                 	  var expenditures=$('#budgetExpenditureGridID').jqxGrid('getcolumnaggregateddata', 'netexpense', ['sum'], true);
