	...
	function funwarningopen(){
		$.messager.confirm('Confirm', 'Transaction will affect Links to the applied Bank Reconcilations & Prepayments.', function(r){
		    if (r){
				 ...
				 if($("#jqxCreditNote").length) $("#jqxCreditNote").jqxGrid({ disabled: false});
	...
	/* SAFE READONLY FUNCTION */
	 function funReadOnly(){
	     try {
			...
			if($("#jqxCreditNote").length) $("#jqxCreditNote").jqxGrid({ disabled: true});
			$("#btnvaluechange").hide();
	 ...
	 function funRemoveReadOnly(){
	     try {
		   ...
		   if ($("#mode").val() == "E") {
			    ...
			    $('#frmTaxCreditNote select').attr('disabled', true);
			    if($("#jqxCreditNote").length) $("#jqxCreditNote").jqxGrid({ disabled: true});
			    if($("#jqxCreditNote").length) $("#jqxCreditNote").jqxGrid('addrow', null, {"type": "","accounts": "","accountname1": "","currency": "","rate": "","dr": true,"amount1": "","description": ""});
			 ...
			 function funFocus(){
			  ...
			  function setValues(){
			      try {
    				  ...
    				  if($('#hidjqxCreditNoteDate').length && $('#hidjqxCreditNoteDate').val()){
    				  ...
    				  if(indexVal>0 && $("#jqxCreditNoteGrid").length){
    						 var check = 1;
			  ...
			  function funvalid(){
			    ...
			    function getCrTotal(){
			       ...
			       function funPrintBtn() {
			    	    ...
			    	    var baseUrl = document.URL.split("saveTaxCreditNote")[0];
...
<div class="modern-ui">
    ...
    <div class="erp-form-area">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="2" style="margin-bottom: 8px;">
            <tr>
                ...
                <td width="46%">
                    <div style="display: flex; gap: 8px; align-items: center;">
                        <input type="text" id="docno" name="txtcreditnotedocno" value='<s:property value="txtcreditnotedocno"/>' style="width: 150px;" tabindex="-1"/>
            ...
            <tr>
                ...
                <td>
                    <select id="cmbcurrency" name="cmbcurrency" value='<s:property value="cmbcurrency"/>' onchange="getRatevalue(this.value,$('#jqxCreditNoteDate').val());">
                        <option></option>
                    </select>
                ...
                <td colspan="3">
                    <input type="text" id="txtrate" name="txtrate" value='<s:property value="txtrate"/>' style="width: 100px;" onblur="funRoundRate(this.value,this.id); getBaseAmountFrom();getCrTotal();" tabindex="-1"/>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="txtamount" name="txtamount" value='<s:property value="txtamount"/>' onblur="funRoundAmt(this.value,this.id); getBaseAmountFrom();getCrTotal();" />
                </td>
    ...
    <div class="grid-container">
        <div id="jqxCreditNoteGrid"><jsp:include page="creditNoteGrid.jsp"></jsp:include></div>
    </div>
