...
$(document).ready(function () {
    ...
    $("#jqxCreditNoteMainSearch").jqxGrid({
        ...
        columns: [
            ...
            { text: "Account No", datafield: "accountno", width: "20%" },
            { text: "Account Name", datafield: "accountname", width: "20%" },
            { text: "Amount", datafield: "amount", cellsformat: "d2", width: "10%",},
    ...
    $("#jqxCreditNoteMainSearch").on("rowdoubleclick", function (event) {
        ...
        document.getElementById("txtaccname").value =
            $("#jqxCreditNoteMainSearch").jqxGrid("getcellvalue", rowindex1, "accountname");

        document.getElementById("docno").value =
            $("#jqxCreditNoteMainSearch").jqxGrid("getcellvalue", rowindex1, "doc_no");
