      	...
      	var rendererstring1=function (aggregates){
            ...
            $("#jqxCreditNote").jqxGrid(  
            {
                ...
                columns: [
							...
							{ text: 'Amount', datafield: 'amount1', cellsformat: 'd'+amtdec, width: '5%', cellsalign: 'right', align: 'right' },
							{ text: 'Base Amount', datafield: 'baseamount1', editable: false, cellsformat: 'd'+amtdec, width: '5%', cellsalign: 'right', align: 'right' },
							{ text: 'Tax%', datafield: 'tax', editable: true, width: '3%' },
							{ text: 'Tax Amount', datafield: 'taxamount', cellsformat: 'd'+amtdec, width: '5%', cellsalign: 'right', align: 'right', editable: false },
							{ text: 'NetTotal', datafield: 'nettotal', cellsformat: 'd'+amtdec, width: '5%', cellsalign: 'right', align: 'right', aggregates: ['sum'],aggregatesrenderer:rendererstring, editable: false },
         		 ...
         		 var datafield = event.args.datafield;
          		 if(datafield=="dr" || datafield=="amount1" || datafield=="rate" || datafield=="nettotal" || datafield=="tax"){
	         	   ...
	         	   var rowlength= rows.length;
	                 ...
	                 var amountk= $("#jqxCreditNote").jqxGrid('getcellvalue', i, "amount1");
	             	 ...
	             	 //edited
	            	 var baseamt = getBaseAmountInGrid(amountk,rate,type);
	            	 amountk = baseamt;
	      			...
	      			{ 
	             		...
	             		//alert("====="+taxempamount);
	             		 $('#jqxCreditNote').jqxGrid('setcellvalue', i, "taxamount",taxempamount.toFixed(amtdec));  
	             		taxempamount=taxempamount.toFixed(amtdec);  
	          		     var taxtotalamount=parseFloat(amountk)+parseFloat(taxempamount);
	          		 // alert("====="+taxtotalamount);
	          		     $('#jqxCreditNote').jqxGrid('setcellvalue', i, "nettotal",taxtotalamount.toFixed(amtdec));
	          			 
	      			}else{
	      				amountk=parseFloat(amountk);
	     				 $('#jqxCreditNote').jqxGrid('setcellvalue', i, "taxamount" ,"0.00");
		              	   $('#jqxCreditNote').jqxGrid('setcellvalue', i, "nettotal" ,amountk.toFixed(amtdec));  
	     			}
	               ...
	               //  var baseamount = getBaseAmountInGrid(value1,rate,type);
	                 ...
	                 if(isNaN(baseamt)){
		                 ...
		                 if(!isNaN(baseamt)){
		                	 amountk=parseFloat(baseamt); 
		              	   $('#jqxCreditNote').jqxGrid('setcellvalue', i, "baseamount1" ,amountk.toFixed(amtdec));
