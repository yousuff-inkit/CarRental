    ...
    <div class="section-row">
        ...
        <div class="section-block">
            ...
            <div class="form-group" style="margin-bottom: 10px;">
                ...
                <select id="cmbfromcurrency" name="cmbfromcurrency" style="width:71%; height: 28px;" value='<s:property value="cmbfromcurrency"/>' onchange="getRate(this.value,$('#jqxUnclearedChequePaymentDate').val());">
                ...
                <input type="text" id="txtfromrate" name="txtfromrate" onchange="funvalid()" style="width:37%;text-align: right;" value='<s:property value="txtfromrate"/>' onblur="funRoundRate(this.value,this.id);getBaseAmountFrom();getCrTotal();" tabindex="-1"/>
            ...
            <div class="form-group">
                ...
                <input type="text" id="txtchequeno" name="txtchequeno" style="width:100%;" onchange="funchequedate();" value='<s:property value="txtchequeno"/>' />
        ...
        <div class="section-block">
            ...
            <div class="form-group" style="margin-bottom: 10px;">
                ...
                <select id="cmbtocurrency" name="cmbtocurrency" style="width:50%; height: 28px;" value='<s:property value="cmbtocurrency"/>' onchange="getRatevalue(this.value,$('#jqxUnclearedChequePaymentDate').val());">
                    <option></option></select>
            ...
            <div class="form-group" style="margin-bottom: 10px;">
                ...
                <input type="text" id="txttoamount" name="txttoamount" style="width:50%;text-align: right;" value='<s:property value="txttoamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountTo();getDrTotal();" />
...
<%--    <td width="45%"><input type="text" id="txtfromrate" name="txtfromrate" onchange="funvalid()" style="width:37%;text-align: right;" value='<s:property value="txtfromrate"/>' onblur="funRoundRate(this.value,this.id);getBaseAmountFrom();getCrTotal();" tabindex="-1"/>--%>
