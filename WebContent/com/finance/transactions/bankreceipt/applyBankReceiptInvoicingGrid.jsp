        ...
        $(document).ready(function () { 	
            ...
            $("#jqxApplyBankInvoicing").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Amount', datafield: 'tramt', cellsformat: 'd'+amtdec, width: '10%', editable: false, cellsalign: 'right', align: 'right' },
							{ text: 'Applying', datafield: 'applying', cellsformat: 'd'+amtdec, width: '10%', cellsalign: 'right', align: 'right', aggregates: ['sum'] },
							{ text: 'Balance', datafield: 'balance', cellsformat: 'd'+amtdec, width: '15%', editable: false, cellsalign: 'right', align: 'right', aggregates: ['sum'] },
							{ text: 'Out Amount',hidden:false , datafield: 'out_amount', cellsformat: 'd'+amtdec,  width: '5%' },
