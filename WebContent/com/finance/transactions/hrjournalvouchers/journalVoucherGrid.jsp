<%@page import="com.finance.transactions.hrjournalvouchers.ClsJournalVouchersDAO"%>
...
<script type="text/javascript">
        ...
        $(document).ready(function () {
         ...
         //  alert("amount=====>"+amtdec+"currency=====>"+curdec);
         var localizationobj = {
        		    thousandsSeparator: ",",
        		    decimalSeparator: "."
        		};
            ...
            var temp1='<%=documentNo%>';
             ...
             if(temp>0){     
            	 data17='<%=DAO.journalVoucherGridReloading(session, docNo,check)%>';      
             }else{
            	 data17={};
             } 
            ...
            $("#jqxJournalVoucher").on("bindingcomplete", function (event){
            	// getConfigs();
            	var currconfig = $('#currstatus').val();
            	if(currconfig=='1'){
            ...
            $("#jqxJournalVoucher").jqxGrid(
            {
               ...
               localization: localizationobj,
                ...
                columns: [
							...
							{ text: 'Currency', datafield: 'curr', cellclassname: cellcostclassname, width: '4%',editable: false },
							{ text: 'Rate', datafield: 'rate',cellsformat: 'd'+curdec, editable: true, width: '3%' },
							
							{ text: 'Debit', datafield: 'debit', width: '8%', cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right', aggregates: ['sum'],
							...
							{ text: 'Credit', datafield: 'credit', width: '8%', cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right', aggregates: ['sum'],
								cellbeginedit: function (row) {
							...
							{ text: 'Base Amount', datafield: 'baseamount', editable: false, cellsformat: 'd'+amtdec, width: '8%', cellsalign: 'right', align: 'right' },
        	...
        	if(currconfig=='1'){
         	 ...
         	 $("#jqxJournalVoucher").on('cellvaluechanged', function (event){
                ...
                var datafield = event.args.datafield;
         		...
         		if(datafield=="debit" || datafield=="credit" || datafield=="rate"){
