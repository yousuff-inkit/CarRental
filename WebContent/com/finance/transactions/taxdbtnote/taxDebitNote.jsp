...
/* ---------------------------------------------------
   MODERN ERP GRID THEME (DARK BORDER + DARK HEADER)
--------------------------------------------------- */
...
/* REMOVE PINK AUTOFILL BACKGROUND FOR ALL INPUTS */
input:-webkit-autofill,
input:-webkit-autofill:hover,
input:-webkit-autofill:focus,
textarea:-webkit-autofill,
select:-webkit-autofill {
    -webkit-box-shadow: 0 0 0 1000px #ffffff inset !important;   /* Force white background */
    box-shadow: 0 0 0 1000px #ffffff inset !important;
    background-color: #ffffff !important;
    color: #1f2f46 !important;  /* text color */
    -webkit-text-fill-color: #1f2f46 !important; /* ensure text stays dark */
...
/* JQX Dropdownlist inside grid or standalone */
...
/* Remove JQX weird pink highlight inside dropdown */
