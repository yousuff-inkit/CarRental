...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        /* Ensure the maindate exists before pulling it to prevent JS errors */
        if($('#maindate').length) {
    ...
    function getAccountDetails(accountsno, accountsname, currs, type, date, check, txtcmtype){
         /* Safely grab the credit date from the parent window if it exists */
         var creditdate = document.getElementById("jqxDebitNoteDate") ? document.getElementById("jqxDebitNoteDate").value : "";
    ...
    <div class="search-panel">
        ...
        <div class="form-row">
            <div class="field-group">
                ...
                <input type="text" name="txtacctno" id="txtacctno" style="width: 140px;" value='<s:property value="txtacctno"/>'>
            </div>
            
            <div class="field-group">
                <label class="fixed-lbl" style="width: 60px;">Currency</label>
                <input type="text" name="txtacctcurrency" id="txtacctcurrency" style="width: 80px;" value='<s:property value="txtacctcurrency"/>'>
        ...
        <div class="form-row" style="margin-bottom: 0;">
            <div class="field-group" style="width: 100%; max-width: 500px;">
                ...
                <input type="text" name="txtacctname" id="txtacctname" style="flex: 1;" value='<s:property value="txtacctname"/>'>
            </div>
        </div>
