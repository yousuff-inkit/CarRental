...
<% String docNo = request.getParameter("txtpettycashdocno2")==null?"0":request.getParameter("txtpettycashdocno2");
   String excelimport = request.getParameter("excel")==null?"0":request.getParameter("excel");
...
<script type="text/javascript">
        ...
        $(document).ready(function () { 
            ...
            var excelimport = '<%=excelimport%>';
             ...
             if(excelimport>0){
            	 data1='<%=DAO.multipleCashPurchaseGridExcelImport(session,check)%>';
             }
            ...
            $("#jqxMultipleCashPurchase").on("bindingcomplete", function (event){
            ...
            if(temp>0){
         	  ...
         	  {         		
                 ...
                 var value1=parseFloat(value1).toFixed(2);      
           ...
           // create context menu
              ...
              $("#jqxMultipleCashPurchase").on('contextmenu', function () {
                  return false;
              });
              
           $("#Menu").on('itemclick', function (event) {
           	   var args = event.args;
                  var rowindex = $("#jqxMultipleCashPurchase").jqxGrid('getselectedrowindex');
                  if ($.trim($(args).text()) == "Edit Selected Row") {
                      editrow = rowindex;
                      var offset = $("#jqxMultipleCashPurchase").offset();
                      $("#popupWindow").jqxWindow({ position: { x: parseInt(offset.left) + 60, y: parseInt(offset.top) + 60} });
                      // get the clicked row's data and initialize the input fields.
                      var dataRecord = $("#jqxMultipleCashPurchase").jqxGrid('getrowdata', editrow);
                      // show the popup window.
                      $("#popupWindow").jqxWindow('show');
                  }
                  else {
                      var rowid = $("#jqxMultipleCashPurchase").jqxGrid('getrowid', rowindex);
                      $("#jqxMultipleCashPurchase").jqxGrid('deleterow', rowid);
                      
                      
                  }
              });
              
              $("#jqxMultipleCashPurchase").on('rowclick', function (event) {
                  if (event.args.rightclick) {
       		   if(document.getElementById("mode").value=="A" || document.getElementById("mode").value=="E"){
                      $("#jqxMultipleCashPurchase").jqxGrid('selectrow', event.args.rowindex);
