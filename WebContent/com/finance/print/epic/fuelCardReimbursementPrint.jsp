...
<div class="document-container">
    ...
    <div class="info-grid">
        ...
        <div class="grid-row">
            ...
            <span class="grid-value"><label id="lblrefno" name="lblrefno"><s:property value="lblrefno"/></label></span>
        </div>
        ...
        <table class="cr-table" id="accounting">
            <thead>
                <tr>
                    ...
                    <th class="text-center" width="15%">Fleet No</th>
                    <th class="text-center" width="15%">Reg. No</th>
