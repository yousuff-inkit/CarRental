...
<div class="document-container">
    ...
    <div id="headerdiv" hidden="true">
        <div style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 10px; border-bottom: 2px solid var(--border-color); margin-bottom: 20px;">
            <div style="flex: 0 0 120px;">
                <img src="<%=contextPath%>/icons/epic.jpg" width="150" height="91" alt=""/>
            </div>
            <div style="flex: 1; text-align: center;">
                <div style="font-size: 20px; font-weight: bold; text-transform: uppercase;">Tax Credit Note</div>
    ...
    <div id="withoutHeaderDiv" hidden="true" style="text-align: center; padding: 20px 0; border-bottom: 2px solid #333; margin-bottom: 20px;">
        ...
        <div style="text-align: right; font-weight: bold; margin-top: 10px; font-size: 14px;">
            TRN : <label id="lblcomptrn" name="lblcomptrn"><s:property value="lblcomptrn"/></label>
        </div>
    </div>
    ...
    <div class="info-grid">
        ...
        <div class="grid-row">
            ...
            <span class="grid-value"><label id="lblcustaddress" name="lblcustaddress"><s:property value="lblcustaddress"/></label></span>
        </div>
        <div class="grid-row">
        ...
        <div class="grid-row">
            <span class="grid-label">Reference Invoice No:</span>
        ...
        <div class="grid-row">
            ...
            <span class="grid-value"><label id="lblclienttrno" name="lblclienttrno"><s:property value="lblclienttrno"/></label></span>
        </div>
        <div class="grid-row" style="grid-column: 1 / -1;">
