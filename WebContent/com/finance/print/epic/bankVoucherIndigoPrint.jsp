...
<div class="document-container">
    ...
    <div class="footer-section">
        <div style="font-weight: bold; font-style: italic; color: #555;">
            * This amount is subjected to adjust against traffic fines, salik, damages, and any other penalties first.
        </div>
