            ...
            $("#jqxIbJournalVoucher").jqxGrid(
            {
               ...
               // localization: {thousandsSeparator: ""},
                ...
                columns: [
							...
							{ text: 'Account', datafield: 'accounts', cellclassname: cellaccclassname, editable: false, width: '7%',cellsformat: 'd'+amtdec },	
							...
							{ text: 'Debit', datafield: 'debit', width: '7%',cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right', aggregates: ['sum'],
							...
							{ text: 'Credit', datafield: 'credit', width: '7%', cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right', aggregates: ['sum'],
								cellbeginedit: function (row) {
							...
							{ text: 'Base Amount', datafield: 'baseamount', editable: false, cellsformat: 'd'+curdec, width: '7%', cellsalign: 'right', align: 'right' },
							...
							{ text: 'Rate',  hidden: true, datafield: 'rate', editable: false, width: '10%', cellsformat: 'd'+curdec, cellsalign: 'right', align: 'right' },
