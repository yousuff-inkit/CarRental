...
        		
        		if(!isNaN(toamount)){
              _B           cr1=parseFloat(cr) + parseFloat(toamount);
...
/* Make inputs and selects responsive within their containers */
/* This will not affect jqxWidgets, only standard inputs */
input[type="text"],
select {
    padding: 5px;
    border: 1px solid #ccc;
    border-radius: 4px;
    box-sizing: border-box; /* Important for padding to not break width */
	font-size: 14px;
}
...
/* Style fieldsets for better sectioning */
fieldset {
...
legend {
	...
	font-weight: 600;
	padding: 0 10px;
	color: #28a745; /* Theme color (green) */
}
...
table {
	...
	background-color: #ffffff; /* Explicitly set table background to white */
}

/* This is the most important rule for alignment */
/* It adds padding to all table cells for spacing */
td {
	padding: 6px 8px;
	vertical-align: top; /* Aligns content to the top of the cell */
}

/* Style for all right-aligned labels */
td[align="right"] {
	text-align: right;
	vertical-align: middle; /* Keep labels centered with their inputs */
	padding-right: 10px;
	font-weight: 600;
	color: #555;
...
CSS   <td width="6%" align="right">Doc No.</td>
...
S    <td colspan="3"><input type="text" id="txttoaccname" name="txttoaccname" style="width:74%;" value='<s:property value="txttoaccname"/>' tabindex="-1"/>
