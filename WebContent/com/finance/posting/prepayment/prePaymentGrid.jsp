...
<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var source =
            {
             ...
             /* 
            $("#jqxPrePayment").on('bindingcomplete', function (event) {   
            	if(parseInt($('#cmbtype').val())==3){
          			$('#jqxPrePayment').jqxGrid({ selectionmode: 'checkbox'});
          			$('#jqxPrePayment').jqxGrid('render');
            	}
            	else{
            ...
            $("#jqxPrePayment").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Amount', datafield: 'dramount',  width: '6%', cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right' },
							{ text: 'Posted', datafield: 'postamount',  width: '6%', cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right' },
							{ text: 'Balance' , datafield: 'pendamount',  width: '6%', cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right' },
							...
							{ text: 'Rate', hidden: true, datafield: 'c_rate',  width: '7%',cellsformat: 'd'+curdec },
							...
							{ text: 'Settle Amt', hidden: true, datafield: 'settleamt',  width: '7%',cellsformat: 'd'+amtdec },	
         	...
         	$("#overlay, #PleaseWait").hide();
          	 ...
          	 $('#jqxPrePayment').on('rowdoubleclick', function (event) {
                 ...
                 if(value==1){
	                 ...
	                 document.getElementById("hidtxtamount").value = $('#jqxPrePayment').jqxGrid('getcellvalue', rowindex1, "dramount");
	                 document.getElementById("txtdecamount").value = $('#jqxPrePayment').jqxGrid('getcellvalue', rowindex1, "settleamt");
                	 ...
                	 $("#btndist").show();
    				 $("#btnpost").hide();$("#btnDistributionSubmit").show();
                 }
                 ...
                 if(value==2){
                	 ...
                	 funreloaddistributiongrid();$("#btnPrintSummary").show();$("#btnDistributionSubmit").hide();
                	 document.getElementById("btnUpdate").value="Edit"; $("#btndist").hide();
    				 $("#btnpost").show();
                 }
