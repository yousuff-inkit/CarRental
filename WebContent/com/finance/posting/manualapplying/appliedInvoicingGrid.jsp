       ...
       $(document).ready(function () { 	
            ...
            $("#jqxAppliedInvoicing").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Amount', datafield: 'tramt', width: '10%', cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right' },
							{ text: 'Applied', datafield: 'applied', width: '10%', cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right', aggregates: ['sum'] },
							{ text: 'Balance', datafield: 'balance', width: '10%', cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right', aggregates: ['sum'] },
