...
<table width="100%">
  <tr>
    ...
    <td colspan="3">
      <input type="text" name="txtpartyname" id="txtpartyname" style="width:95%" value='<s:property value="txtpartyname"/>'>
    </td>
  ...
  <tr>
    ...
    <td width="14%">
      <input type="text" name="txtcurrency" id="txtcurrency" style="width:50%" value='<s:property value="txtcurrency"/>'>
    </td>
    <td width="7%" align="right">Description</td>
    <td colspan="2">
      <input type="text" id="txtdesc" name="txtdesc" style="width:100%" value='<s:property value="txtdesc"/>'>
    </td>
    <td width="14%" align="right">Reconcile Date</td>
    <td>
      <div id="reconciledate" name="reconciledate" style="width:80%" value='<s:property value="reconciledate"/>'></div>
  ...
  <tr>
    <td colspan="7">
      <div id="refreshdiv">
        <jsp:include page="brcnMainSearchGrid.jsp" />
      </div>
    </td>
  </tr>
</table>
