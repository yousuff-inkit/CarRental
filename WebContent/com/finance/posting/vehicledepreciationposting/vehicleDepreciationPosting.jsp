...
<style>
    ...
    html, body {
        ...
        color: #334155;
        /* CRITICAL FIX: This allows the page to scroll if content is too long */
        overflow: auto; 
    }
    ...
    #mainBG, .homeContent {
        ...
        display: block;
        /* Padding at bottom so Totals are visible */
        padding-bottom: 60px; 
    }

    #frmVehicleDepreciationPosting {
        width: 98%;
        margin: 20px auto;
        padding: 0 15px;
        box-sizing: border-box;
...
<script type="text/javascript">
    $(document).ready(function() {
         ...
         $("#jqxVehDepreciationPostingDate").jqxDateTimeInput({ width: '100%', height: '38px', formatString:"dd.MM.yyyy"});
...
<jsp:include page="../../../../header.jsp"></jsp:include><br/>
    ...
    <div class='hidden-scrollbar receipt-header'>
        ...
        <div class="header-card-section">
            <table class="header-table">
              ...
              <tr>
                ...
                <td class="input-cell" style="text-align: center;">
                    <button type="button" class="action-btn" id="btnExcelExporter" title="Export" onclick="funExcelExporter();">
                         <img alt="Export" src="<%=contextPath%>/icons/excel_new.png">
                    </button>
                    <button type="button" class="action-btn" id="btnProcessing" title="Process" onclick="funProcessBtn();">
                         <img alt="Process" src="<%=contextPath%>/icons/process2.png" width="20" height="20">
                    </button>
                ...
                <td class="input-cell">
                    <input type="text" id="docno" name="txtjvno" value='<s:property value="txtjvno"/>' tabindex="-1"/>
                </td>
              </tr>
            </table>
            <div id="errormsg"></div>
        ...
        <div class="grid-card-section">
            <h3>Details</h3>
            <div class="cr-table" id="vehiclesDetailsDiv">
                <jsp:include page="vehiclesDetailsGrid.jsp"></jsp:include>
            </div>
        </div>
        
        <div class="header-card-section" style="padding: 15px;">
            <table class="header-table">
              <tr>
                <td width="80%" class="label-cell">Depr. Total</td>
                <td width="20%" class="input-cell">
                    <input type="text" id="txtdeprtotal" name="txtdeprtotal" style="width:100%;text-align: right;" value='<s:property value="txtdeprtotal"/>' tabindex="-1"/>
                </td>
              </tr>
            </table>
        </div>
        ...
        <div class="header-card-section" style="padding: 15px;">
            <table class="header-table">
              <tr>
                <td width="10%" class="label-cell">Dr. Total</td>
                <td width="30%" class="input-cell">
                    <input type="text" id="txtdrtotal" name="txtdrtotal" style="width:100%;text-align: right;" value='<s:property value="txtdrtotal"/>' tabindex="-1"/>
                </td>
                <td width="20%"></td>
                <td width="10%" class="label-cell">Cr. Total</td>
                <td width="30%" class="input-cell">
                    <input type="text" id="txtcrtotal" name="txtcrtotal" style="width:100%;text-align: right;" value='<s:property value="txtcrtotal"/>' tabindex="-1"/>
                </td>
              </tr>
            </table>
        </div>
