        ...
        $(document).ready(function () { 
            ...
            $("#icPettyCashGridID").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Rate', datafield: 'rate', cellsformat: 'd'+curdec, editable: true, width: '4%', cellsalign: 'right', align: 'right' },
							...
							{ text: 'Amount', datafield: 'amount1', cellsformat: 'd'+amtdec, width: '7%', cellsalign: 'right', align: 'right', aggregates: ['sum'],aggregatesrenderer:rendererstring },
							{ text: 'Base Amount', datafield: 'baseamount1', editable: false, cellsformat: 'd'+amtdec, width: '7%', cellsalign: 'right', align: 'right', aggregates: ['sum'],aggregatesrenderer:rendererstring },
