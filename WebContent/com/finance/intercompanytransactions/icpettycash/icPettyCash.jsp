...
<table width="100%">
  ...
  <tr>
    ...
    <td width="14%"><input type="text" id="txtbaseamount" name="txtbaseamount" style="width:70%;text-align: right;" readonly value='<s:property value="txtbaseamount"/>' onblur="funRoundAmt(this.value,this.id);" tabindex="-1" tabindex="-1"/></td>
