...
<table width="100%">
  <tr>
    ...
    <td width="20%"><input type="text" id="txtfromrate" name="txtfromrate" style="width:32%;text-align: right;" value='<s:property value="txtfromrate"/>' onblur="getBaseAmountFrom();getDrTotal();funRoundRate(this.value,this.id);" tabindex="-1"/></td>
  </tr>
  <tr>
    ...
    <td width="14%"><input type="text" id="txtfrombaseamount" name="txtfrombaseamount" style="width:68%;text-align: right;" value='<s:property value="txtfrombaseamount"/>' onblur="funRoundAmt(this.value,this.id);" tabindex="-1"/></td>
