...
<table width="99%">
  ...
  <tr>
    ...
    <td><input type="text" id="txtdrtotal" name="txtdrtotal" style="width:65%;text-align: right;" value='<s:property value="txtdrtotal"/>' onblur="funRoundAmt(this.value,this.id);" tabindex="-1"/></td>
    <td colspan="4" align="right">Cr. Total</td>
    <td><input type="text" id="txtcrtotal" name="txtcrtotal" style="width:50%;text-align: right;" value='<s:property value="txtcrtotal"/>' onblur="funRoundAmt(this.value,this.id);"  tabindex="-1"/></td>
  </tr>
</table>
