...
<table width="100%">
  <tr>
    ...
    <td width="20%"><input type="text" id="txtfromrate" name="txtfromrate" style="width:32%;text-align: right;" value='<s:property value="txtfromrate"/>' onblur="getBaseAmountFrom();getCrTotal();funRoundRate(this.value,this.id);" tabindex="-1"/></td>
  </tr>
  <tr>
