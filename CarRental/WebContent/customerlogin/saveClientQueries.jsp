...
System.out.println("Call Register fleetno:"+fleetno);
...
System.out.println("Call Register type:"+type);
...
//System.out.println("Call Register cldocno:"+cldocno);
...
try{
	...
	System.out.println("regno val"+strmisc);
	...
	System.out.println("Call Register val:"+sqlbasedate+ "::" +regno+ "::" +fleetno+ "::" +cldocno+ "::" +calledby+ "::" +mobile+ "::" +type+ "::" +sqldatetime+ "::" +date+ "::" +remarks+ "::" +place);
