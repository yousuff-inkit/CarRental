...
var id='<%=id%>';
if(id=="1"){    
	nipur= '<%=viewDAO.accountsDetailsTo(session,type,accountss,accnamess,mobileno,id) %>';
}
else{
	nipur=[];
}
        $(document).ready(function () { 
            ...
            $("#jqxAccountsSearch").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'nontax', datafield: 'nontax', width: '20%', hidden : true }, //, hidden : true
             ...
             $('#jqxAccountsSearch').on('rowdoubleclick', function (event) {
               ...
               // document.getElementById("txtfromdocno").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
                ...
                $('#currate').val($('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "rate"));
            	 ...
            	 document.getElementById("hidnontax").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "nontax");
