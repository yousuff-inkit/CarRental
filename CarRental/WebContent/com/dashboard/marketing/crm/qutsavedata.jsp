...
String srno=request.getParameter("docno");
String brhid=request.getParameter("branchid");
String remarks=request.getParameter("remarks");
String bibid=request.getParameter("bibid").trim();
String cmbinfo=request.getParameter("proname").trim();
String folldate=request.getParameter("date");
...
if(!(folldate.equalsIgnoreCase("undefined"))&&!(folldate.equalsIgnoreCase(""))&&!(folldate.equalsIgnoreCase("0")))
	...
	Statement stmt = conn.createStatement ();
	   ...
	   if(cmbinfo.equalsIgnoreCase("Follow-Up"))
	   {
	   ...
	   else  if(cmbinfo.equalsIgnoreCase("Dropped"))
	   {
	   ...
	   else  if(cmbinfo.equalsIgnoreCase("Declined"))
	   {
