...
function funreload(event){
	 ...
	 /* if(fromdate>todate){
		...
		$("#overlay, #PleaseWait").show();
	 	$('#labourcostGrid').jqxGrid('clear');
	 	$('#sparePartsNewGrid').jqxGrid('clear');
		$("#workshopinvoiceDiv").load("workshopInvoiceGrid.jsp?brhid="+brhid+"&fromdate="+fromdate+'&todate='+todate+'&id=1');
	 /* } */
}
...
function funnipurins(){
	...
	var tyretot=$('#hidtyretot').val();
	var carwashtot=$('#hidcarwashtot').val();
	var batterytot=$('#hidbatterytot').val();
	var fleetno=$('#hidfleetno').val();
	var acnosp=$('#hidacnosp').val();
	var acnolab=$('#hidacnolab').val();
	var acnotyr=$('#hidacnotyr').val();
	var acnocws=$('#hidacnocws').val();
	var acnobat=$('#hidacnobat').val();
	console.log(batterytot+" - "+tyretot+" - "+carwashtot);
	if(sparetot!=0){
	nipurchasearray.push(1+"::"+1+"::"+desc+"::"+sparetot+"::"+sparetot+"::"+0+"::"+sparetot+"::"+sparetot+"::"+
			6+"::"+fleetno+"::"+''+"::"+acnosp+"::"+0+"::"+0+"::"+sparetot+"::0");
	}
	if(labourtot!=0){
	nipurchasearray.push(2+"::"+1+"::"+desc+"::"+labourtot+"::"+labourtot+"::"+0+"::"+labourtot+"::"+labourtot+"::"+
			6+"::"+fleetno+"::"+''+"::"+acnolab+"::"+0+"::"+0+"::"+labourtot+"::0");
	}
	if(tyretot!=0){
	nipurchasearray.push(3+"::"+1+"::"+desc+"::"+tyretot+"::"+tyretot+"::"+0+"::"+tyretot+"::"+tyretot+"::"+
			6+"::"+fleetno+"::"+''+"::"+acnotyr+"::"+0+"::"+0+"::"+tyretot+"::0");
	}
	if(carwashtot!=0){
	nipurchasearray.push(4+"::"+1+"::"+desc+"::"+carwashtot+"::"+carwashtot+"::"+0+"::"+carwashtot+"::"+carwashtot+"::"+
			6+"::"+fleetno+"::"+''+"::"+acnocws+"::"+0+"::"+0+"::"+carwashtot+"::0");
	}
	if(batterytot!=0){
	nipurchasearray.push(5+"::"+1+"::"+desc+"::"+batterytot+"::"+batterytot+"::"+0+"::"+batterytot+"::"+batterytot+"::"+
			6+"::"+fleetno+"::"+''+"::"+acnobat+"::"+0+"::"+0+"::"+batterytot+"::0");
	}
...
function funExportBtn(){
	$("#workshopInvGrid").excelexportjs({
		containerid: "workshopInvGrid",
		datatype: 'json',
		dataset: null,
		gridId: "workshopInvGrid",
		columns: getColumns("workshopInvGrid") ,
		worksheetName:"Workshop Invoice List"
	});
} 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="80%">
    <fieldset>
    	<div id="workshopinvoiceDiv"><jsp:include page="workshopInvoiceGrid.jsp"></jsp:include></div>
    </fieldset>
     <fieldset>
      <legend>Spare Details</legend>
    	<div id="workshopinvoiceSpareDiv"><jsp:include page="spareGrid.jsp"></jsp:include></div>
     </fieldset>
     <fieldset>
      <legend>Labour Details</legend>
    	<div id="workshopinvoiceLabourDiv"><jsp:include page="labourGrid.jsp"></jsp:include></div>
     </fieldset>
    
    </td>
  </tr>
</table>
    <input type="hidden" name="config" id="config" value='<s:property value="config"/>' >
	...
	<input type="hidden" name="hidtyretot" id="hidtyretot" value='<s:property value="hidtyretot"/>' >
	<input type="hidden" name="hidcarwashtot" id="hidcarwashtot" value='<s:property value="hidcarwashtot"/>' >
	<input type="hidden" name="hidbatterytot" id="hidbatterytot" value='<s:property value="hidbatterytot"/>' >
	...
	<input type="hidden" name="hidacnotyr" id="hidacnotyr" value='<s:property value="hidacnotyr"/>' >
	<input type="hidden" name="hidacnocws" id="hidacnocws" value='<s:property value="hidacnocws"/>' >
	<input type="hidden" name="hidacnobat" id="hidacnobat" value='<s:property value="hidacnobat"/>' >
