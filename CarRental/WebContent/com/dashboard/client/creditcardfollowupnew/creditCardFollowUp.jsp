...
<script type="text/javascript">
	...
	function funExportBtn(){
		...
		$("#creditCardFollowUpDiv").excelexportjs({
			containerid: "creditCardFollowUpDiv", 
			datatype: 'json', 
			dataset: null, 
			gridId: "creditCardFollowUp", 
			columns: getColumns("creditCardFollowUp") ,   
			worksheetName:"CreditCardFollowUp"
			});  
	}
