...
System.out.println(chksendmail+"::"+branchid);
...
try{
	...
	String strupdate="update my_acbook ac set clientusername=NULL,clientpassword=NULL where cldocno='"+cldocno[i]+"' and dtype='CRM' and status=3";
