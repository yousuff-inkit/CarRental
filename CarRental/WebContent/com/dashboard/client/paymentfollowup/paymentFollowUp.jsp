...
<td width="20%" >
	...
	<jsp:include page="../../heading.jsp"></jsp:include>
	 ...
	 <td><select id="cmbclientstatus" name="cmbclientstatus" style="width:100%;" value='<s:property value="cmbclientstatus"/>'>
      ...
      <option value="5">On Hire Dispute</option><option value="6">Off Hire Dispute</option><option value="7">Over Due</option><option value="8">Frequent Defaulter</option></select></td></tr>
	 <tr><td colspan="2">&nbsp;</td></tr> 
	 ...
	 <tr><td colspan="2" align="center"><div id="smsdiv"><button class="myButton" type="button" id="btnsms" name="btnsms" onclick="funSendSms(1);">Send SMS</button></div></td></tr>  
	 <tr><td colspan="2" align="center"><div id="paysmsdiv"><button class="myButton" type="button" id="btnpaysms" name="btnsms" onclick="funSendSms(2);">Payment Reminder SMS</button></div></td></tr>
