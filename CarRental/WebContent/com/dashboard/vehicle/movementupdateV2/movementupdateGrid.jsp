...
$(document).ready(function () {
    ...
    var source =
    {
        ...
        datafields: [   
						...
						{name : 'maxdin', type: 'date'},
						{name : 'maxtin', type: 'String'},
						{name : 'maxkm', type: 'String'  },
...
/*     dateout timeout outkm outfuel datein timeout inkm infuel */
    ...
    { 
     ...
     document.getElementById("maxdin").value=$('#vehmovement').jqxGrid('getcellvalue', rowindex1, "maxdin");
     document.getElementById("maxtin").value=$('#vehmovement').jqxGrid('getcellvalue', rowindex1, "maxtin");
     document.getElementById("maxkm").value=$('#vehmovement').jqxGrid('getcellvalue', rowindex1, "maxkm");
     
      $('#dateout').val($('#vehmovement').jqxGrid('getcellvalue', rowindex1, "dout")) ; 
      $('#timeout').val($('#vehmovement').jqxGrid('getcellvalue', rowindex1, "tout")) ; 
     $('#maxdate').val($('#vehmovement').jqxGrid('getcellvalue', rowindex1, "maxdin")) ; 
     $('#maxtime').val($('#vehmovement').jqxGrid('getcellvalue', rowindex1, "maxtin")) ; 
