...
$(document).ready(function () {
    ...
    $("#nonmovement").jqxGrid(
    {
        ...
        columns: [   
        	         ...
        	         { text: 'Fleet No', datafield: 'fleetno', editable:false, width: '5%' },
        	         { text: 'RegNo', datafield: 'reg_no', editable:false, width: '7%' },
        	         { text: 'Vehicle Number', datafield: 'vehiclenum' , width: '8%'}, 
        	         { text: 'Plate Code', datafield: 'platecode', editable:false, width: '7%' },
