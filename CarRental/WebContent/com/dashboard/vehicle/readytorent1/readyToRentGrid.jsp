...
*/
	...
	showfilterrow: true,
        ...
        columns: [ 
                    	...
                    	{ text: 'SL#',datafield: '',columntype:'number', width: '4%',cellclassname: cellclassname,cellsrenderer: function (row, column, value) {
						...
						{ text: 'Plate Code', datafield: 'platecode', width: '6%'  ,cellclassname: cellclassname   },
						{ text: 'Vehicle No', datafield: 'vehiclenum', width: '6%'  ,cellclassname: cellclassname   },
