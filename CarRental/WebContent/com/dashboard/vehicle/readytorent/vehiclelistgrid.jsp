        ...
        $(document).ready(function () { 
            ...
            var source = 
            {
                ...
                datafields: [
					...
					{name : 'vehage', type: 'string'  },
					{name : 'idledays',type:'number'},
					...
					{ text: 'SL#', sortable: false, filterable: false, editable: false, 
					  ...
					  { text: 'Avail. Br', datafield: 'branchname',  width: '8%'  ,pinned: true},
						{ text: 'Location', datafield: 'loc_name', width: '8%' ,pinned: true},
					     ...
					     { text: 'Vehicle Number',editable: false, datafield: 'vehiclenum', width: '8%' }, 
						 ...
						 { text: 'vehAge',editable: false, datafield: 'vehage', width: '6%' },
						 ...
						 { text: 'Idle Days', datafield: 'idledays'  , width: '5%'},
