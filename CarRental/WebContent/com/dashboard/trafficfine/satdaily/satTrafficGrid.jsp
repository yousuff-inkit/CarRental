 ...
 <script type="text/javascript">
        ...
        $(document).ready(function () { 	
            ...
            $("#jqxloadtrafficdataGrid").jqxGrid(
            {
                ...
                columns: [
					{ text: '#TcNo',columntype: 'textbox' , datafield: 'tcno', width: '8%' },
					...
					{ text: 'Traffic Date',columntype: 'textbox' , datafield: 'traffic_date', width: '6%' },
					{ text: 'Time',columntype: 'textbox' , datafield: 'time', width: '4%' },
					{ text: 'Fine Source',columntype: 'textbox' , datafield: 'fine_source', width: '10%' },
					{ text: 'Fees',columntype: 'textbox' , datafield: 'amount', width: '7%', cellsalign:'right' },
					{ text: 'Plate No',columntype: 'textbox' , datafield: 'regno', width: '8%' },
					{ text: 'Plate Category',columntype: 'textbox' , datafield: 'pcolor', width: '7%' },
					{ text: 'Black Points',columntype: 'textbox' , datafield: 'blackpoints', width: '10%' },
