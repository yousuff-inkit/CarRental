 	...
 	if(temp!='NA'){ 
        ...
        $(document).ready(function () { 	
            ...
            $('#jqxstaffAllocatedTraffic').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("txtregno").value = $('#jqxstaffAllocatedTraffic').jqxGrid('getcellvalue', rowindex1, "regno");
                document.getElementById("txtplatecode").value = $('#jqxstaffAllocatedTraffic').jqxGrid('getcellvalue', rowindex1, "platecode");
                document.getElementById("txttdate").value = $('#jqxstaffAllocatedTraffic').jqxGrid('getcellvalue', rowindex1, "tdate");
                document.getElementById("txtttime").value = $('#jqxstaffAllocatedTraffic').jqxGrid('getcellvalue', rowindex1, "ttime");
