...
<script type="text/javascript">
	...
	$(document).ready(function () {
	    ...
	    $('#btnvalidate').click(function(){
	    	$.messager.confirm('Confirm', 'Do you want to validate Saliks?', function(r){
	    		if (r){ 
			    	$.post('validateSaliks.jsp',function(data,status){
	...
	function funExportBtn(){
		if(document.getElementById('rdsalik').checked){
			$("#jqxloaddataGrid").excelexportjs({
				containerid: "jqxloaddataGrid",
				datatype: 'json',
				dataset: null,
				gridId: "jqxloaddataGrid",
				columns: getColumns("jqxloaddataGrid") ,
				worksheetName:"SAT Download List"
			});	
		}
...
<td width="20%" >
	...
	<tr><td colspan="2">
	  <fieldset><legend><b><label class="branch">Report Type</label></b></legend>
       ...
       <td width="52%" align="center"><input type="radio" id="rdtraffic" name="rdcategory" onchange="fundisable();" value="rdtraffic"><label for="rdtraffic" class="branch" id="lbltraffic">Traffic</label></td>
       </tr>
       </table>
	  </fieldset>
	</td></tr>
	<tr><td colspan="2" align="center"><button type="button" name="btnvalidate" id="btnvalidate" class="myButton">Validate Saliks</button></td></tr>
