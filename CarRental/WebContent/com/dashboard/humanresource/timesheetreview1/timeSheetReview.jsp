...
<script type="text/javascript">
	...
	$(document).ready(function () {
		 ...
		 document.getElementById("rddetailed").checked=true;reportTypeChange();
	...
	function funNotify(){
		...
		$.messager.confirm('Confirm', 'Do you want to Confirm?', function(r){
			 ...
			 $('#mode').val('E');
			 $("#overlay, #PleaseWait").show();
			 document.getElementById("frmDashboardTimeSheetReview1").submit();
...
<form id="frmDashboardTimeSheetReview1" action="saveDashboardTimeSheetReview1" method="post">
...
<td width="20%" >
	...
	<jsp:include page="../../heading.jsp"></jsp:include>
	 ...
	 <tr>
	 <td align="right"><label class="branch">Database</label></td>
     <td align="left"><select id="cmbdb" name="cmbdb" style="width:80%;" value='<s:property value="cmbdb"/>'>
      <option value="">--Select--</option><option value="01">Database1</option>
      <option value="02">Database2</option>
     <input type="hidden" id="hidcmbdb" name="hidcmbdb" value='<s:property value="hidcmbdb"/>'/></td></tr>
	...
	<tr><td colspan="2">
	 ...
	 <tr hidden="true"><td colspan="2" align="center"><input type="button" class="myButtons" name="clear" id="clear"  value="Clear" onclick="funClearInfo();">
	 <input type="button" class="myButtonReCheck" name="btnRecheck" id="btnRecheck"  value="Re-Check" onclick="funReCheck();"></td></tr>
	 <tr hidden="true"><td colspan="2" align="center">
