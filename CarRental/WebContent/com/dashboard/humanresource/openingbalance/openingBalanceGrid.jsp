...
<%   String category = request.getParameter("category")==null?"":request.getParameter("category").trim();
	 ...
	 String employee = request.getParameter("employee")==null?"":request.getParameter("employee").trim();
...
<script type="text/javascript">
      ...
      var temp='<%=check%>';
	  	...
	  	if(temp=='1'){ 
	  		    data='<%=DAO.openingBalanceGridLoading(category, department, employee, check, employeebranchchk, branch)%>';    
	  	}
