...
<script type="text/javascript">
	...
	function funUpdate(){
	    ...
	    for (var m = 0; m < rows.length; m++) {
	    	...
	    	if(selectedrows[n]==m){
		        ...
		        $('#timeSheetDetailsGridID').jqxGrid('setcellvalue',rr.length-1,"description",rows[m].description);  
		        $('#timeSheetDetailsGridID').jqxGrid('setcellvalue',rr.length-1,"costbrhid",rows[m].costbrhid);   
		        
		        $("#timeSheetDetailsGridID").jqxGrid('addrow', null, {"date": ""+$('#date').val()+"","empid": ""+$('#txtemployeeid').val()+"","empname": ""+$('#txtemployeename').val()+"","costtype": ""+$('#txtprojecttypeid').val()+"","costgroup": ""+$('#txtprojecttype').val()+"","costcodename": ""+$('#txtprojectidname').val()+"","costcode": ""+$('#txtprojectid').val()+"","hrs": "","empdocno": ""+$('#txtemployeedocno').val(),"costperhour": ""+$('#txtemployeecostperhour').val(),"description": "","costbrhid": "0"});  
	...
	function funSetFillGrid(){
		...
		var selectedcostbrhid=$("#txtselectedbrhid").val();           
		...
		var intime=$('#timeSheetFillInTime').jqxDateTimeInput('val');
  		...
  		var description=$('#txtselecteddesc').val();
...
<table width="100%">
  <tr>
    ...
    <td colspan="5"><input type="text" name="txtselectedcostid" id="txtselectedcostid" placeholder="Press F3 to Search" style="width:70%;height: 20px;" readonly onkeydown="getFillProjectId(event);" value='<s:property value="txtselectedcostid"/>'>
      <input type="hidden" name="txtselectedbrhid" id="txtselectedbrhid" style="width:100%;height: 20px;" readonly value='<s:property value="txtselectedbrhid"/>'>   
      <input type="hidden" name="txtselectedcostiddocno" id="txtselectedcostiddocno" style="width:100%;height: 20px;" readonly value='<s:property value="txtselectedcostiddocno"/>'>
    <input type="hidden" id="txtdaysselected" name="txtdaysselected" style="width:100%;height: 20px;" readonly value='<s:property value="txtdaysselected"/>'/></td>
  ...
  <tr>
    ...
    <td><input type="text" name="txtselectedempids" id="txtselectedempids" placeholder="Press F3 to Search" style="width:100%;height: 20px;" readonly  onkeydown="getFillEmployeeId(event);" value='<s:property value="txtselectedempids"/>'>
    <input type="hidden" name="txtselectedempdocnos" id="txtselectedempdocnos" style="width:100%;height: 20px;" readonly value='<s:property value="txtselectedempdocnos"/>'></td>
    <td align="right" style="font-size:9px;" width="10%" >Total Time</td>
    ...
    <td width="2%" align="right" style="font-size:9px;" hidden="true">Out</td>
    <td width="7%"><div id="timeSheetFillOutTime" name="timeSheetFillOutTime" hidden="true" onchange="funNormalHours();" value='<s:property value="timeSheetFillOutTime" />'></div></td>
    <td width="2%" align="right" style="font-size:9px;" hidden="true">OT</td>
    <td width="7%"><div id="timeSheetFillOTHrs" name="timeSheetFillOTHrs" hidden="true" value='<s:property value="timeSheetFillOTHrs" />'></div></td>
    <td align="right" style="font-size:9px;" hidden="true">Holiday OT</td>
    <td><div id="timeSheetFillHOTHrs" name="timeSheetFillHOTHrs" hidden="true" value='<s:property value="timeSheetFillHOTHrs" />'></div></td>
    <td align="center"><button class="myButton" type="button" id="btnAdd" name="btnAdd" onclick="funUpdate();">OK</button></td>
  </tr>
    <tr>
    <td align="right" style="font-size:9px;">Description</td>    
    <td colspan="10"><input type="text" name="txtselecteddesc" id="txtselecteddesc"  style="width:100%;height: 20px;" value='<s:property value="txtselecteddesc"/>'> </td>
  </tr>
  <tr>
