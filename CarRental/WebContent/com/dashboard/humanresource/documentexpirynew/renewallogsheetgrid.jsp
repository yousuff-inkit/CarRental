...
%>
 ...
 var renewallogdataurl  ='loadrenewallogsheetgrid.jsp?check=<%=check%>&docno=<%=docno%>'; 
 ...
 $(document).ready(function (){ 
         ...
         var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#jqxrenewallogsheetgrid").jqxGrid({ 
            	width: '98%',
                height: 312,
                source: dataAdapter,
...
<div id="jqxrenewallogsheetgrid"></div>