...
<script type="text/javascript">
        ...
        if(temp1=='1'){
        	data='<%=DAO.timeSheetReviewGridLoading(fromdate,todate,category,employee,projecttype,projectid,orderbydate,orderbyemployee,orderbycosttype,orderbycostid,rptType,check)%>';
        }
        ...
        $(document).ready(function () {
        	...
        	$("#timeSheetReviewGridID").on("bindingcomplete", function (event) {
        		if(document.getElementById("rddetailed").checked==true){
        			//$('#timeSheetReviewGridID').jqxGrid('setcolumnproperty', 'Client', 'width', '6%');
        			//$('#timeSheetReviewGridID').jqxGrid('setcolumnproperty', 'Employee', 'width', '6%');
	        		...
	        		$('#timeSheetReviewGridID').jqxGrid('hidecolumn', 'outtime');
        			...
        			$('#timeSheetReviewGridID').jqxGrid('hidecolumn', 'description');
	        		...
	        		//$('#timeSheetReviewGridID').jqxGrid('hidecolumn', 'client');
            ...
            $("#timeSheetReviewGridID").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Client', datafield: 'client', cellclassname: cellclassname, width: '35%',editable: false },
							{ text: 'Employee', datafield: 'empname', cellclassname: cellclassname, editable: false, width: '25%' },  
							{ text: 'Description', datafield: 'description', cellclassname: cellclassname, width: '25%',cellsformat:'d2',cellsalign: 'left',align:'left',editable: false },
							{ text: 'Cost Type', datafield: 'costgroup', cellclassname: cellclassname, width: '7%', editable: false },
							{ text: 'Cost Id', datafield: 'costtype', cellclassname: cellclassname, width: '6%',hidden: true },
							{ text: 'Cost Id', datafield: 'costcodename', cellclassname: cellclassname, width: '6%',editable: false },
							{ text: 'Cost ID', datafield: 'costcode', cellclassname: cellclassname, width: '7%',editable: false,hidden: true },
							{ text: 'Total Time', datafield: 'intime', cellclassname: cellclassname, width: '7%',hidden: true,cellsformat: 'H:mm',  width: '7%', cellsalign: 'left',columntype: 'datetimeinput', 
								createeditor: function(row,cellvalue,editor,celltext,cellwidth,cellheight) {
								    editor.jqxDateTimeInput({showCalendarButton : false});
								},
								cellbeginedit: function (row) {
							...
							{ text: 'Total Time', datafield: 'hrs', cellclassname: cellclassname, width: '7%', cellsalign: 'left',editable: false }, 
							{ text: 'Normal Hours', datafield: 'actualhrs', cellclassname: cellclassname,  width: '7%', cellsalign: 'left',editable: false,hidden:true },
							{ text: 'OT Hours', datafield: 'othrs', cellclassname: cellclassname,  width: '7%', cellsalign: 'left',editable: false ,hidden:true}, 
							{ text: 'HOT Hours', datafield: 'hothrs', cellclassname: cellclassname,  width: '7%', cellsalign: 'left',editable: false,hidden:true },
							...
							{ text: 'Cost per Hours', datafield: 'costperhrs', cellclassname: cellclassname, width: '7%',cellsformat:'d2',cellsalign: 'right',align:'right',editable: false 
								/* createeditor: function(row,cellvalue,editor,celltext,cellwidth,cellheight) {
								    editor.jqxDateTimeInput({showCalendarButton : false});
								},
								cellbeginedit: function (row) {
							...
							{ text: 'Total Cost', datafield: 'totcost', cellclassname: cellclassname, width: '7%',cellsformat:'d2',cellsalign: 'right',align:'right',editable: false }, 
            	...
            	if(document.getElementById("rddetailed").checked==true && $('#mode').val()=='E'){
	         	    ...
	         	    if(datafield=="date"){
		          	...
		          	if(datafield=="intime" || datafield=="outtime"){
		          		...
		          		var costperhour = $("#timeSheetReviewGridID").jqxGrid('getcellvalue', rowindexestemp, "costperhrs");   
		                ...
		                var totalcost = (parseFloat(newhours1)*parseFloat(costperhour))+((parseFloat(newminutes1)/60)*parseFloat(costperhour));
		                $('#timeSheetReviewGridID').jqxGrid('setcellvalue', rowindexestemp, "normalhrs" ,normalHours);
		                $('#timeSheetReviewGridID').jqxGrid('setcellvalue', rowindexestemp, "totcost" ,Math.round(totalcost));    
		          	    }
		          	}
            	}
           });
