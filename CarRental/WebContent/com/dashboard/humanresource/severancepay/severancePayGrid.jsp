        ...
        $(document).ready(function () {
            ...
            $("#severancePayGridID").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Emp. Name', datafield: 'employeename',editable:false, width: '13%',columngroup:'employeeinfo'},
							{ text: 'Date of Join', datafield: 'dateofjoin', width: '7%',editable:false ,cellsformat:'dd.MM.yyyy',columngroup:'employeeinfo',aggregates: ['sum1'],aggregatesrenderer:rendererstring1 },
