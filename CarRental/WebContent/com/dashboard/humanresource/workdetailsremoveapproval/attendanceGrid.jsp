...
<%@page import="com.dashboard.humanresource.workdetailsremoveapproval.ClsWorkdetailsremoveapprovalDAO"%>
<% ClsWorkdetailsremoveapprovalDAO DAO= new ClsWorkdetailsremoveapprovalDAO(); %> 
        ...
        $(document).ready(function () { 	
            ...
            $("#attendanceGridID").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Employee', datafield: 'empname', editable: false, width: '15%' ,   cellclassname: cellclassname},			
							{ text: 'Client',  datafield: 'name', editable: false,  width: '20%' ,   cellclassname: cellclassname},			
							{ text: 'Site',  datafield: 'site', editable: false   ,  width: '20%' ,    cellclassname: cellclassname},			
