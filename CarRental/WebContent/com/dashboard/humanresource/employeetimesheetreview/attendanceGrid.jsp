        ...
        $(document).ready(function () { 	
            ...
            $("#attendanceGridID").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'C Type', datafield: 'costtype', editable: false , width: '4%' ,   cellclassname: cellclassname},
							{ text: 'Code',  datafield: 'code', editable: false , width: '5%',   cellclassname: cellclassname },
							{ text: 'Employee', datafield: 'empname', editable: false, width: '9%' , hidden:true ,   cellclassname: cellclassname},			
							{ text: 'Client',  datafield: 'name', editable: false,  width: '23%' ,  cellclassname: cellclassname},			
							...
							{ text: 'empid', datafield: 'emp', editable: false,hidden: true, width: '7%',  cellclassname: cellclassname},
