  	 ...
  	 $(document).ready(function () { 	  
         var costtype='<%=dtype1%>';
           ...
           $('#costcodeSearch').on('rowdoubleclick', function (event) {
           	 ...
           	 document.getElementById("db").value = $('#costcodeSearch').jqxGrid('getcellvalue', rowindex2, "db");
                ...
                if($('#txtorgridclick').val()=='1') {
		             ...
		             $('#timeSheetFillSearchGridId').jqxGrid('setcellvalue', rowindex1, "costcode" ,$('#costcodeSearch').jqxGrid('getcellvalue', rowindex2, "code"));
		             $('#timeSheetFillSearchGridId').jqxGrid('setcellvalue', rowindex1, "costcodename" ,$('#costcodeSearch').jqxGrid('getcellvalue', rowindex2, "name"));
