<%@page import="com.dashboard.humanresource.timesheetentry.ClsTimeSheetEntryDAO"%>
<%ClsTimeSheetEntryDAO DAO= new ClsTimeSheetEntryDAO(); %>
...
<%
 ...
 String fillfromdate = request.getParameter("fillfromdate")==null?"":request.getParameter("fillfromdate");
 ...
 String empdb=request.getParameter("empdb")==null?"":request.getParameter("empdb");
...
<script type="text/javascript">
        ...
        $(document).ready(function () { 
          ...
          if(gridload=="1"){
        	  fillgriddata = '<%=DAO.timeSheetFillGridLoading(session,fillfromdate,filltodate,daysselected,selectedempdocnos,selectedcosttypename,selectedcosttypeid,selectedcostid,selectedcostiddocno,fillintime,fillouttime,fillnormalhrs,fillothrs,fillhothrs,gridload,db,empdb) %>'; 
          }
            ...
            var source =
            {
                ...
                datafields: [
						    ...
						    {name : 'dbemp', type: 'String'  },
						    {name : 'costdb', type: 'String'  }
            ...
            $("#timeSheetFillSearchGridId").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Normal Hours', datafield: 'hrs', cellsformat: 'H:mm',  width: '7%',hidden:true, cellsalign: 'left',columntype: 'datetimeinput',
								createeditor: function(row,cellvalue,editor,celltext,cellwidth,cellheight) {
								    editor.jqxDateTimeInput({showCalendarButton : false});
								} 
							}, 
						...
						//	}, 
							...
							{ text: 'Emp DB', datafield: 'dbemp',width: '10%' , hidden: true},
							{ text: 'Cost DB', datafield: 'costdb',width: '10%', hidden: true },
