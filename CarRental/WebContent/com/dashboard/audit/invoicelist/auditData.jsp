...
for(int i=0;i<invarray.size();i++){
	...
	String strsql="update gl_invm set audit=1 where doc_no="+invarray.get(i);
	...
	if(val>0){
		  ...
		  String upsql="insert into gl_biblog (doc_no, brhId, dtype, edate, userId, ENTRY) values ("+invarray.get(i)+",'"+branch+"','BINA',now(),'"+session.getAttribute("USERID").toString()+"','E')";
