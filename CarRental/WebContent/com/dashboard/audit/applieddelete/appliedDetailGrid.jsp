...
<%   String trno = request.getParameter("trno")==null?"0":request.getParameter("trno").trim();
 ...
 var data1, detailURL;
        ...
        $(document).ready(function () { 
        	 <%-- data1 ='<%=DAO.applyInvoiceDeleteGridLoading(trno,accountno,check)%>';
			  ...
			  if(check == "1"){
				  detailURL = 'getAppliedDetailData.jsp?trno='+trno+'&accountno='+accountno+'&check='+check; 
			  }
         ...
         var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#appliedDetailsGrid").jqxGrid({ 
                ...
                columns: [
							...
							{ text: 'Remarks', datafield: 'description', editable: false, width: '41%' },	
