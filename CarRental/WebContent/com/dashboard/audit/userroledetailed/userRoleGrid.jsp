        ...
        $(document).ready(function () { 	
            ...
            $("#jqxUserRole").jqxGrid({
                ...
                columns: [							
							...
							{ text: 'User Role', datafield: 'user_role', editable: false, width: '24%'},
							{ text: 'Menu', datafield: 'menu_name', editable: false, width: '23%'},	
							
							{ text: 'View', datafield: 'view', columntype: 'checkbox', width: '6%',cellsalign: 'center', align: 'center' },
							{ text: 'Add', datafield: 'add1', columntype: 'checkbox', width: '6%',cellsalign: 'center', align: 'center' },
							{ text: 'Edit', datafield: 'edit', columntype: 'checkbox', width: '6%',cellsalign: 'center', align: 'center' },
							{ text: 'Delete', datafield: 'del', columntype: 'checkbox', width: '6%',cellsalign: 'center', align: 'center' },
							{ text: 'Print', datafield: 'print', columntype: 'checkbox', width: '6%',cellsalign: 'center', align: 'center' },
							{ text: 'Attach', datafield: 'attach', columntype: 'checkbox', width: '6%',cellsalign: 'center', align: 'center' },
							{ text: 'Excel', datafield: 'excel', columntype: 'checkbox', width: '6%',cellsalign: 'center', align: 'center' },
							{ text: 'MNO', datafield: 'mno', hidden:true, width: '9%'},
							{ text: 'E-Mail', datafield: 'email',columntype: 'checkbox', hidden:false, width: '6%'},
