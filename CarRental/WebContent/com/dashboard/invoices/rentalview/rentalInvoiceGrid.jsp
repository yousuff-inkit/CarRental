 <%@page import="com.dashboard.invoices.rentalview.*"%>
 <%ClsRentalInvoiceViewDAO rentaldao=new ClsRentalInvoiceViewDAO();%>
...
$(document).ready(function () {
    ...
    var source =
    {
        ...
        datafields: [
						...
						{name : 'displayfromdate',type:'date'}
						],
    ...
    $("#rentalInvoiceGrid").jqxGrid(
    {
       ...
       sortable:false,
        columns: [
						...
						{ text: 'Start/Last Invoiced', datafield: 'fromdate', width: '6%',cellsformat:'dd.MM.yyyy' ,cellclassname: cellclassname,hidden:true },
						{ text: 'From', datafield: 'displayfromdate', width: '6%',cellsformat:'dd.MM.yyyy' ,cellclassname: cellclassname },
						...
						{ text: 'Amount', datafield: 'amount', width: '7%',cellsformat:'d2',cellsalign:'right',align:'right' ,cellclassname: cellclassname , aggregates: ['sum'],aggregatesrenderer:rendererstring},
						{ text: 'Cldocno', datafield: 'cldocno', width: '12%',cellsformat:'d2',hidden:true},
						{ text: 'Rental Sum', datafield: 'rentalsum', width: '6%',cellsformat:'d2',cellsalign:'right',align:'right' ,cellclassname: cellclassname, aggregates: ['sum'],aggregatesrenderer:rendererstring},
						{ text: 'Acc Sum', datafield: 'accsum', width: '6%',cellsformat:'d2',cellsalign:'right',align:'right' ,cellclassname: cellclassname, aggregates: ['sum'],aggregatesrenderer:rendererstring},
						{ text: 'salik Amt', datafield: 'salikamt', width: '6%',cellsformat:'d2',cellsalign:'right',align:'right' ,cellclassname: cellclassname, aggregates: ['sum'],aggregatesrenderer:rendererstring},
						{ text: 'Traffic Amt', datafield: 'trafficamt', width: '6%',cellsformat:'d2',cellsalign:'right',align:'right' ,cellclassname: cellclassname, aggregates: ['sum'],aggregatesrenderer:rendererstring},
						{ text: 'Salik Srvc', datafield: 'saliksrvc', width: '6%',cellsformat:'d2',cellsalign:'right',align:'right' ,cellclassname: cellclassname, aggregates: ['sum'],aggregatesrenderer:rendererstring},
						{ text: 'Traffic Srvc', datafield: 'trafficsrvc', width: '6%',cellsformat:'d2',cellsalign:'right',align:'right' ,cellclassname: cellclassname, aggregates: ['sum'],aggregatesrenderer:rendererstring},
						{ text: 'DateDifference', datafield: 'datediff', width: '17%',hidden:true},
						{ text: 'Insurance Charges',datafield: 'insurchg', width: '7%',cellsformat:'d2',cellsalign:'right',align:'right' ,cellclassname: cellclassname, aggregates: ['sum'],aggregatesrenderer:rendererstring},
