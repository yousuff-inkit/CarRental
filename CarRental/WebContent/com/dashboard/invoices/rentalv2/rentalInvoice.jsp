		   ...
		   $.messager.confirm('Confirm', 'Do you want to Generate Invoice?', function(r){
	 			if (r){
    			    ...
    			    for(var j=0;j<selectedrows.length;j++){
						...
						var cdw=$("#rentalInvoiceGrid").jqxGrid('getcellvalue',selectedrows[j],'cdw');
						var pai=$("#rentalInvoiceGrid").jqxGrid('getcellvalue',selectedrows[j],'pai');
						var cdw1=$("#rentalInvoiceGrid").jqxGrid('getcellvalue',selectedrows[j],'cdw1');
						var pai1=$("#rentalInvoiceGrid").jqxGrid('getcellvalue',selectedrows[j],'pai1');
						var gps=$("#rentalInvoiceGrid").jqxGrid('getcellvalue',selectedrows[j],'gps');
						var babyseater=$("#rentalInvoiceGrid").jqxGrid('getcellvalue',selectedrows[j],'babyseater');
						var cooler=$("#rentalInvoiceGrid").jqxGrid('getcellvalue',selectedrows[j],'cooler');
						
						var exkmrte=$("#rentalInvoiceGrid").jqxGrid('getcellvalue',selectedrows[j],'exkmrte');
						var oinschg=$("#rentalInvoiceGrid").jqxGrid('getcellvalue',selectedrows[j],'oinschg');
						var chaufchg=$("#rentalInvoiceGrid").jqxGrid('getcellvalue',selectedrows[j],'chaufchg');
						var chaufexchg=$("#rentalInvoiceGrid").jqxGrid('getcellvalue',selectedrows[j],'chaufexchg');
						
						newTextBox.val(rano+"::"+ratype+"::"+fromdate+"::"+todate+"::"+acno+"::"+acname+"::"+amount+"::"+cldocno+"::"+rentalsum+"::"+accsum+"::"+salikamt+"::"+trafficamt+"::"+saliksrvc+"::"+trafficsrvc+"::"+datediff+"::"+brhid+"::"+curid+"::"+insurchg+"::"+salikcount+"::"+trafficcount+"::"+salamount+"::"+salrate+"::"+salikauhamt+"::"+salikdxbamt+"::"+salikauhsrvc+"::"+salikdxbsrvc+"::"+salikauhcount+"::"+salikdxbcount+"::"+salikauhrate+"::"+salikdxbrate+"::"+salikauhsrvcrate+"::"+salikdxbsrvcrate+"::"+cdw+"::"+pai+"::"+cdw1+"::"+pai1+"::"+gps+"::"+babyseater+"::"+cooler+"::"+exkmrte+"::"+oinschg+"::"+chaufchg+"::"+chaufexchg);
					...
					$("#overlay, #PleaseWait").show();
					document.getElementById("frmDashboardRentalInvoiceV2").submit();
...
<form id="frmDashboardRentalInvoiceV2" action="saveDashboardRentalInvoiceV2" method="post">
