...
function funreload(event)
{
	...
	if(dateval==1){
		var branch = document.getElementById("cmbbranch").value;
     	...
     	else if(document.getElementById("chkexfuel").checked==true){
     		notinvoiced="FUEL";
     	}
     	
	  	$("#invoicediv").load("extrakmGrid.jsp?branch="+branch+"&date1="+date1+"&client="+client+"&temp=1&notinvoiced="+notinvoiced);
	}
}
