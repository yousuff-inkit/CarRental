...
<table width="100%" >
 <tr>
    <td width="166" align="left">Amount :</td>
    <td width="783">&nbsp;</td>
    <td width="163">&nbsp;</td>
    <td width="146" align="right"><b><label id="lbltotalamt" name="lbltotalamt"><s:property value="lbltotalamt"/></label></b></td>
  </tr>
  <tr>
    <td width="166" align="left">VAT :</td>
    <td width="783">&nbsp;</td>
    <td width="163">&nbsp;</td>
    <td width="146" align="right"><b><label id="lblvat" name="lblvat"><s:property value="lblvat"/></label></b></td>
  </tr>
  <tr>
