<%@ page import="com.dashboard.rentalagreement.mranumber.ClsmranochangeDAO" %>
 <%
	  ...
	  aa=1;
        ...
        $(document).ready(function () { 
            ...
            $('#detailedGrid').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("oldmrano").value=$('#detailedGrid').jqxGrid('getcellvalue', rowindex2, "PO NO");
                document.getElementById("mrano").value=$('#detailedGrid').jqxGrid('getcellvalue', rowindex2, "PO NO");
                document.getElementById("reftypes").value=$('#detailedGrid').jqxGrid('getcellvalue', rowindex2, "reftypes");
