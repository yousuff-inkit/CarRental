   ...
   if(id=='1'){
    ...
    var source =
    {
        ...
        datafields: [
                  		...
                  		{name : 'inremark',type:'string'},
                  		{name : 'outremark',type:'string'},
       ...
       showfilterrow: true,
        columns: [
				...
				{ text: 'Fleet Name',datafield:'flname',width:'10%'},
       			...
       			//	{ text: 'Remarks',datafield:'remark',width:'15%'},
				...
				{ text: 'Open User',datafield:'ouser',width:'12%'},
       				...
       				{ text: 'Remarks',datafield:'outremark',width:'15%',columngroup:'outdetails'},
       				...
       				{ text: 'Remarks',datafield:'inremark',width:'15%',columngroup:'indetails'},
