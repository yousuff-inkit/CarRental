<%@ page import="com.dashboard.operations.collectionclosurev2.ClsOperationsDAO" %>
        ...
        $(document).ready(function () {
            ...
            $("#collectionClosure").jqxGrid(
            {
                ...
                columns: [
	                    ...
	                    { text: 'Client Code', datafield: 'clientcode', width: '5%' },
						{ text: 'Client', datafield: 'refname', width: '18%' },
	                    { text: 'Client Category', datafield: 'clientcategory', width: '10%' },
	                    { text: 'Payment Type', datafield: 'paytype', width: '5%' },                
		                { text: 'Paid As', datafield: 'payas', width: '11%' },                
		                { text: 'Credit Type', datafield: 'cardtype', width: '5%' },                
		                { text: 'Chq/Card No/Online', datafield: 'cardnum', width: '11%' },                
				        { text: 'Credit Expiry Date', datafield: 'cardexpiry', cellsformat: 'dd.MM.yyyy' , width: '7%' },                
