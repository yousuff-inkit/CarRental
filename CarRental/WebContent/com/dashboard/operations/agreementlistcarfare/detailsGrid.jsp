<%@ page import="com.dashboard.operations.agreementlistcarfare.ClsagreementDAO"  %>
 <%
        ...
        $(document).ready(function () { 
            ...
            var source = 
            {
                ...
                datafields: [
							...
							{name : 'insurrefname',type:'string'},
							{name : 'contractgroup',type:'string'},
							{name : 'contractyom',type:'string'},
							{name : 'account',type:'string'},
							{name : 'agmtstatus',type:'string'},
							{name : 'clientmail',type:'string'},
							{name : 'advance',type:'string'},
							{name : 'racrate',type:'number'}
                          	],
                          	localdata: datasssss,
            ...
            { 
                ...
                enabletooltips:true,
			         ...
			         columns: [
							...
							{ text: 'Agmt NO', datafield: 'doc', width: '6%' ,cellclassname: cellclassname },   //voc no
							{ text: 'Agmt Status',datafield: 'agmtstatus',width: '6%' ,cellclassname: cellclassname },
							...
							{ text: 'Vehicle Number', datafield: 'vehiclenum', width: '7%',cellclassname: cellclassname },
							...
							{ text: 'Account #', datafield: 'account', width: '7%',cellclassname: cellclassname },
							
							{ text: 'Category', datafield: 'category', width: '18%',cellclassname: cellclassname },
							...
							{ text: 'Email', datafield: 'clientmail', width: '10%',cellclassname: cellclassname},
							{ text: 'Insurance Comp.', datafield: 'insurrefname', width: '18%',cellclassname: cellclassname },
							...
							{ text: 'Rent', datafield: 'rent', width: '5%',cellsformat: 'd2', cellsalign: 'right', align:'right',cellclassname: cellclassname},
								...
								{ text: 'PAI', datafield: 'pai', width: '5%',cellsformat: 'd2', cellsalign: 'right', align:'right',cellclassname: cellclassname},
								 { text: 'Inv Date', datafield: 'invdate', width: '6%',cellsformat:'dd.MM.yyyy',cellclassname: cellclassname},
									{ text: 'Inv Rent', datafield: 'invrental', width: '5%',cellsformat: 'd2', cellsalign: 'right', align:'right',cellclassname: cellclassname},
									...
									{ text: 'Org.YOM',datafield:'contractyom',width:'5%',cellclassname: cellclassname},
									{ text: 'Org.Group',datafield:'contractgroup',width:'6%',cellclassname: cellclassname},
									...
									{ text: 'ODO meter(outkm)', datafield: 'okm', width: '10%' , cellsalign: 'right', align:'right',cellclassname: cellclassname},
							 ...
							 { text: 'RL Type', datafield: 'rltype', width: '10%',hidden:true },
							        { text: 'Restrict kms', datafield: 'kmrest', width: '10%',cellsformat: 'd2', cellsalign: 'right', align:'right',cellclassname: cellclassname},
							        { text: 'Extra KM Rate', datafield: 'exkmrte', width: '10%',cellsformat: 'd2', cellsalign: 'right', align:'right',cellclassname: cellclassname},
							        { text: 'Insurance excess', datafield: 'insex', width: '10%',cellsformat: 'd2', cellsalign: 'right', align:'right',cellclassname: cellclassname},
							        { text: 'RAC RATE', datafield: 'racrate', width: '5%',cellclassname: cellclassname,cellsformat: 'd2',cellsalign: 'right', align:'right'},
							        { text: 'Advance', datafield: 'advance', width: '5%',cellclassname: cellclassname},
