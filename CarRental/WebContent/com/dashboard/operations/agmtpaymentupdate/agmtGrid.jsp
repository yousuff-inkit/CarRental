 ...
 $(document).ready(function () { 	
            ...
            var source =
            {
                ...
                datafields: [
     						...
     						{name : 'pyttotalrent',type:'number'},
     						{name : 'pytadvance',type:'number'},
     						{name : 'pytbalance',type:'number'},
     						{name : 'pytstartdate',type:'date'},
     						{name : 'pytmonthsno',type:'number'},
            ...
            $("#agmtGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Client #',datafield:'acno',width:'10%',editable:false,hidden:true},
							...
							{ text: 'pyttotalrent', datafield: 'pyttotalrent', width: '10%',hidden:true,editable:false},
							{ text: 'pytadvance', datafield: 'pytadvance', width: '10%',hidden:true,editable:false},
							{ text: 'pytbalance', datafield: 'pytbalance', width: '10%',hidden:true,editable:false},
							{ text: 'pytstartdate', datafield: 'pytstartdate', width: '10%',cellsformat:'dd.MM.yyyy',hidden:true,editable:false},
							{ text: 'pytmonthsno', datafield: 'pytmonthsno', width: '10%',hidden:true,editable:false},
            ...
            $('#agmtGrid').on('rowdoubleclick', function (event) 
            		{ 
            		   ...
            		   // right click.
            		    ...
            		    document.getElementById("pyttotalrent").value=$('#agmtGrid').jqxGrid('getcellvalue', boundIndex, "pyttotalrent");
            		    document.getElementById("pytadvance").value=$('#agmtGrid').jqxGrid('getcellvalue', boundIndex, "pytadvance");
            		    document.getElementById("pytbalance").value=$('#agmtGrid').jqxGrid('getcellvalue', boundIndex, "pytbalance");
            		    document.getElementById("pytstartdate").value=$('#agmtGrid').jqxGrid('getcelltext', boundIndex, "pytstartdate");
            		    document.getElementById("pytmonthsno").value=$('#agmtGrid').jqxGrid('getcellvalue', boundIndex, "pytmonthsno");
            		    document.getElementById("date").value=$('#agmtGrid').jqxGrid('getcelltext', boundIndex, "date");
            		    document.getElementById("docno").value=$('#agmtGrid').jqxGrid('getcellvalue', boundIndex, "agmtno");
            		    document.getElementById("clientacno").value=$('#agmtGrid').jqxGrid('getcellvalue', boundIndex, "acno");
