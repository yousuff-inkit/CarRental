            ...
            $("#detailGrid").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'Client', datafield: 'client',editable:false, width: '14%'},
							...
							{ text: 'Sales Price', datafield: 'salesprice', width: '6%',cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring},
							{ text: 'Dep Posted', datafield: 'dep_posted', width: '6%',editable:false ,cellsformat:'dd.MM.yyyy',cellsalign:'right',align:'right'},
							{ text: 'Purchase Value', datafield: 'pur_value', width: '6%',editable:false,cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring},
							{ text: 'Acc.Dep', datafield: 'acc_dep', width: '7%',editable:false,cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring},
							{ text: 'Current Dep',datafield:'cur_dep', width: '7%',editable:false,cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring},
							...
							{ text: 'VAT',  datafield:'vat',width: '7%',editable:false,cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring},
							{ text: 'Grand Total',  datafield:'taxtotal',width: '7%',editable:false,cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring}
