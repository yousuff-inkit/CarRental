...
<link rel="stylesheet" href="<%=contextPath%>/vendors/font-awesome-4.7.0/css/font-awesome.min.css">
...
*/
        $(document).ready(function () {
            ...
            $.get('getConfigs.jsp',function(data){
            	...
            	if(data.pendingcountconfig=="1"){
            		$('.todo-container').hide();
            		$('.pendingcount-container').show();
                    $('#operationgrid').load('pendingCountGrid.jsp?mode=1');
            	}
            });
     ...
     function funTaskConfig(){
			...
			x.open("GET", "getTaskConfig.jsp", true);    
			x.send();  
		}  
				...
				<td width="30%">
					<table  width="100%">
						...
						<tr rowspan="2" id="todolisttd">
							...
							<td hidden="true" class="pendingcount-container"><div id="operationgrid"><jsp:include page="pendingCountGrid.jsp"></jsp:include></div>
						</tr> 
						<tr rowspan="2" id="taskmnmgttd">  
							<td class="task-container">
								...
								<div>
									 <div><jsp:include page="taskManagement.jsp"></jsp:include></div>  
								</div>
								</fieldset>
							</td>
						</tr>   
