...
<td width="20%" >
 ...
 <tr><td align="right"><label class="branch">LA No.</label></td><td align="left"><input type="text" name="rano" id="rano"  placeholder="Press F3 TO Search" readonly="readonly"    onkeydown="getrano(event)" onclick="this.placeholder='' "  style="height:20px;width:70%;" value='<s:property value="rano"/>' ></td></tr>
...
<tr><td  ><label class="branch">Invoice</label></td><td><select name="cmbinvoicing_method" id="cmbinvoicing_method" style="width:70%;"  value='<s:property value="cmbinvoicing_method"/>'  >
	...
	<input type="hidden" id="branchid"  name="branchid" style="text-align: right;"  value='<s:property value="branchid"/>' >
		<input type="hidden" id="blexid"  name="blexid" style="text-align: right;"  value='<s:property value="blexid"/>' >
...
<td width="80%">
  ...
  <tr>
			 <td><div id="rtariffchange"><jsp:include page="ltariffdetails.jsp"></jsp:include></div></td>
		</tr>
