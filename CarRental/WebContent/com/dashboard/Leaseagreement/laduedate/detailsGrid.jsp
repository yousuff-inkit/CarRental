 ...
 aa=0;
                ...
                columns: [
                          ...
                          { text: 'SL#', sortable: false, filterable: false, editable: false,
							...
							/*  { text: 'Due Date', datafield: 'duedate', width: '6%',cellsformat:'dd.MM.yyyy',editable:true,columntype:"datetimeinput", createeditor: function (row, cellvalue, editor, celltext, cellwidth, cellheight) {
							 ...
							 { text: 'Due Date', datafield: 'duedate', width: '6%',cellsformat:'dd.MM.yyyy',editable:false},
							...
							{ text: 'Credit_balance', datafield: 'sum', width: '8%', editable: false,align:'right',cellsalign: 'right',cellsformat:'d2'},
     ...
     /*    $("#detailsgrid").on("cellclick", function (event) 
                ...
                $('#detailsgrid').on('rowdoubleclick', function (event) 
            	  ...
            	  document.getElementById("rentaldoc").value=$('#detailsgrid').jqxGrid('getcellvalue', rowindex1, "doc_no"); 
            	  document.getElementById("fleetno").value=$('#detailsgrid').jqxGrid('getcellvalue', rowindex1, "fleet_no");
                
            	  document.getElementById("branchids").value=$('#detailsgrid').jqxGrid('getcellvalue', rowindex1, "brhid");
            	  $('#duegridDate').val($('#detailsgrid').jqxGrid('getcellvalue', rowindex1, "ddate")) ; 
                  
            	  $('#duegridDate1').val($('#detailsgrid').jqxGrid('getcellvalue', rowindex1, "odate")) ; 
                  
                  
                  $('#timeDue').val($('#detailsgrid').jqxGrid('getcellvalue', rowindex1, "dtime")) ; 
                  
                  
                  $("#detaildiv").load("detailgrid.jsp?rdoc="+$('#detailsgrid').jqxGrid('getcellvalue', rowindex1, "doc_no"));
