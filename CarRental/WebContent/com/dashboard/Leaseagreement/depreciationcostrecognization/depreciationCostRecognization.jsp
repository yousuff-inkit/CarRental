	  	...
	  	$.messager.confirm('Confirm', 'Do you want to Post?', function(r){
  	 		if (r){
  			    ...
  			    for (i = 0; i < selectedrows.length; i++) {
					...
					tempdocs1=tempdocs+",";
					tempdeprtotal=parseFloat(tempdeprtotal)+parseFloat($('#depreciationCostRecognizationGridID').jqxGrid('getcellvalue',selectedrows[i],'deprcamount'));
	    	...
	    	/* Grid Saving */
			 ...
			 for(var i=0 ; i < selectedrows.length ; i++){
				 ...
				 newTextBox = $(document.createElement("input"))
					...
					var depramount=$('#depreciationCostRecognizationGridID').jqxGrid('getcellvalue',selectedrows[i],'deprcamount');
