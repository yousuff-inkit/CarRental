...
sqltest="";
	...
	if(mode.equalsIgnoreCase("1")){
		...
		" select agmt.doc_no docno,agmt.voc_no vocno,agmt.brhid,if(agmt.expirydate is not null,expirydate,date_add(outdate, interval (case when per_name=1 then per_value*12 when per_name=2 then per_value else 0 end) month)) expdate,"+
