<%@page import="com.dashboard.leaseagreement.leaseextreq.*"%>
     <%  ClsLeaseExtReqDAO leasedao= new ClsLeaseExtReqDAO(); %>
<%String docno=request.getParameter("docno")==null?"":request.getParameter("docno");
String pytstartdate=request.getParameter("pytstartdate")==null?"":request.getParameter("pytstartdate");
String pytadvance=request.getParameter("pytadvance")==null?"":request.getParameter("pytadvance").replace(",","").trim();
String pytbalance=request.getParameter("pytbalance")==null?"":request.getParameter("pytbalance").replace(",","").trim();
