                ...
                columnsresize: true,
			         ...
			         columns: [
							...
							{ text: 'Mob NO', datafield: 'per_mob', width: '10%'},
							 ...
							 { text: 'Rental Type', datafield: 'rentaltype', width: '7%',hidden:true },
							{ text: 'Out Date', datafield: 'outdate', width: '6%',cellsformat:'dd.MM.yyyy',hidden:true},
							
							 { text: 'Out Time', datafield: 'outtime', width: '5%' },
							
							 { text: 'Due Date', datafield: 'deldate', width: '6%',cellsformat:'dd.MM.yyyy'},
								
							 { text: 'DueTime', datafield: 'deltime', width: '5%' },
							 { text: 'Ref No', datafield: 'refnos', width: '6%'},
								{ text: 'Manual RA', datafield: 'mrno', width: '6%',hidden:true},
