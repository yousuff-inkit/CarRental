 ...
 aa=0;
	  ...
	  aa=1;
        ...
        $(document).ready(function () { 
            ...
            { 
                ...
                columns: [
							...
							{ text: 'LA NO', datafield: 'voc_no', width: '6%',cellclassname: cellclassname},
							{ text: 'Fleet', datafield: 'fleet_no', width: '6%',cellclassname: cellclassname },
							{ text: 'Fleet Name', datafield: 'vehdetails', width: '18%' ,cellclassname: cellclassname},
							...
							{ text: 'Mob NO', datafield: 'per_mob', width: '10%',cellclassname: cellclassname},
							 ...
							 { text: 'Rental Type', datafield: 'rentaltype', width: '6%' ,cellclassname: cellclassname,hidden:true},
         	...
         	if(parseInt($('#detailsgrid').jqxGrid('getcellvalue', rentalrow, "radvc"))==1)
           {
          	...
          	document.getElementById("advchkval").value=1;
          	document.getElementById("hidadvance_chk").value=1;
           	...
           	document.getElementById("advchkval").value=0;
           	document.getElementById("hidadvance_chk").value=0;
           	
           	}
         	 
         	
         	 document.getElementById("cmbinvoicing_method").value=$('#detailsgrid').jqxGrid('getcellvalue', rentalrow, "rinvtype");
       ...
       //newly added  	 
			...
			var brexid=	$('#detailsgrid').jqxGrid('getcellvalue', rentalrow, "refno");  
		...
		var gid=$('#detailsgrid').jqxGrid('getcellvalue', rentalrow, "gid");
			...
			//   $("#tariff").load("tariff.jsp?branch="+branchname+"&tdocno="+docno+"&revehGroup="+gid);
			  ...
			  $("#rtariff").load("ltariffdetails.jsp?rdocno="+masterdoc+"&refno="+brexid);  
