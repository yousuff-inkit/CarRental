        		  ...
        		  if(advchkval!=hidadvance_chk)
     			  {
          		  ...
          		  var invoice=document.getElementById("cmbinvoicing_method").value;
          	                   //alert("invval=="+invval+"cmbinvoicing_method=="+invoice)
		            		  if(invval!=invoice)
	            			  {
...
function disiem()
{
	...
	/*   $("#tariff").load("tariff.jsp?branch="+0+"&tdocno="+0+"&revehGroup="+0);
	  ...
	  $("#rtariff").load("ltariffdetails.jsp?rdocno="+aa);  */
  ...
  <tr><td align="right"><label class="branch">Fleet</label></td><td align="left"><input type="text" name="fleet" id="fleet"  placeholder="Press F3 TO Search" readonly="readonly"    onkeydown="getfleet(event)" onclick="this.placeholder='' "  style="height:20px;width:70%;" value='<s:property value="fleet"/>' ></td></tr> 
   <tr><td align="right"><label class="branch">Group</label></td><td align="left"><input type="text" name="group" id="group" placeholder="Press F3 TO Search" readonly="readonly" onkeydown="getgroup(event)" onclick="this.placeholder='' " style="height:20px;width:70%;" value='<s:property value="group"/>' ></td></tr> 
    <tr><td align="right"><label class="branch">Brand</label></td><td align="left"><input type="text" name="brand" id="brand" placeholder="Press F3 TO Search" readonly="readonly" onkeydown="getbrand(event)" onclick="this.placeholder='' " style="height:20px;width:70%;" value='<s:property value="brand"/>' ></td></tr> 
     ...
     <tr><td align="right"><label class="branch" hidden='true'>Type</label></td><td align="left">
       <select id="rentaltype" name="rentaltype" hidden='true' style="height:20px;width:70%;" value='<s:property value="rentaltype"/>'>
    <option value="Daily">Daily</option>
	 ...
	 <tr><td  ><label class="branch">Advance</label></td><td><input type="checkbox" id="advance_chk"  name="advance_chk" onchange="funchangeadv();"  >
	  <input type="hidden" id="hidadvance_chk" name="hidadvance_chk" value='<s:property value="hidadvance_chk"/>'/></td></tr>

<tr><td  ><label class="branch">Invoice</label></td><td><select name="cmbinvoicing_method" id="cmbinvoicing_method" style="width:70%;"  value='<s:property value="cmbinvoicing_method"/>'  >
     <option value="">--Select--</option>
      <option value="1">Month End</option>
      <option value="2">Period</option></select>
      <input type="hidden" id="hidcmbinvoicing_method" name="hidcmbinvoicing_method" value='<s:property value="hidcmbinvoicing_method"/>'/></td></tr>
...
<td width="80%">
  ...
  <tr>
			 <td><div id="rtariff"><jsp:include page="ltariffdetails.jsp"></jsp:include></div></td>
		</tr>
