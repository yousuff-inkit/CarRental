...
java.sql.Date sqlprocessdate=null;
	...
	for(j=0;j<temp.length;j++){       
	    ...
	    upsql="update  gl_lagmt  set salid='" +salesman_docno+ "'  where doc_no='"+temp[j]+"' ";
		   System.out.println("----upsql-1--"+upsql);
		     val= stmt.executeUpdate(upsql);
		    
			    
		   upsql="insert into gl_blsa(rano, salid, userid,edate)values('"+temp[j]+"','"+salesman_docno+"','"+session.getAttribute("USERID").toString()+"',now()) ";
