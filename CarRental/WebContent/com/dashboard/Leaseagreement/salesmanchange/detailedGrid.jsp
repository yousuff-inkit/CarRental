                ...
                editable:false,
			         ...
			         columns: [
			                   { text: 'SL#', sortable: false, filterable: false, editable: false,   
								...
								{ text: 'LA NO', datafield: 'ra_no', width: '6%' },   //voc no
								
								{ text: 'Fleet', datafield: 'fleet', width: '6%' },
								{ text: 'Fleet Name', datafield: 'fleetname', width: '13%' },
								{ text: 'Reg NO', datafield: 'regno', width: '8%' },
								{ text: 'Contract Fleet', datafield: 'contractfleet', width: '8%',hidden:true },
								{ text: 'Contract Reg No', datafield: 'contractregno', width: '8%',hidden:true },
								...
								{ text: 'Mob NO', datafield: 'mobno', width: '10%'},
							     ...
							     { text: 'Manual LA', datafield: 'manualra', width: '6%'},
