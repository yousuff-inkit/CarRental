...
<script type="text/javascript">
        ...
        $(document).ready(function () { 
            ...
            $("#jqxBalance").jqxGrid(
            {
                ...
                columns: [ 
                			{ text: 'SL#', sortable: false, filterable: false, editable: false,groupable: false, draggable: false, resizable: false,datafield: 'sl', columntype: 'number', width: '5%',cellsrenderer: function (row, column, value) {
							...
							{ text: 'Pay Type', datafield: 'paytype', width: '10%' },
