<%@page import="com.dashboard.consolidated.client.ClsClientDAO" %>
            ...
            $("#client").jqxGrid(
            {
               ...
               showfilterrow: true, 
                ...
                columns: [
					...
					{ text: 'Client Code', groupable: true, datafield: 'cldocno', width: '5%' },
					{ text: 'Account No', groupable: false, datafield: 'account', width: '5%' },
					{ text: 'Account Group', groupable: true, datafield: 'acc_group', width: '8%' },
					{ text: 'Name', groupable: true, datafield: 'refname', width: '20%' },
					{ text: 'Company', datafield: 'compname', width: '13%'}, 
          	        { text: 'Branch', datafield: 'branch', width: '12%'},
					{ text: 'Category', groupable: true, datafield: 'category', width: '10%' },
					{ text: 'Advance', groupable: true, datafield: 'advance', width: '4%' },
					...
					{ text: 'Credit Limit', groupable: false, datafield: 'credit', width: '5%'},
					{ text: 'Card Type', groupable: false, datafield: 'ctype', width: '6%' },
					{ text: 'Card No', groupable: false, datafield: 'cno', width: '6%' },
					{ text: 'Card Expiary', groupable: false, datafield: 'expdate', width: '6%' },
					{ text: 'Driver Name', groupable: false, datafield: 'drname', width: '15%' },
					{ text: 'Credit Period', groupable: false, datafield: 'period', width: '6%' },
					{ text: 'Date', groupable: false, datafield: 'cldate',cellsformat:'dd.MM.yyyy', width: '6%' },
