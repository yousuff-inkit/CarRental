 ...
 $(document).ready(function(){
        ...
        $("body").prepend("<div id='PleaseWait' style='display: none;position:absolute; z-index: 1;top:200px;right:750px;'><img src='../../../../icons/31load.gif'/></div>");
    	   ...
    	   function loadleavelist(){
    		   ...
    		   $('#leavediv').load('leavelistgrid.jsp?empdocno='+empdocno+'&dbname='+dbname+'&id='+1);
    	   }
    	   
    	   function loaddoclist(){
    		   var empdocno = $("#empdocno").val();
    		   var dbname = $("#dbname").val();
    		   $('#expirydiv').load('expirydetailsgrid.jsp?empdocno='+empdocno+'&dbname='+dbname+'&check=1');  
    	   }
   ...
   function funStatusLoad(){
		  ...
		  $('#statusupdatediv').load('statusupdategrid.jsp?check=1&isrtaavail='+rtaavailable+'&dbname='+dbname);
	}  
   ...
   function saveRtaStatus(){
		...
		x.open("GET","savertastatusupdate.jsp?status="+rtastatusdocno+"&docno="+empdocno+"&description="+rtastatusdesc+"&statuscode="+rtastatuscode+"&isrtaavail="+rtaavailable+'&dbname='+dbname,true);
		x.send();
   }
