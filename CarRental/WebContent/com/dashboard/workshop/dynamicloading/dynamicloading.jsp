...
<script type="text/javascript"> 
    ...
    function funload() {
        ...
        $('#jqxFleetGrid').jqxGrid('refresh');
        $("#dynloadDiv").load("dynamicloadingGrid.jsp?fromdate=" + fromdate + "&todate=" + todate + "&formname=" + encodeURIComponent($("#formname").val()) + "&id=1");
    }
    ...
    function getDatafields(formname) {
        ...
        x.open("GET", "getDatafields.jsp?formname=" + encodeURIComponent(formname), false);
        x.send();
        return items;
    }
