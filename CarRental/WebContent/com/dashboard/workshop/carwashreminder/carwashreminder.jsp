...
$(document).ready(function () {
	...
	// $("#podate").jqxDateTimeInput({ width: '125px', height: '15px',formatString:"dd.MM.yyyy",value:null});
	 ...
	 $('#vehicleToWindow').jqxWindow({width: '51%', height: '58%',  maxHeight: '60%' ,maxWidth: '51%' , title: 'Vehicle Search',position: { x: 300, y: 87 } , theme: 'energyblue', showCloseButton: true, keyboardCloseKey: 27});
...
{	
    ...
    $("#vehmaintenancediv").load("maintenanceGrid.jsp?todate="+todate+"&id=1");
	...
	function funExportBtn(){
		$("#vehmaintenancediv").excelexportjs({ 
    		containerid: "vehmaintenancediv",       
    		datatype: 'json', 
    		dataset: null, 
    		gridId: "maintenanceGrid",     
    		columns: getColumns("maintenanceGrid") ,   
    		worksheetName:" Car Wash Reminder " 
			});  
	}
...
<table width="100%">
	...
	<td width="23%" align="center">
	 ...
	 <tr>
	   <td align="right"><label class="branch">Upto Date</label></td>
