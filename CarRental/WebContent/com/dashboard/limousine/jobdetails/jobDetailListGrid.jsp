...
$(document).ready(function () { 
       ...
       /*      alert("here");
                ...
                columns: [
							...
							{ text: 'End Date',datafield:'closedate',cellsformat:'dd.MM.yyyy',width:'7%'},
							{ text: 'End Time',datafield: 'closetime',cellsformat:'HH:mm',width:'7%'},
							{ text: 'End Km',datafield:'closekm',cellsformat:'d',width:'7%'},
