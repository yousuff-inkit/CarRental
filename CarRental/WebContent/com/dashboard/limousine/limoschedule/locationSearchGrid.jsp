        ...
        $(document).ready(function () { 	
            ...
            $("#locationSearch").jqxGrid(
            {
       		...
       		$('#locationSearch').on('rowdoubleclick', function (event) {
				...
				$("#"+labelid).val($('#locationSearch').jqxGrid('getcellvalue',rowBoundIndex,'location'));
       			(labelid==='dropoffloc')?$('#hiddropoffloc').val($('#locationSearch').jqxGrid('getcellvalue',rowBoundIndex,'doc_no')):$('#hidpickuploc').val($('#locationSearch').jqxGrid('getcellvalue',rowBoundIndex,'doc_no'));
