...
$(document).ready(function () { 
       ...
       /*      alert("here");
                ...
                columns: [
							...
							{ text: 'Tariff',datafield:'tariff',width:'8%',cellsformat:'d2',columngroup:'charges',align:'right',cellsalign:'right'},
							{ text: 'Night Tariff',datafield:'nighttariff',width:'8%',cellsformat:'d2',columngroup:'charges',align:'right',cellsalign:'right'},
							{ text: 'Waiting Charges',datafield:'waitingchg',width:'8%',cellsformat:'d2',columngroup:'charges',align:'right',cellsalign:'right'},
							{ text: 'Excess Km Rate',datafield:'excesskmchg',width:'8%',cellsformat:'d2',columngroup:'charges',align:'right',cellsalign:'right'},
							{ text: 'Excess Hr Rate',datafield:'excesshrchg',width:'8%',cellsformat:'d2',columngroup:'charges',align:'right',cellsalign:'right'},
							{ text: 'Excess Night Hr Rate',datafield:'excessnighthrchg',width:'8%',cellsformat:'d2',columngroup:'charges',align:'right',cellsalign:'right'},
							...
							{ text: 'Baby Seat',datafield:'boquechg',width:'8%',cellsformat:'d2',columngroup:'charges',align:'right',cellsalign:'right',editable:false},
