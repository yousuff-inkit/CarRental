...
<title>GatewayERP(i)</title>
	...
	function getdata(clname,mob,lcno,clientid,driverid,nation,dob,clientaccount,check){	
		 $("#clientsearchdiv").load('clientsearchgrid.jsp?clname='+clname.replace(/ /g, "%20")+'&mob='+mob+'&lcno='+lcno+'&clientid='+clientid+'&driverid='+driverid.replace(/ /g, "%20")+'&nation='+nation.replace(/ /g, "%20")+'&dob='+dob+'&clientaccount='+clientaccount+'&check='+check);
	}
...
<table width="100%">
  <tr>
    <td width="6%"  align="right"><label class="branch" style="background-color:transparent;">Client#</label></td>
    <td><input type="text" name="txtclientid" id="txtclientid" style="width:95%" value='<s:property value="txtclientid"/>'></td>
    <td width="4%" align="right"><label class="branch" style="background-color:transparent;">Name</label></td>
    <td colspan="3"><input type="text" name="txtclientname" id="txtclientname" style="width:100%" value='<s:property value="txtclientname"/>'></td>
    <td align="right"><label class="branch" style="background-color:transparent;">Account</label></td>
  ...
  <tr>
    <td align="right"><label class="branch" style="background-color:transparent;">Licence#</label></td>
    <td width="15%"><input type="text" name="txtlicence" id="txtlicence" style="width:95%" value='<s:property value="txtlicence"/>'></td>
    <td width="4%" align="right"><label class="branch" style="background-color:transparent;">Mob</label></td>
    <td width="17%"><input type="text" name="txtmobile" id="txtmobile" style="width:95%" value='<s:property value="txtmobile"/>'></td>
    <td width="5%" align="right"><label class="branch" style="background-color:transparent;">ID#</label></td>
    ...
    <td width="8%" align="right"><label class="branch" style="background-color:transparent;">Nationality</label></td>
    <td width="14%"><input type="text" id="txtnation" name="txtnation" style="width:100%" value='<s:property value="txtnation"/>'></td>
    <td width="6%" align="right"><label class="branch" style="background-color:transparent;">DOB</label></td>
  ...
  <tr>
    <td colspan="10"><div id="clientsearchdiv"><jsp:include  page="clientsearchgrid.jsp"></jsp:include></div></td>
  </tr>
</table>
  </div>
</body>
