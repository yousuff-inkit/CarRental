...
String msg="",rowno="";
 ...
 System.out.println("======aa==== ");		
		...
		System.out.println("======starttime==== "+starttime+" "+startdate+" "+jobno+" "+regno);
// 		System.out.println("======aa==== "+fleet+":"+regno+":"+mode+":"+del_KM+":"+de_Fuel+":"+deldateOut+":"+deltimeOut);
		...
		Statement stmt=conn.createStatement();
				...
				String sqldid = "SELECT dr_id FROM gl_drdetails WHERE NAME like'%"+dname+"%'";
				ResultSet did = stmt.executeQuery(sqldid);
				while(did.next()){
					driverid=did.getInt("dr_id")+"";
				}
...
// 	    		System.out.println("insertsql=="+sql);
				String systemnote="Started Trip of "+ bookdocno +" - "+jobname+" - "+ sqlstartdate+" - "+starttime+" - "+startkm+" - "+slocation+" - by "+username;
