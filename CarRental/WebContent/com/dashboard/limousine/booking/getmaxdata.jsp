...
String msg="",rowno="",value="",bstatus="";;
	try{
 System.out.println("======in maxdata==== ");		
		...
		String jobno=request.getParameter("jobno")==null?"0":request.getParameter("jobno").trim(); 
...
// 		System.out.println("======aa==== "+fleet+":"+regno+":"+mode+":"+del_KM+":"+de_Fuel+":"+deldateOut+":"+deltimeOut);
		...
		Statement stmt=conn.createStatement();
			...
			System.out.println("STAT="+bstatus);
	...
	response.getWriter().write(value+"::"+bstatus);
