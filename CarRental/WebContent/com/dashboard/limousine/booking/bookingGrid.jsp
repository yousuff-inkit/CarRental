...
$(document).ready(function () {    
        var source =
           ...
           datafields: [
                    	...
                    	{name : 'bookingno',type:'string'},
                     	...
                     	{name : 'remarks',type:'string'}, 
                      	...
                      	{name : 'status',type:'string'},
                       	...
                       	{name : 'bookuser',type:'string'},
                       	{name : 'brhid', type:'string'},
                       	{name : 'vocno', type:'number'},
                       	{name : 'multivehassign', type:'string'},
                       	{name : 'vesselno', type:'string'},
                       	{name : 'vesselname', type:'string'},
                       	{name : 'description', type:'string'},
                       	{name : 'jobdescription', type:'string'},
                       	{name : 'isassignconfirm', type:'string'},
                       	{name : 'flightdetails', type:'string'},
                       	{name : 'hoteldetails', type:'string'},
                       	{name : 'allguest', type:'string'},
                       	{name : 'babyseat', type:'number'},
			...
			var cellclassname = function (row, column, value, data) {
          		...
          		else if(data.status=="Job Assigned" && data.isassignconfirm!="0"){
				...
				else if(data.status=="Job Closed"){
					return "jobclosedClass";
				}
				else if(data.status=="Invoiced"){
					return "invoicedClass";
				}
       ...
       var multiassignrowcell = function (row, column, value, data) {
    	   if (data.multivehassign==1) {                     
   		   		return "redClass";
     		};
       };
          var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#jqxbookGrid").jqxGrid(
            {
               ...
               columns: [
							{ text: 'SL#', cellclassname:multiassignrowcell,sortable: false, filterable: false, editable: false,
							...
							{ text: 'Booking No',datafield:'bookingno',width:'8%',cellclassname:cellclassname},
							...
							{ text: 'Flight',datafield:'flightdetails',width:'5%',cellclassname:cellclassname},
							...
							{ text: 'Group',datafield:'groupname',width:'6%',cellclassname:cellclassname},
							...
							{ text: 'Passengers',datafield:'allguest',width:'8%',cellclassname:cellclassname},
							...
							{ text: 'Voc No', datafield: 'vocno',width:'4%',cellclassname:cellclassname},                  
							...
							{ text: 'V. No',datafield:'vesselno',width:'5%',hidden:!isTariffHiddenbook,cellclassname:cellclassname},
							{ text: 'V. Name',datafield:'vesselname',hidden:!isTariffHiddenbook,width:'8%',cellclassname:cellclassname},
							{ text: 'Other Details',datafield:'otherdetails',width:'10%',cellclassname:cellclassname},
							{ text: 'Job Description',datafield:'jobdescription',width:'10%',cellclassname:cellclassname},
							...
							{ text: 'Doc No', datafield: 'docno',width:'4%',cellclassname:cellclassname,hidden:true},                  
							...
							{ text: 'Brand',datafield:'brand',width:'8%',cellclassname:cellclassname,hidden:false},
							{ text: 'Model',datafield:'model',width:'8%',cellclassname:cellclassname,hidden:false},
							...
							{ text: 'Booked User',datafield:'bookuser',width:'10%',cellclassname:cellclassname},
							...
							{ text: 'Tariff',datafield:'tariff',width:'8%',cellclassname:cellclassname,cellsformat:'d2',cellsalign:'right',align:'right'},
							...
							{ text: 'Baby Seat',datafield:'babyseat',width:'4%',cellclassname:cellclassname,cellsformat:'d2',cellsalign:'right',align:'right'},
            ...
            $("#jqxbookGrid").on("celldoubleclick", function (event)      
            		{
            		    ...
            		    $("#jqxbookGrid").jqxGrid('clearselection');
            		    $("#jqxbookGrid").jqxGrid('selectrow', rowBoundIndex);
            		    console.log("Entered");
            		    ...
            		    if($('#jqxbookGrid').jqxGrid('getcellvalue',rowBoundIndex,'multivehassign')==1 && $('#jqxbookGrid').jqxGrid('getcellvalue',rowBoundIndex,'bstatus')<=6){
            		    	$('#doubleclickselecteddoc').text($('#jqxbookGrid').jqxGrid('getcellvalue',rowBoundIndex,'bookingno')+' - '+$('#jqxbookGrid').jqxGrid('getcellvalue',rowBoundIndex,'job')+' - '+$('#jqxbookGrid').jqxGrid('getcellvalue',rowBoundIndex,'client'));
            		    	$('#modalmultiassign').modal("toggle");
                 		    $('#multiassigndiv').load('assignmultivehgrid.jsp?docno='+$('#jqxbookGrid').jqxGrid('getcellvalue',rowBoundIndex,'docno')+'&job='+$('#jqxbookGrid').jqxGrid('getcellvalue',rowBoundIndex,'job'));
            		    }
