...
$(document).ready(function () {
    ...
    $("#limoInvoiceGrid").jqxGrid(
    {
        ...
        columns: [
						...
						{text:'Group',datafield:'grp',width:'10%'},
						{text:'Guestno',datafield:'guestno',width:'5%',hidden:true},
						{text:'V. No.',datafield:'vesselno',width:'5%',hidden:!isTariffHideinv},
						{text:'V. Name',datafield:'vesselname',width:'5%',hidden:!isTariffHideinv},
						{text:'Job Type',datafield:'jobtype',width:'6%'},
						{text:'Trip Type',datafield:'triptype',width:'8%'},
						{text:'Taxable',datafield:'taxable',width:'8%'},
