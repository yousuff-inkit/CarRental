	...
	if(temp1!='NA')
{
		// alert("===="+temp1);
		if(id=="1"){
			vehdatas= '<%=showDAO.subDetails(fromdate,todate,id,chkincrecv,fleetno)%>';
		}
...
$(document).ready(function () {
    ...
    $('#vehdetails').on('rowdoubleclick', function (event) 
    		{ 
    		    ...
    		    $("#fleetdiv").load("detailsgrid.jsp?fleetno="+fleetno+"&relodestatus="+relodestatus+"&froms="+'<%=fromdate%>'+"&tos="+'<%=todate%>'+"&chkincrecv="+'<%=chkincrecv%>');
    		});
