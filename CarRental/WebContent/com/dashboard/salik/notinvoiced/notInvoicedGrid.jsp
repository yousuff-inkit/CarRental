...
<%String branchval = request.getParameter("branchval")==null?"0":request.getParameter("branchval").trim();
 ...
 var temp='<%=branchval%>';
 	...
 	if(temp!='NA'){ 
 		data1='<%=salikdao.notInvoicedGridLoading(branchval,fromDate, toDate, cldocno, rentalType, agmtNo,type,cmbcategory,id,saliktype)%>';
    }
...
{ text: 'Sr. No.',datafield: '',columntype:'number', width: '5%', cellsrenderer: function (row, column, value) {
    return "<center><div style='margin:4px;'>" + (value + 1) + "</div></center>";
						...
						{ text: 'Type', datafield: 'saliktype', width: '7%' },
						...
						{ text: 'Salik Date', datafield: 'sal_date', width: '7%',cellsformat:'dd.MM.yyyy' },
