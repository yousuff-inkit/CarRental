...
<%@page import="com.dashboard.importdata.vendor.ClsIMVendorDAO"%>
...
<% 
 ...
 $(document).ready(function () { 	
 		...
 		data='<%=DAO.vendorListGridLoading()%>';   
...
columnsresize:true,
 columns: [
					...
					{ text: 'Doc_no', datafield: 'id', editable: false , width: '3%' },
					{ text: 'Cldocno', datafield: 'cldocno', editable: false , width: '3%' },
					{ text: 'Serial No', datafield: 'srno', editable: false , width: '3%' },
					{ text: 'Vendor',  datafield: 'refname', editable: false , width: '10%' },
					...
					{ text: 'Area Name', datafield: 'areaname',   width: '10%'    },
					{ text: 'Area Id', datafield: 'areaid',   width: '4%'    },
					{ text: 'Doc_no', datafield: 'doc_no',   width: '4%'    },
					{ text: 'Atype', datafield: 'atype',   width: '4%'  },
					...
					{ text: 'Mail2', datafield: 'mail2',   width: '10%'  },
					...
					{ text: 'Curid', datafield: 'curid',   width: '5%'    },
					...
					{ text: 'Salid', datafield: 'salid',   width: '5%'    },
					{ text: 'Agent', datafield: 'agent',   width: '5%'    },
					{ text: 'Catid', datafield: 'catid',   width: '5%'    },
					{ text: 'Brhid', datafield: 'brhid',   width: '5%'    },
					{ text: 'Cmpid', datafield: 'cmpid',   width: '5%'    },
					...
					{ text: 'Contact Person No', datafield: 'per_tel',   width: '6%'    },
					...
					{ text: 'Old Docno', datafield: 'olddocno',   width: '6%'    },
