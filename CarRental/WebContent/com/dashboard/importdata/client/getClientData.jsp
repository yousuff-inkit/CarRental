...
<%	
	...
	try{
		...
		if(type.equalsIgnoreCase("Salesman")){
			 strSql = "select doc_no fieldid, sal_name field from my_salm where status=3"; 
		}else if(type.equalsIgnoreCase("Category")){
			strSql = "select doc_no fieldid, cat_name field from my_clcatm where status=3"; 
		}else if(type.equalsIgnoreCase("Area")){
			strSql = "select doc_no fieldid,area field from my_area";
		}else{}  
