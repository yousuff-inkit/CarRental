<%@page import="com.dashboard.vehiclepurchase.vehpurchaseemi.*"%>
...
String branchval = request.getParameter("barchval")==null?"NA":request.getParameter("barchval");
 ...
 ClsVehPurchaseEMIDAO prchdao= new ClsVehPurchaseEMIDAO();
 %>
<style type="text/css">
  .opnClass
  {
   ...
   var temp='<%=val%>';
	  	...
	  	if(temp=="veh"){ 
	  	 ...
	  	 <%-- summdata ='<%=prchdao.searchexceldetails(branchval,type,findoc,dealno, upToDate)%>'; --%>
	  	  ...
	  	  datass ='<%=prchdao.searchdetails1(branchval,type,findoc,dealno, upToDate,fleetno)%>';  
	  	}
        ...
        $(document).ready(function () {
            ...
            $("#vehicleFleetGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Branch', datafield: 'branchname',editable:false, width: '15%' },
