...
<script type="text/javascript">
 ...
 var check='<%=check%>';
	...
	{ 
	 ...
	 var type="postingcash";
	 if(temp!='NA')
		{ 
		 var postingcashurl='getallGridLoadingData.jsp?branchval='+branchval+'&fromDate='+fromDate+'&toDate='+toDate+'&payType='+payType+'&check='+check+'&type='+type;
		}
