...
// alert(data);
	...
	$(document).ready(function () {
	    ...
	    if($('#txtbipostingcardcomm').val().trim()=="0"){
	    	if(temp1=='2' && $('#hidcommaccselection').val().trim()=="1")
	    		{
	    	
		    	   $("#postingJV").jqxGrid('setcellvalue', 1, "docno", $('#txtcmdocno').val());
		   	    $("#postingJV").jqxGrid('setcellvalue', 1, "type", $('#txtcmatype').val());
		   	    $("#postingJV").jqxGrid('setcellvalue', 1, "accounts", $('#txtcmaccid').val());
		   	    $("#postingJV").jqxGrid('setcellvalue', 1, "accountname1", $('#txtcmaccname').val());
		   	    $("#postingJV").jqxGrid('setcellvalue', 1, "debit", commission1);
		   	    if(!isNaN(commission1)){
		   		    if($('#txtcmcurtype').val().trim()=="M"){
		   		    		var commissionbaseamount1 = parseFloat(parseFloat(commission1) * parseFloat($('#txtcmrate').val())).toFixed(2);
		   	    ...
		   	    $("#postingJV").jqxGrid('setcellvalue', 1, "currencyid", $('#txtcmcurid').val());
		   	    $("#postingJV").jqxGrid('setcellvalue', 1, "currencytype", $('#txtcmtype').val());
		   	    $("#postingJV").jqxGrid('setcellvalue', 1, "rate", $('#txtcmrate').val());
	     ...
	     var r=2;
	    var checkAp=$('#postingJV').jqxGrid('getcellvalue', 1, "type");
		    if(checkAp!="AP"){
