<%@page import="com.dashboard.accounts.trialbalancev2.ClsTrialBalance"%>
        ...
        $(document).ready(function () {
            ...
            $("#trialBalance").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Account', datafield: 'account_name', cellclassname: cellclassname, align: 'center',  aggregates: ['sum1'],aggregatesrenderer:rendererstring1 },
							{ text: 'Cur', datafield: 'code', cellclassname: cellclassname, cellsformat: 'd2',align: 'center', width: '3%' },
							{ text: 'Rate', datafield: 'rate', cellclassname: cellclassname,cellsformat: 'd2', align: 'center', width: '4%' },
