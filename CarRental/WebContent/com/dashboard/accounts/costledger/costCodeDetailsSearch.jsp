...
#search {
	...
	$(document).ready(function () {
 	...
 	function loadSearch() {
		...
		getdata(type,costCode,costCodeName,RegNo,check,brhid);
	}
 	
	function getdata(type,costCode,costCodeName,RegNo,check,brhid){
		 $("#refreshdiv").load('costCodeDetailsSearchGrid.jsp?type='+type+'&costCode='+costCode+'&costCodeName='+costCodeName.replace(/ /g, "%20")+'&RegNo='+RegNo.replace(/ /g, "%20")+'&check='+check+'&brhid='+brhid);
		}
