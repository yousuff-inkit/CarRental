		...
		function funExportBtn(){
	     ...
	     var searchdetails=document.getElementById("searchdetails").value;
	       ...
	       if(grpby1=="" && distribution=="" )
    	   {
	    	   ...
	    	   $("#maingrid").excelexportjs({
					containerid: "maingrid",   
					datatype: 'json',
					dataset: null,
					gridId: "alllistgrid",
					columns: getColumns("alllistgrid") ,   
					worksheetName:"Maintenance Analysis"  
				});
    	   ...
    	   $("#maingrids").excelexportjs({
				containerid: "maingrids",   
				datatype: 'json',
				dataset: null,
				gridId: "groupgrid",
				columns: getColumns("groupgrid") ,   
				worksheetName:"Maintenance Analysis"  
			});
