...
*/
    ...
    $("#vehUtilizeGrid").jqxGrid(
    {
        ...
        columns: [
					...
					{ text: 'Rental Idle', datafield: 'rentalidle', width: '7%'  ,cellclassname: cellclassname ,align:'right',cellsalign:'right',cellsformat:'f2',aggregates: ['sum'],aggregatesrenderer:rendererstring},
