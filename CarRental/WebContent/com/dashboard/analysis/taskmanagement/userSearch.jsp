...
#jqxInput{
  ...
  <script type="text/javascript">    
            $(document).ready(function ()   {
                ...
                $("#jqxInputUser").jqxInput({ source: dataAdapter, displayMember: "user", valueMember: "doc_no", items: 20 ,width: '100%', height: 32,placeHolder: 'Please Enter User'});
         ...
         <input id="jqxInputUser"  class="form-control" />