...
<%                         	
String cldocnos = request.getParameter("cldocno")==null || request.getParameter("cldocno").equals("")?"0":request.getParameter("cldocno");
...
try{
	...
	String sql1 = "SELECT refname, per_mob, cldocno FROM my_acbook WHERE cldocno="+cldocnos+" AND dtype='CRM'";  
