 ...
 <nav class="navbar navbar-light bg-light">
  <div class="container-fluid">
    <form class="d-flex" autocomplete="off">  
      <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" id="txtsearch" onkeydown="searchUsers();">
...
<!--header -->
      <div class="header">
        <div class="img-text">
          <div class="user-img">
         <!--  <img class="dp" src="icons/whatsapp_dp.png?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt=""> -->
         <img src = "icons/person-circle.svg" alt=""/></img>
        </div>
          <h6>&nbsp;</h6>  
        </div>
...
<!--chat-container -->
      <div class="chat-container">
        ...
        <div class="message-box friend-message">
         ...
         <div class="message-box my-message">
		    ...
		    <span class="sent-time">12:34 PM</span>
		      <img src="http://localhost:8088/Qudra/attachment/WAM/WAM-50-1.png" alt="Image">
		    </div>
       </div>
  ...
  <div class="message-body">  
    ...
    <span class="message-time">12:32 PM</span>
      ...
      <div class="chatbox-input">
        <!--<button id="btnemoji" name="btnemoji"><i class="fa-regular fa-face-grin"></i></button>-->
        <button id="btnattach" name="btnattach"><i class="fa fa-paperclip" aria-hidden="true"></i></button>
        <input type="text" id="txtmessage" name="txtmessage" placeholder="Type a message" onchange="funcheckInput();">
        <button id="btnvoice" name="btnvoice"><i class="fa fa-microphone" aria-hidden="true"></i></button> 
        <button id="btnsend" name="btnsend"><i class="fa fa-paper-plane"></i></button>        
      </div>    
    </div>
  ...
  <script type="text/javascript">
	  			...
	  			if (x.readyState == 4 && x.status == 200) {
	  				...
	  				for(var i = 0; i < users.length; i++) {  
						...
						if(user.chat=="F" && user.mediaid!=""){  
							...
							//fieldshtml+='<div class="img-msg"><img id="frommedia' + j + '" src = "icons/file-image.svg" alt="" data-value="' + user.mediaid + '"></img>&emsp;<span>'+user.time+'</span></div>'; 
						    ...
						    (function(k) {
						        ...
						        if (imageElement) {
						            ...
						            imageElement.addEventListener('click', function() {
						                ...
						                funDownloadMedia(mediaId, imageElement)   
						            });
						        }
						    })(k);
						}
	...
	function funDownloadMedia(mediaId, imageElement){
		$.ajax({
            type: "POST",
