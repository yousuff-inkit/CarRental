...
<%
	...
	try{
		...
		conn = connDAO.getMyConnection();
	 	...
	 	String filetype="";
		String strSql = "select substring_index(path,'.',-1) filetype from my_fileattach where doc_no='"+docNo+"' and dtype='ALW'";
		...
		if(filetype.equalsIgnoreCase("csv")) {
			...
			ClsAdditionandDeductionDAO emp = new ClsAdditionandDeductionDAO();
			val=emp.ExcelImport(docNo);
		}
