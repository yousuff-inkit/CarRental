...
<script type="text/javascript">
 ...
 var id='<%=id%>';
	if(id=="1") {
		...
		descdata='<%=DAO.reloadgridSearchexcel(id)%>';
	} 
	else
		{
		descdata;
	...
	$(document).ready(function () { 	
            ...
            $("#descdetailsGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Emp. Name', datafield: 'empname',cellclassname: cellclassname, width: '17%' ,cellsalign: 'left', align:'left',editable: false},
							{ text: 'Type', datafield: 'atype',cellclassname: cellclassname, width: '4%',columntype:'dropdownlist',
                                createeditor: function (row, column, editor) {
                                                      editor.jqxDropDownList({ autoDropDownHeight: true, source: list });
                                }
                            },
                            { text: 'Account', datafield: 'account', cellclassname: cellclassname, editable: false,  width: '7%' },	
							{ text: 'Account Name', datafield: 'accountname',cellclassname: cellclassname, editable: false, width: '17%' },	
							...
							{ text: 'Cost Code', datafield: 'costcode',cellclassname: cellclassname, width: '5%',editable: false },
							{ text: 'Addition', datafield: 'addition',cellclassname: cellclassname, width: '8%' ,cellsalign: 'right', align:'right', align:'right',cellsformat:'d2'},
							{ text: 'Deduction', datafield: 'deduction',cellclassname: cellclassname, width: '8%' ,cellsalign: 'right', align:'right',cellsformat:'d2'},
		    				{ text: 'Remarks', datafield: 'remarks', cellclassname: cellclassname,width: '15%'  },
		    				...
		    				{ text: 'errorstat', datafield: 'errorstat', hidden: true, width: '10%' },
