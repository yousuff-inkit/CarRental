...
<% String mode = request.getParameter("mode")==null?"view":request.getParameter("mode");
   ...
   String brhid = request.getParameter("branchid")==null?"0":request.getParameter("branchid");
        ...
        $(document).ready(function () { 	
        	...
        	if(temp=='1')
        	 { 
        		...
        		data='<%=DAO.attendanceGridmarble(session,totDays,year,month,day,department,category,empId, employeebranchchk, brhid)%>';
  ...
  --%>
            ...
            var source =
            {
             ...
             var cellclassname = function (row, column, value, data) {
            	if (data.date1 == 'P') {
                    ...
                    return "redClass";
                }else if (data.date1 == 'N') {
                    return "redClass";
                }else if (data.date1 == 'N2') {
                    return "redClass";
                }else if (data.date1 == 'NA') {
                    return "whiteClass";
                } else if (data.date1 != null && data.date1 != 'P' && data.date1 != 'H' && data.date1 != 'A' && data.date1 != 'S' && data.date1 != 'C' && data.date1 != 'T' && data.date1 != 'M' && data.date1 != 'U' && data.date1 != 'A2' && data.date1 != 'S2' && data.date1 != 'C2' && data.date1 != 'T2' && data.date1 != 'M2' && data.date1 != 'U2' && data.date1 != 'LH' && data.date1 != 'N' && data.date1 != 'N2') {
                    return "greenClass";
                } else {
                	return "whiteClass";
                };
            ...
            var cellclassname1 = function (row, column, value, data) {
            	if (data.date2 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date2 == 'N') {
                    return "redClass";
                } else if (data.date2 == 'N2') {
                    return "redClass";
                } else if (data.date2 == 'NA') {
                    return "whiteClass";
                } else if (data.date2 != null && data.date2 != 'P' && data.date2 != 'H' && data.date2 != 'A' && data.date2 != 'S' && data.date2 != 'C' && data.date2 != 'T' && data.date2 != 'M' && data.date2 != 'U' && data.date2 != 'A2' && data.date2 != 'S2' && data.date2 != 'C2' && data.date2 != 'T2' && data.date2 != 'M2' && data.date2 != 'U2' && data.date2 != 'LH' && data.date2 != 'N'  && data.date2 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname2 = function (row, column, value, data) {
            	if (data.date3 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date3 == 'N') {
                    return "redClass";
                } else if (data.date3 == 'N2') {
                    return "redClass";
                } else if (data.date3 == 'NA') {
                    return "whiteClass";
                } else if (data.date3 != null && data.date3 != 'P' && data.date3 != 'H' && data.date3 != 'A' && data.date3 != 'S' && data.date3 != 'C' && data.date3 != 'T' && data.date3 != 'M' && data.date3 != 'U' && data.date3 != 'A2' && data.date3 != 'S2' && data.date3 != 'C2' && data.date3 != 'T2' && data.date3 != 'M2' && data.date3 != 'U2' && data.date3 != 'LH' && data.date3 != 'N' && data.date3 != 'N2')  {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname3 = function (row, column, value, data) {
            	if (data.date4 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date4 == 'N') {
                    return "redClass";
                } else if (data.date4 == 'N2') {
                    return "redClass";
                } else if (data.date4 == 'NA') {
                    return "whiteClass";
                } else if (data.date4 != null && data.date4 != 'P' && data.date4 != 'H' && data.date4 != 'A' && data.date4 != 'S' && data.date4 != 'C' && data.date4 != 'T' && data.date4 != 'M' && data.date4 != 'U' && data.date4 != 'A2' && data.date4 != 'S2' && data.date4 != 'C2' && data.date4 != 'T2' && data.date4 != 'M2' && data.date4 != 'U2' && data.date4 != 'LH' && data.date4 != 'N' && data.date4 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname4 = function (row, column, value, data) {
            	if (data.date5 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date5 == 'N') {
                    return "redClass";
                } else if (data.date5 == 'N2') {
                    return "redClass";
                } else if (data.date5 == 'NA') {
                    return "whiteClass";
                } else if (data.date5 != null && data.date5 != 'P' && data.date5 != 'H' && data.date5 != 'A' && data.date5 != 'S' && data.date5 != 'C' && data.date5 != 'T' && data.date5 != 'M' && data.date5 != 'U' && data.date5 != 'A2' && data.date5 != 'S2' && data.date5 != 'C2' && data.date5 != 'T2' && data.date5 != 'M2' && data.date5 != 'U2' && data.date5 != 'LH' && data.date5 != 'N' && data.date5 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname5 = function (row, column, value, data) {
            	if (data.date6 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date6 == 'N') {
                    return "redClass";
                } else if (data.date6 == 'N2') {
                    return "redClass";
                } else if (data.date6 == 'NA') {
                    return "whiteClass";
                } else if (data.date6 != null && data.date6 != 'P' && data.date6 != 'H' && data.date6 != 'A' && data.date6 != 'S' && data.date6 != 'C' && data.date6 != 'T' && data.date6 != 'M' && data.date6 != 'U' && data.date6 != 'A2' && data.date6 != 'S2' && data.date6 != 'C2' && data.date6 != 'T2' && data.date6 != 'M2' && data.date6 != 'U2' && data.date6 != 'LH' && data.date6 != 'N' && data.date6 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname6 = function (row, column, value, data) {
            	if (data.date7 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date7 == 'N') {
                    return "redClass";
                } else if (data.date7 == 'N2') {
                    return "redClass";
                } else if (data.date7 == 'NA') {
                    return "whiteClass";
                } else if (data.date7 != null && data.date7 != 'P' && data.date7 != 'H' && data.date7 != 'A' && data.date7 != 'S' && data.date7 != 'C' && data.date7 != 'T' && data.date7 != 'M' && data.date7 != 'U' && data.date7 != 'A2' && data.date7 != 'S2' && data.date7 != 'C2' && data.date7 != 'T2' && data.date7 != 'M2' && data.date7 != 'U2' && data.date7 != 'LH' && data.date7 != 'N' && data.date7 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname7 = function (row, column, value, data) {
            	if (data.date8 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date8 == 'N') {
                    return "redClass";
                } else if (data.date8 == 'N2') {
                    return "redClass";
                } else if (data.date8 == 'NA') {
                    return "whiteClass";
                } else if (data.date8 != null && data.date8 != 'P' && data.date8 != 'H' && data.date8 != 'A' && data.date8 != 'S' && data.date8 != 'C' && data.date8 != 'T' && data.date8 != 'M' && data.date8 != 'U' && data.date8 != 'A2' && data.date8 != 'S2' && data.date8 != 'C2' && data.date8 != 'T2' && data.date8 != 'M2' && data.date8 != 'U2' && data.date8 != 'LH' && data.date8 != 'N' && data.date8 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname8 = function (row, column, value, data) {
            	if (data.date9 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date9 == 'N') {
                    return "redClass";
                } else if (data.date9 == 'N2') {
                    return "redClass";
                } else if (data.date9 == 'NA') {
                    return "whiteClass";
                } else if (data.date9 != null && data.date9 != 'P' && data.date9 != 'H' && data.date9 != 'A' && data.date9 != 'S' && data.date9 != 'C' && data.date9 != 'T' && data.date9 != 'M' && data.date9 != 'U' && data.date9 != 'A2' && data.date9 != 'S2' && data.date9 != 'C2' && data.date9 != 'T2' && data.date9 != 'M2' && data.date9 != 'U2' && data.date9 != 'LH' && data.date9 != 'N' && data.date9 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname9 = function (row, column, value, data) {
            	if (data.date10 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date10 == 'N') {
                    return "redClass";
                } else if (data.date10 == 'N2') {
                    return "redClass";
                } else if (data.date10 == 'NA') {
                    return "whiteClass";
                } else if (data.date10 != null && data.date10 != 'P' && data.date10 != 'H' && data.date10 != 'A' && data.date10 != 'S' && data.date10 != 'C' && data.date10 != 'T' && data.date10 != 'M' && data.date10 != 'U' && data.date10 != 'A2' && data.date10 != 'S2' && data.date10 != 'C2' && data.date10 != 'T2' && data.date10 != 'M2' && data.date10 != 'U2' && data.date10 != 'LH' && data.date10 != 'N' && data.date10 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname10 = function (row, column, value, data) {
            	if (data.date11 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date11 == 'N') {
                    return "redClass";
                } else if (data.date11 == 'N2') {
                    return "redClass";
                } else if (data.date11 == 'NA') {
                    return "whiteClass";
                } else if (data.date11 != null && data.date11 != 'P' && data.date11 != 'H' && data.date11 != 'A' && data.date11 != 'S' && data.date11 != 'C' && data.date11 != 'T' && data.date11 != 'M' && data.date11 != 'U' && data.date11 != 'A2' && data.date11 != 'S2' && data.date11 != 'C2' && data.date11 != 'T2' && data.date11 != 'M2' && data.date11 != 'U2' && data.date11 != 'LH' && data.date11 != 'N' && data.date11 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname11 = function (row, column, value, data) {
            	if (data.date12 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date12 == 'N') {
                    return "redClass";
                } else if (data.date12 == 'N2') {
                    return "redClass";
                } else if (data.date12 == 'NA') {
                    return "whiteClass";
                } else if (data.date12 != null && data.date12 != 'P' && data.date12 != 'H' && data.date12 != 'A' && data.date12 != 'S' && data.date12 != 'C' && data.date12 != 'T' && data.date12 != 'M' && data.date12 != 'U' && data.date12 != 'A2' && data.date12 != 'S2' && data.date12 != 'C2' && data.date12 != 'T2' && data.date12 != 'M2' && data.date12 != 'U2' && data.date12 != 'LH' && data.date12 != 'N' && data.date12 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname12 = function (row, column, value, data) {
            	if (data.date13 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date13 == 'N') {
                    return "redClass";
                } else if (data.date13 == 'N2') {
                    return "redClass";
                } else if (data.date13 == 'NA') {
                    return "whiteClass";
                } else if (data.date13 != null && data.date13 != 'P' && data.date13 != 'H' && data.date13 != 'A' && data.date13 != 'S' && data.date13 != 'C' && data.date13 != 'T' && data.date13 != 'M' && data.date13 != 'U' && data.date13 != 'A2' && data.date13 != 'S2' && data.date13 != 'C2' && data.date13 != 'T2' && data.date13 != 'M2' && data.date13 != 'U2' && data.date13 != 'LH' && data.date13 != 'N' && data.date13 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname13 = function (row, column, value, data) {
            	if (data.date14 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date14 == 'N') {
                    return "redClass";
                } else if (data.date14 == 'N2') {
                    return "redClass";
                } else if (data.date14 == 'NA') {
                    return "whiteClass";
                } else if (data.date14 != null && data.date14 != 'P' && data.date14 != 'H' && data.date14 != 'A' && data.date14 != 'S' && data.date14 != 'C' && data.date14 != 'T' && data.date14 != 'M' && data.date14 != 'U' && data.date14 != 'A2' && data.date14 != 'S2' && data.date14 != 'C2' && data.date14 != 'T2' && data.date14 != 'M2' && data.date14 != 'U2' && data.date14 != 'LH' && data.date14 != 'N' && data.date14 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname14 = function (row, column, value, data) {
            	if (data.date15 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date15 == 'N') {
                    return "redClass";
                } else if (data.date15 == 'N2') {
                    return "redClass";
                } else if (data.date15 == 'NA') {
                    return "whiteClass";
                } else if (data.date15 != null && data.date15 != 'P' && data.date15 != 'H' && data.date15 != 'A' && data.date15 != 'S' && data.date15 != 'C' && data.date15 != 'T' && data.date15 != 'M' && data.date15 != 'U' && data.date15 != 'A2' && data.date15 != 'S2' && data.date15 != 'C2' && data.date15 != 'T2' && data.date15 != 'M2' && data.date15 != 'U2' && data.date15 != 'LH' && data.date15 != 'N' && data.date15 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname15 = function (row, column, value, data) {
            	if (data.date16 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date16 == 'N') {
                    return "redClass";
                } else if (data.date16 == 'N2') {
                    return "redClass";
                } else if (data.date16 == 'NA') {
                    return "whiteClass";
                } else if (data.date16 != null && data.date16 != 'P' && data.date16 != 'H' && data.date16 != 'A' && data.date16 != 'S' && data.date16 != 'C' && data.date16 != 'T' && data.date16 != 'M' && data.date16 != 'U' && data.date16 != 'A2' && data.date16 != 'S2' && data.date16 != 'C2' && data.date16 != 'T2' && data.date16 != 'M2' && data.date16 != 'U2' && data.date16 != 'LH' && data.date16 != 'N' && data.date16 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname16 = function (row, column, value, data) {
            	if (data.date17 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date17 == 'N') {
                    return "redClass";
                } else if (data.date17 == 'N2') {
                    return "redClass";
                } else if (data.date17 == 'NA') {
                    return "whiteClass";
                } else if (data.date17 != null && data.date17 != 'P' && data.date17 != 'H' && data.date17 != 'A' && data.date17 != 'S' && data.date17 != 'C' && data.date17 != 'T' && data.date17 != 'M' && data.date17 != 'U' && data.date17 != 'A2' && data.date17 != 'S2' && data.date17 != 'C2' && data.date17 != 'T2' && data.date17 != 'M2' && data.date17 != 'U2' && data.date17 != 'LH' && data.date17 != 'N' && data.date17 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname17 = function (row, column, value, data) {
            	if (data.date18 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date18 == 'N') {
                    return "redClass";
                } else if (data.date18 == 'N2') {
                    return "redClass";
                } else if (data.date18 == 'NA') {
                    return "whiteClass";
                } else if (data.date18 != null && data.date18 != 'P' && data.date18 != 'H' && data.date18 != 'A' && data.date18 != 'S' && data.date18 != 'C' && data.date18 != 'T' && data.date18 != 'M' && data.date18 != 'U' && data.date18 != 'A2' && data.date18 != 'S2' && data.date18 != 'C2' && data.date18 != 'T2' && data.date18 != 'M2' && data.date18 != 'U2' && data.date18 != 'LH' && data.date18 != 'N' && data.date18 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname18 = function (row, column, value, data) {
            	if (data.date19 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date19 == 'N') {
                    return "redClass";
                } else if (data.date19 == 'N2') {
                    return "redClass";
                } else if (data.date19 == 'NA') {
                    return "whiteClass";
                } else if (data.date19 != null && data.date19 != 'P' && data.date19 != 'H' && data.date19 != 'A' && data.date19 != 'S' && data.date19 != 'C' && data.date19 != 'T' && data.date19 != 'M' && data.date19 != 'U' && data.date19 != 'A2' && data.date19 != 'S2' && data.date19 != 'C2' && data.date19 != 'T2' && data.date19 != 'M2' && data.date19 != 'U2' && data.date19 != 'LH' && data.date19 != 'N' && data.date19 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname19 = function (row, column, value, data) {
            	if (data.date20 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date20 == 'N') {
                    return "redClass";
                } else if (data.date20 == 'N2') {
                    return "redClass";
                } else if (data.date20 == 'NA') {
                    return "whiteClass";
                } else if (data.date20 != null && data.date20 != 'P' && data.date20 != 'H' && data.date20 != 'A' && data.date20 != 'S' && data.date20 != 'C' && data.date20 != 'T' && data.date20 != 'M' && data.date20 != 'U' && data.date20 != 'A2' && data.date20 != 'S2' && data.date20 != 'C2' && data.date20 != 'T2' && data.date20 != 'M2' && data.date20 != 'U2' && data.date20 != 'LH' && data.date20 != 'N' && data.date20 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname20 = function (row, column, value, data) {
            	if (data.date21 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date21 == 'N') {
                    return "redClass";
                } else if (data.date21 == 'N2') {
                    return "redClass";
                } else if (data.date21 == 'NA') {
                    return "whiteClass";
                } else if (data.date21 != null && data.date21 != 'P' && data.date21 != 'H' && data.date21 != 'A' && data.date21 != 'S' && data.date21 != 'C' && data.date21 != 'T' && data.date21 != 'M' && data.date21 != 'U' && data.date21 != 'A2' && data.date21 != 'S2' && data.date21 != 'C2' && data.date21 != 'T2' && data.date21 != 'M2' && data.date21 != 'U2' && data.date21 != 'LH' && data.date21 != 'N' && data.date21 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname21 = function (row, column, value, data) {
            	if (data.date22 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date22 == 'N') {
                    return "redClass";
                } else if (data.date22 == 'N2') {
                    return "redClass";
                } else if (data.date22 == 'NA') {
                    return "whiteClass";
                } else if (data.date22 != null && data.date22 != 'P' && data.date22 != 'H' && data.date22 != 'A' && data.date22 != 'S' && data.date22 != 'C' && data.date22 != 'T' && data.date22 != 'M' && data.date22 != 'U' && data.date22 != 'A2' && data.date22 != 'S2' && data.date22 != 'C2' && data.date22 != 'T2' && data.date22 != 'M2' && data.date22 != 'U2' && data.date22 != 'LH' && data.date22 != 'N' && data.date22 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname22 = function (row, column, value, data) {
            	if (data.date23 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date23 == 'N') {
                    return "redClass";
                } else if (data.date23 == 'N2') {
                    return "redClass";
                } else if (data.date23 == 'NA') {
                    return "whiteClass";
                } else if (data.date23 != null && data.date23 != 'P' && data.date23 != 'H' && data.date23 != 'A' && data.date23 != 'S' && data.date23 != 'C' && data.date23 != 'T' && data.date23 != 'M' && data.date23 != 'U' && data.date23 != 'A2' && data.date23 != 'S2' && data.date23 != 'C2' && data.date23 != 'T2' && data.date23 != 'M2' && data.date23 != 'U2' && data.date23 != 'LH' && data.date23 != 'N' && data.date23 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname23 = function (row, column, value, data) {
            	if (data.date24 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date24 == 'N') {
                    return "redClass";
                } else if (data.date24 == 'N2') {
                    return "redClass";
                } else if (data.date24 == 'NA') {
                    return "whiteClass";
                } else if (data.date24 != null && data.date24 != 'P' && data.date24 != 'H' && data.date24 != 'A' && data.date24 != 'S' && data.date24 != 'C' && data.date24 != 'T' && data.date24 != 'M' && data.date24 != 'U' && data.date24 != 'A2' && data.date24 != 'S2' && data.date24 != 'C2' && data.date24 != 'T2' && data.date24 != 'M2' && data.date24 != 'U2' && data.date24 != 'LH' && data.date24 != 'N' && data.date24 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname24 = function (row, column, value, data) {
            	if (data.date25 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date25 == 'N') {
                    return "redClass";
                } else if (data.date25 == 'N2') {
                    return "redClass";
                } else if (data.date25 == 'NA') {
                    return "whiteClass";
                } else if (data.date25 != null && data.date25 != 'P' && data.date25 != 'H' && data.date25 != 'A' && data.date25 != 'S' && data.date25 != 'C' && data.date25 != 'T' && data.date25 != 'M' && data.date25 != 'U' && data.date25 != 'A2' && data.date25 != 'S2' && data.date25 != 'C2' && data.date25 != 'T2' && data.date25 != 'M2' && data.date25 != 'U2' && data.date25 != 'LH' && data.date25 != 'N' && data.date25 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname25 = function (row, column, value, data) {
            	if (data.date26 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date26 == 'N') {
                    return "redClass";
                } else if (data.date26 == 'N2') {
                    return "redClass";
                } else if (data.date26 == 'NA') {
                    return "whiteClass";
                } else if (data.date26 != null && data.date26 != 'P' && data.date26 != 'H' && data.date26 != 'A' && data.date26 != 'S' && data.date26 != 'C' && data.date26 != 'T' && data.date26 != 'M' && data.date26 != 'U' && data.date26 != 'A2' && data.date26 != 'S2' && data.date26 != 'C2' && data.date26 != 'T2' && data.date26 != 'M2' && data.date26 != 'U2' && data.date26 != 'LH' && data.date26 != 'N' && data.date26 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname26 = function (row, column, value, data) {
            	if (data.date27 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date27 == 'N') {
                    return "redClass";
                } else if (data.date27 == 'N2') {
                    return "redClass";
                } else if (data.date27 == 'NA') {
                    return "whiteClass";
                } else if (data.date27 != null && data.date27 != 'P' && data.date27 != 'H' && data.date27 != 'A' && data.date27 != 'S' && data.date27 != 'C' && data.date27 != 'T' && data.date27 != 'M' && data.date27 != 'U' && data.date27 != 'A2' && data.date27 != 'S2' && data.date27 != 'C2' && data.date27 != 'T2' && data.date27 != 'M2' && data.date27 != 'U2' && data.date27 != 'LH' && data.date27 != 'N' && data.date27 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname27 = function (row, column, value, data) {
            	if (data.date28 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date28 == 'N') {
                    return "redClass";
                } else if (data.date28 == 'N2') {
                    return "redClass";
                } else if (data.date28 == 'NA') {
                    return "whiteClass";
                } else if (data.date28 != null && data.date28 != 'P' && data.date28 != 'H' && data.date28 != 'A' && data.date28 != 'S' && data.date28 != 'C' && data.date28 != 'T' && data.date28 != 'M' && data.date28 != 'U' && data.date28 != 'A2' && data.date28 != 'S2' && data.date28 != 'C2' && data.date28 != 'T2' && data.date28 != 'M2' && data.date28 != 'U2' && data.date28 != 'LH' && data.date28 != 'N' && data.date28 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname28 = function (row, column, value, data) {
            	if (data.date29 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date29 == 'N') {
                    return "redClass";
                } else if (data.date29 == 'N2') {
                    return "redClass";
                } else if (data.date29 == 'NA') {
                    return "whiteClass";
                } else if (data.date29 != null && data.date29 != 'P' && data.date29 != 'H' && data.date29 != 'A' && data.date29 != 'S' && data.date29 != 'C' && data.date29 != 'T' && data.date29 != 'M' && data.date29 != 'U' && data.date29 != 'A2' && data.date29 != 'S2' && data.date29 != 'C2' && data.date29 != 'T2' && data.date29 != 'M2' && data.date29 != 'U2' && data.date29 != 'LH' && data.date29 != 'N' && data.date29 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname29 = function (row, column, value, data) {
            	if (data.date30 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date30 == 'N') {
                    return "redClass";
                } else if (data.date30 == 'N2') {
                    return "redClass";
                } else if (data.date30 == 'NA') {
                    return "whiteClass";
                } else if (data.date30 != null && data.date30 != 'P' && data.date30 != 'H' && data.date30 != 'A' && data.date30 != 'S' && data.date30 != 'C' && data.date30 != 'T' && data.date30 != 'M' && data.date30 != 'U' && data.date30 != 'A2' && data.date30 != 'S2' && data.date30 != 'C2' && data.date30 != 'T2' && data.date30 != 'M2' && data.date30 != 'U2' && data.date30 != 'LH' && data.date30 != 'N' && data.date30 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            var cellclassname30 = function (row, column, value, data) {
        		if (data.date31 == 'P') {
                    ...
                    return "redClass";
                } else if (data.date31 == 'N') {
                    return "redClass";
                } else if (data.date31 == 'N2') {
                    return "redClass";
                } else if (data.date31 == 'NA') {
                    return "whiteClass";
                } else if (data.date31 != null && data.date31 != 'P' && data.date31 != 'H' && data.date31 != 'A' && data.date31 != 'S' && data.date31 != 'C' && data.date31 != 'T' && data.date31 != 'M' && data.date31 != 'U' && data.date31 != 'A2' && data.date31 != 'S2' && data.date31 != 'C2' && data.date31 != 'T2' && data.date31 != 'M2' && data.date31 != 'U2' && data.date31 != 'LH' && data.date31 != 'N' && data.date31 != 'N2') {
                    return "greenClass";
                } else{
                	return "whiteClass";
                };
            ...
            $("#attendanceGridID").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Year', pinned: true, datafield: 'year', editable: false, cellclassname: 'whiteClass', width: '7%',hidden:true },
							{ text: 'Month', pinned: true, datafield: 'month', editable: false, cellclassname: 'whiteClass', width: '7%' ,hidden:true },
							...
							{ text: 'L', datafield: 'leavedet', editable: false, width: '3%', cellsalign: 'center', align: 'center' },
							...
							{ text: 'Paid Leave', datafield: 'leave2total', width: '6%',  cellsalign: 'center', align: 'center'  /* ,cellbeginedit: function (row) {
						         	if ($('#attendanceGridID').jqxGrid('getcellvalue', row, "leave2total")>=0) { 
							         	if(parseInt($('#txtattendanceleaveseditgrid').val())==0) {
							              	return false;
							         	}}} */
							},
							{ text: 'Sick Leave', datafield: 'leave3total', width: '6%', cellsalign: 'center', align: 'center'/* , cellbeginedit: function (row) {
									if ($('#attendanceGridID').jqxGrid('getcellvalue', row, "leave3total")>=0) { 
							         	if(parseInt($('#txtattendanceleaveseditgrid').val())==0) {
							              	return false;
							         	}}} */
							},
							{ text: 'Casual Leave', datafield: 'leave4total', width: '7%',  cellsalign: 'center', align: 'center'/* , cellbeginedit: function (row) {
									if ($('#attendanceGridID').jqxGrid('getcellvalue', row, "leave4total")>=0) { 
							         	if(parseInt($('#txtattendanceleaveseditgrid').val())==0) {
							              	return false;
							         	}}} */
						    },
							{ text: 'Emergency Leave', datafield: 'leave5total', width: '10%',  cellsalign: 'center', align: 'center'/* , cellbeginedit: function (row) {
									if ($('#attendanceGridID').jqxGrid('getcellvalue', row, "leave5total")>=0) { 
							         	if(parseInt($('#txtattendanceleaveseditgrid').val())==0) {
							            	  return false;
							         	}}} */
						    },
							{ text: 'Absconding', datafield: 'leave6total', width: '8%',  cellsalign: 'center', align: 'center'/* , cellbeginedit: function (row) {
									if ($('#attendanceGridID').jqxGrid('getcellvalue', row, "leave6total")>=0) { 
							        	if(parseInt($('#txtattendanceleaveseditgrid').val())==0) {
							            	  return false;
							         	}}} */
						    },
						    { text: 'Suspended', datafield: 'leave7total', width: '8%',  cellsalign: 'center', align: 'center'/* , cellbeginedit: function (row) {
								if ($('#attendanceGridID').jqxGrid('getcellvalue', row, "leave6total")>=0) { 
						        	if(parseInt($('#txtattendanceleaveseditgrid').val())==0) {
						            	  return false;
						         	}}} */
         	 ...
         	 $("#attendanceGridID").on('cellvaluechanged', function (event){
                ...
                for(var i=1;i<=parseInt(totdays);i++)
         		{
                	...
                	if(value=='A' || value=='S' || value=='C' || value=='T' || value=='M' || value=='U' || value=='N'){
                		leave=leave+1;
                	}
                	if(value=='A2' || value=='S2' || value=='C2' || value=='T2' || value=='M2' || value=='U2' || value=='N2'){
                		leave=leave+(0.5);
                	}
                	...
                	if(value=='N'){leave7total=leave7total+1;}
                	...
                	if(value=='N2'){leave7total=leave7total+(0.5);}
                ...
                $('#attendanceGridID').jqxGrid('setcellvalue', rowIndex, "totalholidayovertimes", (((holidayovertime-(holidayovertime % 60))/60).toString() + ":" + ((holidayovertime % 60)<10?"0":"") + (holidayovertime % 60).toString()));
                   ...
                   $('#txtselectedcellleave2totalvalue').val($('#attendanceGridID').jqxGrid('getcellvalue', rowIndex, "leave2total"));
	   			   ...
	   			   $('#txtselectedcellleave7totalvalue').val($('#attendanceGridID').jqxGrid('getcellvalue', rowIndex, "leave7total"));
	        ...
	        $("#attendanceGridID").on("cellclick", function (event) {
	   			   ...
	   			   $('#txtselectedcellcolumn').val("date"+(columnIndex-5));
	   			   $('#txtselectedcellrow').val(rowIndex);
	   			   $('#txtselectedcelltextvalue').val($('#attendanceGridID').jqxGrid('getcellvalue', rowIndex, "date"+(columnIndex-5)));
	   			   if(parseInt($('#txtattendanceleaveseditgrid').val())==0){
		   			   $('#txtselectedcellleave1totalvalue').val($('#attendanceGridID').jqxGrid('getcellvalue', rowIndex, "leave1total"));
		   			   $('#txtselectedcellleave2totalvalue').val($('#attendanceGridID').jqxGrid('getcellvalue', rowIndex, "leave2total"));
		   			   $('#txtselectedcellleave3totalvalue').val($('#attendanceGridID').jqxGrid('getcellvalue', rowIndex, "leave3total"));
	   			   ...
	   			   document.getElementById("savemsg").innerText="Emp. ID : "+$('#attendanceGridID').jqxGrid('getcellvalue', rowIndex, "employeeid")+" - "+$('#cmbmonth option:selected').text().slice(0,5).toUpperCase()+" "+(columnIndex-5)+" - "+applytype;
...
/*         	var rows = $("#attendanceGridID").jqxGrid('getrows');
            ...
            $('#attendanceGridID').jqxGrid('setcellvalue', i, "leavedet",leave);
		...
		if(checktype=="2"){
		 ...
		 function updaterecheck(month,year){
			...
			if (x.readyState==4 && x.status==200)
			{
				...
				if(parseInt(items)>0){
				//alert("check items---"+items);	
				funViewAttendance();
				radioClick();
				$.messager.alert('Message', '  Record Successfully Re-Checked ');
				$("#overlay, #PleaseWait").hide();
				}else{
			...
			x.open("GET", "updateData2.jsp?year="+year+"&month="+month,true);   
			x.send();
		} 
