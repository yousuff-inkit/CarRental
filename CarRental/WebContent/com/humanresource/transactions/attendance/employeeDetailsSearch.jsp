...
#search {
	...
	function getdata(employeeName,empId,contactNo,employeebranchchk,branch){                    
		 $("#refreshdiv").load('employeeDetailsSearchGrid.jsp?employeename='+employeeName.replace(/ /g, "%20")+'&empid='+empId+'&branchid='+branch+'&contactno='+contactNo+'&employeebranchchk='+employeebranchchk);
		}
