...
<script type="text/javascript">
        ...
        $(document).ready(function () { 
        	//alert(temp);
        	if(temp=='1') { 
        		data='<%=DAO.monthlyPayrollGridLoading(date,category,empId,docNo,mode, employeebranchchk, branch)%>'; 
        	} else if(tempDocNo>0){   
        		data='<%=DAO.monthlyPayrollGridReloading(session,date, employeebranchchk, branch)%>';       
          	}
