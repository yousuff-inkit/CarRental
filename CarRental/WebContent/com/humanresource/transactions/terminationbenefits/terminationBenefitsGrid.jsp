...
<script type="text/javascript">
        ...
        $(document).ready(function () { 
	        ...
	        if(!isNaN(leavesalarytobeposted1)){
		           ...
		           if ($("#mode").val() == "A") {
		        	   // based on config 
		        	   if(parseInt($('#chkleavedayconfig').val())>0 && parseFloat($('#txtleavesalarytotal').val())<0){ 
		        		$('#terminationBenefitsAccounts').jqxGrid('setcellvalue', 1, "credit" ,parseFloat(leavesalarytobeposted1)*-1);
			           	$('#terminationBenefitsAccounts').jqxGrid('setcellvalue', 4, "debit" ,parseFloat(leavesalarytobeposted1)*-1);       		   
		        	   } else{
