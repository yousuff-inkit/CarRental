...
<%	
	...
	try{
		...
		String employeeCategoryId="",leavesalaryeligibledays="",leavesalaryposted="",travelsposted="",daysWorked="0",leaveSalaryToBePostedDays="",allowanceID="",leaveSalaryAmount="",leaveSalaryTobePostedAmount="";
