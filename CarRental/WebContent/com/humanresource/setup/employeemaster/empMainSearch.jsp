...
<title>GatewayERP(i)</title>
	...
	function getEmpDesignation() {
 	...
 	function loadSearch() {
 		...
 		console.log(employeebranchchk+"==="+branch);
	...
	function getdata(empname,mob,employeedesignation,employeedepartment,empid,dob, employeebranchchk, branch){
		 ...
		 $("#refreshdiv").load('empMainSearchGrid.jsp?empname='+empname.replace(/ /g, "%20")+'&mob='+mob+'&employeedesignation='+employeedesignation+'&employeedepartment='+employeedepartment+'&empid='+empid+'&dob='+dob+'&branch='+branch+'&employeebranchchk='+employeebranchchk);
		}
