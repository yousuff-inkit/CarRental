...
<script type="text/javascript">
	...
	$(document).ready(function () {    
      ...
      $('#refsearch').on('rowdoubleclick', function (event) {
           ...
           $("#lsetup1").load("terminationgrid.jsp?docno="+$('#refsearch').jqxGrid('getcellvalue', rowindex1, "doc_no"));
           $("#lsetup3").load("resignationgrid.jsp?docno="+$('#refsearch').jqxGrid('getcellvalue', rowindex1, "doc_no"));
           $("#lsetup4").load("leavegrid.jsp?docno="+$('#refsearch').jqxGrid('getcellvalue', rowindex1, "doc_no"));
