...
<script type="text/javascript"> 
  ...
  var deptdata1= '<%=DAO.loadgrid() %>'; 
	  var source =
            ...
            $("#loadsearchgrid").jqxGrid(
                  {
                    ...
                    columns: [
	        					...
	        					{ text: 'EST Code', datafield: 'estcode', width: '15%' },
	        					{ text: 'Company', datafield: 'company',width:'30%' },
            ...
            $("#compdate").jqxDateTimeInput('val', $("#loadsearchgrid").jqxGrid('getcellvalue', rowindex1, "date"));
            document.getElementById("docno").value= $('#loadsearchgrid').jqxGrid('getcellvalue', rowindex1, "doc_no"); 
            document.getElementById("company").value = $("#loadsearchgrid").jqxGrid('getcellvalue', rowindex1, "company");
            document.getElementById("estcode").value = $("#loadsearchgrid").jqxGrid('getcellvalue', rowindex1, "estcode");
