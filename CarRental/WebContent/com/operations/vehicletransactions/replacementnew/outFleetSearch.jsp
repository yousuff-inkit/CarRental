...
String agmttype=request.getParameter("branch")==null?"":request.getParameter("agmttype");

ClsReplacementNewDAO repdao=new ClsReplacementNewDAO();
%> 
 <script type="text/javascript">
 <%-- '<%=repdao.getOutFleetSearch(branch,searchdate,fleetno,docno,regno,color,group)%>'; --%>
 var outfleetdata='<%=repdao.getOutFleetSearchV2(agmttype,agmtno,branch,searchdate,fleetno,docno,regno,color,group)%>';	
