...
<table width="100%" border="0">
  ...
  <tr>
    <td class="borderbottom borderright borderleft">اNﺳﻢ<br>Hirer Name</td>
    <td width="25%" class="borderbottom borderright"><label id="clname" name="clname"><s:property value="clname"/></label></td>
    <td class="borderbottom borderright ">اNﺳﻢ<br>Driver Name</td>
    <td class="borderbottom borderright bordertop"><label id="radrname" name="radrname"><s:property value="radrname"/></label></td>
    </tr>
  <tr>
...
<table width="100%" border="0">
  <tr>
    <td width="50%"><table width="100%" border="0">
      ...
      <tr>
        <td class="borderbottom borderright borderleft">اNﺳﻢ<br>Second Driver Name</td>
        <td colspan="3" class="borderbottom borderright"><label name="adddrname1" id="adddrname1"><s:property value="adddrname1"/></label></td>
      </tr>
      <tr>
        <td class="borderbottom borderright borderleft">رﻗﻢ رﺧﺼﺔ اﻟﻘﻴﺎدة<br>Driving Lic No</td>
        <td width="25%" class="borderbottom borderright"><label name="addlicno1" id="addlicno1"><s:property value="addlicno1"/></label></td>
        <td width="25%" class="borderbottom borderright">ﺻﺎﻟﺤﺔ ﻟﺘﺎرﻳﺦ<br>Valid Upto</td>
        <td width="25%" class="borderbottom borderright"><label name="expdate1" id="expdate1"><s:property value="expdate1"/></label></td>
      </tr>
      <tr>
        <td class="borderbottom borderright borderleft">رﻗﻢ ﺟﻮاز اﻟﺴﻔﺮ<br>Passport No</td>
        <td class="borderbottom borderright"><label name="lbladdpassno1" id="lbladdpassno1"><s:property value="lbladdpassno1"/></label></td>
        <td class="borderbottom borderright">رﻗﻢ اﻟﻤﻮﺑﺎﻳﻞ<br>Tel/Mobile</td>
        <td class="borderbottom borderright"><label name="lblindigoaddmobile" id="lblindigoaddmobile"><s:property value="lblindigoaddmobile"/></label></td>
      </tr>
    <!--  <tr>
  ...
  <td class="bordertop borderbottom borderleft borderright"><ul>
   ...
   <tr>
    <td width="50%"><table width="100%" height="100" border="0" >
      <tr>
        <td align="center"><h1>24/7 Roadside Assistance</h1></td>
        <td style="padding-left:20px;" class="borderbottom">ﺗﻮﻗﻴﻊ اﻟﻤﻮﻇﻒ<br>Staff's Signature<br><br></td>
        
      </tr>
      <tr>
        <td align="center"><img src="<%=contextPath%>/icons/call2.png" width="20" height="20"  alt=""/>&nbsp;&nbsp;&nbsp;<img src="<%=contextPath%>/icons/whatsapps.png" width="20" height="20"  alt=""/></td>
        <td style="padding-left:20px;" class="borderbottom">اﺳﻢ اﻟﻤﺴﺘﺄﺟﺮ اﻟﻜﺎﻣﻞ<br>Hirer's Name<br><br></td>
        </tr>
      <tr>
         <td align="center"><h2>056-4339388</h2></td>
        <td style="padding-left:20px;" class="borderbottom">ﺗﻮﻗﻴﻊ اﻟﻤﺴﺘﺄﺟﺮ<br>Hirer's Signature<br><br></td>
       
      </tr>
      
        
     <!--  <tr><td align="center"><h1>24/7 Roadside Assistance</h1></td></tr> -->
     <%--  <tr><td align="center"><img src="<%=contextPath%>/icons/call2.png" width="20" height="20"  alt=""/>&nbsp;&nbsp;&nbsp;<img src="<%=contextPath%>/icons/whatsapps.png" width="20" height="20"  alt=""/><h2>056-4339388</h2></td></tr> --%>
    </table></td>
