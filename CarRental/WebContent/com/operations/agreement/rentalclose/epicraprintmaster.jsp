...
<td><label id="colfuels" name="colfuels"><s:property value="colfuels"/></label></td>
  ...
  <%--  <fieldset><legend><b> Closing Details</b></legend> 
    ...
    <td width="100%">
 <div id="calcdiv">
  <jsp:include page="calculationGrid1.jsp"></jsp:include></div>
  </td>
  </tr>
  </table> 
  <fieldset width="100%">
