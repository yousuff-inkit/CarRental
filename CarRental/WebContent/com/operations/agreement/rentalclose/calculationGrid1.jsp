...
//System.out.println("amgtn0----"+agmtno);
...
<script type="text/javascript">
        ...
        $(document).ready(function () { 
        	var datacalc2;
        	    var temp1='<%=temp%>';
        	var num = 0;
        	if(temp1=="1" && document.getElementById("docnoval").value==''){
        		//alert("Inside Temp 1"); 
        		datacalc2='<%=closedao.getCalcData(agmtno,tarif,cdwtotal,acctotal,chauffer,excesskmchg,excesshrchg,temp,session,usedhours,clientid,fuel,deliverychg,collectchg,outdate,indate,cmbinfuel,request,exkm,closeinvdate,closecalflag,calctype,useddays)%>';
        	}
        	else if(temp1=="2" && document.getElementById("docnoval").value!=''){
        		//alert("Inside Calculation view");
        		datacalc2='<%=closedao.getCalcData_view(agmtno)%>';
        	}
