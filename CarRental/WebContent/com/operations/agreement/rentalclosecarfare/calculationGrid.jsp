...
{name : 'description' , type: 'string' },
	...
	{name : 'salikparksrvc',type:'number'},
	{name : 'salikparkcount',type:'number'},
	{name : 'salikparkrate',type:'number'},
	{name : 'salikparksrvcrate',type:'number'}
        	...
        	$("#calculationgrid").on("bindingcomplete", function (event) {
        		...
        		if($('#mode').val()=='A'){
            		...
            		for(var i=0;i<rows.length;i++){
            			var insurcomp=$('#calculationgrid').jqxGrid('getcellvalue',i,'insurcomp');
            			if(insurcomp=='1'){
            				insurtotal+=parseFloat($('#calculationgrid').jqxGrid('getcellvalue',i,'total'));
            			}
            			else if(insurcomp!='1'){
            				clienttotal+=parseFloat($('#calculationgrid').jqxGrid('getcellvalue',i,'total'));
            			}
            		}
            		$('#insurcomptotal').val(insurtotal);
            		$('#clienttotal').val(clienttotal);
        		}
        	});
...
{ text: 'Insur.Comp',  datafield: 'insurcomp',  width: '17.5%',hidden:true},

{ text: 'Salik Park Amt',  datafield: 'salikparkamt',  width: '8%',hidden:true,cellsformat: 'd2',cellsalign:'right',align:'right'},
{ text: 'Salik Park Srvc',  datafield: 'salikparksrvc',  width: '8%',hidden:true,cellsformat: 'd2',cellsalign:'right',align:'right'},
{ text: 'Salik Park Count',  datafield: 'salikparkcount',  width: '8%',hidden:true,cellsformat: 'd2',cellsalign:'right',align:'right'},
{ text: 'Salik Park Rate',  datafield: 'salikparkrate',  width: '8%',hidden:true,cellsformat: 'd2',cellsalign:'right',align:'right'},
{ text: 'Salik Park Srvc Rate',  datafield: 'salikparksrvcrate',  width: '8%',hidden:true,cellsformat: 'd2',cellsalign:'right',align:'right'},
], columngroups: 
	                     [
