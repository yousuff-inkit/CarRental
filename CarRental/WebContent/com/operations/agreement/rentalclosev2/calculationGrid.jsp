 ...
 <%@page import="com.operations.agreement.rentalclosev2.*"%>
<%@page import="com.common.ClsCommon"%>
<%@page import="javax.servlet.http.HttpServletRequest" %>
<%@page import="javax.servlet.http.HttpSession" %>
<%
ClsCommon objcommon=new ClsCommon();
ClsRentalCloseV2DAO closedao=new ClsRentalCloseV2DAO();
String agmtno=request.getParameter("agmtno")==null?"0":request.getParameter("agmtno").toString();

String cdw=request.getParameter("cdw")==null?"0":request.getParameter("cdw").toString();
String pai=request.getParameter("pai")==null?"0":request.getParameter("pai").toString();
String cdw1=request.getParameter("cdw1")==null?"0":request.getParameter("cdw1").toString();
String pai1=request.getParameter("pai1")==null?"0":request.getParameter("pai1").toString();
String gps=request.getParameter("gps")==null?"0":request.getParameter("gps").toString();
String babyseater=request.getParameter("babyseater")==null?"0":request.getParameter("babyseater").toString();
String cooler=request.getParameter("cooler")==null?"0":request.getParameter("cooler").toString();
...
String oinschg=request.getParameter("oinschg")==null?"0":request.getParameter("oinschg").toString();
String chaufexchg=request.getParameter("chaufexchg")==null?"0":request.getParameter("chaufexchg").toString();
...
var datacalc;
        $(document).ready(function () { 	
        	...
        	if(temp1=="1" && document.getElementById("docno").value==''){
        		//alert("Inside Temp 1"); 
	        	datacalc='<%=closedao.getCalcData(oinschg,chaufexchg,cdw,pai,cdw1,pai1,gps,babyseater,cooler,agmtno,tarif,cdwtotal,acctotal,chauffer,excesskmchg,excesshrchg,temp,session,usedhours,clientid,fuel,deliverychg,collectchg,outdate,indate,cmbinfuel,request,exkm,closeinvdate,closecalflag,calctype,useddays)%>';
        	}
