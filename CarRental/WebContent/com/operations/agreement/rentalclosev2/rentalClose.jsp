...
function setCollection(){
	...
	function funReadOnly(){
		 setCollection();
		$('#frmRentalCloseV2 input').attr('readonly',true);
		$('#frmRentalCloseV2 select').attr('disabled',true);
 ...
 */
    	...
    	$('#gridlength').val(rows.length);
			...
			//	var myvar = rows[i].tarif; 
				...
				newTextBox.val(rows[i].rentaltype+"::"+rows[i].rate+"::"+rows[i].cdw+"::"+rows[i].pai+"::"+rows[i].cdw1+"::"+rows[i].pai1+"::"+rows[i].gps+"::"+rows[i].babyseater+"::"+rows[i].cooler+"::"+rows[i].exkmrte+"::"+rows[i].exhrchg+"::"+rows[i].chaufchg+"::"+rows[i].oinschg+"::"+rows[i].chaufexchg);
	...
	function funRemoveReadOnly(){
		$('#frmRentalCloseV2 input').attr('readonly',false);
		$('#frmRentalCloseV2 select').attr('disabled',false);
...
if(document.getElementById("rentalagent").value==""){
	...
	function funCalculate(){
		...
		var cdw=zeroValidate($('#totalgrid').jqxGrid('getcellvalue', 2, "cdw"));
		var pai=zeroValidate($('#totalgrid').jqxGrid('getcellvalue', 2, "pai"));
		var cdw1=zeroValidate($('#totalgrid').jqxGrid('getcellvalue', 2, "cdw1"));
		var pai1=zeroValidate($('#totalgrid').jqxGrid('getcellvalue', 2, "pai1"));
		var gps=zeroValidate($('#totalgrid').jqxGrid('getcellvalue', 2, "gps"));
		var babyseater=zeroValidate($('#totalgrid').jqxGrid('getcellvalue', 2, "babyseater"));
		var cooler=zeroValidate($('#totalgrid').jqxGrid('getcellvalue', 2, "cooler"));
		var cdwtotal=0;
...
<form id="frmRentalCloseV2" action="saveRentalCloseV2" autocomplete="off">
	<%-- <script>
