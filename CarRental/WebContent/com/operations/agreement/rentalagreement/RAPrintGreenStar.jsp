 ...
 <tr>
   ...
   <td width="18%" align="left">Exp Date</td>
    <td width="82%" colspan="3">:&nbsp;<label id="lblaccount" name="licexpdate" ><s:property value="licexpdate"/></label></td>
     ...
     <tr>
        <td  width="18%" align="left">EID NO</td>
    <td width="82%" colspan="3">:&nbsp;<label id="lblidno" name="lblidno"><s:property value="lblidno"/></label></td>
    </tr>
    <tr>
   <td width="18%" align="left">Exp Date</td>
    <td width="82%" colspan="3">:&nbsp;<label id="lblaccount" name="lblvisaexp" ><s:property value="lblvisaexp"/></label></td>
    </tr>
    <tr>
...
<td style="font-size: 11px"><label id="colfuels" name="colfuels"><s:property value="colfuels"/></label></td>
  ...
  <!--   </table> 
    <table  width="100%" style="padding:0px" > -->
       ...
       <tr><td width="15%" style="font-size: 11px">Personal Accident Insurance</td><td width="5%" align="right" style="font-size: 11px"><label id="lblpai" name="lblpai"><s:property value="lblpai"/></label></td></tr>
