...
String sclname = request.getParameter("sclname")==null?"0":request.getParameter("sclname");
 ...
 String lponumber = request.getParameter("lponumber")==null?"0":request.getParameter("lponumber");
...
var loaddata1='<%=viewDAO.mainSrearch(session,sclname,smob,rno,flno,sregno,smra,lponumber,branch_chk)%>';    
            ...
            $("#jqxmainsearch").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'MRA', datafield: 'mrnumber', width: '15%'},
							 ...
							 { text: 'Insur.Company', datafield: 'insurcompname', width: '15%',hidden:true  },
							 { text: 'LPO Number', datafield: 'pono', width: '12%',  },
    	...
    	if($('#insurcompconfig').val()=="1"){
    		$('#jqxmainsearch').jqxGrid('setcolumnproperty','insurcompname','hidden',false);
    		$('#jqxmainsearch').jqxGrid('setcolumnproperty','mrnumber','width','10%');
    		$('#jqxmainsearch').jqxGrid('setcolumnproperty','reg_no','width','10%');
    		$('#jqxmainsearch').jqxGrid('setcolumnproperty','per_mob','width','17%');
