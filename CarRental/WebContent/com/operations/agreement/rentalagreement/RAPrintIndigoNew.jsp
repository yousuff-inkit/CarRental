...
<%--       <table width="100%" >
  ...
  <tr>
  	<td colspan="3" align="center"><b>Dubai Police : 999&nbsp;&nbsp;&nbsp;Roadside Assistance : 0554013490</b></td>
  </tr>
  <tr>
...
<table width="100%">
	<tr>
		...
		<td width="20%" style="font-size: 7px">Roadside Assistance[حالة الطوارئ] :</td><td width="20%" style="font-size: 7px"> 0554013490</td>
	</tr>
</table>
<table width="100%" >
  <tr>
    			...
    			<fieldset>
    				<table width="100%" style="padding:0px">
    					<tr>
    						...
    						<td width="50%" style="font-size: 7px">Fine Service Charges&nbsp;&nbsp;&nbsp;60 AED</td>
    					...
    					<tr>
    						...
    						<td width="50%" style="font-size: 7px">Salik Charges&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7 AED</td>
    					...
    					<tr>
    						...
    						<td width="50%" style="font-size: 7px">[قيمة السالك]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        ...
                                        <tr>
    						<td width="50%" style="font-size: 7px"></td>
    						<td width="50%" style="font-size: 7px">Parking Service Charges&nbsp;&nbsp;&nbsp;25%</td>
    					</tr>
    					<tr>
    					   <td width="50%" style="font-size: 7px">&nbsp;&nbsp;&nbsp;</td>
    						<td width="50%" style="font-size: 7px">[رسوم وقوف السيارات]&nbsp;&nbsp;&nbsp;</td>
    					</tr>
    				</table>
    			</fieldset>
    		</td>
