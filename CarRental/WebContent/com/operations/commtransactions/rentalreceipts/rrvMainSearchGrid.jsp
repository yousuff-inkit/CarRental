 ...
 <script type="text/javascript">
            ...
            $("#jqxrentalreceiptsearch").jqxGrid(
            {
                ...
                columns: [
					 ...
					 { text: 'subpaytype', datafield: 'subpaytype', width: '15%',hidden:true },
			  ...
			  $('#jqxrentalreceiptsearch').on('rowdoubleclick', function (event) {
  			 ...
  			 /*   getConfig();
  			  var val=document.getElementById("txtconfigchk").value;
			  		alert("val==="+val+"***");

  			  	if(val=="1"){ 
			var x=	document.getElementById("hidcmbsubchq").value= $('#jqxrentalreceiptsearch').jqxGrid('getcellvalue', rowindex1, "subpaytype");
			  	alert(x);
