...
<tr>
  ...
  <tr>
<!-- <tr><td><p align="justify">The client acknowledge that the payment is considered a
reservation fees is nonrefundable <br>in case the client did not
concluded the lease of vehicle within 10 days.
</p><td></tr> -->
  <%int j=0,k=0; %>
...
<table width="100%" class=tablecontents>
...
<tr><td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tr></td>
<tr><td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tr></td> -->
<%-- <tr><td><p align="justify">The client acknowledge that the payment is considered a<br>
reservation fees is nonrefundable in case the client did not<br>
concluded the lease of vehicle within 10 days.
</p><td></tr>
...
<tr>
  	<td>&nbsp;</td>   
  	<td>&nbsp;</td>
     <td text-align="left"><img src="<%=contextPath%>/icons/newworld.png" width="150" height="91"  alt=""/><b>:</td>
     <td colspan="2" class="borderbottom borderright">يدرك العميل أن المبلغ المدفوع يعد عربون غير مسترد في حالة
   عدم إتمام العميل عملية االستئجار للسيارة خالل مدة 10 ايام من
                                                   تاريخ إصداره</td>
   </tr>
<!-- <tr><td><td></tr> --> --%>
<tr>
          <td class="borderbottom" style="width:300px;">The client acknowledge that the payment is considered a
reservation fees is nonrefundable in case the client did not
concluded the lease of vehicle within 10 days.</td>
         <td style="width:150px;">&nbsp;</td>    <td class="borderbottom" style="text-align: right;">ايدرك العميل أن المبلغ المدفوع يعد عربون غير مسترد في حالة
   عدم إتمام العميل عملية االستئجار للسيارة خالل مدة 10 ايام من
                                                   تاريخ إصداره</td>
        </tr>
        <tr><td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tr></td>
