...
function getPrint(){
	...
	document.getElementById("frmProformaInvoicePrint").submit(); 
}
</script>
</head>
...
<form id="frmProformaInvoicePrint" action="printProformaInvoice" autocomplete="off" target="_blank">
<%-- <jsp:include page="../../../../../header.jsp"></jsp:include> --%> <br/> 
 ...
 <table width="100%" class="normaltable">
  <tr>
    <td width="25%" rowspan="6"><img src="<%=contextPath%>/icons/epic.jpg" width="100%" height="auto"  alt=""/></td>
    <td width="45%" rowspan="2">&nbsp;</td>
    <td width="30%"><font size="3"><label id="lblprintname" name="lblprintname"></label><br><label id="lblcompname" name="lblcompname" ><s:property value="lblcompname"/></label></font></td>
  </tr>
  <tr>
...
<hr>
<table width="100%" border="0" hidden="true">
  <tr>
    <td>Tax Summary</td>
    <td align="right">Amount</td>
...
<table width="100%" >
 ...
 <br/><br/><br/>
  <br/><br/><br/>  <br/><br/><br/><div class="divFooter">
