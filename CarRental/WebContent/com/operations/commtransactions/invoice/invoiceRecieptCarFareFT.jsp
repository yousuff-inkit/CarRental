...
<jsp:include page="../../../common/printProgresscarfareFTHeader.jsp"></jsp:include> <br/> 
</div>
...
<table width="100%">
  ...
  <tr>
    ...
    <s:if test="lblinvtype!='INT' && lblinvtype!='INS'">
    	<td colspan="2">Inv From <label name="lblinvfrom" id="lblinvfrom" style="margin-left:40px;">: <s:property value="lblinvfrom"/></label> To <label name="lblinvto" id="lblinvto" ><s:property value="lblinvto"/></label></td>
    </s:if>
...
<s:if test="#manual==1">
	<table style="width:100%;">
		<tr>
			<td>Remarks:</td>
			<td><label id="lblledgernote" name="lblledgernote"><s:property value="lblledgernote"/></label></td>
		</tr>
	</table>
	<hr>
</s:if>
