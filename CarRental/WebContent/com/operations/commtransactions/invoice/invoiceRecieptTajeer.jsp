...
<table width="100%">
  <tr>
    <td width="15%" align="left" style="text-decoration: underline;padding-bottom: 5px;">Bank Details </td>
    
  </tr>
  <tr>
    <td  align="left">Bank Name </td>
    <td>: <label id="lblclient" name="lblclient">Dubai Islamic Bank</label></td>
    
  </tr>
  <tr>
  <td  align="left">Currency </td>
    <td>: <label name="lblinvno" id="lblinvno" >AED</label></td>
  </tr>
  <tr>
    <td align="left">AC No </td>
    <td>: <label id="lblaccount" name="lblaccount" >3103327860001</label></td>
    
  </tr>
  <tr>
    <td align="left">IBAN </td>
    <td>: <label name="lbldate" id="lbldate" >AE630240003103327860001</label></td>
  </tr>
  <tr>
    <td align="left">SWIFT CODE </td>
    <td>: <label name="lbladdress1" id="lbladdress1" >DUIBAEAD</label></td>
