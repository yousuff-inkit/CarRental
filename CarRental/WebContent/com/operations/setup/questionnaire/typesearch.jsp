...
<%ClsquestionnaireDAO DAO= new ClsquestionnaireDAO();%>
 ...
 var rowIndex='<%=rowIndex%>';
   ...
   serviceType='<%=DAO.typeSearch(session)%>';
         ...
         //	var url1;
            ...
            $("#jqxstypesearch").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'Doc No', datafield: 'docno', width: '19%',hidden:true },
					{ text: 'Name', datafield: 'name', width: '100%' }
				           ...
				           $('#jqxstypesearch').on('rowdoubleclick', function (event) 
				              	...
				              	document.getElementById("txttype").value=$('#jqxstypesearch').jqxGrid('getcellvalue', rowindex1, "name"); 
				              	document.getElementById("txtdocno").value=$('#jqxstypesearch').jqxGrid('getcellvalue', rowindex1, "docno"); 
