           ...
           /*   	 if(args.datafield=="model")
               ...
               */
                ...
                columns: [
							...
							{ text: 'Group', datafield: 'vehgroup', width: '10%' },
							{ text: 'Group Id', datafield: 'vehgroupid', width: '10%',hidden:true },
							
							{ text: 'Specification', datafield: 'specification', width: '26%' },	
            ...
            $('#vehoredergrid').on('celldoubleclick', function (event) {
            	...
            	var datafield=event.args.datafield;
              	if(datafield=="brand"){ 
              		...
              		$("#vehoredergrid").jqxGrid('clearselection');
         			var rowindextemp = event.args.rowindex;
         			if($('#docno').val()!='' && $('#brandval').val()==''){
         				$('#brandval').val($('#vehoredergrid').jqxGrid('getcellvalue',rowindextemp,'brdid'));
         			}
         	    	document.getElementById("rowindex").value = rowindextemp;  
         	   		var  brandval=document.getElementById("brandval").value;
         			modelinfoSearchContent('modelSearch.jsp?brandval='+brandval);
