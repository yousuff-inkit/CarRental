...
<script type="text/javascript">
        ...
        $(document).ready(function () { 	
           ...
           if(temp>0){   
           	   ...
           	   drvdataurl = 'getDriverData.jsp?docNo='+temp+'&check='+id  
          }
            ...
            $("#jqxDriver").on("bindingcomplete", function (event) {
				...
				var showHCColumns = false;
				for (var i = 0; i < rows.length; i++) {
				    const value = rows[i].ltype;
            ...
            //var dataAdapter = new $.jqx.dataAdapter(source, { async: false, autoBind: true }); //commented due to heavy loading time and browser unresponsiveness
            ...
            $("#jqxDriver").jqxGrid(
            {
                ...
                columns: [							
							...
							{ text: 'Lic Issued', datafield: 'issdate', columntype: 'datetimeinput', cellsformat: 'dd.MM.yyyy', width: '7%',
								  ...
								  validation:function(cell,value){
								  	if(value.length==0) return {result:false,message:"Required"};
								  	var issuedate=new Date(value);
								  	var basedate=new Date();
								  	issuedate.setHours(0,0,0,0);
								  	basedate.setHours(0,0,0,0);
								  	if(issuedate>basedate){
								  		document.getElementById("chkvalid").value=1;
								  		return {result:false,message:"Future date restricted"};
								  	}
								  	else{
								  		document.getElementById("chkvalid").value=0;
								  		return true;
