...
<table width="100%">
 <tr>
    ...
    <td align="left" width="20%"><b>Fleet/Reg No.</b></td>
    <td align="left" width="15%"><b>Fleet Name</b></td>
    <td align="left" width="13%"><b>Chassis No.</b></td>
    <td align="right" width="7%"><b>Vat</b></td>
    <td align="right" width="7%"><b>Sales Price</b></td>
 ...
 <s:iterator var="stat1" status="arr" value="%{#request.INV5PRINT}" >
	
		<s:iterator status="arr" value="#stat1" var="stat1" >
        	<tr>   
				
     				<s:iterator status="arr" value="#stat1.split('::')" var="des" begin="0" end="5">
