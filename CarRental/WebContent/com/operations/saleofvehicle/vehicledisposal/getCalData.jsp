...
try{
	...
	String strcheckcurdepr="select sum(dramount) amt from gc_assettran asset left join my_account ac on asset.acno=ac.acno and AC.codeno in ('VEH','VDE','VAD')  where fleet_no="+fleet;
