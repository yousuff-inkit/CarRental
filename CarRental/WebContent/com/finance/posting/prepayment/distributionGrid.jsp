        ...
        $(document).ready(function () { 
            ...
            $("#jqxDistributionGrid").jqxGrid(
            {
                ...
                columns: [                { text: 'SL#', sortable: false, filterable: false,            
							...
							{ text: 'Amount', datafield: 'amount', editable: true, cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right', cellbeginedit: cellbeginedit, cellclassname: cellclassname, aggregates: ['sum']  },
            ...
            $("#Menu2").on('itemclick', function (event) {
                ...
                if ($.trim($(args).text()) == "Edit Selected Row") {
                	...
                	var rowid = $("#jqxDistributionGrid").jqxGrid('getrowid', rowindex);
                	  var posted=$('#jqxDistributionGrid').jqxGrid('getcellvalue', rowid, "posted");
                      if(posted==0){
