        ...
        $(document).ready(function () {
            ...
            $("#jqxJournalVoucherApplying").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Debit', datafield: 'debit', width: '10%', editable: false, cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right'},
							{ text: 'Credit', datafield: 'credit', width: '10%', editable: false, cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right'},
