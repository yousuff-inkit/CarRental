        ...
        $(document).ready(function () {
            ...
            $("#jqxJournalVoucherApplying").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Debit', datafield: 'debit', width: '8%', cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right'},
							{ text: 'Credit', datafield: 'credit', width: '8%', cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right'},
							...
							{ text: 'Rate', hidden: true, datafield: 'rate', editable: false,width: '10%', cellsalign: 'right', align: 'right',cellsformat: 'd'+curdec },
