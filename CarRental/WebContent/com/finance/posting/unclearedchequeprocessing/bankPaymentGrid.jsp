        ...
        $(document).ready(function () { 
            ...
            $("#jqxBankPayment").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Rate', datafield: 'rate', cellsformat: 'd'+curdec,  width: '4%', cellsalign: 'right', align: 'right' },
							...
							{ text: 'Base Amount', datafield: 'baseamount1', cellsformat: 'd'+amtdec, width: '8%', cellsalign: 'right', align: 'right' },
