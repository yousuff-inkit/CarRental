        ...
        $(document).ready(function () { 	
            ...
            $("#jqxApplyInvoicing").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Amount', datafield: 'tramt', width: '10%', cellsformat: 'd'+amtdec, editable: false, cellsalign: 'right', align: 'right' },
							{ text: 'Applying', datafield: 'applying', width: '10%', cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right', aggregates: ['sum'] },
							{ text: 'Balance', datafield: 'balance', width: '10%',cellsformat: 'd'+amtdec, editable: false, cellsalign: 'right', align: 'right', aggregates: ['sum'] },
