<%@page import="com.finance.posting.manualapplyingnew.ClsManualApplyingDAO"%>  
<%ClsManualApplyingDAO DAO= new ClsManualApplyingDAO(); %>
<%@page import="javax.servlet.http.HttpServletRequest" %>
<%@page import="javax.servlet.http.HttpSession" %>
<% String accNo = request.getParameter("accNo")==null || request.getParameter("accNo")==""?"0":request.getParameter("accNo");  
...
<script type="text/javascript">
       var data2;
        $(document).ready(function () { 	
             ...
             if(temp>0)
           	 { 
            	  data2='<%=DAO.applyInvoiceGridLoading(accNo,aType,check,docno)%>';    
           	 } 
            ...
            $("#overlay, #PleaseWait").hide();
             ...
             var totamount = $('#txtapplyinvoiceamt').val();
   		     if(!isNaN(totamount || applied1)){
   		        var totbalance= parseFloat(totamount) - parseFloat(applied1);  
				funRoundAmt(totbalance,"txtapplyinvoicebalance");
   		     } 
   		     console.log(totamount+"=="+applied1);  
             applied1="";
