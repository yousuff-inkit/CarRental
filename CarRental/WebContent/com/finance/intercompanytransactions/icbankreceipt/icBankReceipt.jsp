...
<table width="100%">
  <tr>
    ...
    <td width="19%"><input type="text" id="txtfromrate" name="txtfromrate" style="width:45%;text-align: right;" value='<s:property value="txtfromrate"/>' onblur="getBaseAmountFrom();getDrTotal();funRoundRate(this.value,this.id);" tabindex="-1"/></td>
  </tr>
  <tr>
    ...
    <td width="16%"><input type="text" id="txtfrombaseamount" name="txtfrombaseamount" style="width:75%;text-align: right;" value='<s:property value="txtfrombaseamount"/>' tabindex="-1" onblur="funRoundAmt(this.value,this.id);" /></td>
...
<table width="100%">
  <tr>
    ...
    <td width="68%"><input type="text" id="txtdrtotal" name="txtdrtotal" style="width:15%;text-align: right;" value='<s:property value="txtdrtotal"/>' tabindex="-1" onblur="funRoundAmt(this.value,this.id);" /></td>
