...
//	 		 funRemoveReadOnly();
			 ...
			 $('#cmbfromcurrency ').attr('disabled', false );
				...
				// $("#icBankPaymentGridId").jqxGrid('clear');
				$("#icBankPaymentGridId").jqxGrid('addrow', null, {});
		 }
...
<table width="100%">
  <tr>
    ...
    <td width="19%"><input type="text" id="txtfromrate" name="txtfromrate" style="width:45%;text-align: right;" value='<s:property value="txtfromrate"/>' onblur="getBaseAmountFrom();getCrTotal();funRoundRate(this.value,this.id);" tabindex="-1"/></td>
  </tr>
  <tr>
    ...
    <td width="16%"><input type="text" id="txtfrombaseamount" name="txtfrombaseamount" style="width:75%;text-align: right;" value='<s:property value="txtfrombaseamount"/>' onblur="funRoundAmt(this.value,this.id);"  tabindex="-1"/></td>
...
<table width="100%">
  <tr>
    ...
    <td width="68%"><input type="text" id="txtdrtotal" name="txtdrtotal" style="width:15%;text-align: right;" value='<s:property value="txtdrtotal"/>' onblur="funRoundAmt(this.value,this.id);" tabindex="-1"/></td>
    <td width="6%" align="right">Cr. Total</td>
    <td width="19%"><input type="text" id="txtcrtotal" name="txtcrtotal" style="width:50%;text-align: right;" value='<s:property value="txtcrtotal"/>' onblur="funRoundAmt(this.value,this.id);"  tabindex="-1"/></td>
  </tr>
</table>
