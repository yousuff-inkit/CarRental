...
background-image: url("<%=contextPath%>/icons/draft.png");
...
<jsp:include page="../../../common/printHeaderCreditfireits.jsp"></jsp:include>
</div>
...
<table width="100%">
 ...
 <div id="image" hidden="true" style="height:0px;width:0px"><img src="<%=contextPath%>/icons/draft.png" /></div> 
...
<table width="100%">
  ...
  <tr>
    <td><b>by</b>&nbsp;<label name="lblpreparedby" id="lblpreparedby" ><s:property value="lblpreparedby"/></label></td>
     <td><b>by</b>&nbsp;<label name="verified" id="verified" ><s:property value="verified"/></label></td>
