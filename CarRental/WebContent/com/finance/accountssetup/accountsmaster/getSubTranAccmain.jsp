...
try{
	...
	String strSql = "select replace(h.description,',','') mainac,h.brhid, h.den,trim(h.doc_no) doc_no from my_head h where h.m_s=1  and den<>255 and den<>340 order by mainac";
