        ...
        $(document).ready(function () { 
            ...
            $("#jqxIbBankPayment").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Rate', datafield: 'rate', editable: true,width: '4%', cellsformat: 'd'+curdec, cellsalign: 'right', align: 'right' },
							...
							{ text: 'Amount', datafield: 'amount1', width: '7%',  cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right' },
							{ text: 'Base Amount', datafield: 'baseamount1', editable: false,  cellsformat: 'd'+amtdec, width: '7%', cellsalign: 'right', align: 'right' },
