        ...
        $(document).ready(function () { 
            ...
            $("#jqxApplyIbBankInvoicing").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Amount', datafield: 'tramt', width: '10%', editable: false, cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right' },
							{ text: 'Applying', datafield: 'applying', width: '10%', cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right', aggregates: ['sum'] },
							{ text: 'Balance', datafield: 'balance', width: '15%', editable: false, cellsformat: 'd'+amtdec, cellsalign: 'right', align: 'right', aggregates: ['sum'] },
							{ text: 'Out Amount',hidden: true, datafield: 'out_amount',  width: '5%', cellsformat: 'd'+amtdec },
