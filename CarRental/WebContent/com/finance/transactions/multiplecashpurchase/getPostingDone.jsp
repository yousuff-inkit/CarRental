...
<%
	...
	try{
		...
		for(int j=0;j<vndarray.size();j++){
			...
			sql1="select d.qty,d.unitprice,coalesce(ac.cldocno,0) cldocno,coalesce(ac.refname,0) refname,coalesce(ac.acno,0) acno,d.costtype,d.acno glacno,d.costcode,d.tax,d.taxamt,REPLACE(COALESCE(d.description,''), ',', '') description,d.total,d.amount,d.invno,m.date invdate from my_mcpbd d left join my_mcpbm m on m.tr_no=d.tr_no left join my_acbook ac on d.vendid=ac.cldocno and ac.dtype='VND' where d.tr_no="+trno+" and d.vendid="+vnd[0]+" and d.invno='"+vnd[1]+"'";
