        ...
        $(document).ready(function () { 
            ...
            $("#jqxPettyCash").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Amount', datafield: 'amount1',  cellsformat: 'd'+amtdec, width: '8%', cellsalign: 'right', align: 'right', aggregates: ['sum'],aggregatesrenderer:rendererstring },
							{ text: 'Base Amount', datafield: 'baseamount1', editable: false,  cellsformat: 'd'+amtdec, width: '8%', cellsalign: 'right', align: 'right', aggregates: ['sum'],aggregatesrenderer:rendererstring },
