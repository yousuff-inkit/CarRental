	 ...
	 function funFocus() {
	  ...
	  function funNotify(){	
		  /* Validation */
	    	...
	    	document.getElementById("errormsg").innerText="";
	         ...
	         /* Validation Ends*/
	         $('#budgetIncomeGridID').jqxGrid('clearfilters');       
	         $('#budgetExpenditureGridID').jqxGrid('clearfilters');   
	    	 /* Income Grid  Saving*/
			    ...
			    /* Expenditure Grid  Saving*/
				  ...
				  for(var i=0 ; i < rows.length ; i++){  
					    ...
					    if(typeof(chks) != "undefined" && typeof(chks) != "NaN" && chks != "" && chks != "0"){
		  				...
		  				newTextBox.val(rows[i].acno+":: "+rows[i].monthamt1+":: "+rows[i].monthamt2+":: "+rows[i].monthamt3+":: "+rows[i].monthamt4+":: "+rows[i].monthamt5+":: "+rows[i].monthamt6+":: "+rows[i].monthamt7+":: "+rows[i].monthamt8+":: "+rows[i].monthamt9+":: "+rows[i].monthamt10+":: "+rows[i].monthamt11+":: "+rows[i].monthamt12+":: "+rows[i].grtype+":: "+rows[i].netexpense);  
		  				newTextBox.appendTo('form');
		  			  }
				    }
	  ...
	  function funPrintBtn() {
			if (($("#mode").val() == "view") && $("#docno").val()!="") {
			     ...
			     var reurl=url.split("budgetAction");   
