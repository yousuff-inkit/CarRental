...
<table width="100%">
  <tr>
    <td colspan="2" width="8%" align="left">Your Account has been<label id="lblcreditordebit" name="lblcreditordebit"><s:property value="lblcreditordebit"/></label></td>
    <td width="60%">: <label id="lblaccountname" name="lblaccountname"><s:property value="lblaccountname"/></label></td>
    <td width="3%" align="left">Docno</td>
    <td colspan="2" width="76%">: <label id="Lbldocumentno" name="Lbldocumentno"><s:property value="Lbldocumentno"/></label></td>    
  </tr>
  <tr>
    ...
    <td colspan="2" width="76%">: <label id="lbldate" name="lbldate"><s:property value="lbldate"/></label></td>
