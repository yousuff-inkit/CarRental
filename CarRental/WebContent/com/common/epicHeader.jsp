...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-left: 20px">
  <tr>
    ...
    <b><label id="lblcompname1" name="lblcompname1" ><s:property value="lblcompname1"/>EPIC RENT A CAR - SOLE PROPRIETORSHIP LLC</label></b></font></td>
  </tr>
  
  <tr>
    <td colspan="9" align="center" style="height: 3mm;"><label style="font-size: 11px;" id="lblcompaddress1" name="lblcompaddress1"><s:property value="lblcompaddress1"/>PO BOX 112768, Al Mabroukah Building , Shaikh Rashid Bin Saeed Street, Al Manhal, Abu Dhabi, UAE </label></td>
  </tr>
  <tr>
