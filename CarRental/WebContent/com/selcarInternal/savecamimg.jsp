...
<%@page import="java.text.SimpleDateFormat" %>
 ...
 Statement stmt1 = conn.createStatement();
	...
	String inspsql="select brhid from gl_vinspm where doc_no='"+inspdoc+"'";
	System.out.println("==sqlbrhidinspm=="+inspsql);
	ResultSet rstst = stmt1.executeQuery(inspsql);
	while(rstst.next()) {
...
//  	System.out.println("IMGPATH:"+path);
  ...
  File dir = new File(path+ "/attachment/VIP");
	...
	System.out.println("CALL fileAttachApp");
	
	stmtAttach.setString(1,code);
	stmtAttach.setString(2,inspdoc);
      ...
      output.flush();
        ...
        */
        ...
        //.substring(data.indexOf(",")+1, data.length());  
			...
			byteArray = Base64.getDecoder().decode(imageString.getBytes("UTF-8"));
			fos.write(byteArray);
			fos.flush();
			fos.close();
  }
