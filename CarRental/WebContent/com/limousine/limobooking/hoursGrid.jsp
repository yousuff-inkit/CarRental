            ...
            $("#hoursGrid").jqxGrid(
            {
               ...
               handlekeyboardnavigation: function (event) {
                ...
                columns: [
							...
							{ text: 'Group', datafield: 'groupid',width:'5%',editable:true,renderer: columnsrenderer,hidden:false},
							...
							{ text: 'Allowance', datafield: 'allowance',width:'8%',editable:false,renderer: columnsrenderer,cellsformat:'d2',cellsalign:'right'},
            ...
            $("#hoursGrid").on("celldoubleclick", function (event)
            		{
            		    ...
            		    if(dataField=="pickuplocation"){
        					...
        					brandSearchContent('groupsearchgrid.jsp?datafield='+dataField+'&gridname=hoursGrid&gridrowindex='+document.getElementById("hoursrowindex").value, $('#groupwindow'));
            		    }
            		    else if(dataField=="model"){
            		    	if($('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'brand')=="" || $('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'brand')=="undefined" || $('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'brand')==null || typeof($('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'brand'))=="undefined"){
            		    		document.getElementById("errormsg").innerText="";
            			   ...
            			   $('#hoursGrid').jqxGrid('clearselection'); 
                       	   ...
                       	   var brandid=$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'brandid');
                       		...
                       		var pickuplocid=$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'pickuplocationid');
                       		$('#tarifwindow').jqxWindow('open');
    						$('#tarifwindow').jqxWindow('focus');																					//   document.getElementById("hoursrowindex").value
    						tarifSearchContent('tarifSearchGrid.jsp?pickuplocid='+pickuplocid+'&datafield='+dataField+'&gridname=hoursGrid&gridrowindex='+rowBoundIndex+'&brandid='+brandid+'&modelid='+modelid+'&blockhrs='+blockhrs+'&client='+document.getElementById("hidclient").value+'&transfertype='+transfertype, $('#tarifwindow'));            		   	   
            		   }
            		});
            ...
            $("#hoursGrid").on('cellvaluechanged', function (event) 
            		{
            		    ...
            		    if(datafield=="guestname" || "guestcontact"){
            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'guestid','0');
            		    } 
            		    if(datafield=="blockhrs"){
            		    	if(isTariffHidden){
	            		    	setTariffHourGridEdit(rowBoundIndex,$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'brandid'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'modelid'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'pickuplocationid'),value,$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'gid'));
            		    	} else {
            		    ...
            		    if(datafield=="brandid"){
            		    	if(isTariffHidden){
	            		    	setTariffHourGridEdit(rowBoundIndex,value,$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'modelid'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'pickuplocationid'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'blockhrs'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'gid'));
            		    	} else {
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarifdocno','');
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarif','');
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'allowance','');
	            		  ...
	            		  //  	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'gid','');
            		    	...
            		    	if(isTariffHidden){
	            		    	setTariffHourGridEdit(rowBoundIndex,$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'brandid'),value,$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'pickuplocationid'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'blockhrs'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'gid'));
            		    	} else {
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarifdocno','');
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarif','');
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'allowance','');
            		    ...
            		    } else if(datafield=="pickuplocationid"){
            		    	if(isTariffHidden){
	            		    	setTariffHourGridEdit(rowBoundIndex,$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'brandid'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'modelid'),value,$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'blockhrs'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'gid'));
            		    	} else {
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarifdocno','');
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarif','');
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'allowance','');
            		    	...
            		    	if(isTariffHidden){
	            		    	setTariffHourGridEdit(rowBoundIndex,$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'brandid'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'modelid'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'pickuplocationid'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'blockhrs'),value,$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'gid'));
            		    	} else {
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarifdocno','');
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarif','');
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'allowance','');
            		    	...
            		    	if(isTariffHidden){
	            		    	setTariffHourGridEdit(rowBoundIndex,$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'brandid'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'modelid'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'pickuplocationid'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'blockhrs'),$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype'),value);
            		    	} else {
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarifdocno','');
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarif','');
	            		    	$('#hoursGrid').jqxGrid('setcellvalue',rowBoundIndex,'allowance','');
