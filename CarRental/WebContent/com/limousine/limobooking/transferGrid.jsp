...
$(document).ready(function () { 
 ...
 var columnsrenderer = function (value) {
          ...
          var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            // var rows = $('#jqxgridtarif').jqxGrid('getrows');
                ...
                columns: [
							...
							{ text: 'Guest Id', datafield: 'guestid',width:'10%',editable:true,renderer: columnsrenderer,hidden:true},
							{ text: 'Guest', datafield: 'guestname',width:'10%',editable:true,renderer: columnsrenderer},
							{ text: 'Guest Contact', datafield: 'guestcontact',width:'10%',editable:true,renderer: columnsrenderer},
							{ text: 'Description', datafield: 'description',width:'10%',editable:true,renderer: columnsrenderer},
							...
							{ text: 'Group', datafield: 'groupid',width:'8%',editable:true,renderer: columnsrenderer},
							{ text: 'Group ID', datafield: 'gid',width:'12%',editable:true,renderer: columnsrenderer,hidden:true},
							{ text: 'Nos', datafield: 'nos',width:'4%',editable:true,renderer: columnsrenderer},
							{ text: 'PAX', datafield: 'pax',width:'4%',editable:true,renderer: columnsrenderer},
							...
							{ text: 'Allowance', datafield: 'allowance',width:'6%',editable:false,renderer: columnsrenderer,cellsalign:'right',cellsformat:'d2'},
            ...
            $("#transferGrid").on("celldoubleclick", function (event)
            		{
            		    ...
            		    if(dataField=="pickuplocation" || dataField=="dropofflocation"){
        					...
        					$('#brandwindow').jqxWindow('focus');
        					brandSearchContent('brandSearchGrid.jsp?datafield='+dataField+'&gridname=transferGrid&gridrowindex='+document.getElementById("transferrowindex").value, $('#brandwindow'));
            		    } else if(dataField=="groupid"){
            		    	document.getElementById("transferrowindex").value=rowBoundIndex;
            		    	$('#transferGrid').jqxGrid('clearselection'); 
            		    	$('#transferGrid').jqxGrid('render');
            		    	$('#groupwindow').jqxWindow('open');
        					$('#groupwindow').jqxWindow('focus');
        					groupSearchContent('groupsearchgrid.jsp?datafield='+dataField+'&gridname=transferGrid&gridrowindex='+document.getElementById("transferrowindex").value, $('#groupwindow'));
            		    }
            		    else if(dataField=="model"){
            		    	if($('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'brand')=="" || $('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'brand')=="undefined" || $('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'brand')==null || typeof($('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'brand'))=="undefined"){
            		    		document.getElementById("errormsg").innerText="";
            			   ...
            			   $('#transferGrid').jqxGrid('clearselection'); 
    						...
    						tarifSearchContent('tarifSearchGrid.jsp?datafield='+dataField+'&gridname=transferGrid&gridrowindex='+rowBoundIndex+'&brandid='+brandid+'&modelid='+modelid+'&pickuplocid='+pickuplocid+'&dropofflocid='+dropofflocid+'&client='+document.getElementById("hidclient").value+'&transfertype='+transfertype, $('#tarifwindow'));            		   	   
            		   }
            		});
            ...
            $("#transferGrid").on('cellvaluechanged', function (event) 
            		{
            		    ...
            		    if(datafield=="guestname" || "guestcontact"){
            		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'guestid','0');
            		    } 
            		    ...
            		    if(datafield=="pickuplocationid"){
            		    	if(isTariffHidden){
            		    		setTariffTransferGridEdit(rowBoundIndex,$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'brandid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'modelid'),value,$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'dropofflocationid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'gid'));            		    		
            		    	} else {
            		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarifdocno','');
            		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'estdistance','');
            		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'esttime','');
            		    ...
            		    } else if (datafield=="modelid"){
            		    	if(isTariffHidden){
            		    		setTariffTransferGridEdit(rowBoundIndex,$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'brandid'),value,$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'pickuplocationid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'dropofflocationid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype',$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'gid')));            		    		
            		    	} else {
            		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarifdocno','');
            		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'estdistance','');
            		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'esttime','');
            		...
            		} else if (datafield=="brandid"){
        		    	if(isTariffHidden){
        		    		setTariffTransferGridEdit(rowBoundIndex,value,$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'modelid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'pickuplocationid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'dropofflocationid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'gid'));            		    		
        		    	} else {
        		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarifdocno','');
        		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'estdistance','');
        		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'esttime','');
        		...
        		}  else if (datafield=="dropofflocationid"){
    		    	if(isTariffHidden){
    		    		setTariffTransferGridEdit(rowBoundIndex,$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'brandid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'modelid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'pickuplocationid'),value,$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'gid'));            		    		
    		    	} else {
    		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarifdocno','');
    		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'estdistance','');
    		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'esttime','');
		    	...
		    	if(isTariffHidden){
		    		setTariffTransferGridEdit(rowBoundIndex,$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'brandid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'modelid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'pickuplocationid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'dropofflocationid'),value,$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'gid'));            		    		
		    	} else {
		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarifdocno','');
		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'estdistance','');
		    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'esttime','');
		...
		} else if (datafield=="gid"){
	    	if(isTariffHidden){
	    		setTariffTransferGridEdit(rowBoundIndex,$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'brandid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'modelid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'pickuplocationid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'dropofflocationid'),$('#transferGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype'),value);            		    		
	    	} else {
	    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'tarifdocno','');
	    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'estdistance','');
	    	$('#transferGrid').jqxGrid('setcellvalue',rowBoundIndex,'esttime','');
...
function appendDetails(gridname,row1,row2){
	...
	if(gridname=="transferGrid"){
		...
		$('#'+gridname).jqxGrid('setcellvalue',row2,'pax',$('#'+gridname).jqxGrid('getcellvalue',row1,'pax'));
		...
		$('#'+gridname).jqxGrid('setcellvalue',row2,'allowance',$('#'+gridname).jqxGrid('getcellvalue',row1,'allowance'));
		...
		$('#'+gridname).jqxGrid('setcellvalue',row2,'chkothersrvc',$('#'+gridname).jqxGrid('getcellvalue',row1,'chkothersrvc'));
		$('#'+gridname).jqxGrid('setcellvalue',row2,'gid',$('#'+gridname).jqxGrid('getcellvalue',row1,'gid'));
		$('#'+gridname).jqxGrid('setcellvalue',row2,'days',$('#'+gridname).jqxGrid('getcellvalue',row1,'days'));
		$('#'+gridname).jqxGrid('setcellvalue',row2,'transfertype',$('#'+gridname).jqxGrid('getcellvalue',row1,'transfertype')); 
		$('#'+gridname).jqxGrid('setcellvalue',row2,'tarifdocno',$('#'+gridname).jqxGrid('getcellvalue',row1,'tarifdocno'));
