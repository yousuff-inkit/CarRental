         ...
         $('#gridGroup1').on('rowdoubleclick', function (event) 
              {
				...
				var totalRowstt = $('#gridTarifTransfer').jqxGrid('getrows').length;
	        	var totalRowsth = $('#gridTarifHour').jqxGrid('getrows').length;
	        	var totalRowsttg = $('#limoTaxiTarifGrid').jqxGrid('getrows').length;
	        	if(totalRowstt==0){
