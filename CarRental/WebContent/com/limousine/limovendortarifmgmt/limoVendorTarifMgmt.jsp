	    ...
	    $(function(){
	     ...
	     function funNotify(){
	    	 ...
	    	 if(document.getElementById("hidtarifvendor").value==""){
	    			// alert ("Entered");
	    		 if($('#cmbtariftype').val()=="vendor" || $('#cmbtariftype').val()=="corporate") {
	    			 document.getElementById("errormsg").innerText="";
		    		 document.getElementById("errormsg").innerText="Corporate/Vendor is mandatory";
		    		 document.getElementById("tarifvendor").focus();
		    		 return 0;
	    		 } else {
