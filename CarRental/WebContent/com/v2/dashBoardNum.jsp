...
<%
    HttpSession portalsession = ServletActionContext.getRequest().getSession(false);
    if (portalsession == null || portalsession.getAttribute("PORTALUSER") == null || portalsession.getAttribute("PORTALUSER")=="") {
        response.sendRedirect(request.getContextPath() + "/customerloginnew/index.jsp");
    }
%>
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<div class="panel panel-default agmt-count">
					<div class="panel-body">
						<div style="display:flex;align-items:center;justify-content:space-between;" class="card-detail-container">
							<img src="../../icons/dashboard-car.png" class="img-responsive"/>
							
							<div class="text-center daily-count">
                                <p>Daily</p>
                                <h4><span class="counter">0</span></h4>
                            </div>
                            <div class="text-center weekly-count">
                                <p>Weekly</p>
                                <h4><span class="counter">0</span></h4>
                            </div>
                            <div class="text-center monthly-count">
                                <p>Monthly</p>
                                <h4><span class="counter">0</span></h4>
                            </div>
                            <div class="text-center lease-count">
                                <p>Lease</p>
                                <h4><span class="counter">0</span></h4>
                            </div>
                            <div class="text-center booking-count">
                                <p>Bookings</p>
                                <h4><span class="counter">0</span></h4>
                            </div>
						</div>
                ...
                <%-- <div class="card-container agmt-count">
                    <div class="card-body">
                        <div class="card-icon-container p-l-5">
                            <img src="../../icons/dashboard-car.png" class="img-responsive"/>
                        </div>
                        <div class="card-detail-container">
                            <div>
	    ...
	    <div class="row">
	    	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
	    		<div class="panel panel-default widget-revenuecomplist">
	                ...
	                <div class="panel-body table-responsive pos-relative no-padding" style="height:277px;overflow:auto;border:none;">
	                	<div class="panel-loader dis-none">
	                		<i class="fa fa-circle-o-notch fa-spin fa-fw ab-c-m fa-2x"></i>
	                	</div>
	                	<div class="p-15">
	    	...
	    	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
	    		<div class="panel panel-default widget-fleetstatus">
	                <div class="panel-heading">
	                    <h4 class="panel-title">
	                        <span class="panel-title-text fs-12"><strong>Fleet Status</strong></span>
	                    </h4>
	                </div>
	                <div class="panel-body table-responsive pos-relative no-padding" style="height:310px;overflow:auto;border:none;">
	                	<div class="panel-loader dis-none">
	                	...
	                	<div class="p-15">
	                		<table class="table" style="width:100%" id="tblfleetstatus">
		                        <thead>
		                        	<tr>
	    ...
	    <div class="row">
	    	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
	    		<div class="panel panel-default widget-salikstatus">
	                <div class="panel-heading">
	                    <h4 class="panel-title">
	                        <span class="panel-title-text fs-12"><strong>Salik Status</strong></span>
	                        <div>
	                        	<input type="text" name="daterangesalik" value="" id="daterangesalik" style="font-size: 12px;padding:7px;width: 180px;display: inline-block;" class="form-control"/>
	                        </div>
	                    </h4>
	                </div>
	                <div class="panel-body table-responsive pos-relative no-padding" style="border:none;">
	                	<div class="panel-loader dis-none">
	                		<i class="fa fa-circle-o-notch fa-spin fa-fw ab-c-m fa-2x"></i>
	                	</div>
	                	<div class="p-15">
	                		<table class="table" style="width:100%" id="tblsalikstatus">
		                        <thead>
		                        	<tr>
		                                <th>Status</th>
	    	...
	    	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
	    		<div class="panel panel-default widget-trafficstatus">
	                <div class="panel-heading">
	                    <h4 class="panel-title">
	                        <span class="panel-title-text fs-12"><strong>Traffic Status</strong></span>
	                        <div>
	                        	<input type="text" name="daterangetraffic" value="" id="daterangetraffic" style="font-size: 12px;padding:7px;width: 180px;display: inline-block;" class="form-control"/>
	                        </div>
	                    </h4>
	                </div>
	                <div class="panel-body table-responsive pos-relative no-padding" style="border:none;">
	                	...
	                	<div class="p-15">
	                		<table class="table" style="width:100%" id="tbltrafficstatus">
		                        <thead>
		                        	<tr>
		                                <th>Status</th>
		                                <th class="text-right">Branch</th>
	    ...
	    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	    		<div class="panel panel-default widget-bookingflupstatus" >
	                <div class="panel-heading">
	                    <h4 class="panel-title">
	                        <span class="panel-title-text fs-12"><strong>Pending Booking List</strong></span>
	                        <div>
	                        	<input type="text" name="daterangebookingflup" value="" id="daterangebookingflup" style="font-size: 12px;padding:7px;width: 180px;display: inline-block;" class="form-control"/>
	                        </div>
	                    </h4>
	                </div>
	              <div class="panel-body table-responsive pos-relative no-padding" style="height:310px;overflow:auto;border:none;">
	                	...
	                	<div class="p-15">
	                		<table class="table" style="width:100%" id="tblbookingflup">
		                        <thead>
		                        	<tr>
		                        	    <th >Sr No</th>
		                        	    <th >Doc No</th>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$('#daterangefleetutil,#daterangerevenue,#daterangecollection,#daterangerevenuecomp1,#daterangerevenuecomp2,#daterangesalik,#daterangetraffic').daterangepicker({
                showCalendars:true,
                locale: {
            		format: 'DD/MM/YYYY'
        		}
			   ...
			   $('#daterangebookingflup').daterangepicker({
			...
			$('#daterangesalik').data('daterangepicker').setStartDate(moment().subtract(1, 'month'));
			$('#daterangesalik').data('daterangepicker').setEndDate(moment());
			$('#daterangetraffic').data('daterangepicker').setStartDate(moment().subtract(1, 'month'));
			$('#daterangetraffic').data('daterangepicker').setEndDate(moment());
			/* $('#daterangebookingflup').data('daterangepicker').setStartDate(moment().subtract(1, 'month'));
			 */$('#daterangebookingflup').data('daterangepicker').setStartDate(moment());
			...
			$('#daterangesalik').on('apply.daterangepicker', function(ev, picker) {
  				var fromdate=picker.startDate.format('DD.MM.YYYY');
  				var todate=picker.endDate.format('DD.MM.YYYY');
  				funGetFilterData(fromdate,todate,"",'salikstatus');
			});
			
			$('#daterangetraffic').on('apply.daterangepicker', function(ev, picker) {
  				var fromdate=picker.startDate.format('DD.MM.YYYY');
  				var todate=picker.endDate.format('DD.MM.YYYY');
  				funGetFilterData(fromdate,todate,"",'trafficstatus');
			});
			$('#daterangebookingflup').on('apply.daterangepicker', function(ev, picker) {
  				/* var fromdate=picker.startDate.format('DD.MM.YYYY');
  				 */var todate=picker.startDate.format('DD.MM.YYYY');
  				 
  				//funGetFilterData(fromdate,todate,"",'bookingflupstatus');
  				funGetFilterData("",todate,"",'bookingflupstatus');
			});
		...
		function funGetFilterData(fromdate,todate,filtertype,widgetname){
			...
			x.onreadystatechange=function(){
				if (x.readyState==4 && x.status==200){
					...
					if(widgetname=='fleetutillist'){
					...
					else if(widgetname=="salikstatus"){
						rawdata.salikstatusdata=objdata.salikstatusdata;
						rawdata.branchdata=objdata.branchdata;
						var htmldata='';
						htmldata+='<tr>';
						htmldata+='<th>Status</th>';
						$.each(rawdata.branchdata,function(key,value){
							htmldata+='<th>'+value.refname+'</th>';
						});
						htmldata+='</tr>';
						$('#tblsalikstatus thead').html($.parseHTML(htmldata));
						htmldata='';
						$.each(rawdata.salikstatusdata,function(key,value){
							htmldata+='<tr>';
							htmldata+='<td>'+value.statusname+'</td>';
							$.each(rawdata.branchdata,function(subkey,subvalue){
								htmldata+='<td>'+value["branch"+subkey]+'</td>';
							});
							htmldata+='</tr>';
						});
						$('#tblsalikstatus tbody').html($.parseHTML(htmldata));
					}
					else if(widgetname=="trafficstatus"){
						rawdata.trafficstatusdata=objdata.trafficstatusdata;
						rawdata.branchdata=objdata.branchdata;
						var htmldata='';
						htmldata+='<tr>';
						htmldata+='<th>Status</th>';
						...
						htmldata+='</tr>';
						$('#tbltrafficstatus thead').html($.parseHTML(htmldata));
						htmldata='';
						$.each(rawdata.trafficstatusdata,function(key,value){
							htmldata+='<tr>';
							htmldata+='<td>'+value.statusname+'</td>';
							$.each(rawdata.branchdata,function(subkey,subvalue){
								htmldata+='<td>'+value["branch"+subkey]+'</td>';
						...
						$('#tbltrafficstatus tbody').html($.parseHTML(htmldata));
					}
					else if(widgetname=="bookingflupstatus"){
							rawdata.bookingflupdata=objdata.bookingflupdata;
							var bfluphtml='';
							$.each(rawdata.bookingflupdata,function(key,value){
								bfluphtml+='<tr>';
								bfluphtml+='<td >'+value.slno+'</td>';
								bfluphtml+='<td >'+value.docno+'</td>';
								bfluphtml+='<td >'+value.fleet_no+'</td>';
								bfluphtml+='<td >'+value.brmodel+'</td>';
								bfluphtml+='<td>'+value.name+'</td>';
								bfluphtml+='<td>'+value.rtype+'</td>';
								bfluphtml+='<td >'+value.frmdate+'</td>';
								bfluphtml+='<td >'+value.todate+'</td>';
								bfluphtml+='</tr>';
							});
							$('#tblbookingflup tbody').html($.parseHTML(bfluphtml));
						}
		...
		x.onreadystatechange=function(){
			if (x.readyState==4 && x.status==200){
            	...
            	$("#gauge1").closest('.card-container').find('.card-footer').find('.countervalue').text(guagedata.occtotalvalue);
            	$("#gauge2").closest('.card-container').find('.card-footer').find('.countervalue').text(guagedata.occavailvalue);
            	$("#gauge3").closest('.card-container').find('.card-footer').find('.countervalue').text(guagedata.occgaragevalue);
            	$("#gauge4").closest('.card-container').find('.card-footer').find('.countervalue').text(guagedata.occunrentablevalue);
            	
            	//body > div.container-fluid > div:nth-child(4) > div > div.panel.panel-default.agmt-count > div > div > div:nth-child(2)
				$('.agmt-count .daily-count').find('.counter').text(guagedata.agmtdailycount);
				$('.agmt-count .weekly-count').find('.counter').text(guagedata.agmtweeklycount);
				$('.agmt-count .monthly-count').find('.counter').text(guagedata.agmtmonthlycount);
				$('.agmt-count .lease-count').find('.counter').text(guagedata.agmtleasecount);
				$('.agmt-count .booking-count').find('.counter').text(guagedata.bookingcount);
				$('.admin-cover').find('.user-text').text(guagedata.portaluser);
				
				var htmldata='';
				$.each(guagedata.fleetstatusdata,function(index,value){
					htmldata+='<tr>';
					htmldata+='<td>'+value.trancode+'</td>';
					htmldata+='<td class="text-right">'+value.itemcount+'</td>';
					htmldata+='</tr>';
				});
				$('#tblfleetstatus tbody').html($.parseHTML(htmldata));
				
				$('.counter,.countervalue').counterUp({
		            delay: 10,
		            time: 1000
		        });
				...
				var salikfromdate = $('#daterangesalik').data('daterangepicker').startDate.format('DD.MM.YYYY');
				var saliktodate = $('#daterangesalik').data('daterangepicker').endDate.format('DD.MM.YYYY');
				funGetFilterData(salikfromdate,saliktodate,"",'salikstatus');
				
				var trafficfromdate = $('#daterangetraffic').data('daterangepicker').startDate.format('DD.MM.YYYY');
				var traffictodate = $('#daterangetraffic').data('daterangepicker').endDate.format('DD.MM.YYYY');
				funGetFilterData(trafficfromdate,traffictodate,"",'trafficstatus');
				
				/* var bookingflupfromdate = $('#daterangebookingflup').data('daterangepicker').startDate.format('DD.MM.YYYY');
				 */var bookingfluptodate = $('#daterangebookingflup').data('daterangepicker').startDate.format('DD.MM.YYYY');
				//funGetFilterData(bookingflupfromdate,bookingfluptodate,"",'bookingflupstatus');
				funGetFilterData("",bookingfluptodate,"",'bookingflupstatus');
