...
private Date branchaccdate1;
private Date hidbranchaccdate1;
private Date branchaccdate2;
private Date hidbranchaccdate2;
private String cmbbranchcurr;
private String hidcmbbranchcurr;
private String mode;
private String deleted;
private String cmbcompname;
private int hidcmbcompname;
...
public int getHidcmbcompname() {
	return hidcmbcompname;
}
public void setHidcmbcompname(int hidcmbcompname) {
...
public Date getBranchaccdate1() {
	return branchaccdate1;
}
public void setBranchaccdate1(Date branchaccdate1) {
	this.branchaccdate1 = branchaccdate1;
}
public Date getHidbranchaccdate1() {
	return hidbranchaccdate1;
}
public void setHidbranchaccdate1(Date hidbranchaccdate1) {
	this.hidbranchaccdate1 = hidbranchaccdate1;
}
public Date getBranchaccdate2() {
	return branchaccdate2;
}
public void setBranchaccdate2(Date branchaccdate2) {
	this.branchaccdate2 = branchaccdate2;
}
public Date getHidbranchaccdate2() {
	return hidbranchaccdate2;
}
public void setHidbranchaccdate2(Date hidbranchaccdate2) {
