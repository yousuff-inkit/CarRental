...
public class ClsVehTypeAction {
	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(mode.equalsIgnoreCase("A")){
			int val=dao.insert(getName(),sqldate,session,mode,getFormdetailcode(),deptarray);
			if(val>0.0){
			...
			int editstatus=dao.edit(getDocno(),sqldate,getName(),session,getMode(),getFormdetailcode(),deptarray,getDeletedrows());
			if(editstatus>0){
