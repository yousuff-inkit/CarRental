...
public class ClsYearEndCloseAction {
	...
	private String hidycloseDateTo,chkstatus;
	private int txttrno;
		...
		if(mode.equalsIgnoreCase("A")){
			...
			/*Year End Close Group Grid Saving Ends*/
						...
						if(val>0.0){
							...
							setHidaccountingYearFrom(nextAccountingYearFromDate==null?null:nextAccountingYearFromDate.toString());
							setHidaccountingYearTo(nextAccountingYearToDate==null?null:nextAccountingYearToDate.toString());
							yearEndCloseBean=(ClsYearEndCloseBean)request.getAttribute("yearEndCloseBean"); 
							if(yearEndCloseBean!=null){
    							if(!yearEndCloseBean.getValidmsg().equals("") && yearEndCloseBean.getValidmsg()!=null) {
    								setMsg(yearEndCloseBean.getValidmsg());
    								setChkstatus("1");
    							}else {
    							    setMsg("Not Saved");
    							}
