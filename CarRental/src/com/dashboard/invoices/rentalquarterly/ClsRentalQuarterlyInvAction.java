...
public class ClsRentalQuarterlyInvAction {
		...
		try{
			...
			if(mode.equalsIgnoreCase("A")){
				...
				for(int j=0;j <getGridlength();j++){
					...
					System.out.println("Action From Date:"+fromdate);
					System.out.println("Action To Date:"+todate);
					...
					String note=objcommon.changeSqltoString(fromdate) +" to "+objcommon.changeSqltoString(todate) +" for Rental Aggrement no "+agmtno;
					...
					currencyid, mode,invoice[4] , "INV###12", "INV",qty2);
					setDetail(getDetail());
