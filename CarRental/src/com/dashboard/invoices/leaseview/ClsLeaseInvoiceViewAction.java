...
public class ClsLeaseInvoiceViewAction {
	ClsConnection ClsConnection=new ClsConnection();

	ClsCommon ClsCommon=new ClsCommon();

	
ClsLeaseInvoiceViewDAO leaseinvoiceDAO=new ClsLeaseInvoiceViewDAO();
...
public String saveAction() throws ParseException, SQLException{
	...
	String mode=getMode();
	ClsLeaseInvoiceViewBean bean=new ClsLeaseInvoiceViewBean();
Connection conn = ClsConnection.getMyConnection();
try{

Statement stmt=conn.createStatement();
ClsLeaseInvoiceViewDAO leaseinvDAO=new ClsLeaseInvoiceViewDAO();
