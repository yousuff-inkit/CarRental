...
public class ClsLeaveRequestDAO  {
	...
	public JSONArray leaveDetailsGridLoading(String rptType, String branchval, String fromdate, String todate, String department, String designation, String category, String employee, String check,String employeebranchchk) throws SQLException {
		    ...
		    try {
		            ...
		            if(employeebranchchk.equalsIgnoreCase("1")){    
		            	if(!(branchval.equalsIgnoreCase("")) && !(branchval.equalsIgnoreCase("0")) && !(branchval.equalsIgnoreCase("a"))){  
		            		sql=sql+" and r.brhid='"+branchval+"'";       
		            	}
		            } 
