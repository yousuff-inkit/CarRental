...
public class ClsAdditionAndDeductionDAO {
	...
	public JSONArray additionAndDeductionGridLoading(String year,String month,String acno,String empId,String check,String employeebranchchk,String brhid) throws SQLException {
	    ...
	    try {
	           ...
	           sql = "select e.codeno empid,e.name empname,CONVERT(if(sum(d.addition)=0,' ',round(sum(d.addition),2)),CHAR(100)) addition, "
	           		...
	           		+ "group by d.empid order by e.name"; 
