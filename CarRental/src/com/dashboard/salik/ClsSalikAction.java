...
public class ClsSalikAction extends ActionSupport{
	...
	private String cmbsaliktype;
	
	
	
	public String getCmbsaliktype() {
		return cmbsaliktype;
	}

	public void setCmbsaliktype(String cmbsaliktype) {
		this.cmbsaliktype = cmbsaliktype;
	}
...
//		System.out.println("chk=========== "+invoice);
		...
		if(mode.equalsIgnoreCase("A")){
			...
			ArrayList<String> invoicearray=salikdao.generateInv(getCmbbranch(),sqlfromdate,sqltodate,getTxtcldocno(),getRentaltype(),getTxtagreementno(),session,getCmbtype(),getCmbcategory(),getCmbsaliktype());
