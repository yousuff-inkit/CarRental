...
public class ClsIndividualAgeingCarAction extends ActionSupport{
    
	ClsIndividualAgeingCar ClsIndividualAgeingCarDAO= new ClsIndividualAgeingCar();
	ClsIndividualAgeingCarBean ClsIndividualAgeingCarBean;
	...
	public String printAction() throws ParseException, SQLException{
		//System.out.println("Inside action 1 ");
		 ...
		 ClsIndividualAgeingCar DAO=new ClsIndividualAgeingCar();
		 ClsIndividualAgeingCarBean printbean= new ClsIndividualAgeingCarBean();
		 ...
		 setUrl(common.getBIBPrintPath("IDA"));
      	  // System.out.println("iside jrxml");
             ...
             param.put("account", printbean.getLblaccountname());
             param.put("runbal",printbean.getRunbal());
