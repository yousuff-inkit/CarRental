	    ...
	    try {
				...
				if(check.equalsIgnoreCase("1")){
				 ...
				 sql = "SELECT m.fleet_no,m.flname,m.reg_no,m.plate,m.yom,m.age,m.purdate,m.deprper,\r\n" + 
			    		...
			    		"if(a.date>='"+sqlFromDate+"' and a.date<='"+sqlToDate+"' AND  (a.dramount<0 or a.ttype='ADJ'),a.dramount,'') depr_add,\r\n" + 
			    		"if(a.date>='"+sqlFromDate+"' and a.date<='"+sqlToDate+"' AND a.dramount>0 AND a.ttype!='ADJ',a.dramount,'')  depr_del,\r\n" + 
