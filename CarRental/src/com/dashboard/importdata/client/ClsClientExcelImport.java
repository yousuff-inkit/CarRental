...
public class ClsClientExcelImport {
    ...
    public int ExcelImport(String docNo) throws SQLException {
        ...
        try{
			...
			String path="";
			String sql = "select path from my_fileattach where doc_no='"+docNo+"' and dtype='CLT'";
            ...
            for(int i=1; i<=sheet.getLastRowNum(); i++){  //Changed i=0 because of header in excel - 2022/07/11
               ...
               for(int j=0;j<25;j++)
               {
                ...
                String salesman = row.getCell(8)==null?"":row.getCell(8).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String taxable = row.getCell(9)==null?"":row.getCell(9).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String trnnumber = row.getCell(10)==null?"":row.getCell(10).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String category = row.getCell(11)==null?"":row.getCell(11).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String areaname = row.getCell(12)==null?"":row.getCell(12).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String areaid = row.getCell(13)==null?"":row.getCell(13).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String doc_no = row.getCell(14)==null?"":row.getCell(14).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String atype = row.getCell(15)==null?"":row.getCell(15).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String acno = row.getCell(16)==null?"":row.getCell(16).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String parentco = row.getCell(17)==null?"":row.getCell(17).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String fax1 = row.getCell(18)==null?"":row.getCell(18).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String fax2 = row.getCell(19)==null?"":row.getCell(19).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String web1 = row.getCell(20)==null?"":row.getCell(20).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String mail1 = row.getCell(21)==null?"":row.getCell(21).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                ...
                String date = row.getCell(25)==null?"":row.getCell(25).getStringCellValue().toString(); 
                ...
                String dtjoin = row.getCell(29)==null?"":row.getCell(29).getStringCellValue().toString(); 
                String basic = row.getCell(30)==null?"":row.getCell(30).getStringCellValue().replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
                String contactperson = row.getCell(31)==null?"":row.getCell(31).getStringCellValue(); 
                ...
                String branchname = row.getCell(53)==null?"":row.getCell(53).getStringCellValue().replace(".", " ").replace("\"","'").replaceAll("'", "/").replaceAll("\\s+", " "); 
     	  ...
     	  if(!(dtjoin.equalsIgnoreCase("undefined"))&&!(dtjoin.equalsIgnoreCase(""))&&!(dtjoin.equalsIgnoreCase("null"))){
    		     ...
    		     sqlDtjoin=ClsCommon.changeStringtoSqlDate3(dtjoin);
			              ...
			              String sql1 ="select refname from im_client where refname='"+refname+"' ";
			              ...
			              else if (!(refname.equalsIgnoreCase("")))
			              {
			     			 ...
			     			 System.out.println("value==="+date);  
			     			  ...
			     			  String sql2 ="insert into im_client"
			     					+ "( serial_no, refname, salutation, address, com_mob, per_mob, opt_mob, salesman, taxable, trnnumber, category,"
			     					+ " areaname, areaid, doc_no, atype, acno, parentco, fax1, fax2, web1, mail1,"
			     					...
			     					+ " accgroup, serdefault, persalikrate, pertrafficcharge, reftype, contactperno, extno, contractupto, auditt, spclnotes,"
