...
public class ClsDepreciationCostRecognizationAction {
	...
	ClsDepreciationCostRecognizationBean bean ;
	private String mode;
	private String msg;
	...
	private String txtselecteddocs,chkstatus;
	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(mode.equalsIgnoreCase("A")){
			...
			if(val>0.0){
				...
				setDetailname("Depr. Cost Recognization");
				setHiduptodate(dbUpToDate.toString());
				bean=(ClsDepreciationCostRecognizationBean)request.getAttribute("depreciationCostRecognizationBean");   
				if(bean!=null){
