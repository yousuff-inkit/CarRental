package com.dashboard.audit.defleetdetailsupdate;
...
public class ClsDefleetDetailsUpdateDAO {
	...
	public JSONArray getDeFleetData(String id,String fromdate,String todate,String branch,String cldocno) throws SQLException
	{
		...
		try{
			...
			" coalesce(mov2.kmin,0) actualkm,ret.salesprice,ret.date defleetdate,ret.cldocno,ret.agmtno,ac.acno,ret.doc_no,veh.fleet_no,veh.reg_no,veh.flname,veh.prch_cost purcost,veh.residual_val residualval,"+
	...
	public ClsDefleetDetailsUpdateBean getPrint(String fleetno) throws SQLException {

		
		// TODO Auto-generated method stub
		ClsDefleetDetailsUpdateBean bean=new ClsDefleetDetailsUpdateBean();
		Connection conn=null;
		try{
			conn=objconn.getMyConnection();
			Statement stmt=conn.createStatement();
