	...
	public JSONArray workOrderStatusGridLoading(String branch,String fromdate,String todate,String dtype) throws SQLException {
        ...
        java.sql.Date sqlToDate = null;
		  ...
		  try {
			    ...
			    sql = "select "+sql1+"m.voc_no docno,COALESCE(m.tcost,0) totalamt,m.date,m.fleetno,UCASE(m.mtype) type,v.reg_no,v.flname,g.name garage,b.branchname,CONVERT(CONCAT(m.wostatus,m.apstatus,m.psstatus),CHAR(50)) checks from gl_vmcostm m left join "
