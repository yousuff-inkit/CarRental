...
public class ClsCollectionClosureAction extends ActionSupport{
    
	ClsCollectionClosureDAO operationsDAO= new ClsCollectionClosureDAO();
	ClsCollectionClosureBean operationsBean;
	...
	private String lblubertotal;
	private String lblcareemtotal;
	private String lblvouchertotal;

	public String getLblubertotal() {
		return lblubertotal;
	}
	public void setLblubertotal(String lblubertotal) {
		this.lblubertotal = lblubertotal;
	}
	public String getLblcareemtotal() {
		return lblcareemtotal;
	}
	public void setLblcareemtotal(String lblcareemtotal) {
		this.lblcareemtotal = lblcareemtotal;
	}
	public String getLblvouchertotal() {
		return lblvouchertotal;
	}
	public void setLblvouchertotal(String lblvouchertotal) {
		this.lblvouchertotal = lblvouchertotal;
	}
	...
	public String printAction() throws ParseException, SQLException{
		...
		setLblubertotal(operationsBean.getLblubertotal());
		setLblcareemtotal(operationsBean.getLblcareemtotal());
		setLblvouchertotal(operationsBean.getLblvouchertotal());
