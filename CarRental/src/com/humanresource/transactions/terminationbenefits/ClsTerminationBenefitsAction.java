...
public class ClsTerminationBenefitsAction extends ActionSupport{
	...
	private String hidterminationBenefitsPostingDate,chkstatus;
	private int txtjvno;
		...
		if(mode.equalsIgnoreCase("A")){
			...
			/*Journal Voucher Grid Ends*/
						...
						if(val>0.0){
							...
							setData();
							setHidterminationBenefitsPostingDate(terminationBenfitDate.toString());
							terminationBenefitsPostingBean=(ClsTerminationBenefitsBean)request.getAttribute("terminationBenefitsPostingBean");   
							if(terminationBenefitsPostingBean!=null){
							if(!terminationBenefitsPostingBean.getValidmsg().equals("") && terminationBenefitsPostingBean.getValidmsg()!=null) {
								setMsg(terminationBenefitsPostingBean.getValidmsg());
								setChkstatus("1");
							}else {
							setMsg("Not Saved");
							}
