...
public class ClsTerminationAction extends ActionSupport{
	...
	private String hidcmbtype,chkstatus;
	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(mode.equalsIgnoreCase("A")){
			...
			if(val>0.0){
				...
				terminationBean=(ClsTerminationBean)request.getAttribute("terminationBean");   
				if(terminationBean!=null){
				if(!terminationBean.getValidmsg().equals("") && terminationBean.getValidmsg()!=null) {
					setMsg(terminationBean.getValidmsg());
					setChkstatus("1");
				}else {
				setMsg("Not Saved");
				}
