...
public class ClsCandidateMasterBean {
	...
	private String cvarraygridlength,hidcnddate,hidcnddob,hidcmbgender;
	...
	public String getCvarraygridlength() {
		return cvarraygridlength;
	}
	public void setCvarraygridlength(String cvarraygridlength) {
	...
	public String getTxtsuitable() {
		return txtsuitable;
	}
	public void setTxtsuitable(String txtsuitable) {
		this.txtsuitable = txtsuitable;
	}
