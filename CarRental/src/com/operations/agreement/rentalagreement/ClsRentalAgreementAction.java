...
public class ClsRentalAgreementAction {
	...
	//  main 
	private String hidchkinsurcomp,cmbinsurcomp,hidcmbinsurcomp,insurcompdays,racardoo,raaccessorysum;
	private String racrate;
	private String chkstatus;
	private String cmbenqtype,hidcmbenqtype;
	private String actualclientstatus,actualcldocno,actualclientname,actualclientconfig,actualcategory;
	private String Selcarcdwtotal,Selcarcdw1total;
	
	public String getSelcarcdwtotal() {
		return Selcarcdwtotal;
	}
	...
	public void setSelcarcdwtotal(String selcarcdwtotal) {
		Selcarcdwtotal = selcarcdwtotal;
	}

	public String getSelcarcdw1total() {
		return Selcarcdw1total;
	}

	public void setSelcarcdw1total(String selcarcdw1total) {
		Selcarcdw1total = selcarcdw1total;
	}

	public String getRacardoo() {
		return racardoo;
	}

	public void setRacardoo(String racardoo) {
		this.racardoo = racardoo;
	}

	public String getRaaccessorysum() {
		return raaccessorysum;
	}

	public void setRaaccessorysum(String raaccessorysum) {
		this.raaccessorysum = raaccessorysum;
	}
	...
	public String getActualclientstatus() {
		return actualclientstatus;
	}

	public void setActualclientstatus(String actualclientstatus) {
		this.actualclientstatus = actualclientstatus;
	}

	public String getActualcldocno() {
		return actualcldocno;
	}

	public void setActualcldocno(String actualcldocno) {
		this.actualcldocno = actualcldocno;
	}
	...
	public void setActualclientname(String actualclientname) {
		this.actualclientname = actualclientname;
	}

	public String getActualclientconfig() {
		return actualclientconfig;
	}

	public void setActualclientconfig(String actualclientconfig) {
		this.actualclientconfig = actualclientconfig;
	}

	public void setLblfuelrate(double lblfuelrate) {
		this.lblfuelrate = lblfuelrate;
	}

	public String getCmbenqtype() {
		return cmbenqtype;
	}

	public void setCmbenqtype(String cmbenqtype) {
		this.cmbenqtype = cmbenqtype;
	}

	public String getHidcmbenqtype() {
		return hidcmbenqtype;
	}

	public void setHidcmbenqtype(String hidcmbenqtype) {
		this.hidcmbenqtype = hidcmbenqtype;
	}

	public String getRacrate() {
		return racrate;
	}

	public void setRacrate(String racrate) {
		this.racrate = racrate;
	}

	public String getHidchkinsurcomp() {
		return hidchkinsurcomp;
	}

	public void setHidchkinsurcomp(String hidchkinsurcomp) {
		this.hidchkinsurcomp = hidchkinsurcomp;
	}

	public String getCmbinsurcomp() {
		return cmbinsurcomp;
	}

	public void setCmbinsurcomp(String cmbinsurcomp) {
		this.cmbinsurcomp = cmbinsurcomp;
	}

	public String getHidcmbinsurcomp() {
		return hidcmbinsurcomp;
	}

	public void setHidcmbinsurcomp(String hidcmbinsurcomp) {
		this.hidcmbinsurcomp = hidcmbinsurcomp;
	}

	public String getInsurcompdays() {
		return insurcompdays;
	}

	public void setInsurcompdays(String insurcompdays) {
		this.insurcompdays = insurcompdays;
	}

	private String vehauth,branchwisname,srvckm,pltid;
    ...
    private String rentalproject,hidrentalproject;
		private String lbldesc,lblauthority,lblduedate;
		private double totaltot,rentaltotals,lblfuelrate;
		
		public Double getLblfuelrate() {
			return lblfuelrate;
		}
	...
	private String ravehname,ravehregno,ravehmodel,ravehgroup,radateout,ratimeout,raklmout,excessinsu;  
	 ...
	 private String radaily,raweakly,ramonthly,tariff,racdwscdw,raaccessory,rarentserdue,raadditionalcge,rafuelout,totalpaids,invamount,balance,rasupercdw,ravmd ,indigoradaily;
	...
	private String inkm,infuel,indate,intime,docnoval,rastatus,rayom,racolor,adddrname1,adddrname2,addlicno1,addlicno2,expdate1,expdate2,adddob1,adddob2,raextrakm,raexxtakmchg,rarenttypes;
		...
		private String lblnation,nation2,lblissfromdate,lblissby,lblidno,lblpassissued;
...
public Map<String, Object> getParam() {
	...
	//---------print----------//
		...
		private String ravehauthregno;
				...
				private String lblvisaissdate,lbfueltype;
...
//----------------------------------------------------------------------------------------------
	...
	public String getLblcosmofleetno() {
			...
			private String lbltotalfuelused;
			private String lbltotalfuelamt;
			private String lbltotalfuelamtwords,kmmobno,kmdlno,kmdob;
			
			
			public String getKmmobno() {
				return kmmobno;
			}

			public void setKmmobno(String kmmobno) {
				this.kmmobno = kmmobno;
			}

			public String getKmdlno() {
				return kmdlno;
			}

			public void setKmdlno(String kmdlno) {
				this.kmdlno = kmdlno;
			}

			public String getKmdob() {
				return kmdob;
			}

			public void setKmdob(String kmdob) {
				this.kmdob = kmdob;
			}

			public String getLbltotalfuelamtwords() {
				return lbltotalfuelamtwords;
			}

			public void setLbltotalfuelamtwords(String lbltotalfuelamtwords) {
				this.lbltotalfuelamtwords = lbltotalfuelamtwords;
			}

			
			public String getLbltotalfuelused() {
				return lbltotalfuelused;
			}

			public void setLbltotalfuelused(String lbltotalfuelused) {
				this.lbltotalfuelused = lbltotalfuelused;
			}

			public String getLbltotalfuelamt() {
				return lbltotalfuelamt;
			}

			public void setLbltotalfuelamt(String lbltotalfuelamt) {
				this.lbltotalfuelamt = lbltotalfuelamt;
			}
			...
			public String lblindigoemail,lblindigoaddress;



			public String getLblindigoemail() {
				return lblindigoemail;
			}

			public void setLblindigoemail(String lblindigoemail) {
				this.lblindigoemail = lblindigoemail;
			}

			public String getLblindigoaddress() {
				return lblindigoaddress;
			}

			public void setLblindigoaddress(String lblindigoaddress) {
				this.lblindigoaddress = lblindigoaddress;
			}
	...
	public String saveAction() throws ParseException, SQLException{
		...
		setHidchkorgregcard(getHidchkorgregcard());
           if(mode.equalsIgnoreCase("A")){
			...
			ClsRentalAgreementAction masteraction=new ClsRentalAgreementAction();
			masteraction.setHidchkinsurcomp(getHidchkinsurcomp()==null?"0":getHidchkinsurcomp());
			masteraction.setCmbinsurcomp(getCmbinsurcomp()==null?"0":getCmbinsurcomp());
			masteraction.setInsurcompdays(getInsurcompdays()==null?"0":getInsurcompdays());
			masteraction.setRacrate(getRacrate()==null?"0":getRacrate());
			masteraction.setCmbenqtype(getCmbenqtype()==null?"0":getCmbenqtype());
			
			masteraction.setActualcldocno(getActualcldocno()==null || getActualcldocno().equalsIgnoreCase("")?"0":getActualcldocno());
			...
			int val=rentalAgmtDAO.insert(sqlrentalDate,getTxtfleetno(),getTxtcusid(),getRe_salmanid(),getRe_clcodeno(),
					...
					getWeekend(),getHidchkorgregcard(),getHidchkigst(),getHidrentalproject(),masteraction);
			int vdocno=Integer.parseInt(request.getAttribute("vocno")==null?"0":request.getAttribute("vocno").toString());
			if(val>0){
				setActualcldocno(getActualcldocno());
				setActualclientname(getActualclientname());
				setRacrate(getRacrate());
				setHidchkinsurcomp(getHidchkinsurcomp());
	  			setHidcmbinsurcomp(getCmbinsurcomp());
	  			setInsurcompdays(getInsurcompdays());
	  			setCmbenqtype(getCmbenqtype());
	  			setHidcmbenqtype(getCmbenqtype());
				//main 
				...
				if(val==-1) {
					setChkstatus("1");
					setMsg("Duplicate agreement found");
				}
				return "fail";
			}	
  			...
  			setActualcldocno(RentalAgreementBean.getActualcldocno());
  			setActualclientname(RentalAgreementBean.getActualclientname());
  			setHidcmbenqtype(RentalAgreementBean.getHidcmbenqtype());
  			setRacrate(RentalAgreementBean.getRacrate());
  			setHidchkinsurcomp(RentalAgreementBean.getHidchkinsurcomp());
  			setHidcmbinsurcomp(RentalAgreementBean.getHidcmbinsurcomp());
  			setInsurcompdays(RentalAgreementBean.getInsurcompdays());
...
//  			System.out.println("From Action ORGREG : "+getHidchkorgregcard());
			...
			System.out.println("Excess Insur. In Action"+getExcessinsur());
			//payment
...
/*		public  String payment(){
		...
		//System.out.println("========hiiiiiiiiiiii"+getFormdetailcode());
			 ...
			 try{
			  ...
			  int sigdoc=0;
			  sigdoc=Integer.parseInt(getInspdoc());
			  String[] path={"",""};
			  if(sigdoc>0){
//			  System.out.println("sigdoc====="+sigdoc);
			  ...
			  //path=inspbean.getSignature().split("/attachment");
			      if(inspbean.getSignature().contains("attachment")){
			          System.out.println("Inside 1st split");
			          path=inspbean.getSignature().split("attachment");
			      }
			  }
			  for(int i=0;i<path.length;i++){
			      System.out.println("Split Sign "+i+" ::"+path[i]);
			  }
			  System.out.println("Signature Path:"+inspbean.getSignature());
			  ...
			  Double prate=0.00,drate=0.00,frate=0.00;
...
if(getLbfueltype()!=null){
    if(bean.getLbfueltype().equalsIgnoreCase("P"))
    {
        frate=prate;
    }
    else
...
param=new HashMap<>();
ArrayList<String> appPicsArray=rentalAgmtDAO.getAppInspectionPrintPics(inspdoc, request.getParameter("lblurl"),agmtno, agmtype);
if(appPicsArray.size()>0) {
	 param.put("showdet1","1");
}
for(int i=0,j=0;i<appPicsArray.size();i++,j++){
   ...
   if(i<4){
      ...
      param.put("refimgleft"+(j+1),temp);
   }
	else if(i>=4 && i<8){
		param.put("refimgright"+(j+1),temp);
	}
	else if(i>=8 && i<12){
		param.put("refimgfrnt"+(j+1),temp);
	}
	else if(i>=8 && i<12){
		param.put("showdet2","1");
		param.put("refimgbck"+(j+1),temp);
	}
	else if(i>=12 && i<16){
		param.put("showdet3","1");
		param.put("refimgintr"+(j+1),temp);
	}	
	else if(i>=16 && i<20){
		param.put("refimgid"+(j+1),temp);
	}	
}
			  ...
			  setSrvckm(bean.getSrvckm());
			  setPltid(bean.getPltid());
			  ...
			  setLblindigoaddress(bean.getLblindigoaddress()); //brch address
			  setLblindigoemail(bean.getLblindigoemail()); // brch email
...
//			  System.out.println("emaillll"+bean.getClemail());
			  ...
			  setLblcldocno(bean.getLblcldocno());
	    	   setLdllandno(bean.getLdllandno());
				...
				setKmdob(bean.getKmdob());
				setKmdlno(bean.getKmdlno());
				setKmmobno(bean.getKmmobno()); 
	    	   //System.out.println("driver---"+bean.getKmdriver());
			  
			  // main upper
			  setBarnchval(bean.getBarnchval());
			  setMrano(bean.getMrano());
			  setRentaldoc(bean.getRentaldoc());
			  setRacardoo(bean.getRacardoo());
	    	  setRaaccessorysum(bean.getRaaccessorysum()); 
	    	    // dr details
...
//			  System.out.println("dateee"+bean.getHidjqxDateOut());
			...
			setIndigoradaily(bean.getRadaily());  
...
//			  System.out.println("===== "+bean.getRadaily()+"===== "+bean.getRaweakly()+"======= "+bean.getRamonthly()); 
			if(bean.getLblrentaltype().equalsIgnoreCase("Monthly")){
				...
				setLblcosmoexkmratemonthly(bean.getRaexxtakmchg());
				 setExcessinsur(bean.getExcessinsur());
			}
		...
		//	System.out.println("===== after == "+bean.getRadaily()+"===== "+bean.getRaweakly()+"======= "+bean.getRamonthly());
			  ...
			  setSelcarcdwtotal(bean.getSelcarcdwtotal());
			  setSelcarcdw1total(bean.getSelcarcdw1total());
...
//				System.out.println("RentalAgreementBean.getClsiclpo()=="+bean.getClsiclpo());
				...
				setActualcldocno(bean.getActualcldocno()==null || bean.getActualcldocno().equalsIgnoreCase("")?"0":bean.getActualcldocno());
	        	setActualcategory(bean.getActualcategory());
				...
				if(getUrl().contains(".jrxml")==true){
		        	   ...
		        	   // String reportFileName = "com/operations/agreement/rentalagreement/confident_rentalagreementprint.jrxml";
					     String reportFileName = "com/operations/agreement/rentalagreement/rentalAgreementCreate.jrxml";
...
//		        		   System.out.println("===== "+bean.getRadaily()+"===== "+bean.getRaweakly()+"======= "+bean.getRamonthly());
		        		  /* String imgpath=request.getSession().getServletContext().getRealPath("/icons/epic.jpg");
		        		   ...
		        		   param.put("date",getCreatedate());
						    param.put("docno",getRentaldoc());
		        		   param.put("billingaddress",getCladdress());
		        		   ...
		        		   param.put("clstatus", getRastatus());
		        		   ...
		        		   param.put("extrakm", getRaextrakm());
		        		   param.put("extrakmch", getRaexxtakmchg());
		        		   param.put("licenseplate", getDrivravehregno());
...
//		        		   System.out.println("dateout"+getHidjqxDateOut());
		        		   ...
		        		   param.put("vehicle_chno", getCh_no());
		        		   param.put("cargroup", getRavehgroup());
		        		   param.put("rentalagent",getRarenral_Agent());
                        //   System.out.println("rentalagent=="+getRarenral_Agent());
...
//				System.out.println(bean.getLbltotalexcesskmrate());
				...
				return "print";
		 		 		 ...
		 		 		 public String printFuel() throws SQLException{
			 HttpServletRequest request=ServletActionContext.getRequest();
				int docNo=Integer.parseInt(request.getParameter("docno"));
				bean=rentalAgmtDAO.getFuelPrint(request,docNo);
				setKmagmtno(bean.getKmagmtno());
				setKmclient(bean.getKmclient());
				//setKmdriver(bean.getKmdriver());
				setKmvehicle(bean.getKmvehicle());
				...
				setLbllocation(bean.getLbllocation());
				setLblbranch(bean.getLblbranch());
				setLblprintname("Fuel Details");
				setLbltotalallowedkm(bean.getLbltotalallowedkm());
				setLbltotalexcesskm(bean.getLbltotalexcesskm());
				setLbltotalexcesskmrate(bean.getLbltotalexcesskmrate());
				setLbltotalfuelused(bean.getLbltotalfuelused());
				setLbltotalfuelamt(bean.getLbltotalfuelamt());
...
//				System.out.println(bean.getLbltotalexcesskmrate());
				...
				setLblclstatus(bean.getLblclstatus());
				ClsAmountToWords objamount=new ClsAmountToWords();
				if(Double.parseDouble(bean.getLbltotalfuelamt())>0.0){
					setLbltotalfuelamtwords(objamount.convertAmountToWords(bean.getLbltotalfuelamt()));					
				}
				return "print";
		 }
                ...
                public String getIndigoradaily() {
                    return indigoradaily;
                }

                public void setIndigoradaily(String indigoradaily) {
                    this.indigoradaily = indigoradaily;
                }
