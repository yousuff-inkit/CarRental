...
public class ClsLeaseAgreementAction extends ActionSupport{
	...
	private String cardtype,cosmocreditcardno,cltelno,lblcosmocreditvaliddate,lblindigoaddnationality1,lblindigoaddnationality2,lblindigoaddmobile;
	...
	public String getLblindigoaddnationality2() {
        return lblindigoaddnationality2;
    }

    public void setLblindigoaddnationality2(String lblindigoaddnationality2) {
        this.lblindigoaddnationality2 = lblindigoaddnationality2;
    }
	...
	private String lbltotalfuelamtwords;
...
//grid
	...
	public void setParam(Map<String, Object> param) {
	  ...
	  private String lblvisaexp,lblidno;
		...
		int val=0;
		 ...
		 Map<String, String[]> requestParams = request.getParameterMap();
           ...
           if(mode.equalsIgnoreCase("A")){
        	   ...
        	   int advance_chk=getHidadvance_chk();
        	   int invoice=getInvoice();
        	  System.out.println("adv===="+advance_chk);
    	   ...
    	   ArrayList<String> paymentarray= new ArrayList<>();
     	   ...
     	   java.sql.Date sqldelDateout = commonDAO.changeStringtoSqlDate(getDeldateout());   
		     ...
		     setMasterdoc_no(getMasterdoc_no());
				...
				setHidadvance_chk(LeaseAgreementBean.getHidadvance_chk());
				System.out.println("getHidadvance_chk()==="+getHidadvance_chk());
...
public void reloadData(int docNo){
			try {
				...
				setHidadvance_chk(getHidadvance_chk());
...
public String printActions() throws ParseException, SQLException{
	...
	// int docnos=Integer.parseInt(request.getParameter("docno"));
	 ...
	 mainbean=leaseAgmtDAO.getmainPrint(doc);
	  ...
	  setLblindigoaddnationality2(bean.getLblindigoaddnationality2());
...
//	   HttpServletRequest request=ServletActionContext.getRequest();
		...
		// System.out.println("---------------master print-----------------"+getUrl());
...
HttpServletRequest request=ServletActionContext.getRequest();
int docNo=Integer.parseInt(request.getParameter("docno"));
bean=leaseAgmtDAO.getFuelPrint(request,docNo); 
setKmagmtno(bean.getKmagmtno());
setKmclient(bean.getKmclient());
setKmdriver(bean.getKmdriver());
setKmvehicle(bean.getKmvehicle());
