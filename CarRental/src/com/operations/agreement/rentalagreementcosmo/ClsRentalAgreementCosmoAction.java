...
public class ClsRentalAgreementCosmoAction {
	ClsRentalAgreementCosmoDAO rentalAgmtDAO= new ClsRentalAgreementCosmoDAO();
	ClsConnection conobj=new ClsConnection();
	ClsCommon commonDAO=new ClsCommon();
	
	
	ClsRentalAgreementCosmoBean RentalAgreementBean;
	ClsRentalAgreementCosmoBean bean;
	//  main 
...
public Map<String, Object> getParam() {
	...
	//---------print----------//
		private String ravehplate,lblnofdays,lbltraficfine,lblsalik,lblrentaldesc,lblrentaltype,lblrentalrate,lblcldocno,lbluser,lblcurrentdate;
...
// classic 
	...
	public String saveAction() throws ParseException, SQLException{
		...
		setHidchkorgregcard(getHidchkorgregcard());
           if(mode.equalsIgnoreCase("A")){
			...
			if(val>0){
  			...
  			//String branch=null;
        	int masterdocno=0;
        	int requestdocno=Integer.parseInt(request.getParameter("docno")==null?"0":request.getParameter("docno").toString());
        	masterdocno=getMasterdoc_no()>0?getMasterdoc_no():requestdocno;
        	System.out.println("Request Doc No:"+requestdocno);
  			System.out.println("Master Doc No:"+masterdocno);
        	RentalAgreementBean=rentalAgmtDAO.getViewDetails(session,masterdocno);
		...
		/*public  JSONArray tariffsearch(){
			  ...
			  try {
				  List <ClsRentalAgreementCosmoBean> list= ClsRentalAgreementCosmoDAO.list6();
				  for(ClsRentalAgreementCosmoBean bean:list){
	...
	/*	public  JSONArray chufferinfo(){
			  ...
			  JSONObject cellobj1 = null;
			  try {
				  List <ClsRentalAgreementCosmoBean> list= ClsRentalAgreementCosmoDAO.list7();
				  for(ClsRentalAgreementCosmoBean bean:list){
				  cellobj1 = new JSONObject();
		...
		/*public  JSONArray SalesgentSearch(){
			  ...
			  JSONObject cellobj1 = null;
			  try {
				  List <ClsRentalAgreementCosmoBean> list= ClsRentalAgreementCosmoDAO.list1();
				  for(ClsRentalAgreementCosmoBean bean:list){
				  cellobj1 = new JSONObject();
	...
	/*	public  JSONArray RentalgentSearch(){ 
			  ...
			  JSONObject cellobj1 = null;
			  try {
				  List <ClsRentalAgreementCosmoBean> list= ClsRentalAgreementCosmoDAO.list2();
				  for(ClsRentalAgreementCosmoBean bean:list){
				  cellobj1 = new JSONObject();
...
/*		public  JSONArray checkoutSearch(){
			  ...
			  JSONObject cellobj1 = null;
			  try {
				  List <ClsRentalAgreementCosmoBean> list= ClsRentalAgreementCosmoDAO.list3();
				  for(ClsRentalAgreementCosmoBean bean:list){
				  cellobj1 = new JSONObject();
...
/*		public  String payment(){
			...
			String cellarray1 = "";  
			  ...
			  try {
				  List <ClsRentalAgreementCosmoBean> list= ClsRentalAgreementCosmoDAO.list4();
				  for(ClsRentalAgreementCosmoBean bean:list){
...
/*			  setDeldates setDeltimes setDelkmins setDelfuels*/
			  ...
			  setDrivername(bean.getDrivername());
			  // veh details
	...
	setLblcollectfuel(bean.getLblcollectfuel());
		...
		/* public String nooriprintAction() throws ParseException, SQLException{
			 ...
			 setDocnoval(request.getParameter("docno"));
			  bean=ClsRentalAgreementCosmoDAO.getPrintnoori(doc,request);
