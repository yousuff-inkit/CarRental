...
public class ClsLeaseAgreementCosmoAction extends ActionSupport{
	ClsLeaseAgreementCosmoDAO leaseAgmtDAO= new ClsLeaseAgreementCosmoDAO();
	ClsCommon commonDAO=new ClsCommon();
	ClsConnection conobj=new ClsConnection();
	ClsLeaseAgreementCosmoBean LeaseAgreementBean;
	ClsLeaseAgreementCosmoBean bean;
	ClsLeaseAgreementCosmoBean mainbean;
		 ...
		 Map<String, String[]> requestParams = request.getParameterMap();
           ...
           if(mode.equalsIgnoreCase("A")){
			...
			val=leaseAgmtDAO.insert(sqlleaseDate,getClientid(),getLe_salmanid(),getDescription(),getLe_clcodeno(),
					...
					advance_chk,invoice,getVehlocation(),getFormdetailcode(),getClientname(),request,vehdetarray,getExcessinsur(),getLeaseprojectDoc(),
					getLeasePo(),getManualla(),getHidservicelevel(),getHidchkleaseown(),getLeaseserviceamt());
     	   ...
     	   java.sql.Date sqldelDateout = commonDAO.changeStringtoSqlDate(getDeldateout());   
		     ...
		     setMasterdoc_no(getMasterdoc_no());
				...
				setHiddelcmbtype(getCmbdelfuelout());
     			...
     			LeaseAgreementBean=leaseAgmtDAO.getViewDetails(session,masterdocno);
