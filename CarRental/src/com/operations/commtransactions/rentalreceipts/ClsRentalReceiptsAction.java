...
public class ClsRentalReceiptsAction extends ActionSupport{
	...
	private String cmbsubchq;
	private String hidcmbsubchq;
	private String txtconfigchk;

	public String getTxtconfigchk() {
		return txtconfigchk;
	}

	public void setTxtconfigchk(String txtconfigchk) {
		this.txtconfigchk = txtconfigchk;
	}

	public String getCmbsubchq() {
		return cmbsubchq;
	}

	public void setCmbsubchq(String cmbsubchq) {
		this.cmbsubchq = cmbsubchq;
	}

	public String getHidcmbsubchq() {
		return hidcmbsubchq;
	}

	public void setHidcmbsubchq(String hidcmbsubchq) {
		this.hidcmbsubchq = hidcmbsubchq;
	}
	...
	//	System.out.println("config----"+getTxtconfigchk()+"-------");

		if(getTxtconfigchk().trim().equalsIgnoreCase("1") && getCmbpaytype().trim().equalsIgnoreCase("3")){
			String typepay=getCmbpaytype().trim()+" :: "+getCmbsubchq().trim();

			setCmbpaytype(typepay);
	//		System.out.println("typepa----"+getCmbpaytype());
			}
		...
		if(mode.equalsIgnoreCase("A")){
			...
			if(val>0.0){
				...
				setChkstatus("1");
				conn.close();
				rentalReceiptsBean=(ClsRentalReceiptsBean)request.getAttribute("rentalReceiptsBean");   
				if(rentalReceiptsBean!=null){
				if(!rentalReceiptsBean.getValidmsg().equals("") && rentalReceiptsBean.getValidmsg()!=null) {
					setMsg(rentalReceiptsBean.getValidmsg());
				}else {
				setMsg("Not Saved");
				}
				}else {
		...
		if(Status){
			...
			return "fail";
				...
				setHidcmbsubchq(rentalReceiptsBean.getHidcmbsubchq());
	...
	public String printAction() throws ParseException, SQLException{
		...
		//System.out.println("rentalReceiptsBean1====="+rentalReceiptsBean.getLblcompname());
		//System.out.println("rentalReceiptsBean12====="+rentalReceiptsBean.getLblcomptel());
		//System.out.println("rentalReceiptsBean12====="+rentalReceiptsBean.getLblcompfax());
		//System.out.println("rentalReceiptsBean13====="+rentalReceiptsBean.getLblcomptel());
		//System.out.println("rentalReceiptsBean14====="+rentalReceiptsBean.getLblbranch());
	...
	public void setData(){
		String[] items;
		String cmbpaytypes="";
		 if(getCmbpaytype().startsWith("3 :: "))
	        {
			 items = getCmbpaytype().split(" :: ");
			 cmbpaytypes=items[0].trim();
			 setCmbpaytype(cmbpaytypes);
	        }
		System.out.println("paytype==="+getCmbpaytype());
