		...
		try {
			...
			while(rsemc.next()){
				...
				bean.setLblcourtesyvehicle(rsemc.getString("emccourtesyvehicle"));
					...
					+" left join gl_vmove v on v.rdocno=d.rano and (v.rdtype=inv.ratype) and trancode='dl' and repno=0  and exchng=0 and custno=0 "
...
//				System.out.println("Salik Size: "+salikdet.size());
				...
				employees.add(new ClsProformaInvoiceAction(resultSet.getString("voc_no"),resultSet.getString("refname"),resultSet.getString("codeno"),resultSet.getString("date"),
						...
						resultSet.getString("tel"),resultSet.getString("fax"),"Proforma Invoice",resultSet.getString("branchname"),resultSet.getString("branchaddress"),
