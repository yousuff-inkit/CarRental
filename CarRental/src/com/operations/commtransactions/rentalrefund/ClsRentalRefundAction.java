...
public class ClsRentalRefundAction extends ActionSupport{
	...
	private String formdetailcode, cnrdocno;
	private String mode;
	...
	private String txtpaidto,chkstatus;
	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(mode.equalsIgnoreCase("A")){
			...
			if(val>0.0){
				...
				setData();
				rentalRefundBean=(ClsRentalRefundBean)request.getAttribute("rentalRefundBean");   
				if(rentalRefundBean!=null){
				if(!rentalRefundBean.getValidmsg().equals("") && rentalRefundBean.getValidmsg()!=null) {
					setMsg(rentalRefundBean.getValidmsg());
					setChkstatus("1");
				}else {
				setMsg("Not Saved");
				}
