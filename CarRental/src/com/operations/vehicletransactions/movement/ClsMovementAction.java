...
//Config for Rider Management
private String riderconfig;



public String getRiderconfig() {
	return riderconfig;
}
public void setRiderconfig(String riderconfig) {
...
//driver details
	private String lbldrvdrivername;
	private String lbldrvlicenseno;
	private String lbldrvexpiry;
	private String lbldrvissuedfrom;
...
private String lbltotalkm;
 ...
 private String lblcloseremarks, drdname,drddlno,drdled,drddob,drdissfrm,drdmobno;
 private String lblvehtype;
 private String drdemrid;
 private String drdemredate;
 private String drdNation;
 private String lblFleetDetailsG;
 
 //brtinno
 
 private String lblbrtinno;
 
 public String getLblbrtinno() {
	return lblbrtinno;
}
public void setLblbrtinno(String lblbrtinno) {
	this.lblbrtinno = lblbrtinno;
}
public String getDrdNation() {
	return drdNation;
}
public void setDrdNation(String drdNation) {
	this.drdNation = drdNation;
}
public String getLblFleetDetailsG() {
	return lblFleetDetailsG;
}
public void setLblFleetDetailsG(String lblFleetDetailsG) {
	this.lblFleetDetailsG = lblFleetDetailsG;
}
public String getDrdemrid() {
	return drdemrid;
}
public void setDrdemrid(String drdemrid) {
	this.drdemrid = drdemrid;
}
public String getDrdemredate() {
	return drdemredate;
}
public void setDrdemredate(String drdemredate) {
	this.drdemredate = drdemredate;
}
public String getLblvehtype() {
	return lblvehtype;
}
public void setLblvehtype(String lblvehtype) {
	this.lblvehtype = lblvehtype;
}
public String getDrdname() {
	return drdname;
}
public void setDrdname(String drdname) {
	this.drdname = drdname;
}
public String getDrddlno() {
	return drddlno;
}
public void setDrddlno(String drddlno) {
	this.drddlno = drddlno;
}
public String getDrdled() {
	return drdled;
}
public void setDrdled(String drdled) {
	this.drdled = drdled;
}
public String getDrddob() {
	return drddob;
}
public void setDrddob(String drddob) {
	this.drddob = drddob;
}
public String getDrdissfrm() {
	return drdissfrm;
}
public void setDrdissfrm(String drdissfrm) {
	this.drdissfrm = drdissfrm;
}
public String getDrdmobno() {
	return drdmobno;
}
public void setDrdmobno(String drdmobno) {
	this.drdmobno = drdmobno;
}
...
public String getLbldrvdrivername() {
	return lbldrvdrivername;
}
public void setLbldrvdrivername(String lbldrvdrivername) {
	this.lbldrvdrivername = lbldrvdrivername;
}
public String getLbldrvlicenseno() {
	return lbldrvlicenseno;
}
public void setLbldrvlicenseno(String lbldrvlicenseno) {
	this.lbldrvlicenseno = lbldrvlicenseno;
}
public String getLbldrvexpiry() {
	return lbldrvexpiry;
}
public void setLbldrvexpiry(String lbldrvexpiry) {
	this.lbldrvexpiry = lbldrvexpiry;
}
public String getLbldrvissuedfrom() {
	return lbldrvissuedfrom;
}
public void setLbldrvissuedfrom(String lbldrvissuedfrom) {
	this.lbldrvissuedfrom = lbldrvissuedfrom;
}
//Reload Method
...
//	System.out.println("sessoin"+session.getAttribute("COMPANYNAME"));
	...
	if((mode.equalsIgnoreCase("A"))||mode.equalsIgnoreCase("close")||mode.equalsIgnoreCase("D")){
		...
		if(getClosedate()!=null && !getClosedate().equalsIgnoreCase("")){
			closedate = objcommon.changeStringtoSqlDate(getClosedate());	
		}
		if(getGaragedeldate()!=null && !getGaragedeldate().equalsIgnoreCase("")){
			garagedeliverydate=objcommon.changeStringtoSqlDate(getGaragedeldate());	
		}
	
		if(getGaragecollectdate()!=null && !getGaragecollectdate().equalsIgnoreCase("")){
	...
	if(mode.equalsIgnoreCase("A")){
					...
					if(val>0.0){
						if(getRiderconfig().trim().equalsIgnoreCase("1")) {
							boolean updateRiderMov=movementDAO.updateRiderMov(val,getCmbstatus(),getHidstaff());
						}
						...
						setMsg("Not Saved");setExtramsg(getMsg());
						setChkstatus("1");
						setDeliverystatus("0");
						return "fail";
					}	
...
//		System.out.println("Inside Close");
	...
	if(value>0){
		//boolean riderclosestatus=movementDAO.closeRiderMov(getDocno());
		setvalues(date,dateout,closedate,garagedeliverydate,garagecollectdate,mode,session);
		setDocno(getDocno());
		setMsg("Successfully Saved");setExtramsg(getMsg());
...
//				System.out.println("sucess");
	...
	/*else if(mode.equalsIgnoreCase("E")){
			...
			int deletevalue=movementDAO.delete(getDocno(),getFormdetailcode(),session);
		...
		if(deletevalue>0){
		    ...
		    setvalues(date,dateout,closedate,garagedeliverydate,garagecollectdate,mode,session);
            setMsg("Not Deleted");
            setExtramsg("Not Deleted,Other movements found against this vehicle");
            setDocno(getDocno());
			...
			setvalues(date,dateout,closedate,garagedeliverydate,garagecollectdate,mode,session);
			setMsg("Not Deleted");setExtramsg(getMsg());
			setDocno(getDocno());
...
//	System.out.println("Inside print Action");
	...
	setLblprintname("Non-Revenue Agreement");
	...
	setLbldrvdrivername(bean.getLbldrvdrivername());
	setLbldrvlicenseno(bean.getLbldrvlicenseno());
	setLbldrvissuedfrom(bean.getLbldrvissuedfrom());
	setLbldrvexpiry(bean.getLbldrvexpiry());
	...
	setDrddob(bean.getDrddob());
	setDrdname(bean.getDrdname());
	setDrddlno(bean.getDrddlno());
	setDrdled(bean.getDrdled());
	setDrdissfrm(bean.getDrdissfrm());
	setLblFleetDetailsG(bean.getLblFleetDetailsG());
	setDrdNation(bean.getDrdNation());
	setDrdmobno(bean.getDrdmobno());
	setLblclosegarage(bean.getLblclosegarage());
	setLblmovtype(bean.getLblmovtype());
	setLblvehtype(bean.getLblvehtype());
//System.out.println("bean.getLblmovtype()--"+bean.getLblmovtype());
	setLblopenremarks(bean.getLblopenremarks());
	setLblcloseremarks(bean.getLblcloseremarks());
	setDrdemrid(bean.getDrdemrid());
	setDrdemredate(bean.getDrdemredate());
	setLblbrtinno(bean.getLblbrtinno());
	return "print";
}
