...
public class ClsClientAction extends ActionSupport{
	...
	//Checkboxes for Salik & Traffic
	private String chksalikauhpercent,chksalikdxbpercent,chktrafficpercent,chkparkingpercent;
	private String hidchksalikauhpercent,hidchksalikdxbpercent,hidchktrafficpercent,hidchkparkingpercent;
	...
	public void setTxtparking(String txtparking) {
		this.txtparking = txtparking;
	}

	public String getChksalikauhpercent() {
		return chksalikauhpercent;
	}

	public void setChksalikauhpercent(String chksalikauhpercent) {
		this.chksalikauhpercent = chksalikauhpercent;
	}

	public String getChksalikdxbpercent() {
		return chksalikdxbpercent;
	}

	public void setChksalikdxbpercent(String chksalikdxbpercent) {
		this.chksalikdxbpercent = chksalikdxbpercent;
	}

	public String getChktrafficpercent() {
		return chktrafficpercent;
	}

	public void setChktrafficpercent(String chktrafficpercent) {
		this.chktrafficpercent = chktrafficpercent;
	}

	public String getChkparkingpercent() {
		return chkparkingpercent;
	}

	public void setChkparkingpercent(String chkparkingpercent) {
		this.chkparkingpercent = chkparkingpercent;
	}

	public String getHidchksalikauhpercent() {
		return hidchksalikauhpercent;
	}

	public void setHidchksalikauhpercent(String hidchksalikauhpercent) {
		this.hidchksalikauhpercent = hidchksalikauhpercent;
	}

	public String getHidchksalikdxbpercent() {
		return hidchksalikdxbpercent;
	}

	public void setHidchksalikdxbpercent(String hidchksalikdxbpercent) {
		this.hidchksalikdxbpercent = hidchksalikdxbpercent;
	}

	public String getHidchktrafficpercent() {
		return hidchktrafficpercent;
	}

	public void setHidchktrafficpercent(String hidchktrafficpercent) {
		this.hidchktrafficpercent = hidchktrafficpercent;
	}

	public String getHidchkparkingpercent() {
		return hidchkparkingpercent;
	}

	public void setHidchkparkingpercent(String hidchkparkingpercent) {
		this.hidchkparkingpercent = hidchkparkingpercent;
	}

	public String getParkingpercent() {
		return parkingpercent;
	}

	public void setParkingpercent(String parkingpercent) {
		this.parkingpercent = parkingpercent;
	}
	...
	public int getReferencelength1() {
		return referencelength1;
	}

	public void setReferencelength1(int referencelength1) {
		this.referencelength1 = referencelength1;
	}
	...
	public void setChksalikpercent(String chksalikpercent) {
		this.chksalikpercent = chksalikpercent;
	}

	public String getHidchksalikpercent() {
		return hidchksalikpercent;
	}

	public void setHidchksalikpercent(String hidchksalikpercent) {
		this.hidchksalikpercent = hidchksalikpercent;
	}

	public String getSalikpercent() {
		return salikpercent;
	}

	public void setSalikpercent(String salikpercent) {
		this.salikpercent = salikpercent;
	}

	public String getSalikauhpercent() {
		return salikauhpercent;
	}

	public void setSalikauhpercent(String salikauhpercent) {
		this.salikauhpercent = salikauhpercent;
	}
	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(mode.equalsIgnoreCase("A")){
			...
			masteraction.setSalikpercent(getSalikpercent());
			masteraction.setTrafficpercent(getTrafficpercent());
			
			masteraction.setHidchksalikauhpercent(getHidchksalikauhpercent());
			masteraction.setHidchksalikdxbpercent(getHidchksalikdxbpercent());
			masteraction.setHidchktrafficpercent(getHidchktrafficpercent());
			...
			int val=clientDAO.insert(clientDate,getFormdetailcode(),getTxtclient_name(),getCmbsalutation(),getCmbcurrency(),getCmbgroup(),getCmbcategory(),
					...
					contractDate,getTxtcontractremarks(),getTxtjobtitle(),dateOfJoiningDate,getTxtbankname(),getTxtregisteredtrnno(),driverarray,referencearray,referencearraynew,attacharray,creditcardarray,separateservicechargearray,
					session,request,getTxtsalikauh(),masteraction);
			if(val>0.0){
			...
			int Status=clientDAO.edit(getTxtclientdocno(),getFormdetailcode(),clientDate,getTxtclient_name(),getCmbsalutation(),getCmbcurrency(),getCmbgroup(),
					...
					getTxtbankname(),getTxtregisteredtrnno(),driverarray,referencearray,referencearraynew,
					attacharray,creditcardarray,separateservicechargearray,session,getTxtsalikauh(),masteraction);
			if(Status>0){
		...
		if(Status>0){
           ...
           setHidchksalikpercent(clientbean.getHidchksalikpercent());
           setHidchksalikauhpercent(clientbean.getHidchksalikauhpercent());
           setHidchksalikdxbpercent(clientbean.getHidchksalikdxbpercent());
            setHidchktrafficpercent(clientbean.getHidchktrafficpercent());
            setHidchkparkingpercent(clientbean.getHidchkparkingpercent());
    
            setSalikauhpercent(clientbean.getSalikauhpercent());
            setSalikpercent(clientbean.getSalikpercent());
            setTrafficpercent(clientbean.getTrafficpercent());
            setParkingpercent(clientbean.getParkingpercent());
            
            setTxtparking(clientbean.getTxtparking());
            setTxtsalikauh(clientbean.getTxtsalikauh());
            setHidjqxClientDate(clientbean.getHidjqxClientDate());
		...
		public void setData() {
			...
			setHidchkparkingpercent(getHidchkparkingpercent());
			setHidchksalikauhpercent(getHidchksalikauhpercent());
			setHidchksalikdxbpercent(getHidchksalikdxbpercent());
			setHidchktrafficpercent(getHidchktrafficpercent());
			
			setHidchksalikpercent(getHidchksalikpercent());
			setSalikauhpercent(getSalikauhpercent());
			setSalikpercent(getSalikpercent());
			setTrafficpercent(getTrafficpercent());
