		...
		if(mode.equalsIgnoreCase("A")){
			...
			if(chk>0){
						...
						if(val>0.0){
							...
							setData();
							ibCashPaymentBean = (ClsIbCashPaymentBean)request.getAttribute("ibCashPaymentBean"); 
							if(ibCashPaymentBean!=null){
    							if(!ibCashPaymentBean.getValidmsg().equals("") && ibCashPaymentBean.getValidmsg()!=null) {
    								setMsg(ibCashPaymentBean.getValidmsg());
    								setChkstatus("1");
    							}else {
    							    setMsg("Not Saved");
    							}   
