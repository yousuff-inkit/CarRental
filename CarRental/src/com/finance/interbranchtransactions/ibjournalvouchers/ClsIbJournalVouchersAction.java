		...
		if(mode.equalsIgnoreCase("A")){
			...
			/*Ib-Journal Voucher Grid Ends*/
						...
						if(val>0.0){
							...
							setData();
							ibJournalVouchersBean=(ClsIbJournalVouchersBean)request.getAttribute("ibJournalVouchersBean"); 
							if(ibJournalVouchersBean!=null){
    							if(!ibJournalVouchersBean.getValidmsg().equals("") && ibJournalVouchersBean.getValidmsg()!=null) {
    								setMsg(ibJournalVouchersBean.getValidmsg());
    								setChkstatus("1");
    							}else {
    							    setMsg("Not Saved");
    							}
