...
public class ClsVehicleDepreciationPostingAction extends ActionSupport{
	...
	private String lblpreparedat,chkstatus;
		...
		if(mode.equalsIgnoreCase("A")){
			...
			/*Journal Voucher Grid Ends*/
						...
						if(val>0.0){
							...
							setData();
							setHidjqxVehDepreciationPostingDate(vehDepreciationDate.toString());
							vehicleDepreciationPostingBean=(ClsVehicleDepreciationPostingBean)request.getAttribute("vehicleDepreciationPostingBean");   
							if(vehicleDepreciationPostingBean!=null){
							if(!vehicleDepreciationPostingBean.getValidmsg().equals("") && vehicleDepreciationPostingBean.getValidmsg()!=null) {
								setMsg(vehicleDepreciationPostingBean.getValidmsg());
								setChkstatus("1");
							}else {
							setMsg("Not Saved");
							}
