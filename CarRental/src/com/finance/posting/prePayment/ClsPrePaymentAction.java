...
public class ClsPrePaymentAction extends ActionSupport{
	...
	public double getTxtdecamount() {
		return txtdecamount;
	}

	public void setTxtdecamount(double txtdecamount) {
		this.txtdecamount = txtdecamount;
	}
	private String hidmodes;
	
	public String getHidmodes() {
		return hidmodes;
	}

	public void setHidmodes(String hidmodes) {
		this.hidmodes = hidmodes;
	}
...
//System.out.println("IN SAVE ACTION"+getMode());
		String mode=getMode();
	...
	public void setData() {
    	    ...
    	    setTxtdecamount(getTxtdecamount());
    	    if(startDate != null){
