		...
		if(mode.equalsIgnoreCase("A")){
			...
			/*Fuel Card Reimbursement Grid Saving Ends*/
						...
						if(val>0.0){
							...
							setData();
							fuelCardReimbursementBean=(ClsFuelCardReimbursementBean)request.getAttribute("fuelCardReimbursementBean");
							if(fuelCardReimbursementBean!=null){
    							if(!fuelCardReimbursementBean.getValidmsg().equals("") && fuelCardReimbursementBean.getValidmsg()!=null) {
    								setMsg(fuelCardReimbursementBean.getValidmsg());
    								setChkstatus("1");
    							}else {
    							    setMsg("Not Saved");
    							}
